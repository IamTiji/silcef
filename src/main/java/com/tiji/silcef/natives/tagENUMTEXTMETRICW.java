...
public class tagENUMTEXTMETRICW {
    ...
    private static final long etmNewTextMetricEx$OFFSET = $LAYOUT.byteOffset(groupElement("etmNewTextMetricEx"));
    ...
    private static final long etmAxesList$OFFSET = $LAYOUT.byteOffset(groupElement("etmAxesList"));
