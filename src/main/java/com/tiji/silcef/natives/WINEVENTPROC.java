 ...
 * }
 */
public final class WINEVENTPROC {

    private WINEVENTPROC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(WINEVENTPROC.Function.class, "apply", $DESC);
