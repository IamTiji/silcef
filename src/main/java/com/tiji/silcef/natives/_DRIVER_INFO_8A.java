...
public class _DRIVER_INFO_8A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_POINTER.withName("pszPrintProcessor"),
        cef_master_h.C_POINTER.withName("pszVendorSetup"),
        cef_master_h.C_POINTER.withName("pszzColorProfiles"),
        cef_master_h.C_POINTER.withName("pszInfPath"),
        cef_master_h.C_LONG.withName("dwPrinterDriverAttributes"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("pszzCoreDriverDependencies"),
        _FILETIME.layout().withName("ftMinInboxDriverVerDate"),
        cef_master_h.C_LONG_LONG.withName("dwlMinInboxDriverVerVersion")
