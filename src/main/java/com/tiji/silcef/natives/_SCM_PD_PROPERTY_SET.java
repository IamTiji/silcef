...
public class _SCM_PD_PROPERTY_SET {
    ...
    private static final long PropertyId$OFFSET = $LAYOUT.byteOffset(groupElement("PropertyId"));
    ...
    private static final long SetType$OFFSET = $LAYOUT.byteOffset(groupElement("SetType"));
    ...
    private static final long AdditionalParameters$OFFSET = $LAYOUT.byteOffset(groupElement("AdditionalParameters"));
    ...
    public static byte AdditionalParameters(MemorySegment struct, long index0) {
        return (byte)AdditionalParameters$ELEM_HANDLE.get(struct, AdditionalParameters$OFFSET, index0);
    }
    ...
    public static void AdditionalParameters(MemorySegment struct, long index0, byte fieldValue) {
        AdditionalParameters$ELEM_HANDLE.set(struct, AdditionalParameters$OFFSET, index0, fieldValue);
    }
