...
public class tagSOLE_AUTHENTICATION_SERVICE {
    ...
    private static final long pPrincipalName$OFFSET = $LAYOUT.byteOffset(groupElement("pPrincipalName"));
    ...
    private static final long hr$OFFSET = $LAYOUT.byteOffset(groupElement("hr"));
