 ...
 * }
 */
public final class ENUMRESNAMEPROCW {

    private ENUMRESNAMEPROCW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ENUMRESNAMEPROCW.Function.class, "apply", $DESC);
