...
public class _CERT_SIMPLE_CHAIN {
    ...
    private static final long cElement$OFFSET = $LAYOUT.byteOffset(groupElement("cElement"));
    ...
    private static final long rgpElement$OFFSET = $LAYOUT.byteOffset(groupElement("rgpElement"));
    ...
    private static final long pTrustListInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pTrustListInfo"));
