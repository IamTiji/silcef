...
public class _CRYPT_ATTRIBUTES {
    ...
    private static final long cAttr$OFFSET = $LAYOUT.byteOffset(groupElement("cAttr"));
    ...
    private static final long rgAttr$OFFSET = $LAYOUT.byteOffset(groupElement("rgAttr"));
