 ...
 * }
 */
public final class PFIBER_START_ROUTINE {

    private PFIBER_START_ROUTINE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFIBER_START_ROUTINE.Function.class, "apply", $DESC);
