...
public class _CREATE_PROCESS_DEBUG_INFO {
    ...
    private static final long hFile$OFFSET = $LAYOUT.byteOffset(groupElement("hFile"));
    ...
    private static final long lpBaseOfImage$OFFSET = $LAYOUT.byteOffset(groupElement("lpBaseOfImage"));
    ...
    private static final long dwDebugInfoFileOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwDebugInfoFileOffset"));
    ...
    private static final long nDebugInfoSize$OFFSET = $LAYOUT.byteOffset(groupElement("nDebugInfoSize"));
    ...
    private static final long lpThreadLocalBase$OFFSET = $LAYOUT.byteOffset(groupElement("lpThreadLocalBase"));
    ...
    private static final long lpStartAddress$OFFSET = $LAYOUT.byteOffset(groupElement("lpStartAddress"));
    ...
    private static final long lpImageName$OFFSET = $LAYOUT.byteOffset(groupElement("lpImageName"));
    ...
    private static final long fUnicode$OFFSET = $LAYOUT.byteOffset(groupElement("fUnicode"));
