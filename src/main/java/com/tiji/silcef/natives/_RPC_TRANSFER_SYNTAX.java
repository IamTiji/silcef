...
public class _RPC_TRANSFER_SYNTAX {
    ...
    private static final long VersMajor$OFFSET = $LAYOUT.byteOffset(groupElement("VersMajor"));
    ...
    private static final long VersMinor$OFFSET = $LAYOUT.byteOffset(groupElement("VersMinor"));
