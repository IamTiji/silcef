 ...
 * }
 */
public final class FONTENUMPROCA {

    private FONTENUMPROCA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(FONTENUMPROCA.Function.class, "apply", $DESC);
