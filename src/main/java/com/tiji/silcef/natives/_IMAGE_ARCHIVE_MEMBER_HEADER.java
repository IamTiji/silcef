...
public class _IMAGE_ARCHIVE_MEMBER_HEADER {
    ...
    public static byte Date(MemorySegment struct, long index0) {
        return (byte)Date$ELEM_HANDLE.get(struct, Date$OFFSET, index0);
    }
    ...
    public static void Date(MemorySegment struct, long index0, byte fieldValue) {
        Date$ELEM_HANDLE.set(struct, Date$OFFSET, index0, fieldValue);
    }
    ...
    public static byte UserID(MemorySegment struct, long index0) {
        return (byte)UserID$ELEM_HANDLE.get(struct, UserID$OFFSET, index0);
    }
    ...
    public static void UserID(MemorySegment struct, long index0, byte fieldValue) {
        UserID$ELEM_HANDLE.set(struct, UserID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long GroupID$OFFSET = $LAYOUT.byteOffset(groupElement("GroupID"));
    ...
    public static byte GroupID(MemorySegment struct, long index0) {
        return (byte)GroupID$ELEM_HANDLE.get(struct, GroupID$OFFSET, index0);
    }
    ...
    public static void GroupID(MemorySegment struct, long index0, byte fieldValue) {
        GroupID$ELEM_HANDLE.set(struct, GroupID$OFFSET, index0, fieldValue);
    }
    ...
    public static byte Mode(MemorySegment struct, long index0) {
        return (byte)Mode$ELEM_HANDLE.get(struct, Mode$OFFSET, index0);
    }
    ...
    public static void Mode(MemorySegment struct, long index0, byte fieldValue) {
        Mode$ELEM_HANDLE.set(struct, Mode$OFFSET, index0, fieldValue);
    }
    ...
    public static byte Size(MemorySegment struct, long index0) {
        return (byte)Size$ELEM_HANDLE.get(struct, Size$OFFSET, index0);
    }
    ...
    public static void Size(MemorySegment struct, long index0, byte fieldValue) {
        Size$ELEM_HANDLE.set(struct, Size$OFFSET, index0, fieldValue);
    }
    ...
    private static final long EndHeader$OFFSET = $LAYOUT.byteOffset(groupElement("EndHeader"));
    ...
    public static byte EndHeader(MemorySegment struct, long index0) {
        return (byte)EndHeader$ELEM_HANDLE.get(struct, EndHeader$OFFSET, index0);
    }
    ...
    public static void EndHeader(MemorySegment struct, long index0, byte fieldValue) {
        EndHeader$ELEM_HANDLE.set(struct, EndHeader$OFFSET, index0, fieldValue);
    }
