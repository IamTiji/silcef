...
public class _NDR_CS_ROUTINES {
    ...
    private static final long pSizeConvertRoutines$OFFSET = $LAYOUT.byteOffset(groupElement("pSizeConvertRoutines"));
    ...
    private static final long pTagGettingRoutines$OFFSET = $LAYOUT.byteOffset(groupElement("pTagGettingRoutines"));
