...
public class _SCM_PD_DEVICE_SPECIFIC_INFO {
    ...
    private static final long NumberOfProperties$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfProperties"));
    ...
    private static final long DeviceSpecificProperties$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceSpecificProperties"));
    ...
    public static MemorySegment DeviceSpecificProperties(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)DeviceSpecificProperties$ELEM_HANDLE.invokeExact(struct, DeviceSpecificProperties$OFFSET, index0);
