...
public class _STREAM_EXTENT_ENTRY {
    ...
    public static class ExtentInformation {
        ...
        private static final long RetrievalPointers$OFFSET = $LAYOUT.byteOffset(groupElement("RetrievalPointers"));
    ...
    private static final long ExtentInformation$OFFSET = $LAYOUT.byteOffset(groupElement("ExtentInformation"));
