...
public class _userFLAG_STGMEDIUM {
    ...
    private static final long fPassOwnership$OFFSET = $LAYOUT.byteOffset(groupElement("fPassOwnership"));
    ...
    private static final long Stgmed$OFFSET = $LAYOUT.byteOffset(groupElement("Stgmed"));
