...
public class _CMC_TAGGED_CONTENT_INFO {
    ...
    private static final long dwBodyPartID$OFFSET = $LAYOUT.byteOffset(groupElement("dwBodyPartID"));
    ...
    private static final long EncodedContentInfo$OFFSET = $LAYOUT.byteOffset(groupElement("EncodedContentInfo"));
