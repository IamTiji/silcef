...
public class _UMS_SCHEDULER_STARTUP_INFO {
    ...
    private static final long CompletionList$OFFSET = $LAYOUT.byteOffset(groupElement("CompletionList"));
    ...
    private static final long SchedulerProc$OFFSET = $LAYOUT.byteOffset(groupElement("SchedulerProc"));
    ...
    private static final long SchedulerParam$OFFSET = $LAYOUT.byteOffset(groupElement("SchedulerParam"));
