...
public class SChannelHookCallInfo {
    ...
    private static final long uCausality$OFFSET = $LAYOUT.byteOffset(groupElement("uCausality"));
    ...
    private static final long dwServerPid$OFFSET = $LAYOUT.byteOffset(groupElement("dwServerPid"));
    ...
    private static final long pObject$OFFSET = $LAYOUT.byteOffset(groupElement("pObject"));
