...
public class _MMIOINFO {
    ...
    private static final long fccIOProc$OFFSET = $LAYOUT.byteOffset(groupElement("fccIOProc"));
    ...
    private static final long pIOProc$OFFSET = $LAYOUT.byteOffset(groupElement("pIOProc"));
    ...
    private static final long wErrorRet$OFFSET = $LAYOUT.byteOffset(groupElement("wErrorRet"));
    ...
    private static final long htask$OFFSET = $LAYOUT.byteOffset(groupElement("htask"));
    ...
    private static final long cchBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("cchBuffer"));
    ...
    private static final long pchBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pchBuffer"));
    ...
    private static final long pchNext$OFFSET = $LAYOUT.byteOffset(groupElement("pchNext"));
    ...
    private static final long pchEndRead$OFFSET = $LAYOUT.byteOffset(groupElement("pchEndRead"));
    ...
    private static final long pchEndWrite$OFFSET = $LAYOUT.byteOffset(groupElement("pchEndWrite"));
    ...
    private static final long lBufOffset$OFFSET = $LAYOUT.byteOffset(groupElement("lBufOffset"));
    ...
    private static final long lDiskOffset$OFFSET = $LAYOUT.byteOffset(groupElement("lDiskOffset"));
    ...
    private static final long adwInfo$OFFSET = $LAYOUT.byteOffset(groupElement("adwInfo"));
    ...
    public static int adwInfo(MemorySegment struct, long index0) {
        return (int)adwInfo$ELEM_HANDLE.get(struct, adwInfo$OFFSET, index0);
    }
    ...
    public static void adwInfo(MemorySegment struct, long index0, int fieldValue) {
        adwInfo$ELEM_HANDLE.set(struct, adwInfo$OFFSET, index0, fieldValue);
    }
    ...
    private static final long dwReserved2$OFFSET = $LAYOUT.byteOffset(groupElement("dwReserved2"));
    ...
    private static final long hmmio$OFFSET = $LAYOUT.byteOffset(groupElement("hmmio"));
