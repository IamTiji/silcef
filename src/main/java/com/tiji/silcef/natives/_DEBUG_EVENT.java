...
public class _DEBUG_EVENT {
    ...
    private static final long dwDebugEventCode$OFFSET = $LAYOUT.byteOffset(groupElement("dwDebugEventCode"));
    ...
    public static class u {
        ...
        private static final GroupLayout Exception_$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Exception"));
         ...
         * }
         */
        public static final GroupLayout Exception_$layout() {
            return Exception_$LAYOUT;
        }

        private static final long Exception_$OFFSET = $LAYOUT.byteOffset(groupElement("Exception"));
         ...
         * }
         */
        public static final long Exception_$offset() {
            return Exception_$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment Exception_(MemorySegment union) {
            return union.asSlice(Exception_$OFFSET, Exception_$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void Exception_(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, Exception_$OFFSET, Exception_$LAYOUT.byteSize());
        }
        ...
        private static final long CreateThread$OFFSET = $LAYOUT.byteOffset(groupElement("CreateThread"));
        ...
        private static final long CreateProcessInfo$OFFSET = $LAYOUT.byteOffset(groupElement("CreateProcessInfo"));
        ...
        private static final long ExitThread$OFFSET = $LAYOUT.byteOffset(groupElement("ExitThread"));
        ...
        private static final long ExitProcess$OFFSET = $LAYOUT.byteOffset(groupElement("ExitProcess"));
        ...
        private static final long LoadDll$OFFSET = $LAYOUT.byteOffset(groupElement("LoadDll"));
        ...
        private static final long UnloadDll$OFFSET = $LAYOUT.byteOffset(groupElement("UnloadDll"));
        ...
        private static final long DebugString$OFFSET = $LAYOUT.byteOffset(groupElement("DebugString"));
        ...
        private static final long RipInfo$OFFSET = $LAYOUT.byteOffset(groupElement("RipInfo"));
