...
public class tagMIXERLINECONTROLSA {
    ...
    private static final OfInt dwControlID$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2230:5"), groupElement("dwControlID"));
    ...
    private static final long dwControlID$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2230:5"), groupElement("dwControlID"));
    ...
    private static final OfInt dwControlType$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2230:5"), groupElement("dwControlType"));
    ...
    private static final long dwControlType$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2230:5"), groupElement("dwControlType"));
