...
public class tagMSGBOXPARAMSW {
    ...
    private static final long lpszText$OFFSET = $LAYOUT.byteOffset(groupElement("lpszText"));
    ...
    private static final long lpszCaption$OFFSET = $LAYOUT.byteOffset(groupElement("lpszCaption"));
    ...
    private static final long lpszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("lpszIcon"));
    ...
    private static final long dwContextHelpId$OFFSET = $LAYOUT.byteOffset(groupElement("dwContextHelpId"));
    ...
    private static final long lpfnMsgBoxCallback$OFFSET = $LAYOUT.byteOffset(groupElement("lpfnMsgBoxCallback"));
    ...
    private static final long dwLanguageId$OFFSET = $LAYOUT.byteOffset(groupElement("dwLanguageId"));
