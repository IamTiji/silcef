...
public class _SYSTEM_POWER_STATUS {
    ...
    private static final long ACLineStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ACLineStatus"));
    ...
    private static final long BatteryFlag$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryFlag"));
    ...
    private static final long BatteryLifePercent$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryLifePercent"));
    ...
    private static final long SystemStatusFlag$OFFSET = $LAYOUT.byteOffset(groupElement("SystemStatusFlag"));
    ...
    private static final long BatteryLifeTime$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryLifeTime"));
    ...
    private static final long BatteryFullLifeTime$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryFullLifeTime"));
