...
public class ANON_OBJECT_HEADER_BIGOBJ {
    ...
    private static final long Sig1$OFFSET = $LAYOUT.byteOffset(groupElement("Sig1"));
    ...
    private static final long Sig2$OFFSET = $LAYOUT.byteOffset(groupElement("Sig2"));
    ...
    private static final long Machine$OFFSET = $LAYOUT.byteOffset(groupElement("Machine"));
    ...
    private static final long ClassID$OFFSET = $LAYOUT.byteOffset(groupElement("ClassID"));
    ...
    private static final long SizeOfData$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfData"));
    ...
    private static final long MetaDataSize$OFFSET = $LAYOUT.byteOffset(groupElement("MetaDataSize"));
    ...
    private static final long MetaDataOffset$OFFSET = $LAYOUT.byteOffset(groupElement("MetaDataOffset"));
    ...
    private static final long NumberOfSections$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfSections"));
    ...
    private static final long PointerToSymbolTable$OFFSET = $LAYOUT.byteOffset(groupElement("PointerToSymbolTable"));
    ...
    private static final long NumberOfSymbols$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfSymbols"));
