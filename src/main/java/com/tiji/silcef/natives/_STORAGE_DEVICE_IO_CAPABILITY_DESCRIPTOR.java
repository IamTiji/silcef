...
public class _STORAGE_DEVICE_IO_CAPABILITY_DESCRIPTOR {
    ...
    private static final long LunMaxIoCount$OFFSET = $LAYOUT.byteOffset(groupElement("LunMaxIoCount"));
    ...
    private static final long AdapterMaxIoCount$OFFSET = $LAYOUT.byteOffset(groupElement("AdapterMaxIoCount"));
