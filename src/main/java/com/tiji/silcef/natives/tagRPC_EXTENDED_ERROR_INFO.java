...
public class tagRPC_EXTENDED_ERROR_INFO {
    ...
    private static final long ComputerName$OFFSET = $LAYOUT.byteOffset(groupElement("ComputerName"));
    ...
    private static final long ProcessID$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessID"));
    ...
    public static class u {
        ...
        private static final long FileTime$OFFSET = $LAYOUT.byteOffset(groupElement("FileTime"));
    ...
    private static final long GeneratingComponent$OFFSET = $LAYOUT.byteOffset(groupElement("GeneratingComponent"));
    ...
    private static final long DetectionLocation$OFFSET = $LAYOUT.byteOffset(groupElement("DetectionLocation"));
    ...
    private static final long NumberOfParameters$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfParameters"));
    ...
    public static MemorySegment Parameters(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Parameters$ELEM_HANDLE.invokeExact(struct, Parameters$OFFSET, index0);
