...
public class _DISK_INT13_INFO {
    ...
    private static final long DriveSelect$OFFSET = $LAYOUT.byteOffset(groupElement("DriveSelect"));
    ...
    private static final long MaxCylinders$OFFSET = $LAYOUT.byteOffset(groupElement("MaxCylinders"));
    ...
    private static final long MaxHeads$OFFSET = $LAYOUT.byteOffset(groupElement("MaxHeads"));
    ...
    private static final long NumberDrives$OFFSET = $LAYOUT.byteOffset(groupElement("NumberDrives"));
