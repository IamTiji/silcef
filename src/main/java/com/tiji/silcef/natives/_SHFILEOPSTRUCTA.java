...
public class _SHFILEOPSTRUCTA {
    ...
    private static final long wFunc$OFFSET = $LAYOUT.byteOffset(groupElement("wFunc"));
    ...
    private static final long pFrom$OFFSET = $LAYOUT.byteOffset(groupElement("pFrom"));
    ...
    private static final long pTo$OFFSET = $LAYOUT.byteOffset(groupElement("pTo"));
    ...
    private static final long fAnyOperationsAborted$OFFSET = $LAYOUT.byteOffset(groupElement("fAnyOperationsAborted"));
    ...
    private static final long hNameMappings$OFFSET = $LAYOUT.byteOffset(groupElement("hNameMappings"));
    ...
    private static final long lpszProgressTitle$OFFSET = $LAYOUT.byteOffset(groupElement("lpszProgressTitle"));
