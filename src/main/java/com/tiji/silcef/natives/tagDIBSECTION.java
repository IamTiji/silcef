...
public class tagDIBSECTION {
    ...
    private static final long dsBm$OFFSET = $LAYOUT.byteOffset(groupElement("dsBm"));
    ...
    private static final long dsBmih$OFFSET = $LAYOUT.byteOffset(groupElement("dsBmih"));
    ...
    private static final long dsBitfields$OFFSET = $LAYOUT.byteOffset(groupElement("dsBitfields"));
    ...
    public static int dsBitfields(MemorySegment struct, long index0) {
        return (int)dsBitfields$ELEM_HANDLE.get(struct, dsBitfields$OFFSET, index0);
    }
    ...
    public static void dsBitfields(MemorySegment struct, long index0, int fieldValue) {
        dsBitfields$ELEM_HANDLE.set(struct, dsBitfields$OFFSET, index0, fieldValue);
    }
    ...
    private static final long dshSection$OFFSET = $LAYOUT.byteOffset(groupElement("dshSection"));
    ...
    private static final long dsOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dsOffset"));
