...
public class _SCRUB_DATA_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG_LONG.withName("ErrorFileOffset"),
        cef_master_h.C_LONG_LONG.withName("ErrorLength"),
        cef_master_h.C_LONG_LONG.withName("NumberOfBytesRepaired"),
        cef_master_h.C_LONG_LONG.withName("NumberOfBytesFailed"),
        cef_master_h.C_LONG_LONG.withName("InternalFileReference"),
        cef_master_h.C_SHORT.withName("ResumeContextLength"),
        cef_master_h.C_SHORT.withName("ParityExtentDataOffset"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_LONG_LONG.withName("NextStartingByteOffset"),
        cef_master_h.C_LONG_LONG.withName("ValidDataLength"),
        MemoryLayout.sequenceLayout(4, cef_master_h.C_LONG).withName("Reserved"),
        cef_master_h.C_LONG_LONG.withName("NumberOfMetadataBytesProcessed"),
        cef_master_h.C_LONG_LONG.withName("NumberOfDataBytesProcessed"),
        cef_master_h.C_LONG_LONG.withName("TotalNumberOfMetadataBytesInUse"),
        cef_master_h.C_LONG_LONG.withName("TotalNumberOfDataBytesInUse"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToNoAllocation"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToInvalidRun"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToIntegrityStream"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToRegionBeingClean"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToLockConflict"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToNoScrubDataFlag"),
        cef_master_h.C_LONG_LONG.withName("DataBytesSkippedDueToNoScrubNonIntegrityStreamFlag"),
        cef_master_h.C_LONG_LONG.withName("DataBytesScrubbed"),
