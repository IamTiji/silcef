...
public class _JOBOBJECT_IO_ATTRIBUTION_INFORMATION {
    ...
    private static final long ReadStats$OFFSET = $LAYOUT.byteOffset(groupElement("ReadStats"));
    ...
    private static final long WriteStats$OFFSET = $LAYOUT.byteOffset(groupElement("WriteStats"));
