...
public class tagGESTURECONFIG {
    ...
    private static final long dwWant$OFFSET = $LAYOUT.byteOffset(groupElement("dwWant"));
    ...
    private static final long dwBlock$OFFSET = $LAYOUT.byteOffset(groupElement("dwBlock"));
