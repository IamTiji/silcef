 ...
 * }
 */
public final class RPC_ADDRESS_CHANGE_FN {

    private RPC_ADDRESS_CHANGE_FN() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPC_ADDRESS_CHANGE_FN.Function.class, "apply", $DESC);
