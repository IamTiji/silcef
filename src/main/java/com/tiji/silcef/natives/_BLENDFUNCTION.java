...
public class _BLENDFUNCTION {
    ...
    private static final long BlendOp$OFFSET = $LAYOUT.byteOffset(groupElement("BlendOp"));
    ...
    private static final long BlendFlags$OFFSET = $LAYOUT.byteOffset(groupElement("BlendFlags"));
    ...
    private static final long SourceConstantAlpha$OFFSET = $LAYOUT.byteOffset(groupElement("SourceConstantAlpha"));
    ...
    private static final long AlphaFormat$OFFSET = $LAYOUT.byteOffset(groupElement("AlphaFormat"));
