...
public class _BY_HANDLE_FILE_INFORMATION {
    ...
    private static final long dwVolumeSerialNumber$OFFSET = $LAYOUT.byteOffset(groupElement("dwVolumeSerialNumber"));
    ...
    private static final long nNumberOfLinks$OFFSET = $LAYOUT.byteOffset(groupElement("nNumberOfLinks"));
    ...
    private static final long nFileIndexHigh$OFFSET = $LAYOUT.byteOffset(groupElement("nFileIndexHigh"));
    ...
    private static final long nFileIndexLow$OFFSET = $LAYOUT.byteOffset(groupElement("nFileIndexLow"));
