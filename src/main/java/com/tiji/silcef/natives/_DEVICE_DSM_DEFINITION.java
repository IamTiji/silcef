...
public class _DEVICE_DSM_DEFINITION {
    ...
    private static final long SingleRange$OFFSET = $LAYOUT.byteOffset(groupElement("SingleRange"));
    ...
    private static final long ParameterBlockAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("ParameterBlockAlignment"));
    ...
    private static final long ParameterBlockLength$OFFSET = $LAYOUT.byteOffset(groupElement("ParameterBlockLength"));
    ...
    private static final long HasOutput$OFFSET = $LAYOUT.byteOffset(groupElement("HasOutput"));
    ...
    private static final long OutputBlockAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("OutputBlockAlignment"));
    ...
    private static final long OutputBlockLength$OFFSET = $LAYOUT.byteOffset(groupElement("OutputBlockLength"));
