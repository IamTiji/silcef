...
public class _DRAWPATRECT {
    ...
    private static final long ptPosition$OFFSET = $LAYOUT.byteOffset(groupElement("ptPosition"));
    ...
    private static final long ptSize$OFFSET = $LAYOUT.byteOffset(groupElement("ptSize"));
    ...
    private static final long wStyle$OFFSET = $LAYOUT.byteOffset(groupElement("wStyle"));
    ...
    private static final long wPattern$OFFSET = $LAYOUT.byteOffset(groupElement("wPattern"));
