...
public class _CERT_LOGOTYPE_DETAILS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_POINTER.withName("pwszMimeType"),
    ...
    private static final long pwszMimeType$OFFSET = $LAYOUT.byteOffset(groupElement("pwszMimeType"));
    ...
    private static final long cHashedUrl$OFFSET = $LAYOUT.byteOffset(groupElement("cHashedUrl"));
    ...
    private static final long rgHashedUrl$OFFSET = $LAYOUT.byteOffset(groupElement("rgHashedUrl"));
