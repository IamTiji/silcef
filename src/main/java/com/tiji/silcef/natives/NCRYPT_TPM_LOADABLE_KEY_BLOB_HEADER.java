...
public class NCRYPT_TPM_LOADABLE_KEY_BLOB_HEADER {
    ...
    private static final long cbHeader$OFFSET = $LAYOUT.byteOffset(groupElement("cbHeader"));
    ...
    private static final long cbPublic$OFFSET = $LAYOUT.byteOffset(groupElement("cbPublic"));
    ...
    private static final long cbPrivate$OFFSET = $LAYOUT.byteOffset(groupElement("cbPrivate"));
    ...
    private static final long cbName$OFFSET = $LAYOUT.byteOffset(groupElement("cbName"));
