...
public class _QUERY_SERVICE_CONFIGA {
    ...
    private static final long dwStartType$OFFSET = $LAYOUT.byteOffset(groupElement("dwStartType"));
    ...
    private static final long dwErrorControl$OFFSET = $LAYOUT.byteOffset(groupElement("dwErrorControl"));
    ...
    private static final long lpBinaryPathName$OFFSET = $LAYOUT.byteOffset(groupElement("lpBinaryPathName"));
    ...
    private static final long lpLoadOrderGroup$OFFSET = $LAYOUT.byteOffset(groupElement("lpLoadOrderGroup"));
    ...
    private static final long dwTagId$OFFSET = $LAYOUT.byteOffset(groupElement("dwTagId"));
    ...
    private static final long lpDependencies$OFFSET = $LAYOUT.byteOffset(groupElement("lpDependencies"));
    ...
    private static final long lpServiceStartName$OFFSET = $LAYOUT.byteOffset(groupElement("lpServiceStartName"));
    ...
    private static final long lpDisplayName$OFFSET = $LAYOUT.byteOffset(groupElement("lpDisplayName"));
