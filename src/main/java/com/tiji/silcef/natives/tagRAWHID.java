...
public class tagRAWHID {
    ...
    private static final long dwSizeHid$OFFSET = $LAYOUT.byteOffset(groupElement("dwSizeHid"));
    ...
    private static final long bRawData$OFFSET = $LAYOUT.byteOffset(groupElement("bRawData"));
    ...
    public static byte bRawData(MemorySegment struct, long index0) {
        return (byte)bRawData$ELEM_HANDLE.get(struct, bRawData$OFFSET, index0);
    }
    ...
    public static void bRawData(MemorySegment struct, long index0, byte fieldValue) {
        bRawData$ELEM_HANDLE.set(struct, bRawData$OFFSET, index0, fieldValue);
    }
