...
public class tagPELARRAY {
    ...
    private static final long paXCount$OFFSET = $LAYOUT.byteOffset(groupElement("paXCount"));
    ...
    private static final long paYCount$OFFSET = $LAYOUT.byteOffset(groupElement("paYCount"));
    ...
    private static final long paXExt$OFFSET = $LAYOUT.byteOffset(groupElement("paXExt"));
    ...
    private static final long paYExt$OFFSET = $LAYOUT.byteOffset(groupElement("paYExt"));
    ...
    private static final long paRGBs$OFFSET = $LAYOUT.byteOffset(groupElement("paRGBs"));
