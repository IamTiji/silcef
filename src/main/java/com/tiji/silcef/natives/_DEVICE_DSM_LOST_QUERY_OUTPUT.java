...
public class _DEVICE_DSM_LOST_QUERY_OUTPUT {
    ...
    private static final long NumberOfBits$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfBits"));
    ...
    private static final long BitMap$OFFSET = $LAYOUT.byteOffset(groupElement("BitMap"));
    ...
    public static int BitMap(MemorySegment struct, long index0) {
        return (int)BitMap$ELEM_HANDLE.get(struct, BitMap$OFFSET, index0);
    }
    ...
    public static void BitMap(MemorySegment struct, long index0, int fieldValue) {
        BitMap$ELEM_HANDLE.set(struct, BitMap$OFFSET, index0, fieldValue);
    }
