...
public class _ENCRYPTION_BUFFER {
    ...
    private static final long EncryptionOperation$OFFSET = $LAYOUT.byteOffset(groupElement("EncryptionOperation"));
    ...
    private static final long Private$OFFSET = $LAYOUT.byteOffset(groupElement("Private"));
    ...
    public static byte Private(MemorySegment struct, long index0) {
        return (byte)Private$ELEM_HANDLE.get(struct, Private$OFFSET, index0);
    }
    ...
    public static void Private(MemorySegment struct, long index0, byte fieldValue) {
        Private$ELEM_HANDLE.set(struct, Private$OFFSET, index0, fieldValue);
    }
