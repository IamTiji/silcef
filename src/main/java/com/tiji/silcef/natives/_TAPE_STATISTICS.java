...
public class _TAPE_STATISTICS {
    ...
    private static final long RecoveredWrites$OFFSET = $LAYOUT.byteOffset(groupElement("RecoveredWrites"));
    ...
    private static final long UnrecoveredWrites$OFFSET = $LAYOUT.byteOffset(groupElement("UnrecoveredWrites"));
    ...
    private static final long RecoveredReads$OFFSET = $LAYOUT.byteOffset(groupElement("RecoveredReads"));
    ...
    private static final long UnrecoveredReads$OFFSET = $LAYOUT.byteOffset(groupElement("UnrecoveredReads"));
    ...
    private static final long CompressionRatioReads$OFFSET = $LAYOUT.byteOffset(groupElement("CompressionRatioReads"));
    ...
    private static final long CompressionRatioWrites$OFFSET = $LAYOUT.byteOffset(groupElement("CompressionRatioWrites"));
