...
public class tagIMECHARPOSITION {
    ...
    private static final long dwCharPos$OFFSET = $LAYOUT.byteOffset(groupElement("dwCharPos"));
    ...
    private static final long cLineHeight$OFFSET = $LAYOUT.byteOffset(groupElement("cLineHeight"));
    ...
    private static final long rcDocument$OFFSET = $LAYOUT.byteOffset(groupElement("rcDocument"));
