...
public class _IMAGE_TLS_DIRECTORY32 {
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21052:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21052:5"), groupElement("Characteristics"));
