...
public class _SID {
    ...
    private static final long SubAuthorityCount$OFFSET = $LAYOUT.byteOffset(groupElement("SubAuthorityCount"));
    ...
    private static final long IdentifierAuthority$OFFSET = $LAYOUT.byteOffset(groupElement("IdentifierAuthority"));
    ...
    private static final long SubAuthority$OFFSET = $LAYOUT.byteOffset(groupElement("SubAuthority"));
    ...
    public static int SubAuthority(MemorySegment struct, long index0) {
        return (int)SubAuthority$ELEM_HANDLE.get(struct, SubAuthority$OFFSET, index0);
    }
    ...
    public static void SubAuthority(MemorySegment struct, long index0, int fieldValue) {
        SubAuthority$ELEM_HANDLE.set(struct, SubAuthority$OFFSET, index0, fieldValue);
    }
