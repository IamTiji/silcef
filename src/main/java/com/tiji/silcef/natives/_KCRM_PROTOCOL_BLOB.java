...
public class _KCRM_PROTOCOL_BLOB {
    ...
    private static final long ProtocolId$OFFSET = $LAYOUT.byteOffset(groupElement("ProtocolId"));
    ...
    private static final long StaticInfoLength$OFFSET = $LAYOUT.byteOffset(groupElement("StaticInfoLength"));
    ...
    private static final long TransactionIdInfoLength$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionIdInfoLength"));
    ...
    private static final long Unused1$OFFSET = $LAYOUT.byteOffset(groupElement("Unused1"));
    ...
    private static final long Unused2$OFFSET = $LAYOUT.byteOffset(groupElement("Unused2"));
