...
public class _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 {
    ...
    private static final long ValueType$OFFSET = $LAYOUT.byteOffset(groupElement("ValueType"));
    ...
    private static final long ValueCount$OFFSET = $LAYOUT.byteOffset(groupElement("ValueCount"));
    ...
    public static class Values {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("pInt64"),
            MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("pUint64"),
            MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("ppString"),
            MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("pFqbn"),
            MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("pOctetString")
        ).withName("$anon$12522:5");
        ...
        private static final long pInt64$OFFSET = $LAYOUT.byteOffset(groupElement("pInt64"));
        ...
        public static int pInt64(MemorySegment union, long index0) {
            return (int)pInt64$ELEM_HANDLE.get(union, pInt64$OFFSET, index0);
        }
        ...
        public static void pInt64(MemorySegment union, long index0, int fieldValue) {
            pInt64$ELEM_HANDLE.set(union, pInt64$OFFSET, index0, fieldValue);
        }
        ...
        private static final long pUint64$OFFSET = $LAYOUT.byteOffset(groupElement("pUint64"));
        ...
        public static int pUint64(MemorySegment union, long index0) {
            return (int)pUint64$ELEM_HANDLE.get(union, pUint64$OFFSET, index0);
        }
        ...
        public static void pUint64(MemorySegment union, long index0, int fieldValue) {
            pUint64$ELEM_HANDLE.set(union, pUint64$OFFSET, index0, fieldValue);
        }
        ...
        private static final long ppString$OFFSET = $LAYOUT.byteOffset(groupElement("ppString"));
        ...
        public static int ppString(MemorySegment union, long index0) {
            return (int)ppString$ELEM_HANDLE.get(union, ppString$OFFSET, index0);
        }
        ...
        public static void ppString(MemorySegment union, long index0, int fieldValue) {
            ppString$ELEM_HANDLE.set(union, ppString$OFFSET, index0, fieldValue);
        }
        ...
        private static final long pFqbn$OFFSET = $LAYOUT.byteOffset(groupElement("pFqbn"));
        ...
        public static int pFqbn(MemorySegment union, long index0) {
            return (int)pFqbn$ELEM_HANDLE.get(union, pFqbn$OFFSET, index0);
        }
        ...
        public static void pFqbn(MemorySegment union, long index0, int fieldValue) {
            pFqbn$ELEM_HANDLE.set(union, pFqbn$OFFSET, index0, fieldValue);
        }
        ...
        private static final long pOctetString$OFFSET = $LAYOUT.byteOffset(groupElement("pOctetString"));
        ...
        public static int pOctetString(MemorySegment union, long index0) {
            return (int)pOctetString$ELEM_HANDLE.get(union, pOctetString$OFFSET, index0);
        }
        ...
        public static void pOctetString(MemorySegment union, long index0, int fieldValue) {
            pOctetString$ELEM_HANDLE.set(union, pOctetString$OFFSET, index0, fieldValue);
        }
