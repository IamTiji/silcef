 ...
 * }
 */
public final class PTP_WIN32_IO_CALLBACK {

    private PTP_WIN32_IO_CALLBACK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PTP_WIN32_IO_CALLBACK.Function.class, "apply", $DESC);
