...
public class tagCY {
    ...
    private static final long Lo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$679:5"), groupElement("Lo"));
    ...
    private static final long Hi$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$679:5"), groupElement("Hi"));
    ...
    private static final long int64$OFFSET = $LAYOUT.byteOffset(groupElement("int64"));
