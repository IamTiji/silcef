...
public class _SHFILEINFOW {
    ...
    private static final long iIcon$OFFSET = $LAYOUT.byteOffset(groupElement("iIcon"));
    ...
    private static final long dwAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("dwAttributes"));
    ...
    private static final long szTypeName$OFFSET = $LAYOUT.byteOffset(groupElement("szTypeName"));
    ...
    public static short szTypeName(MemorySegment struct, long index0) {
        return (short)szTypeName$ELEM_HANDLE.get(struct, szTypeName$OFFSET, index0);
    }
    ...
    public static void szTypeName(MemorySegment struct, long index0, short fieldValue) {
        szTypeName$ELEM_HANDLE.set(struct, szTypeName$OFFSET, index0, fieldValue);
    }
