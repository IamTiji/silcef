...
public class _BCRYPT_RSAKEY_BLOB {
    ...
    private static final long BitLength$OFFSET = $LAYOUT.byteOffset(groupElement("BitLength"));
    ...
    private static final long cbPublicExp$OFFSET = $LAYOUT.byteOffset(groupElement("cbPublicExp"));
    ...
    private static final long cbModulus$OFFSET = $LAYOUT.byteOffset(groupElement("cbModulus"));
    ...
    private static final long cbPrime1$OFFSET = $LAYOUT.byteOffset(groupElement("cbPrime1"));
    ...
    private static final long cbPrime2$OFFSET = $LAYOUT.byteOffset(groupElement("cbPrime2"));
