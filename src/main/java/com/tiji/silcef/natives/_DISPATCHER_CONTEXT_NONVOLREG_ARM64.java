...
public class _DISPATCHER_CONTEXT_NONVOLREG_ARM64 {
    ...
    private static final SequenceLayout GpNvRegs$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$7118:5"), groupElement("GpNvRegs"));
    ...
    private static final long GpNvRegs$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7118:5"), groupElement("GpNvRegs"));
    ...
    private static final SequenceLayout FpNvRegs$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$7118:5"), groupElement("FpNvRegs"));
    ...
    private static final long FpNvRegs$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7118:5"), groupElement("FpNvRegs"));
