...
public class IPersistStorageVtbl {
    ...
    public final static class InitNew {
        ...
        private static final MethodHandle UP$MH = cef_master_h.upcallHandle(InitNew.Function.class, "apply", $DESC);
    ...
    public final static class HandsOffStorage {
        ...
        private static final MethodHandle UP$MH = cef_master_h.upcallHandle(HandsOffStorage.Function.class, "apply", $DESC);
