...
public class _FSCTL_OFFLOAD_WRITE_INPUT {
    ...
    private static final long CopyLength$OFFSET = $LAYOUT.byteOffset(groupElement("CopyLength"));
    ...
    private static final long TransferOffset$OFFSET = $LAYOUT.byteOffset(groupElement("TransferOffset"));
