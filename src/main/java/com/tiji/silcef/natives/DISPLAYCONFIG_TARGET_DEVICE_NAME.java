...
public class DISPLAYCONFIG_TARGET_DEVICE_NAME {
    ...
    private static final long outputTechnology$OFFSET = $LAYOUT.byteOffset(groupElement("outputTechnology"));
    ...
    private static final long edidManufactureId$OFFSET = $LAYOUT.byteOffset(groupElement("edidManufactureId"));
    ...
    private static final long edidProductCodeId$OFFSET = $LAYOUT.byteOffset(groupElement("edidProductCodeId"));
    ...
    private static final long connectorInstance$OFFSET = $LAYOUT.byteOffset(groupElement("connectorInstance"));
    ...
    private static final long monitorFriendlyDeviceName$OFFSET = $LAYOUT.byteOffset(groupElement("monitorFriendlyDeviceName"));
    ...
    public static short monitorFriendlyDeviceName(MemorySegment struct, long index0) {
        return (short)monitorFriendlyDeviceName$ELEM_HANDLE.get(struct, monitorFriendlyDeviceName$OFFSET, index0);
    }
    ...
    public static void monitorFriendlyDeviceName(MemorySegment struct, long index0, short fieldValue) {
        monitorFriendlyDeviceName$ELEM_HANDLE.set(struct, monitorFriendlyDeviceName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long monitorDevicePath$OFFSET = $LAYOUT.byteOffset(groupElement("monitorDevicePath"));
    ...
    public static short monitorDevicePath(MemorySegment struct, long index0) {
        return (short)monitorDevicePath$ELEM_HANDLE.get(struct, monitorDevicePath$OFFSET, index0);
    }
    ...
    public static void monitorDevicePath(MemorySegment struct, long index0, short fieldValue) {
        monitorDevicePath$ELEM_HANDLE.set(struct, monitorDevicePath$OFFSET, index0, fieldValue);
    }
