...
public class tagCAUI {
    ...
    private static final long cElems$OFFSET = $LAYOUT.byteOffset(groupElement("cElems"));
    ...
    private static final long pElems$OFFSET = $LAYOUT.byteOffset(groupElement("pElems"));
