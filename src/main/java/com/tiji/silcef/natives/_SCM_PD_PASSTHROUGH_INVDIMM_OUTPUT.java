...
public class _SCM_PD_PASSTHROUGH_INVDIMM_OUTPUT {
    ...
    private static final long GeneralStatus$OFFSET = $LAYOUT.byteOffset(groupElement("GeneralStatus"));
    ...
    private static final long ExtendedStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ExtendedStatus"));
    ...
    private static final long OutputDataLength$OFFSET = $LAYOUT.byteOffset(groupElement("OutputDataLength"));
    ...
    private static final long OutputData$OFFSET = $LAYOUT.byteOffset(groupElement("OutputData"));
    ...
    public static byte OutputData(MemorySegment struct, long index0) {
        return (byte)OutputData$ELEM_HANDLE.get(struct, OutputData$OFFSET, index0);
    }
    ...
    public static void OutputData(MemorySegment struct, long index0, byte fieldValue) {
        OutputData$ELEM_HANDLE.set(struct, OutputData$OFFSET, index0, fieldValue);
    }
