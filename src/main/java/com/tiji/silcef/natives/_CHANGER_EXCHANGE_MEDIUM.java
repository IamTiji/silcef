...
public class _CHANGER_EXCHANGE_MEDIUM {
    ...
    private static final long Destination1$OFFSET = $LAYOUT.byteOffset(groupElement("Destination1"));
    ...
    private static final long Destination2$OFFSET = $LAYOUT.byteOffset(groupElement("Destination2"));
    ...
    private static final long Flip1$OFFSET = $LAYOUT.byteOffset(groupElement("Flip1"));
    ...
    private static final long Flip2$OFFSET = $LAYOUT.byteOffset(groupElement("Flip2"));
