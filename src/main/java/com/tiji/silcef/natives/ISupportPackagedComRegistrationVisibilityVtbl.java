...
/**
 * {@snippet lang=c :
 * struct ISupportPackagedComRegistrationVisibilityVtbl {
 *     HRESULT (*QueryInterface)(ISupportPackagedComRegistrationVisibility *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportPackagedComRegistrationVisibility *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportPackagedComRegistrationVisibility *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportPackagedComRegistrationVisibilityVtbl {
    ...
    ).withName("ISupportPackagedComRegistrationVisibilityVtbl");
