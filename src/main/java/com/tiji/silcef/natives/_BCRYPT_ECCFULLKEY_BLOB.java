...
public class _BCRYPT_ECCFULLKEY_BLOB {
    ...
    private static final long dwCurveType$OFFSET = $LAYOUT.byteOffset(groupElement("dwCurveType"));
    ...
    private static final long dwCurveGenerationAlgId$OFFSET = $LAYOUT.byteOffset(groupElement("dwCurveGenerationAlgId"));
    ...
    private static final long cbFieldLength$OFFSET = $LAYOUT.byteOffset(groupElement("cbFieldLength"));
    ...
    private static final long cbSubgroupOrder$OFFSET = $LAYOUT.byteOffset(groupElement("cbSubgroupOrder"));
    ...
    private static final long cbCofactor$OFFSET = $LAYOUT.byteOffset(groupElement("cbCofactor"));
    ...
    private static final long cbSeed$OFFSET = $LAYOUT.byteOffset(groupElement("cbSeed"));
