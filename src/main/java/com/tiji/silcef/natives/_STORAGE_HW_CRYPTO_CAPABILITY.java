 ...
 * }
 */
public class _STORAGE_HW_CRYPTO_CAPABILITY {
    ...
    ).withName("_STORAGE_HW_CRYPTO_CAPABILITY");
    ...
    private static final long CryptoCapabilityIndex$OFFSET = $LAYOUT.byteOffset(groupElement("CryptoCapabilityIndex"));
    ...
    private static final long AlgorithmId$OFFSET = $LAYOUT.byteOffset(groupElement("AlgorithmId"));
    ...
    private static final long DataUnitSizeBitmask$OFFSET = $LAYOUT.byteOffset(groupElement("DataUnitSizeBitmask"));
    ...
    private static final long MaxIVBitSize$OFFSET = $LAYOUT.byteOffset(groupElement("MaxIVBitSize"));
