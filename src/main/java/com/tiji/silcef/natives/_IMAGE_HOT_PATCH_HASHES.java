...
public class _IMAGE_HOT_PATCH_HASHES {
    ...
    private static final long SHA256$OFFSET = $LAYOUT.byteOffset(groupElement("SHA256"));
    ...
    public static byte SHA256(MemorySegment struct, long index0) {
        return (byte)SHA256$ELEM_HANDLE.get(struct, SHA256$OFFSET, index0);
    }
    ...
    public static void SHA256(MemorySegment struct, long index0, byte fieldValue) {
        SHA256$ELEM_HANDLE.set(struct, SHA256$OFFSET, index0, fieldValue);
    }
    ...
    private static final long SHA1$OFFSET = $LAYOUT.byteOffset(groupElement("SHA1"));
    ...
    public static byte SHA1(MemorySegment struct, long index0) {
        return (byte)SHA1$ELEM_HANDLE.get(struct, SHA1$OFFSET, index0);
    }
    ...
    public static void SHA1(MemorySegment struct, long index0, byte fieldValue) {
        SHA1$ELEM_HANDLE.set(struct, SHA1$OFFSET, index0, fieldValue);
    }
