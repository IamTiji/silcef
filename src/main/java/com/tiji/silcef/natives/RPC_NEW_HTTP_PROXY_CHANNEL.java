 ...
 * }
 */
public final class RPC_NEW_HTTP_PROXY_CHANNEL {

    private RPC_NEW_HTTP_PROXY_CHANNEL() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPC_NEW_HTTP_PROXY_CHANNEL.Function.class, "apply", $DESC);
