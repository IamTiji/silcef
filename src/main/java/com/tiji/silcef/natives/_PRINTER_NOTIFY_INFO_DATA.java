...
public class _PRINTER_NOTIFY_INFO_DATA {
    ...
    public static class NotifyData {
        ...
        private static final long adwData$OFFSET = $LAYOUT.byteOffset(groupElement("adwData"));
        ...
        public static int adwData(MemorySegment union, long index0) {
            return (int)adwData$ELEM_HANDLE.get(union, adwData$OFFSET, index0);
        }
        ...
        public static void adwData(MemorySegment union, long index0, int fieldValue) {
            adwData$ELEM_HANDLE.set(union, adwData$OFFSET, index0, fieldValue);
        }
    ...
    private static final long NotifyData$OFFSET = $LAYOUT.byteOffset(groupElement("NotifyData"));
