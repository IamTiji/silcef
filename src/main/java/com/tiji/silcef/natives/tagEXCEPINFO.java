...
public class tagEXCEPINFO {
    ...
    private static final long wCode$OFFSET = $LAYOUT.byteOffset(groupElement("wCode"));
    ...
    private static final long bstrSource$OFFSET = $LAYOUT.byteOffset(groupElement("bstrSource"));
    ...
    private static final long bstrDescription$OFFSET = $LAYOUT.byteOffset(groupElement("bstrDescription"));
    ...
    private static final long bstrHelpFile$OFFSET = $LAYOUT.byteOffset(groupElement("bstrHelpFile"));
    ...
    private static final long dwHelpContext$OFFSET = $LAYOUT.byteOffset(groupElement("dwHelpContext"));
     ...
     * }
     */
    public final static class pfnDeferredFillIn {

        private pfnDeferredFillIn() {
            // Should not be called directly
        }
    ...
    private static final long pfnDeferredFillIn$OFFSET = $LAYOUT.byteOffset(groupElement("pfnDeferredFillIn"));
    ...
    private static final long scode$OFFSET = $LAYOUT.byteOffset(groupElement("scode"));
