...
public class _CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO {
    ...
    private static final long KeyEncryptionAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("KeyEncryptionAlgorithm"));
    ...
    private static final long pvKeyEncryptionAuxInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pvKeyEncryptionAuxInfo"));
    ...
    private static final long KeyWrapAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("KeyWrapAlgorithm"));
    ...
    private static final long pvKeyWrapAuxInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pvKeyWrapAuxInfo"));
    ...
    private static final long dwKeySpec$OFFSET = $LAYOUT.byteOffset(groupElement("dwKeySpec"));
    ...
    private static final long dwKeyChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwKeyChoice"));
    ...
    private static final AddressLayout pEphemeralAlgorithm$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7140:5"), groupElement("pEphemeralAlgorithm"));
    ...
    private static final long pEphemeralAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7140:5"), groupElement("pEphemeralAlgorithm"));
    ...
    private static final AddressLayout pSenderId$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7140:5"), groupElement("pSenderId"));
    ...
    private static final long pSenderId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7140:5"), groupElement("pSenderId"));
    ...
    private static final long UserKeyingMaterial$OFFSET = $LAYOUT.byteOffset(groupElement("UserKeyingMaterial"));
    ...
    private static final long cRecipientEncryptedKeys$OFFSET = $LAYOUT.byteOffset(groupElement("cRecipientEncryptedKeys"));
    ...
    private static final long rgpRecipientEncryptedKeys$OFFSET = $LAYOUT.byteOffset(groupElement("rgpRecipientEncryptedKeys"));
