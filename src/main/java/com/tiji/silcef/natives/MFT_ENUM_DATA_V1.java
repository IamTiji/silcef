...
public class MFT_ENUM_DATA_V1 {
    ...
    private static final long StartFileReferenceNumber$OFFSET = $LAYOUT.byteOffset(groupElement("StartFileReferenceNumber"));
    ...
    private static final long LowUsn$OFFSET = $LAYOUT.byteOffset(groupElement("LowUsn"));
    ...
    private static final long HighUsn$OFFSET = $LAYOUT.byteOffset(groupElement("HighUsn"));
