...
public class _CERT_PHYSICAL_STORE_INFO {
    ...
    private static final long pszOpenStoreProvider$OFFSET = $LAYOUT.byteOffset(groupElement("pszOpenStoreProvider"));
    ...
    private static final long dwOpenEncodingType$OFFSET = $LAYOUT.byteOffset(groupElement("dwOpenEncodingType"));
    ...
    private static final long dwOpenFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwOpenFlags"));
    ...
    private static final long OpenParameters$OFFSET = $LAYOUT.byteOffset(groupElement("OpenParameters"));
    ...
    private static final long dwPriority$OFFSET = $LAYOUT.byteOffset(groupElement("dwPriority"));
