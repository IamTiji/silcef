...
public class _FSCTL_QUERY_REGION_INFO_OUTPUT {
    ...
    private static final long TotalNumberOfRegions$OFFSET = $LAYOUT.byteOffset(groupElement("TotalNumberOfRegions"));
    ...
    private static final long NumberOfRegionsReturned$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfRegionsReturned"));
    ...
    private static final long Regions$OFFSET = $LAYOUT.byteOffset(groupElement("Regions"));
    ...
    public static MemorySegment Regions(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Regions$ELEM_HANDLE.invokeExact(struct, Regions$OFFSET, index0);
