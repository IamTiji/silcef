...
public class _DEVICE_DATA_SET_LB_PROVISIONING_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("SlabOffsetDeltaInBytes"),
    ...
    private static final long SlabSizeInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("SlabSizeInBytes"));
    ...
    private static final long SlabOffsetDeltaInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("SlabOffsetDeltaInBytes"));
    ...
    private static final long SlabAllocationBitMapBitCount$OFFSET = $LAYOUT.byteOffset(groupElement("SlabAllocationBitMapBitCount"));
    ...
    private static final long SlabAllocationBitMapLength$OFFSET = $LAYOUT.byteOffset(groupElement("SlabAllocationBitMapLength"));
    ...
    private static final long SlabAllocationBitMap$OFFSET = $LAYOUT.byteOffset(groupElement("SlabAllocationBitMap"));
    ...
    public static int SlabAllocationBitMap(MemorySegment struct, long index0) {
        return (int)SlabAllocationBitMap$ELEM_HANDLE.get(struct, SlabAllocationBitMap$OFFSET, index0);
    }
    ...
    public static void SlabAllocationBitMap(MemorySegment struct, long index0, int fieldValue) {
        SlabAllocationBitMap$ELEM_HANDLE.set(struct, SlabAllocationBitMap$OFFSET, index0, fieldValue);
    }
