...
public class tagMONITORINFOEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("szDevice")
    ...
    private static final long szDevice$OFFSET = $LAYOUT.byteOffset(groupElement("szDevice"));
    ...
    public static byte szDevice(MemorySegment struct, long index0) {
        return (byte)szDevice$ELEM_HANDLE.get(struct, szDevice$OFFSET, index0);
    }
    ...
    public static void szDevice(MemorySegment struct, long index0, byte fieldValue) {
        szDevice$ELEM_HANDLE.set(struct, szDevice$OFFSET, index0, fieldValue);
    }
