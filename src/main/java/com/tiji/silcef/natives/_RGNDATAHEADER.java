...
public class _RGNDATAHEADER {
    ...
    private static final long nRgnSize$OFFSET = $LAYOUT.byteOffset(groupElement("nRgnSize"));
    ...
    private static final long rcBound$OFFSET = $LAYOUT.byteOffset(groupElement("rcBound"));
