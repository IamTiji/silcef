 ...
 * }
 */
public final class RpcServerInterfaceGroupCreateA$IdleCallbackFn {

    private RpcServerInterfaceGroupCreateA$IdleCallbackFn() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RpcServerInterfaceGroupCreateA$IdleCallbackFn.Function.class, "apply", $DESC);
