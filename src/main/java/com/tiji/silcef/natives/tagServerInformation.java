...
public class tagServerInformation {
    ...
    private static final long dwServerTid$OFFSET = $LAYOUT.byteOffset(groupElement("dwServerTid"));
    ...
    private static final long ui64ServerAddress$OFFSET = $LAYOUT.byteOffset(groupElement("ui64ServerAddress"));
