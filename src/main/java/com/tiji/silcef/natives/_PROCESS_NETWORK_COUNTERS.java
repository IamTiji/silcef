...
public class _PROCESS_NETWORK_COUNTERS {
    ...
    private static final long BytesIn$OFFSET = $LAYOUT.byteOffset(groupElement("BytesIn"));
    ...
    private static final long BytesOut$OFFSET = $LAYOUT.byteOffset(groupElement("BytesOut"));
