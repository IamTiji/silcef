...
public class tagEMRTEXT {
    ...
    private static final long ptlReference$OFFSET = $LAYOUT.byteOffset(groupElement("ptlReference"));
    ...
    private static final long nChars$OFFSET = $LAYOUT.byteOffset(groupElement("nChars"));
    ...
    private static final long offString$OFFSET = $LAYOUT.byteOffset(groupElement("offString"));
    ...
    private static final long fOptions$OFFSET = $LAYOUT.byteOffset(groupElement("fOptions"));
    ...
    private static final long rcl$OFFSET = $LAYOUT.byteOffset(groupElement("rcl"));
    ...
    private static final long offDx$OFFSET = $LAYOUT.byteOffset(groupElement("offDx"));
