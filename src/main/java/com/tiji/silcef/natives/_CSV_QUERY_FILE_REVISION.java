...
public class _CSV_QUERY_FILE_REVISION {
    ...
    private static final long FileRevision$OFFSET = $LAYOUT.byteOffset(groupElement("FileRevision"));
    ...
    public static long FileRevision(MemorySegment struct, long index0) {
        return (long)FileRevision$ELEM_HANDLE.get(struct, FileRevision$OFFSET, index0);
    }
    ...
    public static void FileRevision(MemorySegment struct, long index0, long fieldValue) {
        FileRevision$ELEM_HANDLE.set(struct, FileRevision$OFFSET, index0, fieldValue);
    }
