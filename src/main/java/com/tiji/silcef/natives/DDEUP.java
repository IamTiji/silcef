...
public class DDEUP {
    ...
    private static final long rgb$OFFSET = $LAYOUT.byteOffset(groupElement("rgb"));
    ...
    public static byte rgb(MemorySegment struct, long index0) {
        return (byte)rgb$ELEM_HANDLE.get(struct, rgb$OFFSET, index0);
    }
    ...
    public static void rgb(MemorySegment struct, long index0, byte fieldValue) {
        rgb$ELEM_HANDLE.set(struct, rgb$OFFSET, index0, fieldValue);
    }
