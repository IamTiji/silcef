...
public class _JIT_DEBUG_INFO {
    ...
    private static final long dwProcessorArchitecture$OFFSET = $LAYOUT.byteOffset(groupElement("dwProcessorArchitecture"));
    ...
    private static final long lpExceptionAddress$OFFSET = $LAYOUT.byteOffset(groupElement("lpExceptionAddress"));
    ...
    private static final long lpExceptionRecord$OFFSET = $LAYOUT.byteOffset(groupElement("lpExceptionRecord"));
    ...
    private static final long lpContextRecord$OFFSET = $LAYOUT.byteOffset(groupElement("lpContextRecord"));
