...
public class _CRYPT_KEY_SIGN_MESSAGE_PARA {
    ...
    private static final long dwMsgAndCertEncodingType$OFFSET = $LAYOUT.byteOffset(groupElement("dwMsgAndCertEncodingType"));
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$16380:5"), groupElement("hCryptProv"));
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$16380:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$16380:5"), groupElement("hNCryptKey"));
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$16380:5"), groupElement("hNCryptKey"));
    ...
    private static final long PubKeyAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("PubKeyAlgorithm"));
