...
public class _DRAGINFOA {
    ...
    private static final long uSize$OFFSET = $LAYOUT.byteOffset(groupElement("uSize"));
    ...
    private static final long fNC$OFFSET = $LAYOUT.byteOffset(groupElement("fNC"));
    ...
    private static final long lpFileList$OFFSET = $LAYOUT.byteOffset(groupElement("lpFileList"));
    ...
    private static final long grfKeyState$OFFSET = $LAYOUT.byteOffset(groupElement("grfKeyState"));
