...
public class _CERT_NAME_CONSTRAINTS_INFO {
    ...
    private static final long cPermittedSubtree$OFFSET = $LAYOUT.byteOffset(groupElement("cPermittedSubtree"));
    ...
    private static final long rgPermittedSubtree$OFFSET = $LAYOUT.byteOffset(groupElement("rgPermittedSubtree"));
    ...
    private static final long cExcludedSubtree$OFFSET = $LAYOUT.byteOffset(groupElement("cExcludedSubtree"));
    ...
    private static final long rgExcludedSubtree$OFFSET = $LAYOUT.byteOffset(groupElement("rgExcludedSubtree"));
