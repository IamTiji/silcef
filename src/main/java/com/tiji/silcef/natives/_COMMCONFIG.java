...
public class _COMMCONFIG {
    ...
    private static final long dcb$OFFSET = $LAYOUT.byteOffset(groupElement("dcb"));
    ...
    private static final long dwProviderSubType$OFFSET = $LAYOUT.byteOffset(groupElement("dwProviderSubType"));
    ...
    private static final long dwProviderOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwProviderOffset"));
    ...
    private static final long dwProviderSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwProviderSize"));
    ...
    private static final long wcProviderData$OFFSET = $LAYOUT.byteOffset(groupElement("wcProviderData"));
    ...
    public static short wcProviderData(MemorySegment struct, long index0) {
        return (short)wcProviderData$ELEM_HANDLE.get(struct, wcProviderData$OFFSET, index0);
    }
    ...
    public static void wcProviderData(MemorySegment struct, long index0, short fieldValue) {
        wcProviderData$ELEM_HANDLE.set(struct, wcProviderData$OFFSET, index0, fieldValue);
    }
