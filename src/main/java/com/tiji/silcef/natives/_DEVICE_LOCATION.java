...
public class _DEVICE_LOCATION {
    ...
    private static final long Socket$OFFSET = $LAYOUT.byteOffset(groupElement("Socket"));
    ...
    private static final long Adapter$OFFSET = $LAYOUT.byteOffset(groupElement("Adapter"));
    ...
    private static final OfInt Channel$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3367:5"), groupElement("$anon$3369:9"), groupElement("Channel"));
    ...
    private static final long Channel$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3367:5"), groupElement("$anon$3369:9"), groupElement("Channel"));
    ...
    private static final OfInt Device$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3367:5"), groupElement("$anon$3369:9"), groupElement("Device"));
    ...
    private static final long Device$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3367:5"), groupElement("$anon$3369:9"), groupElement("Device"));
    ...
    private static final OfInt Target$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3367:5"), groupElement("$anon$3377:9"), groupElement("Target"));
    ...
    private static final long Target$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3367:5"), groupElement("$anon$3377:9"), groupElement("Target"));
    ...
    private static final OfInt Lun$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3367:5"), groupElement("$anon$3377:9"), groupElement("Lun"));
    ...
    private static final long Lun$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3367:5"), groupElement("$anon$3377:9"), groupElement("Lun"));
