...
public class _FILE_SYSTEM_RECOGNITION_INFORMATION {
    ...
    private static final long FileSystem$OFFSET = $LAYOUT.byteOffset(groupElement("FileSystem"));
    ...
    public static byte FileSystem(MemorySegment struct, long index0) {
        return (byte)FileSystem$ELEM_HANDLE.get(struct, FileSystem$OFFSET, index0);
    }
    ...
    public static void FileSystem(MemorySegment struct, long index0, byte fieldValue) {
        FileSystem$ELEM_HANDLE.set(struct, FileSystem$OFFSET, index0, fieldValue);
    }
