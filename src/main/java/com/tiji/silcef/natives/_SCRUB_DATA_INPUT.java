...
public class _SCRUB_DATA_INPUT {
    ...
    private static final OfLong StartingByteOffset$LAYOUT = (OfLong)$LAYOUT.select(groupElement("StartingByteOffset"));
     ...
     * }
     */
    public static final OfLong StartingByteOffset$layout() {
        return StartingByteOffset$LAYOUT;
    }

    private static final long StartingByteOffset$OFFSET = $LAYOUT.byteOffset(groupElement("StartingByteOffset"));
     ...
     * }
     */
    public static final long StartingByteOffset$offset() {
        return StartingByteOffset$OFFSET;
    }
     ...
     * }
     */
    public static long StartingByteOffset(MemorySegment struct) {
        return struct.get(StartingByteOffset$LAYOUT, StartingByteOffset$OFFSET);
    }
     ...
     * }
     */
    public static void StartingByteOffset(MemorySegment struct, long fieldValue) {
        struct.set(StartingByteOffset$LAYOUT, StartingByteOffset$OFFSET, fieldValue);
    }
