...
public class _PKCS12_PBES2_EXPORT_PARAMS {
    ...
    private static final long hNcryptDescriptor$OFFSET = $LAYOUT.byteOffset(groupElement("hNcryptDescriptor"));
    ...
    private static final long pwszPbes2Alg$OFFSET = $LAYOUT.byteOffset(groupElement("pwszPbes2Alg"));
