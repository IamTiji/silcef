...
public class _PROPSHEETPAGEW_V1 {
    ...
    private static final long pszTemplate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$244:5"), groupElement("pszTemplate"));
    ...
    private static final long pResource$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$244:5"), groupElement("pResource"));
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$244:5"), groupElement("hIcon"));
    ...
    private static final long pszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$244:5"), groupElement("pszIcon"));
