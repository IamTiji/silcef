...
public class _STORAGE_CRYPTO_DESCRIPTOR_V2 {
    ...
    private static final long CryptoCapabilities$OFFSET = $LAYOUT.byteOffset(groupElement("CryptoCapabilities"));
    ...
    public static MemorySegment CryptoCapabilities(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)CryptoCapabilities$ELEM_HANDLE.invokeExact(struct, CryptoCapabilities$OFFSET, index0);
