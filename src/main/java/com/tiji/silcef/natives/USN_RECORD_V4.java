...
public class USN_RECORD_V4 {
    ...
    private static final long RemainingExtents$OFFSET = $LAYOUT.byteOffset(groupElement("RemainingExtents"));
    ...
    private static final long NumberOfExtents$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfExtents"));
    ...
    private static final long ExtentSize$OFFSET = $LAYOUT.byteOffset(groupElement("ExtentSize"));
    ...
    private static final long Extents$OFFSET = $LAYOUT.byteOffset(groupElement("Extents"));
    ...
    public static MemorySegment Extents(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Extents$ELEM_HANDLE.invokeExact(struct, Extents$OFFSET, index0);
