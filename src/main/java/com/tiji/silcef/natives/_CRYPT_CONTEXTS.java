...
public class _CRYPT_CONTEXTS {
    ...
    private static final long cContexts$OFFSET = $LAYOUT.byteOffset(groupElement("cContexts"));
    ...
    private static final long rgpszContexts$OFFSET = $LAYOUT.byteOffset(groupElement("rgpszContexts"));
