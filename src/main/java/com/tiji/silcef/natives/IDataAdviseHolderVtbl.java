...
public class IDataAdviseHolderVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("SendOnDataChange")
     ...
     * }
     */
    public final static class SendOnDataChange {

        private SendOnDataChange() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SendOnDataChange.Function.class, "apply", $DESC);
    ...
    private static final long SendOnDataChange$OFFSET = $LAYOUT.byteOffset(groupElement("SendOnDataChange"));
