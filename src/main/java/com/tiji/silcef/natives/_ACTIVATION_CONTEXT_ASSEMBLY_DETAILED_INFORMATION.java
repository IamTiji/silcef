...
public class _ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("ulEncodedAssemblyIdentityLength"),
        cef_master_h.C_LONG.withName("ulManifestPathType"),
        cef_master_h.C_LONG.withName("ulManifestPathLength"),
        _LARGE_INTEGER.layout().withName("liManifestLastWriteTime"),
        cef_master_h.C_LONG.withName("ulPolicyPathType"),
        cef_master_h.C_LONG.withName("ulPolicyPathLength"),
        _LARGE_INTEGER.layout().withName("liPolicyLastWriteTime"),
        cef_master_h.C_LONG.withName("ulMetadataSatelliteRosterIndex"),
        cef_master_h.C_LONG.withName("ulManifestVersionMajor"),
        cef_master_h.C_LONG.withName("ulManifestVersionMinor"),
        cef_master_h.C_LONG.withName("ulPolicyVersionMajor"),
        cef_master_h.C_LONG.withName("ulPolicyVersionMinor"),
        cef_master_h.C_LONG.withName("ulAssemblyDirectoryNameLength"),
        cef_master_h.C_POINTER.withName("lpAssemblyEncodedAssemblyIdentity"),
        cef_master_h.C_POINTER.withName("lpAssemblyManifestPath"),
        cef_master_h.C_POINTER.withName("lpAssemblyPolicyPath"),
        cef_master_h.C_POINTER.withName("lpAssemblyDirectoryName"),
        cef_master_h.C_LONG.withName("ulFileCount"),
