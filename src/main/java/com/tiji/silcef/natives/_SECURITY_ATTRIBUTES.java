...
public class _SECURITY_ATTRIBUTES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("lpSecurityDescriptor"),
    ...
    private static final long lpSecurityDescriptor$OFFSET = $LAYOUT.byteOffset(groupElement("lpSecurityDescriptor"));
    ...
    private static final long bInheritHandle$OFFSET = $LAYOUT.byteOffset(groupElement("bInheritHandle"));
