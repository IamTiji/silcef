...
public class _FILE_STAT_BASIC_INFORMATION {
    ...
    private static final long DeviceCharacteristics$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceCharacteristics"));
    ...
    private static final long FileId128$OFFSET = $LAYOUT.byteOffset(groupElement("FileId128"));
