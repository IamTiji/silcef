...
public class DISPLAYCONFIG_MODE_INFO {
    ...
    private static final long infoType$OFFSET = $LAYOUT.byteOffset(groupElement("infoType"));
    ...
    private static final long targetMode$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2936:5"), groupElement("targetMode"));
    ...
    private static final long sourceMode$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2936:5"), groupElement("sourceMode"));
    ...
    private static final long desktopImageInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2936:5"), groupElement("desktopImageInfo"));
