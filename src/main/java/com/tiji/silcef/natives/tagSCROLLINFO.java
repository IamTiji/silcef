...
public class tagSCROLLINFO {
    ...
    private static final long nMin$OFFSET = $LAYOUT.byteOffset(groupElement("nMin"));
    ...
    private static final long nMax$OFFSET = $LAYOUT.byteOffset(groupElement("nMax"));
    ...
    private static final long nPage$OFFSET = $LAYOUT.byteOffset(groupElement("nPage"));
    ...
    private static final long nPos$OFFSET = $LAYOUT.byteOffset(groupElement("nPos"));
    ...
    private static final long nTrackPos$OFFSET = $LAYOUT.byteOffset(groupElement("nTrackPos"));
