...
public class _STORAGE_MINIPORT_DESCRIPTOR {
    ...
    private static final long Portdriver$OFFSET = $LAYOUT.byteOffset(groupElement("Portdriver"));
    ...
    private static final long LUNResetSupported$OFFSET = $LAYOUT.byteOffset(groupElement("LUNResetSupported"));
    ...
    private static final long TargetResetSupported$OFFSET = $LAYOUT.byteOffset(groupElement("TargetResetSupported"));
    ...
    private static final long IoTimeoutValue$OFFSET = $LAYOUT.byteOffset(groupElement("IoTimeoutValue"));
    ...
    private static final long ExtraIoInfoSupported$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraIoInfoSupported"));
