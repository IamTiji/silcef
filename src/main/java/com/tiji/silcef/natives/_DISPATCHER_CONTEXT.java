...
public class _DISPATCHER_CONTEXT {
    ...
    private static final long TargetIp$OFFSET = $LAYOUT.byteOffset(groupElement("TargetIp"));
    ...
    private static final long Fill0$OFFSET = $LAYOUT.byteOffset(groupElement("Fill0"));
