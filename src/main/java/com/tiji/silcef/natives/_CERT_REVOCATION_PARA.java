...
public class _CERT_REVOCATION_PARA {
    ...
    private static final long pIssuerCert$OFFSET = $LAYOUT.byteOffset(groupElement("pIssuerCert"));
    ...
    private static final long cCertStore$OFFSET = $LAYOUT.byteOffset(groupElement("cCertStore"));
    ...
    private static final long rgCertStore$OFFSET = $LAYOUT.byteOffset(groupElement("rgCertStore"));
    ...
    private static final long hCrlStore$OFFSET = $LAYOUT.byteOffset(groupElement("hCrlStore"));
    ...
    private static final long pftTimeToUse$OFFSET = $LAYOUT.byteOffset(groupElement("pftTimeToUse"));
