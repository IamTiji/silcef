...
public class _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION {
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3290:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3290:5"), groupElement("value"));
