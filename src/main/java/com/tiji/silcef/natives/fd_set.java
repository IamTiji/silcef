...
public class fd_set {
    ...
    private static final long fd_count$OFFSET = $LAYOUT.byteOffset(groupElement("fd_count"));
    ...
    private static final long fd_array$OFFSET = $LAYOUT.byteOffset(groupElement("fd_array"));
    ...
    public static long fd_array(MemorySegment struct, long index0) {
        return (long)fd_array$ELEM_HANDLE.get(struct, fd_array$OFFSET, index0);
    }
    ...
    public static void fd_array(MemorySegment struct, long index0, long fieldValue) {
        fd_array$ELEM_HANDLE.set(struct, fd_array$OFFSET, index0, fieldValue);
    }
