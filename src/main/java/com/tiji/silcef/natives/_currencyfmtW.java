...
public class _currencyfmtW {
    ...
    private static final long NumDigits$OFFSET = $LAYOUT.byteOffset(groupElement("NumDigits"));
    ...
    private static final long LeadingZero$OFFSET = $LAYOUT.byteOffset(groupElement("LeadingZero"));
    ...
    private static final long Grouping$OFFSET = $LAYOUT.byteOffset(groupElement("Grouping"));
    ...
    private static final long lpDecimalSep$OFFSET = $LAYOUT.byteOffset(groupElement("lpDecimalSep"));
    ...
    private static final long lpThousandSep$OFFSET = $LAYOUT.byteOffset(groupElement("lpThousandSep"));
    ...
    private static final long NegativeOrder$OFFSET = $LAYOUT.byteOffset(groupElement("NegativeOrder"));
    ...
    private static final long PositiveOrder$OFFSET = $LAYOUT.byteOffset(groupElement("PositiveOrder"));
    ...
    private static final long lpCurrencySymbol$OFFSET = $LAYOUT.byteOffset(groupElement("lpCurrencySymbol"));
