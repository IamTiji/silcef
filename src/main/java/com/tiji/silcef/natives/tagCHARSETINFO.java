...
public class tagCHARSETINFO {
    ...
    private static final long ciCharset$OFFSET = $LAYOUT.byteOffset(groupElement("ciCharset"));
    ...
    private static final long ciACP$OFFSET = $LAYOUT.byteOffset(groupElement("ciACP"));
