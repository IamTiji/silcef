...
public class _COMMPROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_SHORT.withName("wPacketLength"),
        cef_master_h.C_SHORT.withName("wPacketVersion"),
        cef_master_h.C_LONG.withName("dwServiceMask"),
        cef_master_h.C_LONG.withName("dwReserved1"),
        cef_master_h.C_LONG.withName("dwMaxTxQueue"),
        cef_master_h.C_LONG.withName("dwMaxRxQueue"),
        cef_master_h.C_LONG.withName("dwMaxBaud"),
        cef_master_h.C_LONG.withName("dwProvSubType"),
        cef_master_h.C_LONG.withName("dwProvCapabilities"),
        cef_master_h.C_LONG.withName("dwSettableParams"),
        cef_master_h.C_LONG.withName("dwSettableBaud"),
        cef_master_h.C_SHORT.withName("wSettableData"),
        cef_master_h.C_SHORT.withName("wSettableStopParity"),
        cef_master_h.C_LONG.withName("dwCurrentTxQueue"),
        cef_master_h.C_LONG.withName("dwCurrentRxQueue"),
        cef_master_h.C_LONG.withName("dwProvSpec1"),
        cef_master_h.C_LONG.withName("dwProvSpec2"),
        MemoryLayout.sequenceLayout(1, cef_master_h.C_SHORT).withName("wcProvChar"),
