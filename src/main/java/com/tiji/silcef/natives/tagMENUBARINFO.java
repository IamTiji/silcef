...
public class tagMENUBARINFO {
    ...
    private static final long rcBar$OFFSET = $LAYOUT.byteOffset(groupElement("rcBar"));
    ...
    private static final long hwndMenu$OFFSET = $LAYOUT.byteOffset(groupElement("hwndMenu"));
