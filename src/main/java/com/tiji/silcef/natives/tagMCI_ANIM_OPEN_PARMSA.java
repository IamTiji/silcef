...
public class tagMCI_ANIM_OPEN_PARMSA {
    ...
    private static final long wDeviceID$OFFSET = $LAYOUT.byteOffset(groupElement("wDeviceID"));
    ...
    private static final long lpstrDeviceType$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrDeviceType"));
    ...
    private static final long lpstrElementName$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrElementName"));
    ...
    private static final long lpstrAlias$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrAlias"));
