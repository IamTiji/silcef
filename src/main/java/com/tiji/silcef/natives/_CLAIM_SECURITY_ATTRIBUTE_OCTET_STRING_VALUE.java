...
public class _CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE {
    ...
    private static final long pValue$OFFSET = $LAYOUT.byteOffset(groupElement("pValue"));
    ...
    private static final long ValueLength$OFFSET = $LAYOUT.byteOffset(groupElement("ValueLength"));
