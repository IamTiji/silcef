...
public class _ACCESS_DENIED_OBJECT_ACE {
    ...
    private static final long InheritedObjectType$OFFSET = $LAYOUT.byteOffset(groupElement("InheritedObjectType"));
    ...
    private static final long SidStart$OFFSET = $LAYOUT.byteOffset(groupElement("SidStart"));
