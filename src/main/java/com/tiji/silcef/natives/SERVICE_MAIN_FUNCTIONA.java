 ...
 * }
 */
public final class SERVICE_MAIN_FUNCTIONA {

    private SERVICE_MAIN_FUNCTIONA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SERVICE_MAIN_FUNCTIONA.Function.class, "apply", $DESC);
