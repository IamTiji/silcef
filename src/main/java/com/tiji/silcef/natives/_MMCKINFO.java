...
public class _MMCKINFO {
    ...
    private static final long ckid$OFFSET = $LAYOUT.byteOffset(groupElement("ckid"));
    ...
    private static final long cksize$OFFSET = $LAYOUT.byteOffset(groupElement("cksize"));
    ...
    private static final long fccType$OFFSET = $LAYOUT.byteOffset(groupElement("fccType"));
    ...
    private static final long dwDataOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwDataOffset"));
