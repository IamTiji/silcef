...
public class _CRYPT_RC2_CBC_PARAMETERS {
    ...
    private static final long fIV$OFFSET = $LAYOUT.byteOffset(groupElement("fIV"));
    ...
    private static final long rgbIV$OFFSET = $LAYOUT.byteOffset(groupElement("rgbIV"));
    ...
    public static byte rgbIV(MemorySegment struct, long index0) {
        return (byte)rgbIV$ELEM_HANDLE.get(struct, rgbIV$OFFSET, index0);
    }
    ...
    public static void rgbIV(MemorySegment struct, long index0, byte fieldValue) {
        rgbIV$ELEM_HANDLE.set(struct, rgbIV$OFFSET, index0, fieldValue);
    }
