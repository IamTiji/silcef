...
public class _SERVERSILO_BASIC_INFORMATION {
    ...
    private static final long ServiceSessionId$OFFSET = $LAYOUT.byteOffset(groupElement("ServiceSessionId"));
    ...
    private static final long ExitStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ExitStatus"));
    ...
    private static final long ApiSetSchema$OFFSET = $LAYOUT.byteOffset(groupElement("ApiSetSchema"));
    ...
    private static final long HostApiSetSchema$OFFSET = $LAYOUT.byteOffset(groupElement("HostApiSetSchema"));
    ...
    private static final long ContainerBuildNumber$OFFSET = $LAYOUT.byteOffset(groupElement("ContainerBuildNumber"));
    ...
    private static final long HostBuildNumber$OFFSET = $LAYOUT.byteOffset(groupElement("HostBuildNumber"));
