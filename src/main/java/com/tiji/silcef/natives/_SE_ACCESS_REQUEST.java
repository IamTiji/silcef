...
public class _SE_ACCESS_REQUEST {
    ...
    private static final long SeSecurityDescriptor$OFFSET = $LAYOUT.byteOffset(groupElement("SeSecurityDescriptor"));
    ...
    private static final long DesiredAccess$OFFSET = $LAYOUT.byteOffset(groupElement("DesiredAccess"));
    ...
    private static final long PreviouslyGrantedAccess$OFFSET = $LAYOUT.byteOffset(groupElement("PreviouslyGrantedAccess"));
    ...
    private static final long PrincipalSelfSid$OFFSET = $LAYOUT.byteOffset(groupElement("PrincipalSelfSid"));
    ...
    private static final long GenericMapping$OFFSET = $LAYOUT.byteOffset(groupElement("GenericMapping"));
    ...
    private static final long ObjectTypeListCount$OFFSET = $LAYOUT.byteOffset(groupElement("ObjectTypeListCount"));
    ...
    private static final long ObjectTypeList$OFFSET = $LAYOUT.byteOffset(groupElement("ObjectTypeList"));
