...
public class _DEVICE_DSM_REPORT_ZONES_PARAMETERS {
    ...
    private static final long ReportOption$OFFSET = $LAYOUT.byteOffset(groupElement("ReportOption"));
    ...
    private static final long Partial$OFFSET = $LAYOUT.byteOffset(groupElement("Partial"));
