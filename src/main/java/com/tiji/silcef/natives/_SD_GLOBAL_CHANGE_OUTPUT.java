...
public class _SD_GLOBAL_CHANGE_OUTPUT {
    ...
    private static final long ChangeType$OFFSET = $LAYOUT.byteOffset(groupElement("ChangeType"));
    ...
    private static final GroupLayout SdChange$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14956:5"), groupElement("SdChange"));
    ...
    private static final long SdChange$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14956:5"), groupElement("SdChange"));
    ...
    private static final GroupLayout SdQueryStats$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14956:5"), groupElement("SdQueryStats"));
    ...
    private static final long SdQueryStats$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14956:5"), groupElement("SdQueryStats"));
    ...
    private static final GroupLayout SdEnumSds$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14956:5"), groupElement("SdEnumSds"));
    ...
    private static final long SdEnumSds$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14956:5"), groupElement("SdEnumSds"));
