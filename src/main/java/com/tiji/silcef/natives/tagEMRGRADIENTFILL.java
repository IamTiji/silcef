...
public class tagEMRGRADIENTFILL {
    ...
    private static final long nVer$OFFSET = $LAYOUT.byteOffset(groupElement("nVer"));
    ...
    private static final long nTri$OFFSET = $LAYOUT.byteOffset(groupElement("nTri"));
    ...
    private static final long ulMode$OFFSET = $LAYOUT.byteOffset(groupElement("ulMode"));
    ...
    private static final long Ver$OFFSET = $LAYOUT.byteOffset(groupElement("Ver"));
    ...
    public static MemorySegment Ver(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Ver$ELEM_HANDLE.invokeExact(struct, Ver$OFFSET, index0);
