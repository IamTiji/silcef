...
public class _IMAGE_HOT_PATCH_BASE {
    ...
    private static final long OriginalTimeDateStamp$OFFSET = $LAYOUT.byteOffset(groupElement("OriginalTimeDateStamp"));
    ...
    private static final long OriginalCheckSum$OFFSET = $LAYOUT.byteOffset(groupElement("OriginalCheckSum"));
    ...
    private static final long CodeIntegrityInfo$OFFSET = $LAYOUT.byteOffset(groupElement("CodeIntegrityInfo"));
    ...
    private static final long CodeIntegritySize$OFFSET = $LAYOUT.byteOffset(groupElement("CodeIntegritySize"));
    ...
    private static final long PatchTable$OFFSET = $LAYOUT.byteOffset(groupElement("PatchTable"));
