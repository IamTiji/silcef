...
public class tagMOUSEINPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("dx"),
        cef_render_handler_capi_h.C_LONG.withName("dy"),
    ...
    private static final long mouseData$OFFSET = $LAYOUT.byteOffset(groupElement("mouseData"));
