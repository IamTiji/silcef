...
public class tagLOGCOLORSPACEA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("lcsFilename")
    ...
    private static final long lcsSignature$OFFSET = $LAYOUT.byteOffset(groupElement("lcsSignature"));
    ...
    private static final long lcsVersion$OFFSET = $LAYOUT.byteOffset(groupElement("lcsVersion"));
    ...
    private static final long lcsSize$OFFSET = $LAYOUT.byteOffset(groupElement("lcsSize"));
    ...
    private static final long lcsCSType$OFFSET = $LAYOUT.byteOffset(groupElement("lcsCSType"));
    ...
    private static final long lcsIntent$OFFSET = $LAYOUT.byteOffset(groupElement("lcsIntent"));
    ...
    private static final long lcsEndpoints$OFFSET = $LAYOUT.byteOffset(groupElement("lcsEndpoints"));
    ...
    private static final long lcsGammaRed$OFFSET = $LAYOUT.byteOffset(groupElement("lcsGammaRed"));
    ...
    private static final long lcsGammaGreen$OFFSET = $LAYOUT.byteOffset(groupElement("lcsGammaGreen"));
    ...
    private static final long lcsGammaBlue$OFFSET = $LAYOUT.byteOffset(groupElement("lcsGammaBlue"));
    ...
    private static final long lcsFilename$OFFSET = $LAYOUT.byteOffset(groupElement("lcsFilename"));
    ...
    public static byte lcsFilename(MemorySegment struct, long index0) {
        return (byte)lcsFilename$ELEM_HANDLE.get(struct, lcsFilename$OFFSET, index0);
    }
    ...
    public static void lcsFilename(MemorySegment struct, long index0, byte fieldValue) {
        lcsFilename$ELEM_HANDLE.set(struct, lcsFilename$OFFSET, index0, fieldValue);
    }
