...
public class _FIND_NAME_BUFFER {
    ...
    private static final long access_control$OFFSET = $LAYOUT.byteOffset(groupElement("access_control"));
    ...
    private static final long frame_control$OFFSET = $LAYOUT.byteOffset(groupElement("frame_control"));
    ...
    private static final long destination_addr$OFFSET = $LAYOUT.byteOffset(groupElement("destination_addr"));
    ...
    public static byte destination_addr(MemorySegment struct, long index0) {
        return (byte)destination_addr$ELEM_HANDLE.get(struct, destination_addr$OFFSET, index0);
    }
    ...
    public static void destination_addr(MemorySegment struct, long index0, byte fieldValue) {
        destination_addr$ELEM_HANDLE.set(struct, destination_addr$OFFSET, index0, fieldValue);
    }
    ...
    private static final long source_addr$OFFSET = $LAYOUT.byteOffset(groupElement("source_addr"));
    ...
    public static byte source_addr(MemorySegment struct, long index0) {
        return (byte)source_addr$ELEM_HANDLE.get(struct, source_addr$OFFSET, index0);
    }
    ...
    public static void source_addr(MemorySegment struct, long index0, byte fieldValue) {
        source_addr$ELEM_HANDLE.set(struct, source_addr$OFFSET, index0, fieldValue);
    }
    ...
    private static final long routing_info$OFFSET = $LAYOUT.byteOffset(groupElement("routing_info"));
    ...
    public static byte routing_info(MemorySegment struct, long index0) {
        return (byte)routing_info$ELEM_HANDLE.get(struct, routing_info$OFFSET, index0);
    }
    ...
    public static void routing_info(MemorySegment struct, long index0, byte fieldValue) {
        routing_info$ELEM_HANDLE.set(struct, routing_info$OFFSET, index0, fieldValue);
    }
