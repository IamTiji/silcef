...
public class _JOBOBJECT_LIMIT_VIOLATION_INFORMATION {
    ...
    private static final long JobMemoryLimit$OFFSET = $LAYOUT.byteOffset(groupElement("JobMemoryLimit"));
    ...
    private static final long RateControlTolerance$OFFSET = $LAYOUT.byteOffset(groupElement("RateControlTolerance"));
    ...
    private static final long RateControlToleranceLimit$OFFSET = $LAYOUT.byteOffset(groupElement("RateControlToleranceLimit"));
