...
public class tagBITMAPCOREHEADER {
    ...
    private static final long bcSize$OFFSET = $LAYOUT.byteOffset(groupElement("bcSize"));
    ...
    private static final long bcWidth$OFFSET = $LAYOUT.byteOffset(groupElement("bcWidth"));
    ...
    private static final long bcHeight$OFFSET = $LAYOUT.byteOffset(groupElement("bcHeight"));
    ...
    private static final long bcPlanes$OFFSET = $LAYOUT.byteOffset(groupElement("bcPlanes"));
    ...
    private static final long bcBitCount$OFFSET = $LAYOUT.byteOffset(groupElement("bcBitCount"));
