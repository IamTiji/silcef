...
public class tagSOUNDSENTRYW {
    ...
    private static final long iFSTextEffect$OFFSET = $LAYOUT.byteOffset(groupElement("iFSTextEffect"));
    ...
    private static final long iFSTextEffectMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iFSTextEffectMSec"));
    ...
    private static final long iFSTextEffectColorBits$OFFSET = $LAYOUT.byteOffset(groupElement("iFSTextEffectColorBits"));
    ...
    private static final long iFSGrafEffect$OFFSET = $LAYOUT.byteOffset(groupElement("iFSGrafEffect"));
    ...
    private static final long iFSGrafEffectMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iFSGrafEffectMSec"));
    ...
    private static final long iFSGrafEffectColor$OFFSET = $LAYOUT.byteOffset(groupElement("iFSGrafEffectColor"));
    ...
    private static final long iWindowsEffect$OFFSET = $LAYOUT.byteOffset(groupElement("iWindowsEffect"));
    ...
    private static final long iWindowsEffectMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iWindowsEffectMSec"));
    ...
    private static final long lpszWindowsEffectDLL$OFFSET = $LAYOUT.byteOffset(groupElement("lpszWindowsEffectDLL"));
    ...
    private static final long iWindowsEffectOrdinal$OFFSET = $LAYOUT.byteOffset(groupElement("iWindowsEffectOrdinal"));
