...
public class _MESSAGE_RESOURCE_BLOCK {
    ...
    private static final long LowId$OFFSET = $LAYOUT.byteOffset(groupElement("LowId"));
    ...
    private static final long HighId$OFFSET = $LAYOUT.byteOffset(groupElement("HighId"));
    ...
    private static final long OffsetToEntries$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetToEntries"));
