...
public class tagEMRPOLYPOLYLINE {
    ...
    private static final long cptl$OFFSET = $LAYOUT.byteOffset(groupElement("cptl"));
    ...
    private static final long aptl$OFFSET = $LAYOUT.byteOffset(groupElement("aptl"));
    ...
    public static MemorySegment aptl(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)aptl$ELEM_HANDLE.invokeExact(struct, aptl$OFFSET, index0);
