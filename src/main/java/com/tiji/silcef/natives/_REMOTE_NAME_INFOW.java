...
public class _REMOTE_NAME_INFOW {
    ...
    private static final long lpUniversalName$OFFSET = $LAYOUT.byteOffset(groupElement("lpUniversalName"));
    ...
    private static final long lpConnectionName$OFFSET = $LAYOUT.byteOffset(groupElement("lpConnectionName"));
    ...
    private static final long lpRemainingPath$OFFSET = $LAYOUT.byteOffset(groupElement("lpRemainingPath"));
