...
public class _NCB {
    ...
    private static final long ncb_command$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_command"));
    ...
    private static final long ncb_retcode$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_retcode"));
    ...
    private static final long ncb_lsn$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_lsn"));
    ...
    private static final long ncb_num$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_num"));
    ...
    private static final long ncb_buffer$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_buffer"));
    ...
    private static final long ncb_length$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_length"));
    ...
    private static final long ncb_callname$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_callname"));
    ...
    public static byte ncb_callname(MemorySegment struct, long index0) {
        return (byte)ncb_callname$ELEM_HANDLE.get(struct, ncb_callname$OFFSET, index0);
    }
    ...
    public static void ncb_callname(MemorySegment struct, long index0, byte fieldValue) {
        ncb_callname$ELEM_HANDLE.set(struct, ncb_callname$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ncb_name$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_name"));
    ...
    public static byte ncb_name(MemorySegment struct, long index0) {
        return (byte)ncb_name$ELEM_HANDLE.get(struct, ncb_name$OFFSET, index0);
    }
    ...
    public static void ncb_name(MemorySegment struct, long index0, byte fieldValue) {
        ncb_name$ELEM_HANDLE.set(struct, ncb_name$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ncb_rto$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_rto"));
    ...
    private static final long ncb_sto$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_sto"));
     ...
     * }
     */
    public final static class ncb_post {
    ...
    private static final long ncb_post$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_post"));
    ...
    private static final long ncb_lana_num$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_lana_num"));
    ...
    private static final long ncb_cmd_cplt$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_cmd_cplt"));
    ...
    private static final long ncb_reserve$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_reserve"));
    ...
    public static byte ncb_reserve(MemorySegment struct, long index0) {
        return (byte)ncb_reserve$ELEM_HANDLE.get(struct, ncb_reserve$OFFSET, index0);
    }
    ...
    public static void ncb_reserve(MemorySegment struct, long index0, byte fieldValue) {
        ncb_reserve$ELEM_HANDLE.set(struct, ncb_reserve$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ncb_event$OFFSET = $LAYOUT.byteOffset(groupElement("ncb_event"));
