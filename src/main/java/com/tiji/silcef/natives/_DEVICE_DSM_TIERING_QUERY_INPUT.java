...
public class _DEVICE_DSM_TIERING_QUERY_INPUT {
    ...
    private static final long NumberOfTierIds$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfTierIds"));
    ...
    private static final long TierIds$OFFSET = $LAYOUT.byteOffset(groupElement("TierIds"));
    ...
    public static MemorySegment TierIds(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)TierIds$ELEM_HANDLE.invokeExact(struct, TierIds$OFFSET, index0);
