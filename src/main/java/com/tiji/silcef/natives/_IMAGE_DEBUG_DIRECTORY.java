...
public class _IMAGE_DEBUG_DIRECTORY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("AddressOfRawData"),
    ...
    private static final long AddressOfRawData$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfRawData"));
