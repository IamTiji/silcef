...
public class tagGESTUREINFO {
    ...
    private static final long dwID$OFFSET = $LAYOUT.byteOffset(groupElement("dwID"));
    ...
    private static final long ptsLocation$OFFSET = $LAYOUT.byteOffset(groupElement("ptsLocation"));
    ...
    private static final long dwInstanceID$OFFSET = $LAYOUT.byteOffset(groupElement("dwInstanceID"));
    ...
    private static final long dwSequenceID$OFFSET = $LAYOUT.byteOffset(groupElement("dwSequenceID"));
    ...
    private static final long ullArguments$OFFSET = $LAYOUT.byteOffset(groupElement("ullArguments"));
    ...
    private static final long cbExtraArgs$OFFSET = $LAYOUT.byteOffset(groupElement("cbExtraArgs"));
