...
public class _CERT_RDN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cRDNAttr"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgRDNAttr")
    ).withName("_CERT_RDN");
    ...
    private static final long cRDNAttr$OFFSET = $LAYOUT.byteOffset(groupElement("cRDNAttr"));
    ...
    private static final long rgRDNAttr$OFFSET = $LAYOUT.byteOffset(groupElement("rgRDNAttr"));
