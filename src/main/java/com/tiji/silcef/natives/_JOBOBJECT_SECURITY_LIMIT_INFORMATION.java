...
public class _JOBOBJECT_SECURITY_LIMIT_INFORMATION {
    ...
    private static final long SecurityLimitFlags$OFFSET = $LAYOUT.byteOffset(groupElement("SecurityLimitFlags"));
    ...
    private static final long JobToken$OFFSET = $LAYOUT.byteOffset(groupElement("JobToken"));
    ...
    private static final long SidsToDisable$OFFSET = $LAYOUT.byteOffset(groupElement("SidsToDisable"));
    ...
    private static final long PrivilegesToDelete$OFFSET = $LAYOUT.byteOffset(groupElement("PrivilegesToDelete"));
