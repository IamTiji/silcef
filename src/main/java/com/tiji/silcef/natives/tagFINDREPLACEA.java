...
public class tagFINDREPLACEA {
    ...
    private static final long lpstrFindWhat$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrFindWhat"));
    ...
    private static final long lpstrReplaceWith$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrReplaceWith"));
    ...
    private static final long wFindWhatLen$OFFSET = $LAYOUT.byteOffset(groupElement("wFindWhatLen"));
    ...
    private static final long wReplaceWithLen$OFFSET = $LAYOUT.byteOffset(groupElement("wReplaceWithLen"));
