...
public class _QUERY_FILE_LAYOUT_INPUT {
    ...
    private static final OfInt FilterEntryCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15629:5"), groupElement("FilterEntryCount"));
    ...
    private static final long FilterEntryCount$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15629:5"), groupElement("FilterEntryCount"));
    ...
    private static final OfInt NumberOfPairs$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15629:5"), groupElement("NumberOfPairs"));
    ...
    private static final long NumberOfPairs$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15629:5"), groupElement("NumberOfPairs"));
    ...
    private static final long FilterType$OFFSET = $LAYOUT.byteOffset(groupElement("FilterType"));
    ...
    public static class Filter {
        ...
        private static final long ClusterRanges$OFFSET = $LAYOUT.byteOffset(groupElement("ClusterRanges"));
        ...
        public static MemorySegment ClusterRanges(MemorySegment union, long index0) {
            try {
                return (MemorySegment)ClusterRanges$ELEM_HANDLE.invokeExact(union, ClusterRanges$OFFSET, index0);
        ...
        private static final long FileReferenceRanges$OFFSET = $LAYOUT.byteOffset(groupElement("FileReferenceRanges"));
        ...
        public static MemorySegment FileReferenceRanges(MemorySegment union, long index0) {
            try {
                return (MemorySegment)FileReferenceRanges$ELEM_HANDLE.invokeExact(union, FileReferenceRanges$OFFSET, index0);
            } catch (Error | RuntimeException ex) {
                throw ex;
            } catch (Throwable ex$) {
                throw new AssertionError("should not reach here", ex$);
        ...
        private static final long StorageReserveIds$OFFSET = $LAYOUT.byteOffset(groupElement("StorageReserveIds"));
        ...
        public static int StorageReserveIds(MemorySegment union, long index0) {
            return (int)StorageReserveIds$ELEM_HANDLE.get(union, StorageReserveIds$OFFSET, index0);
        }
        ...
        public static void StorageReserveIds(MemorySegment union, long index0, int fieldValue) {
            StorageReserveIds$ELEM_HANDLE.set(union, StorageReserveIds$OFFSET, index0, fieldValue);
        }
