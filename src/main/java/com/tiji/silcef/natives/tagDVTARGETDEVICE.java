...
public class tagDVTARGETDEVICE {
    ...
    private static final long tdSize$OFFSET = $LAYOUT.byteOffset(groupElement("tdSize"));
    ...
    private static final long tdDriverNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("tdDriverNameOffset"));
    ...
    private static final long tdDeviceNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("tdDeviceNameOffset"));
    ...
    private static final long tdPortNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("tdPortNameOffset"));
    ...
    private static final long tdExtDevmodeOffset$OFFSET = $LAYOUT.byteOffset(groupElement("tdExtDevmodeOffset"));
    ...
    private static final long tdData$OFFSET = $LAYOUT.byteOffset(groupElement("tdData"));
    ...
    public static byte tdData(MemorySegment struct, long index0) {
        return (byte)tdData$ELEM_HANDLE.get(struct, tdData$OFFSET, index0);
    }
    ...
    public static void tdData(MemorySegment struct, long index0, byte fieldValue) {
        tdData$ELEM_HANDLE.set(struct, tdData$OFFSET, index0, fieldValue);
    }
