...
public class _WIN32_FIND_DATAA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("cFileName"),
        MemoryLayout.sequenceLayout(14, cef_render_handler_capi_h.C_CHAR).withName("cAlternateFileName"),
    ...
    public static byte cFileName(MemorySegment struct, long index0) {
        return (byte)cFileName$ELEM_HANDLE.get(struct, cFileName$OFFSET, index0);
    }
    ...
    public static byte cAlternateFileName(MemorySegment struct, long index0) {
        return (byte)cAlternateFileName$ELEM_HANDLE.get(struct, cAlternateFileName$OFFSET, index0);
    }
