...
public class _TAPE_GET_MEDIA_PARAMETERS {
    ...
    private static final long Remaining$OFFSET = $LAYOUT.byteOffset(groupElement("Remaining"));
    ...
    private static final long WriteProtected$OFFSET = $LAYOUT.byteOffset(groupElement("WriteProtected"));
