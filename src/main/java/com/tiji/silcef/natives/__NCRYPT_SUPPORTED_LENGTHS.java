...
public class __NCRYPT_SUPPORTED_LENGTHS {
    ...
    private static final long dwMinLength$OFFSET = $LAYOUT.byteOffset(groupElement("dwMinLength"));
    ...
    private static final long dwMaxLength$OFFSET = $LAYOUT.byteOffset(groupElement("dwMaxLength"));
    ...
    private static final long dwIncrement$OFFSET = $LAYOUT.byteOffset(groupElement("dwIncrement"));
    ...
    private static final long dwDefaultLength$OFFSET = $LAYOUT.byteOffset(groupElement("dwDefaultLength"));
