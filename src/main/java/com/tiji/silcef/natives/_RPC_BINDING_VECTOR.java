...
public class _RPC_BINDING_VECTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_POINTER).withName("BindingH")
    ...
    private static final long BindingH$OFFSET = $LAYOUT.byteOffset(groupElement("BindingH"));
    ...
    public static MemorySegment BindingH(MemorySegment struct, long index0) {
        return (MemorySegment)BindingH$ELEM_HANDLE.get(struct, BindingH$OFFSET, index0);
    }
    ...
    public static void BindingH(MemorySegment struct, long index0, MemorySegment fieldValue) {
        BindingH$ELEM_HANDLE.set(struct, BindingH$OFFSET, index0, fieldValue);
    }
