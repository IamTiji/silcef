...
public class _XSAVE_FORMAT {
    ...
    private static final long ControlWord$OFFSET = $LAYOUT.byteOffset(groupElement("ControlWord"));
    ...
    private static final long StatusWord$OFFSET = $LAYOUT.byteOffset(groupElement("StatusWord"));
    ...
    private static final long TagWord$OFFSET = $LAYOUT.byteOffset(groupElement("TagWord"));
    ...
    private static final long ErrorOpcode$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorOpcode"));
    ...
    private static final long ErrorOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorOffset"));
    ...
    private static final long ErrorSelector$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorSelector"));
    ...
    private static final long DataSelector$OFFSET = $LAYOUT.byteOffset(groupElement("DataSelector"));
    ...
    private static final long MxCsr_Mask$OFFSET = $LAYOUT.byteOffset(groupElement("MxCsr_Mask"));
    ...
    private static final long FloatRegisters$OFFSET = $LAYOUT.byteOffset(groupElement("FloatRegisters"));
    ...
    public static MemorySegment FloatRegisters(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)FloatRegisters$ELEM_HANDLE.invokeExact(struct, FloatRegisters$OFFSET, index0);
    ...
    private static final long XmmRegisters$OFFSET = $LAYOUT.byteOffset(groupElement("XmmRegisters"));
    ...
    public static MemorySegment XmmRegisters(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)XmmRegisters$ELEM_HANDLE.invokeExact(struct, XmmRegisters$OFFSET, index0);
        } catch (Error | RuntimeException ex) {
            throw ex;
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static byte Reserved4(MemorySegment struct, long index0) {
        return (byte)Reserved4$ELEM_HANDLE.get(struct, Reserved4$OFFSET, index0);
    }
    ...
    public static void Reserved4(MemorySegment struct, long index0, byte fieldValue) {
        Reserved4$ELEM_HANDLE.set(struct, Reserved4$OFFSET, index0, fieldValue);
    }
