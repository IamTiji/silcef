...
public class tagMINMAXINFO {
    ...
    private static final long ptReserved$OFFSET = $LAYOUT.byteOffset(groupElement("ptReserved"));
    ...
    private static final long ptMaxSize$OFFSET = $LAYOUT.byteOffset(groupElement("ptMaxSize"));
    ...
    private static final long ptMaxPosition$OFFSET = $LAYOUT.byteOffset(groupElement("ptMaxPosition"));
    ...
    private static final long ptMinTrackSize$OFFSET = $LAYOUT.byteOffset(groupElement("ptMinTrackSize"));
    ...
    private static final long ptMaxTrackSize$OFFSET = $LAYOUT.byteOffset(groupElement("ptMaxTrackSize"));
