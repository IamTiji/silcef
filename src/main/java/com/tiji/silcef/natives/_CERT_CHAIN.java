...
public class _CERT_CHAIN {
    ...
    private static final long cCerts$OFFSET = $LAYOUT.byteOffset(groupElement("cCerts"));
    ...
    private static final long certs$OFFSET = $LAYOUT.byteOffset(groupElement("certs"));
    ...
    private static final long keyLocatorInfo$OFFSET = $LAYOUT.byteOffset(groupElement("keyLocatorInfo"));
