...
public class tagAXISINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_CHAR).withName("axAxisName")
    ...
    public static byte axAxisName(MemorySegment struct, long index0) {
        return (byte)axAxisName$ELEM_HANDLE.get(struct, axAxisName$OFFSET, index0);
    }
