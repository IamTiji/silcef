...
public class _ENCRYPTED_DATA_INFO {
    ...
    private static final long StartingFileOffset$OFFSET = $LAYOUT.byteOffset(groupElement("StartingFileOffset"));
    ...
    private static final long OutputBufferOffset$OFFSET = $LAYOUT.byteOffset(groupElement("OutputBufferOffset"));
    ...
    private static final long BytesWithinFileSize$OFFSET = $LAYOUT.byteOffset(groupElement("BytesWithinFileSize"));
    ...
    private static final long BytesWithinValidDataLength$OFFSET = $LAYOUT.byteOffset(groupElement("BytesWithinValidDataLength"));
    ...
    private static final long CompressionFormat$OFFSET = $LAYOUT.byteOffset(groupElement("CompressionFormat"));
    ...
    private static final long DataUnitShift$OFFSET = $LAYOUT.byteOffset(groupElement("DataUnitShift"));
    ...
    private static final long ChunkShift$OFFSET = $LAYOUT.byteOffset(groupElement("ChunkShift"));
    ...
    private static final long ClusterShift$OFFSET = $LAYOUT.byteOffset(groupElement("ClusterShift"));
    ...
    private static final long EncryptionFormat$OFFSET = $LAYOUT.byteOffset(groupElement("EncryptionFormat"));
    ...
    private static final long NumberOfDataBlocks$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfDataBlocks"));
    ...
    private static final long DataBlockSize$OFFSET = $LAYOUT.byteOffset(groupElement("DataBlockSize"));
    ...
    public static int DataBlockSize(MemorySegment struct, long index0) {
        return (int)DataBlockSize$ELEM_HANDLE.get(struct, DataBlockSize$OFFSET, index0);
    }
    ...
    public static void DataBlockSize(MemorySegment struct, long index0, int fieldValue) {
        DataBlockSize$ELEM_HANDLE.set(struct, DataBlockSize$OFFSET, index0, fieldValue);
    }
