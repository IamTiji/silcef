...
public class _CRYPT_BLOB_ARRAY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cBlob"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgBlob")
    ...
    private static final long cBlob$OFFSET = $LAYOUT.byteOffset(groupElement("cBlob"));
    ...
    private static final long rgBlob$OFFSET = $LAYOUT.byteOffset(groupElement("rgBlob"));
