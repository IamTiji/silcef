...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD {
    ...
    private static final long Cdb$OFFSET = $LAYOUT.byteOffset(groupElement("Cdb"));
    ...
    public static byte Cdb(MemorySegment struct, long index0) {
        return (byte)Cdb$ELEM_HANDLE.get(struct, Cdb$OFFSET, index0);
    }
    ...
    public static void Cdb(MemorySegment struct, long index0, byte fieldValue) {
        Cdb$ELEM_HANDLE.set(struct, Cdb$OFFSET, index0, fieldValue);
    }
    ...
    private static final long OperationStatus$OFFSET = $LAYOUT.byteOffset(groupElement("OperationStatus"));
    ...
    private static final long OperationError$OFFSET = $LAYOUT.byteOffset(groupElement("OperationError"));
    ...
    public static class StackSpecific {
        ...
        private static final long ExternalStack$OFFSET = $LAYOUT.byteOffset(groupElement("ExternalStack"));
        ...
        public static class AtaPort {
            ...
            private static final long dwAtaPortSpecific$OFFSET = $LAYOUT.byteOffset(groupElement("dwAtaPortSpecific"));
        ...
        private static final long AtaPort$OFFSET = $LAYOUT.byteOffset(groupElement("AtaPort"));
        ...
        public static class StorPort {
            ...
            private static final long SrbTag$OFFSET = $LAYOUT.byteOffset(groupElement("SrbTag"));
        ...
        private static final long StorPort$OFFSET = $LAYOUT.byteOffset(groupElement("StorPort"));
    ...
    private static final long StackSpecific$OFFSET = $LAYOUT.byteOffset(groupElement("StackSpecific"));
