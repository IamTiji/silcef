...
public class netent {
    ...
    private static final long n_name$OFFSET = $LAYOUT.byteOffset(groupElement("n_name"));
    ...
    private static final long n_aliases$OFFSET = $LAYOUT.byteOffset(groupElement("n_aliases"));
    ...
    private static final long n_addrtype$OFFSET = $LAYOUT.byteOffset(groupElement("n_addrtype"));
    ...
    private static final long n_net$OFFSET = $LAYOUT.byteOffset(groupElement("n_net"));
