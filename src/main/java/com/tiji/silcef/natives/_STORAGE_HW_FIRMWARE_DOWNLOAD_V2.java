...
public class _STORAGE_HW_FIRMWARE_DOWNLOAD_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("ImageSize"),
    ...
    private static final long ImageSize$OFFSET = $LAYOUT.byteOffset(groupElement("ImageSize"));
    ...
    private static final long ImageBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("ImageBuffer"));
    ...
    public static byte ImageBuffer(MemorySegment struct, long index0) {
        return (byte)ImageBuffer$ELEM_HANDLE.get(struct, ImageBuffer$OFFSET, index0);
    }
    ...
    public static void ImageBuffer(MemorySegment struct, long index0, byte fieldValue) {
        ImageBuffer$ELEM_HANDLE.set(struct, ImageBuffer$OFFSET, index0, fieldValue);
    }
