...
public class _CERT_ID {
    ...
    private static final long dwIdChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwIdChoice"));
    ...
    private static final GroupLayout IssuerSerialNumber$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6859:5"), groupElement("IssuerSerialNumber"));
    ...
    private static final long IssuerSerialNumber$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6859:5"), groupElement("IssuerSerialNumber"));
    ...
    private static final GroupLayout KeyId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6859:5"), groupElement("KeyId"));
    ...
    private static final long KeyId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6859:5"), groupElement("KeyId"));
    ...
    private static final GroupLayout HashId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6859:5"), groupElement("HashId"));
    ...
    private static final long HashId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6859:5"), groupElement("HashId"));
