...
public class tagTOUCH_HIT_TESTING_INPUT {
    ...
    private static final long boundingBox$OFFSET = $LAYOUT.byteOffset(groupElement("boundingBox"));
    ...
    private static final long nonOccludedBoundingBox$OFFSET = $LAYOUT.byteOffset(groupElement("nonOccludedBoundingBox"));
