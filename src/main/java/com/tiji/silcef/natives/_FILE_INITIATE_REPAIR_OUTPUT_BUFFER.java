...
public class _FILE_INITIATE_REPAIR_OUTPUT_BUFFER {
    ...
    private static final long Hint1$OFFSET = $LAYOUT.byteOffset(groupElement("Hint1"));
    ...
    private static final long Hint2$OFFSET = $LAYOUT.byteOffset(groupElement("Hint2"));
    ...
    private static final long Clsn$OFFSET = $LAYOUT.byteOffset(groupElement("Clsn"));
