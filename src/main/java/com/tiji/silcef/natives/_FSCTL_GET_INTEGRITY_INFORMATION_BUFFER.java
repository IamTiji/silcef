...
public class _FSCTL_GET_INTEGRITY_INFORMATION_BUFFER {
    ...
    private static final long ChecksumAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("ChecksumAlgorithm"));
    ...
    private static final long ChecksumChunkSizeInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("ChecksumChunkSizeInBytes"));
    ...
    private static final long ClusterSizeInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("ClusterSizeInBytes"));
