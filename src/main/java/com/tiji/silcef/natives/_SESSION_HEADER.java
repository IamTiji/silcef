...
public class _SESSION_HEADER {
    ...
    private static final long sess_name$OFFSET = $LAYOUT.byteOffset(groupElement("sess_name"));
    ...
    private static final long num_sess$OFFSET = $LAYOUT.byteOffset(groupElement("num_sess"));
    ...
    private static final long rcv_dg_outstanding$OFFSET = $LAYOUT.byteOffset(groupElement("rcv_dg_outstanding"));
    ...
    private static final long rcv_any_outstanding$OFFSET = $LAYOUT.byteOffset(groupElement("rcv_any_outstanding"));
