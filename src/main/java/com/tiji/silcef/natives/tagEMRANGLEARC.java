...
public class tagEMRANGLEARC {
    ...
    private static final long ptlCenter$OFFSET = $LAYOUT.byteOffset(groupElement("ptlCenter"));
    ...
    private static final long nRadius$OFFSET = $LAYOUT.byteOffset(groupElement("nRadius"));
    ...
    private static final long eStartAngle$OFFSET = $LAYOUT.byteOffset(groupElement("eStartAngle"));
    ...
    private static final long eSweepAngle$OFFSET = $LAYOUT.byteOffset(groupElement("eSweepAngle"));
