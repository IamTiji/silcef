...
public class tagMDINEXTMENU {
    ...
    private static final long hmenuIn$OFFSET = $LAYOUT.byteOffset(groupElement("hmenuIn"));
    ...
    private static final long hmenuNext$OFFSET = $LAYOUT.byteOffset(groupElement("hmenuNext"));
    ...
    private static final long hwndNext$OFFSET = $LAYOUT.byteOffset(groupElement("hwndNext"));
