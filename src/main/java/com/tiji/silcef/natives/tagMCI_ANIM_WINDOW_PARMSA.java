...
public class tagMCI_ANIM_WINDOW_PARMSA {
    ...
    private static final long nCmdShow$OFFSET = $LAYOUT.byteOffset(groupElement("nCmdShow"));
    ...
    private static final long lpstrText$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrText"));
