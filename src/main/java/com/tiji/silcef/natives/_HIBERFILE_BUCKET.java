...
public class _HIBERFILE_BUCKET {
    ...
    private static final long MaxPhysicalMemory$OFFSET = $LAYOUT.byteOffset(groupElement("MaxPhysicalMemory"));
    ...
    private static final long PhysicalMemoryPercent$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalMemoryPercent"));
    ...
    public static int PhysicalMemoryPercent(MemorySegment struct, long index0) {
        return (int)PhysicalMemoryPercent$ELEM_HANDLE.get(struct, PhysicalMemoryPercent$OFFSET, index0);
    }
    ...
    public static void PhysicalMemoryPercent(MemorySegment struct, long index0, int fieldValue) {
        PhysicalMemoryPercent$ELEM_HANDLE.set(struct, PhysicalMemoryPercent$OFFSET, index0, fieldValue);
    }
