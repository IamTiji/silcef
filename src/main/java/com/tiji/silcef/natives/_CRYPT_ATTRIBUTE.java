...
public class _CRYPT_ATTRIBUTE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("cValue"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgValue")
    ...
    private static final long cValue$OFFSET = $LAYOUT.byteOffset(groupElement("cValue"));
    ...
    private static final long rgValue$OFFSET = $LAYOUT.byteOffset(groupElement("rgValue"));
