...
public class tagWINDOWPLACEMENT {
    ...
    private static final long showCmd$OFFSET = $LAYOUT.byteOffset(groupElement("showCmd"));
    ...
    private static final long ptMinPosition$OFFSET = $LAYOUT.byteOffset(groupElement("ptMinPosition"));
    ...
    private static final long rcNormalPosition$OFFSET = $LAYOUT.byteOffset(groupElement("rcNormalPosition"));
