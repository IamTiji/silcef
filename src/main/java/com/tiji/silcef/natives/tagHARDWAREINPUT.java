...
public class tagHARDWAREINPUT {
    ...
    private static final long uMsg$OFFSET = $LAYOUT.byteOffset(groupElement("uMsg"));
    ...
    private static final long wParamL$OFFSET = $LAYOUT.byteOffset(groupElement("wParamL"));
    ...
    private static final long wParamH$OFFSET = $LAYOUT.byteOffset(groupElement("wParamH"));
