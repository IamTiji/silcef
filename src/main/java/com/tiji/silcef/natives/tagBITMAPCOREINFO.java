...
public class tagBITMAPCOREINFO {
    ...
    private static final long bmciHeader$OFFSET = $LAYOUT.byteOffset(groupElement("bmciHeader"));
    ...
    private static final long bmciColors$OFFSET = $LAYOUT.byteOffset(groupElement("bmciColors"));
    ...
    public static MemorySegment bmciColors(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)bmciColors$ELEM_HANDLE.invokeExact(struct, bmciColors$OFFSET, index0);
