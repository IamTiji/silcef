...
public class PPM_WMI_IDLE_STATES_EX {
    ...
    private static final long TargetState$OFFSET = $LAYOUT.byteOffset(groupElement("TargetState"));
    ...
    private static final long OldState$OFFSET = $LAYOUT.byteOffset(groupElement("OldState"));
