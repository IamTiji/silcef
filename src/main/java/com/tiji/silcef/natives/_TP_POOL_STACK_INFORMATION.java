...
public class _TP_POOL_STACK_INFORMATION {
    ...
    private static final long StackReserve$OFFSET = $LAYOUT.byteOffset(groupElement("StackReserve"));
    ...
    private static final long StackCommit$OFFSET = $LAYOUT.byteOffset(groupElement("StackCommit"));
