...
public class _CRYPT_TIMESTAMP_ACCURACY {
    ...
    private static final long dwSeconds$OFFSET = $LAYOUT.byteOffset(groupElement("dwSeconds"));
    ...
    private static final long dwMillis$OFFSET = $LAYOUT.byteOffset(groupElement("dwMillis"));
    ...
    private static final long dwMicros$OFFSET = $LAYOUT.byteOffset(groupElement("dwMicros"));
