...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_CHAR.withName("PowerButtonPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("SleepButtonPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("LidPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemS1"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemS2"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemS3"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemS4"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemS5"),
        cef_render_handler_capi_h.C_CHAR.withName("HiberFilePresent"),
        cef_render_handler_capi_h.C_CHAR.withName("FullWake"),
        cef_render_handler_capi_h.C_CHAR.withName("VideoDimPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("ApmPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("UpsPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("ThermalControl"),
        cef_render_handler_capi_h.C_CHAR.withName("ProcessorThrottle"),
        cef_render_handler_capi_h.C_CHAR.withName("ProcessorMinThrottle"),
        cef_render_handler_capi_h.C_CHAR.withName("ProcessorMaxThrottle"),
        cef_render_handler_capi_h.C_CHAR.withName("FastSystemS4"),
        cef_render_handler_capi_h.C_CHAR.withName("Hiberboot"),
        cef_render_handler_capi_h.C_CHAR.withName("WakeAlarmPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("AoAc"),
        cef_render_handler_capi_h.C_CHAR.withName("DiskSpinDown"),
        cef_render_handler_capi_h.C_CHAR.withName("HiberFileType"),
        cef_render_handler_capi_h.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, cef_render_handler_capi_h.C_CHAR).withName("spare3"),
        cef_render_handler_capi_h.C_CHAR.withName("SystemBatteriesPresent"),
        cef_render_handler_capi_h.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        cef_render_handler_capi_h.C_INT.withName("AcOnLineWake"),
        cef_render_handler_capi_h.C_INT.withName("SoftLidWake"),
        cef_render_handler_capi_h.C_INT.withName("RtcWake"),
        cef_render_handler_capi_h.C_INT.withName("MinDeviceWakeState"),
        cef_render_handler_capi_h.C_INT.withName("DefaultLowLatencyWake")
    ).withName("$anon$19527:9");
    ...
    private static final long PowerButtonPresent$OFFSET = $LAYOUT.byteOffset(groupElement("PowerButtonPresent"));
    ...
    private static final long SleepButtonPresent$OFFSET = $LAYOUT.byteOffset(groupElement("SleepButtonPresent"));
    ...
    private static final long LidPresent$OFFSET = $LAYOUT.byteOffset(groupElement("LidPresent"));
    ...
    private static final long SystemS1$OFFSET = $LAYOUT.byteOffset(groupElement("SystemS1"));
    ...
    private static final long SystemS2$OFFSET = $LAYOUT.byteOffset(groupElement("SystemS2"));
    ...
    private static final long SystemS3$OFFSET = $LAYOUT.byteOffset(groupElement("SystemS3"));
    ...
    private static final long SystemS4$OFFSET = $LAYOUT.byteOffset(groupElement("SystemS4"));
    ...
    private static final long SystemS5$OFFSET = $LAYOUT.byteOffset(groupElement("SystemS5"));
    ...
    private static final long HiberFilePresent$OFFSET = $LAYOUT.byteOffset(groupElement("HiberFilePresent"));
    ...
    private static final long FullWake$OFFSET = $LAYOUT.byteOffset(groupElement("FullWake"));
    ...
    private static final long VideoDimPresent$OFFSET = $LAYOUT.byteOffset(groupElement("VideoDimPresent"));
    ...
    private static final long ApmPresent$OFFSET = $LAYOUT.byteOffset(groupElement("ApmPresent"));
    ...
    private static final long UpsPresent$OFFSET = $LAYOUT.byteOffset(groupElement("UpsPresent"));
    ...
    private static final long ThermalControl$OFFSET = $LAYOUT.byteOffset(groupElement("ThermalControl"));
    ...
    private static final long ProcessorThrottle$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessorThrottle"));
    ...
    private static final long ProcessorMinThrottle$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessorMinThrottle"));
    ...
    private static final long ProcessorMaxThrottle$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessorMaxThrottle"));
    ...
    private static final long FastSystemS4$OFFSET = $LAYOUT.byteOffset(groupElement("FastSystemS4"));
    ...
    private static final long Hiberboot$OFFSET = $LAYOUT.byteOffset(groupElement("Hiberboot"));
    ...
    private static final long WakeAlarmPresent$OFFSET = $LAYOUT.byteOffset(groupElement("WakeAlarmPresent"));
    ...
    private static final long AoAc$OFFSET = $LAYOUT.byteOffset(groupElement("AoAc"));
    ...
    private static final long DiskSpinDown$OFFSET = $LAYOUT.byteOffset(groupElement("DiskSpinDown"));
    ...
    private static final long HiberFileType$OFFSET = $LAYOUT.byteOffset(groupElement("HiberFileType"));
    ...
    private static final long AoAcConnectivitySupported$OFFSET = $LAYOUT.byteOffset(groupElement("AoAcConnectivitySupported"));
    ...
    private static final long spare3$OFFSET = $LAYOUT.byteOffset(groupElement("spare3"));
    ...
    public static byte spare3(MemorySegment struct, long index0) {
        return (byte)spare3$ELEM_HANDLE.get(struct, spare3$OFFSET, index0);
    }
    ...
    public static void spare3(MemorySegment struct, long index0, byte fieldValue) {
        spare3$ELEM_HANDLE.set(struct, spare3$OFFSET, index0, fieldValue);
    }
    ...
    private static final long SystemBatteriesPresent$OFFSET = $LAYOUT.byteOffset(groupElement("SystemBatteriesPresent"));
    ...
    private static final long BatteriesAreShortTerm$OFFSET = $LAYOUT.byteOffset(groupElement("BatteriesAreShortTerm"));
    ...
    private static final long BatteryScale$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryScale"));
    ...
    public static MemorySegment BatteryScale(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)BatteryScale$ELEM_HANDLE.invokeExact(struct, BatteryScale$OFFSET, index0);
    ...
    private static final long AcOnLineWake$OFFSET = $LAYOUT.byteOffset(groupElement("AcOnLineWake"));
    ...
    private static final long SoftLidWake$OFFSET = $LAYOUT.byteOffset(groupElement("SoftLidWake"));
    ...
    private static final long RtcWake$OFFSET = $LAYOUT.byteOffset(groupElement("RtcWake"));
    ...
    private static final long MinDeviceWakeState$OFFSET = $LAYOUT.byteOffset(groupElement("MinDeviceWakeState"));
    ...
    private static final long DefaultLowLatencyWake$OFFSET = $LAYOUT.byteOffset(groupElement("DefaultLowLatencyWake"));
