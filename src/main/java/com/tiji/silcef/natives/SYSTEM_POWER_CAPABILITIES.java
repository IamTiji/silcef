...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_CHAR.withName("PowerButtonPresent"),
        cef_master_h.C_CHAR.withName("SleepButtonPresent"),
        cef_master_h.C_CHAR.withName("LidPresent"),
        cef_master_h.C_CHAR.withName("SystemS1"),
        cef_master_h.C_CHAR.withName("SystemS2"),
        cef_master_h.C_CHAR.withName("SystemS3"),
        cef_master_h.C_CHAR.withName("SystemS4"),
        cef_master_h.C_CHAR.withName("SystemS5"),
        cef_master_h.C_CHAR.withName("HiberFilePresent"),
        cef_master_h.C_CHAR.withName("FullWake"),
        cef_master_h.C_CHAR.withName("VideoDimPresent"),
        cef_master_h.C_CHAR.withName("ApmPresent"),
        cef_master_h.C_CHAR.withName("UpsPresent"),
        cef_master_h.C_CHAR.withName("ThermalControl"),
        cef_master_h.C_CHAR.withName("ProcessorThrottle"),
        cef_master_h.C_CHAR.withName("ProcessorMinThrottle"),
        cef_master_h.C_CHAR.withName("ProcessorMaxThrottle"),
        cef_master_h.C_CHAR.withName("FastSystemS4"),
        cef_master_h.C_CHAR.withName("Hiberboot"),
        cef_master_h.C_CHAR.withName("WakeAlarmPresent"),
        cef_master_h.C_CHAR.withName("AoAc"),
        cef_master_h.C_CHAR.withName("DiskSpinDown"),
        cef_master_h.C_CHAR.withName("HiberFileType"),
        cef_master_h.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, cef_master_h.C_CHAR).withName("spare3"),
        cef_master_h.C_CHAR.withName("SystemBatteriesPresent"),
        cef_master_h.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        cef_master_h.C_INT.withName("AcOnLineWake"),
        cef_master_h.C_INT.withName("SoftLidWake"),
        cef_master_h.C_INT.withName("RtcWake"),
        cef_master_h.C_INT.withName("MinDeviceWakeState"),
        cef_master_h.C_INT.withName("DefaultLowLatencyWake")
