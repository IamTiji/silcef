...
public class tagBINDPTR {
    ...
    private static final long lpfuncdesc$OFFSET = $LAYOUT.byteOffset(groupElement("lpfuncdesc"));
    ...
    private static final long lpvardesc$OFFSET = $LAYOUT.byteOffset(groupElement("lpvardesc"));
    ...
    private static final long lptcomp$OFFSET = $LAYOUT.byteOffset(groupElement("lptcomp"));
