...
public class _CERT_GENERAL_SUBTREE {
    ...
    private static final long dwMinimum$OFFSET = $LAYOUT.byteOffset(groupElement("dwMinimum"));
    ...
    private static final long fMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("fMaximum"));
    ...
    private static final long dwMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("dwMaximum"));
