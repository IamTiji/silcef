...
public class _STORAGE_DEVICE_RESILIENCY_DESCRIPTOR {
    ...
    private static final long NumberOfLogicalCopies$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfLogicalCopies"));
    ...
    private static final long NumberOfPhysicalCopies$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfPhysicalCopies"));
    ...
    private static final long PhysicalDiskRedundancy$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalDiskRedundancy"));
    ...
    private static final long NumberOfColumns$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfColumns"));
    ...
    private static final long Interleave$OFFSET = $LAYOUT.byteOffset(groupElement("Interleave"));
