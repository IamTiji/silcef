...
public class _CRYPT_BIT_BLOB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("cUnusedBits"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long pbData$OFFSET = $LAYOUT.byteOffset(groupElement("pbData"));
    ...
    private static final long cUnusedBits$OFFSET = $LAYOUT.byteOffset(groupElement("cUnusedBits"));
