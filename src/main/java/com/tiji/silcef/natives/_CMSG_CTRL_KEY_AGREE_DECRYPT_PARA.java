...
public class _CMSG_CTRL_KEY_AGREE_DECRYPT_PARA {
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8283:5"), groupElement("hCryptProv"));
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8283:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8283:5"), groupElement("hNCryptKey"));
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8283:5"), groupElement("hNCryptKey"));
    ...
    private static final long pKeyAgree$OFFSET = $LAYOUT.byteOffset(groupElement("pKeyAgree"));
    ...
    private static final long dwRecipientEncryptedKeyIndex$OFFSET = $LAYOUT.byteOffset(groupElement("dwRecipientEncryptedKeyIndex"));
    ...
    private static final long OriginatorPublicKey$OFFSET = $LAYOUT.byteOffset(groupElement("OriginatorPublicKey"));
