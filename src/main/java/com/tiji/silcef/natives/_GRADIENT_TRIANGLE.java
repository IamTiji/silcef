...
public class _GRADIENT_TRIANGLE {
    ...
    private static final long Vertex1$OFFSET = $LAYOUT.byteOffset(groupElement("Vertex1"));
    ...
    private static final long Vertex2$OFFSET = $LAYOUT.byteOffset(groupElement("Vertex2"));
    ...
    private static final long Vertex3$OFFSET = $LAYOUT.byteOffset(groupElement("Vertex3"));
