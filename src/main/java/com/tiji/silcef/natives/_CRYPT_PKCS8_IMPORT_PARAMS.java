...
public class _CRYPT_PKCS8_IMPORT_PARAMS {
    ...
    private static final long PrivateKey$OFFSET = $LAYOUT.byteOffset(groupElement("PrivateKey"));
    ...
    private static final long pResolvehCryptProvFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pResolvehCryptProvFunc"));
    ...
    private static final long pVoidResolveFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pVoidResolveFunc"));
    ...
    private static final long pDecryptPrivateKeyFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pDecryptPrivateKeyFunc"));
    ...
    private static final long pVoidDecryptFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pVoidDecryptFunc"));
