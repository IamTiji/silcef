...
public class _CERT_KEY_ATTRIBUTES_INFO {
    ...
    private static final long IntendedKeyUsage$OFFSET = $LAYOUT.byteOffset(groupElement("IntendedKeyUsage"));
    ...
    private static final long pPrivateKeyUsagePeriod$OFFSET = $LAYOUT.byteOffset(groupElement("pPrivateKeyUsagePeriod"));
