...
public class _CERT_KEY_CONTEXT {
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$9564:5"), groupElement("hCryptProv"));
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9564:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$9564:5"), groupElement("hNCryptKey"));
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9564:5"), groupElement("hNCryptKey"));
