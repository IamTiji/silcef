...
public class _CERT_BIOMETRIC_DATA {
    ...
    private static final long dwTypeOfBiometricDataChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeOfBiometricDataChoice"));
    ...
    private static final OfInt dwPredefined$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5644:5"), groupElement("dwPredefined"));
    ...
    private static final long dwPredefined$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5644:5"), groupElement("dwPredefined"));
    ...
    private static final AddressLayout pszObjId$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5644:5"), groupElement("pszObjId"));
    ...
    private static final long pszObjId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5644:5"), groupElement("pszObjId"));
    ...
    private static final long HashedUrl$OFFSET = $LAYOUT.byteOffset(groupElement("HashedUrl"));
