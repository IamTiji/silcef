...
public class IInternetBindInfoExVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("GetBindString"),
     ...
     * }
     */
    public final static class GetBindString {

        private GetBindString() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetBindString.Function.class, "apply", $DESC);
    ...
    private static final long GetBindString$OFFSET = $LAYOUT.byteOffset(groupElement("GetBindString"));
