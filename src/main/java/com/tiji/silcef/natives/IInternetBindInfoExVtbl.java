...
public class IInternetBindInfoExVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_POINTER.withName("GetBindString"),
    ...
    public final static class GetBindString {
        ...
        private static final MethodHandle UP$MH = cef_master_h.upcallHandle(GetBindString.Function.class, "apply", $DESC);
