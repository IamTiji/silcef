...
public class tagMIDIOUTCAPS2W {
    ...
    private static final long wTechnology$OFFSET = $LAYOUT.byteOffset(groupElement("wTechnology"));
    ...
    private static final long wVoices$OFFSET = $LAYOUT.byteOffset(groupElement("wVoices"));
    ...
    private static final long wNotes$OFFSET = $LAYOUT.byteOffset(groupElement("wNotes"));
    ...
    private static final long wChannelMask$OFFSET = $LAYOUT.byteOffset(groupElement("wChannelMask"));
    ...
    private static final long dwSupport$OFFSET = $LAYOUT.byteOffset(groupElement("dwSupport"));
