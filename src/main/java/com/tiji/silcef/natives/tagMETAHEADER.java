...
public class tagMETAHEADER {
    ...
    private static final long mtType$OFFSET = $LAYOUT.byteOffset(groupElement("mtType"));
    ...
    private static final long mtHeaderSize$OFFSET = $LAYOUT.byteOffset(groupElement("mtHeaderSize"));
    ...
    private static final long mtVersion$OFFSET = $LAYOUT.byteOffset(groupElement("mtVersion"));
    ...
    private static final long mtSize$OFFSET = $LAYOUT.byteOffset(groupElement("mtSize"));
    ...
    private static final long mtNoObjects$OFFSET = $LAYOUT.byteOffset(groupElement("mtNoObjects"));
    ...
    private static final long mtMaxRecord$OFFSET = $LAYOUT.byteOffset(groupElement("mtMaxRecord"));
    ...
    private static final long mtNoParameters$OFFSET = $LAYOUT.byteOffset(groupElement("mtNoParameters"));
