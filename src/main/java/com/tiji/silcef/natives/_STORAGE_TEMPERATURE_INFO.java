...
public class _STORAGE_TEMPERATURE_INFO {
    ...
    private static final long OverThreshold$OFFSET = $LAYOUT.byteOffset(groupElement("OverThreshold"));
    ...
    private static final long UnderThreshold$OFFSET = $LAYOUT.byteOffset(groupElement("UnderThreshold"));
    ...
    private static final long OverThresholdChangable$OFFSET = $LAYOUT.byteOffset(groupElement("OverThresholdChangable"));
    ...
    private static final long UnderThresholdChangable$OFFSET = $LAYOUT.byteOffset(groupElement("UnderThresholdChangable"));
    ...
    private static final long EventGenerated$OFFSET = $LAYOUT.byteOffset(groupElement("EventGenerated"));
