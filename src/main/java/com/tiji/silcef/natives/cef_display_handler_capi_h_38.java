...
class cef_display_handler_capi_h_38 extends cef_display_handler_capi_h_39 {

    cef_display_handler_capi_h_38() {
    ...
    private static final int COPY_FILE2_V2_DONT_COPY_JUNCTIONS = (int)1L;
    /**
     * {@snippet lang=c :
     * #define COPY_FILE2_V2_DONT_COPY_JUNCTIONS 1
     * }
     */
    public static int COPY_FILE2_V2_DONT_COPY_JUNCTIONS() {
        return COPY_FILE2_V2_DONT_COPY_JUNCTIONS;
    }
    private static final int COPY_FILE2_V2_DISABLE_BLOCK_CLONING = (int)2L;
    /**
     * {@snippet lang=c :
     * #define COPY_FILE2_V2_DISABLE_BLOCK_CLONING 2
     * }
     */
    public static int COPY_FILE2_V2_DISABLE_BLOCK_CLONING() {
        return COPY_FILE2_V2_DISABLE_BLOCK_CLONING;
    }
    ...
    private static final int FACILITY_USERMODE_UNIONFS = (int)2341L;
    /**
     * {@snippet lang=c :
     * #define FACILITY_USERMODE_UNIONFS 2341
     * }
     */
    public static int FACILITY_USERMODE_UNIONFS() {
        return FACILITY_USERMODE_UNIONFS;
    }
    private static final int FACILITY_USERMODE_PRM = (int)2342L;
    /**
     * {@snippet lang=c :
     * #define FACILITY_USERMODE_PRM 2342
     * }
     */
    public static int FACILITY_USERMODE_PRM() {
        return FACILITY_USERMODE_PRM;
    }
    private static final int FACILITY_USERMODE_WIN_ACCEL = (int)2343L;
    /**
     * {@snippet lang=c :
     * #define FACILITY_USERMODE_WIN_ACCEL 2343
     * }
     */
    public static int FACILITY_USERMODE_WIN_ACCEL() {
        return FACILITY_USERMODE_WIN_ACCEL;
    }
    private static final int FACILITY_PPF = (int)2344L;
    /**
     * {@snippet lang=c :
     * #define FACILITY_PPF 2344
     * }
     */
    public static int FACILITY_PPF() {
        return FACILITY_PPF;
    }
    ...
    private static final int RPI_SMB2_SHAREFLAG_COMPRESS_DATA = (int)2L;
    /**
     * {@snippet lang=c :
     * #define RPI_SMB2_SHAREFLAG_COMPRESS_DATA 2
     * }
     */
    public static int RPI_SMB2_SHAREFLAG_COMPRESS_DATA() {
        return RPI_SMB2_SHAREFLAG_COMPRESS_DATA;
    }
