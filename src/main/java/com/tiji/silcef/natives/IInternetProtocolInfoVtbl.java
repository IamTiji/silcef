...
public class IInternetProtocolInfoVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("ParseUrl"),
        cef_render_handler_capi_h.C_POINTER.withName("CombineUrl"),
        cef_render_handler_capi_h.C_POINTER.withName("CompareUrl"),
        cef_render_handler_capi_h.C_POINTER.withName("QueryInfo")
     ...
     * }
     */
    public final static class ParseUrl {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ParseUrl.Function.class, "apply", $DESC);
    ...
    private static final long ParseUrl$OFFSET = $LAYOUT.byteOffset(groupElement("ParseUrl"));
     ...
     * }
     */
    public final static class CombineUrl {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(CombineUrl.Function.class, "apply", $DESC);
    ...
    private static final long CombineUrl$OFFSET = $LAYOUT.byteOffset(groupElement("CombineUrl"));
     ...
     * }
     */
    public final static class CompareUrl {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(CompareUrl.Function.class, "apply", $DESC);
    ...
    private static final long CompareUrl$OFFSET = $LAYOUT.byteOffset(groupElement("CompareUrl"));
     ...
     * }
     */
    public final static class QueryInfo {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(QueryInfo.Function.class, "apply", $DESC);
    ...
    private static final long QueryInfo$OFFSET = $LAYOUT.byteOffset(groupElement("QueryInfo"));
