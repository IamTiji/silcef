...
public class _FILE_RENAME_INFO {
    ...
    private static final OfByte ReplaceIfExists$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$9114:5"), groupElement("ReplaceIfExists"));
    ...
    private static final long ReplaceIfExists$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9114:5"), groupElement("ReplaceIfExists"));
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$9114:5"), groupElement("Flags"));
    ...
    private static final long Flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9114:5"), groupElement("Flags"));
    ...
    private static final long RootDirectory$OFFSET = $LAYOUT.byteOffset(groupElement("RootDirectory"));
