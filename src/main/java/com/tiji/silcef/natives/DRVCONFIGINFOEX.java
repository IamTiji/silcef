...
public class DRVCONFIGINFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 1).withName("dwDCISize"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_POINTER, 1).withName("lpszDCISectionName"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_POINTER, 1).withName("lpszDCIAliasName"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 1).withName("dnDevNode")
    ...
    private static final long dwDCISize$OFFSET = $LAYOUT.byteOffset(groupElement("dwDCISize"));
    ...
    private static final long lpszDCISectionName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszDCISectionName"));
    ...
    private static final long lpszDCIAliasName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszDCIAliasName"));
    ...
    private static final long dnDevNode$OFFSET = $LAYOUT.byteOffset(groupElement("dnDevNode"));
