...
public class tagOBJECTDESCRIPTOR {
    ...
    private static final long dwDrawAspect$OFFSET = $LAYOUT.byteOffset(groupElement("dwDrawAspect"));
    ...
    private static final long sizel$OFFSET = $LAYOUT.byteOffset(groupElement("sizel"));
    ...
    private static final long pointl$OFFSET = $LAYOUT.byteOffset(groupElement("pointl"));
    ...
    private static final long dwFullUserTypeName$OFFSET = $LAYOUT.byteOffset(groupElement("dwFullUserTypeName"));
    ...
    private static final long dwSrcOfCopy$OFFSET = $LAYOUT.byteOffset(groupElement("dwSrcOfCopy"));
