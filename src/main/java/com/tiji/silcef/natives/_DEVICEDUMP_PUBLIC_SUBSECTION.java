...
public class _DEVICEDUMP_PUBLIC_SUBSECTION {
    ...
    private static final long GPLogTable$OFFSET = $LAYOUT.byteOffset(groupElement("GPLogTable"));
    ...
    public static MemorySegment GPLogTable(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)GPLogTable$ELEM_HANDLE.invokeExact(struct, GPLogTable$OFFSET, index0);
    ...
    private static final long bData$OFFSET = $LAYOUT.byteOffset(groupElement("bData"));
    ...
    public static byte bData(MemorySegment struct, long index0) {
        return (byte)bData$ELEM_HANDLE.get(struct, bData$OFFSET, index0);
    }
    ...
    public static void bData(MemorySegment struct, long index0, byte fieldValue) {
        bData$ELEM_HANDLE.set(struct, bData$OFFSET, index0, fieldValue);
    }
