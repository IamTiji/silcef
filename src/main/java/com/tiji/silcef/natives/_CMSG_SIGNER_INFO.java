...
public class _CMSG_SIGNER_INFO {
    ...
    private static final long HashEncryptionAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("HashEncryptionAlgorithm"));
    ...
    private static final long EncryptedHash$OFFSET = $LAYOUT.byteOffset(groupElement("EncryptedHash"));
    ...
    private static final long AuthAttrs$OFFSET = $LAYOUT.byteOffset(groupElement("AuthAttrs"));
    ...
    private static final long UnauthAttrs$OFFSET = $LAYOUT.byteOffset(groupElement("UnauthAttrs"));
