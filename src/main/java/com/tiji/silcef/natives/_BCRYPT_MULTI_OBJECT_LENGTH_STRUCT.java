...
public class _BCRYPT_MULTI_OBJECT_LENGTH_STRUCT {
    ...
    private static final long cbPerObject$OFFSET = $LAYOUT.byteOffset(groupElement("cbPerObject"));
    ...
    private static final long cbPerElement$OFFSET = $LAYOUT.byteOffset(groupElement("cbPerElement"));
