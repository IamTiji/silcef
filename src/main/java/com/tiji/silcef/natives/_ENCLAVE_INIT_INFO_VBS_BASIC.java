...
public class _ENCLAVE_INIT_INFO_VBS_BASIC {
    ...
    private static final long EnclaveSvn$OFFSET = $LAYOUT.byteOffset(groupElement("EnclaveSvn"));
    ...
    private static final AddressLayout SignatureInfoHandle$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$15161:5"), groupElement("SignatureInfoHandle"));
    ...
    private static final long SignatureInfoHandle$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15161:5"), groupElement("SignatureInfoHandle"));
    ...
    private static final OfLong Unused$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$15161:5"), groupElement("Unused"));
    ...
    private static final long Unused$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15161:5"), groupElement("Unused"));
