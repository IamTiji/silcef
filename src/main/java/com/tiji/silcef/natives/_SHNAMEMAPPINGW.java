...
public class _SHNAMEMAPPINGW {
    ...
    private static final long pszOldPath$OFFSET = $LAYOUT.byteOffset(groupElement("pszOldPath"));
    ...
    private static final long pszNewPath$OFFSET = $LAYOUT.byteOffset(groupElement("pszNewPath"));
    ...
    private static final long cchOldPath$OFFSET = $LAYOUT.byteOffset(groupElement("cchOldPath"));
    ...
    private static final long cchNewPath$OFFSET = $LAYOUT.byteOffset(groupElement("cchNewPath"));
