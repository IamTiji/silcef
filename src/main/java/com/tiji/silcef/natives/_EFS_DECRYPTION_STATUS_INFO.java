...
public class _EFS_DECRYPTION_STATUS_INFO {
    ...
    private static final long dwDecryptionError$OFFSET = $LAYOUT.byteOffset(groupElement("dwDecryptionError"));
    ...
    private static final long dwHashOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwHashOffset"));
    ...
    private static final long cbHash$OFFSET = $LAYOUT.byteOffset(groupElement("cbHash"));
