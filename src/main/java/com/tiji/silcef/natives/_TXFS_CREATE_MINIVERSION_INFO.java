...
public class _TXFS_CREATE_MINIVERSION_INFO {
    ...
    private static final long BaseVersion$OFFSET = $LAYOUT.byteOffset(groupElement("BaseVersion"));
    ...
    private static final long MiniVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MiniVersion"));
