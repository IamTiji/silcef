 ...
 * }
 */
public final class RPC_BLOCKING_FN {

    private RPC_BLOCKING_FN() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPC_BLOCKING_FN.Function.class, "apply", $DESC);
