...
public class _PROPSHEETHEADERA_V2 {
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("hIcon"));
    ...
    private static final long pszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("pszIcon"));
    ...
    private static final long nStartPage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("nStartPage"));
    ...
    private static final long pStartPage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("pStartPage"));
    ...
    private static final long ppsp$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("ppsp"));
    ...
    private static final long phpage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$479:5"), groupElement("phpage"));
    ...
    private static final long hbmWatermark$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$480:5"), groupElement("hbmWatermark"));
    ...
    private static final long pszbmWatermark$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$480:5"), groupElement("pszbmWatermark"));
    ...
    private static final long hbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$486:5"), groupElement("hbmHeader"));
    ...
    private static final long pszbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$486:5"), groupElement("pszbmHeader"));
