...
public class _NCRYPT_VBS_IDENTITY_ATTESTATION_HEADER {
    ...
    private static final long cbAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("cbAttributes"));
    ...
    private static final long cbHashAlg$OFFSET = $LAYOUT.byteOffset(groupElement("cbHashAlg"));
    ...
    private static final long cbPadding$OFFSET = $LAYOUT.byteOffset(groupElement("cbPadding"));
    ...
    private static final long cbSignatureAlg$OFFSET = $LAYOUT.byteOffset(groupElement("cbSignatureAlg"));
    ...
    private static final long cbSignature$OFFSET = $LAYOUT.byteOffset(groupElement("cbSignature"));
