...
public class tagRGBTRIPLE {
    ...
    private static final long rgbtBlue$OFFSET = $LAYOUT.byteOffset(groupElement("rgbtBlue"));
    ...
    private static final long rgbtGreen$OFFSET = $LAYOUT.byteOffset(groupElement("rgbtGreen"));
    ...
    private static final long rgbtRed$OFFSET = $LAYOUT.byteOffset(groupElement("rgbtRed"));
