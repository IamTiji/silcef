...
public class _UMS_CREATE_THREAD_ATTRIBUTES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("UmsContext"),
        cef_render_handler_capi_h.C_POINTER.withName("UmsCompletionList")
    ...
    private static final long UmsVersion$OFFSET = $LAYOUT.byteOffset(groupElement("UmsVersion"));
    ...
    private static final long UmsContext$OFFSET = $LAYOUT.byteOffset(groupElement("UmsContext"));
    ...
    private static final long UmsCompletionList$OFFSET = $LAYOUT.byteOffset(groupElement("UmsCompletionList"));
