...
public class _TP_CALLBACK_ENVIRON_V3 {
    ...
    private static final long CleanupGroup$OFFSET = $LAYOUT.byteOffset(groupElement("CleanupGroup"));
    ...
    private static final long CleanupGroupCancelCallback$OFFSET = $LAYOUT.byteOffset(groupElement("CleanupGroupCancelCallback"));
    ...
    private static final long RaceDll$OFFSET = $LAYOUT.byteOffset(groupElement("RaceDll"));
    ...
    private static final long ActivationContext$OFFSET = $LAYOUT.byteOffset(groupElement("ActivationContext"));
    ...
    private static final long FinalizationCallback$OFFSET = $LAYOUT.byteOffset(groupElement("FinalizationCallback"));
    ...
    private static final long CallbackPriority$OFFSET = $LAYOUT.byteOffset(groupElement("CallbackPriority"));
