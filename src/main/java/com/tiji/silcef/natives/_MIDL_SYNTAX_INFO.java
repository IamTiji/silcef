...
public class _MIDL_SYNTAX_INFO {
    ...
    private static final long DispatchTable$OFFSET = $LAYOUT.byteOffset(groupElement("DispatchTable"));
    ...
    private static final long ProcString$OFFSET = $LAYOUT.byteOffset(groupElement("ProcString"));
    ...
    private static final long FmtStringOffset$OFFSET = $LAYOUT.byteOffset(groupElement("FmtStringOffset"));
    ...
    private static final long TypeString$OFFSET = $LAYOUT.byteOffset(groupElement("TypeString"));
    ...
    private static final long pMethodProperties$OFFSET = $LAYOUT.byteOffset(groupElement("pMethodProperties"));
    ...
    private static final long pReserved2$OFFSET = $LAYOUT.byteOffset(groupElement("pReserved2"));
