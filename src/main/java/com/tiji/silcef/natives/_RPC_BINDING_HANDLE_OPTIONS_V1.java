...
public class _RPC_BINDING_HANDLE_OPTIONS_V1 {
    ...
    private static final long ComTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("ComTimeout"));
    ...
    private static final long CallTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("CallTimeout"));
