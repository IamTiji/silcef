...
public class _GET_FILTER_FILE_IDENTIFIER_OUTPUT {
    ...
    private static final long FilterFileIdentifierLength$OFFSET = $LAYOUT.byteOffset(groupElement("FilterFileIdentifierLength"));
    ...
    private static final long FilterFileIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("FilterFileIdentifier"));
    ...
    public static byte FilterFileIdentifier(MemorySegment struct, long index0) {
        return (byte)FilterFileIdentifier$ELEM_HANDLE.get(struct, FilterFileIdentifier$OFFSET, index0);
    }
    ...
    public static void FilterFileIdentifier(MemorySegment struct, long index0, byte fieldValue) {
        FilterFileIdentifier$ELEM_HANDLE.set(struct, FilterFileIdentifier$OFFSET, index0, fieldValue);
    }
