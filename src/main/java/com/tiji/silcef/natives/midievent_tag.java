...
public class midievent_tag {
    ...
    private static final long dwDeltaTime$OFFSET = $LAYOUT.byteOffset(groupElement("dwDeltaTime"));
    ...
    private static final long dwEvent$OFFSET = $LAYOUT.byteOffset(groupElement("dwEvent"));
    ...
    private static final long dwParms$OFFSET = $LAYOUT.byteOffset(groupElement("dwParms"));
    ...
    public static int dwParms(MemorySegment struct, long index0) {
        return (int)dwParms$ELEM_HANDLE.get(struct, dwParms$OFFSET, index0);
    }
    ...
    public static void dwParms(MemorySegment struct, long index0, int fieldValue) {
        dwParms$ELEM_HANDLE.set(struct, dwParms$OFFSET, index0, fieldValue);
    }
