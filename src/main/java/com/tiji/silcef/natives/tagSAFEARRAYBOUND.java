...
public class tagSAFEARRAYBOUND {
    ...
    private static final long cElements$OFFSET = $LAYOUT.byteOffset(groupElement("cElements"));
    ...
    private static final long lLbound$OFFSET = $LAYOUT.byteOffset(groupElement("lLbound"));
