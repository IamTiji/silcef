...
public class RPC_ENDPOINT_TEMPLATEA {
    ...
    private static final long ProtSeq$OFFSET = $LAYOUT.byteOffset(groupElement("ProtSeq"));
    ...
    private static final long Backlog$OFFSET = $LAYOUT.byteOffset(groupElement("Backlog"));
