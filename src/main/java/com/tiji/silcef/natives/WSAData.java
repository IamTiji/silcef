...
public class WSAData {
    ...
    private static final long wVersion$OFFSET = $LAYOUT.byteOffset(groupElement("wVersion"));
    ...
    private static final long wHighVersion$OFFSET = $LAYOUT.byteOffset(groupElement("wHighVersion"));
    ...
    private static final long iMaxSockets$OFFSET = $LAYOUT.byteOffset(groupElement("iMaxSockets"));
    ...
    private static final long iMaxUdpDg$OFFSET = $LAYOUT.byteOffset(groupElement("iMaxUdpDg"));
    ...
    private static final long lpVendorInfo$OFFSET = $LAYOUT.byteOffset(groupElement("lpVendorInfo"));
    ...
    public static byte szDescription(MemorySegment struct, long index0) {
        return (byte)szDescription$ELEM_HANDLE.get(struct, szDescription$OFFSET, index0);
    }
    ...
    private static final long szSystemStatus$OFFSET = $LAYOUT.byteOffset(groupElement("szSystemStatus"));
    ...
    public static byte szSystemStatus(MemorySegment struct, long index0) {
        return (byte)szSystemStatus$ELEM_HANDLE.get(struct, szSystemStatus$OFFSET, index0);
    }
    ...
    public static void szSystemStatus(MemorySegment struct, long index0, byte fieldValue) {
        szSystemStatus$ELEM_HANDLE.set(struct, szSystemStatus$OFFSET, index0, fieldValue);
    }
