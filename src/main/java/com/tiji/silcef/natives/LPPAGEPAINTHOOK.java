 ...
 * }
 */
public final class LPPAGEPAINTHOOK {

    private LPPAGEPAINTHOOK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPPAGEPAINTHOOK.Function.class, "apply", $DESC);
