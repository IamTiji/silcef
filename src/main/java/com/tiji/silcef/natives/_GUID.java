...
public class _GUID {
    ...
    private static final long Data3$OFFSET = $LAYOUT.byteOffset(groupElement("Data3"));
    ...
    private static final long Data4$OFFSET = $LAYOUT.byteOffset(groupElement("Data4"));
    ...
    public static byte Data4(MemorySegment struct, long index0) {
        return (byte)Data4$ELEM_HANDLE.get(struct, Data4$OFFSET, index0);
    }
    ...
    public static void Data4(MemorySegment struct, long index0, byte fieldValue) {
        Data4$ELEM_HANDLE.set(struct, Data4$OFFSET, index0, fieldValue);
    }
