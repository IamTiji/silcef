...
public class _TXFS_GET_TRANSACTED_VERSION {
    ...
    private static final long ThisBaseVersion$OFFSET = $LAYOUT.byteOffset(groupElement("ThisBaseVersion"));
    ...
    private static final long LatestVersion$OFFSET = $LAYOUT.byteOffset(groupElement("LatestVersion"));
    ...
    private static final long ThisMiniVersion$OFFSET = $LAYOUT.byteOffset(groupElement("ThisMiniVersion"));
    ...
    private static final long FirstMiniVersion$OFFSET = $LAYOUT.byteOffset(groupElement("FirstMiniVersion"));
    ...
    private static final long LatestMiniVersion$OFFSET = $LAYOUT.byteOffset(groupElement("LatestMiniVersion"));
