...
public class _FILE_ID_BOTH_DIR_INFO {
    ...
    private static final long FileIndex$OFFSET = $LAYOUT.byteOffset(groupElement("FileIndex"));
    ...
    private static final long EaSize$OFFSET = $LAYOUT.byteOffset(groupElement("EaSize"));
    ...
    private static final long ShortNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("ShortNameLength"));
    ...
    public static short ShortName(MemorySegment struct, long index0) {
        return (short)ShortName$ELEM_HANDLE.get(struct, ShortName$OFFSET, index0);
    }
    ...
    public static void ShortName(MemorySegment struct, long index0, short fieldValue) {
        ShortName$ELEM_HANDLE.set(struct, ShortName$OFFSET, index0, fieldValue);
    }
