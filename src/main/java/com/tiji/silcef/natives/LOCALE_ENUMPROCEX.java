 ...
 * }
 */
public final class LOCALE_ENUMPROCEX {

    private LOCALE_ENUMPROCEX() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LOCALE_ENUMPROCEX.Function.class, "apply", $DESC);
