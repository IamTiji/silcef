...
public class _PERF_INSTANCE_DEFINITION {
    ...
    private static final long ParentObjectTitleIndex$OFFSET = $LAYOUT.byteOffset(groupElement("ParentObjectTitleIndex"));
    ...
    private static final long ParentObjectInstance$OFFSET = $LAYOUT.byteOffset(groupElement("ParentObjectInstance"));
    ...
    private static final long NameLength$OFFSET = $LAYOUT.byteOffset(groupElement("NameLength"));
