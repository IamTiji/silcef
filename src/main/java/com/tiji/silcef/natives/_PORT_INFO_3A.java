...
public class _PORT_INFO_3A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("pszStatus"),
        cef_render_handler_capi_h.C_LONG.withName("dwSeverity"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final long pszStatus$OFFSET = $LAYOUT.byteOffset(groupElement("pszStatus"));
    ...
    private static final long dwSeverity$OFFSET = $LAYOUT.byteOffset(groupElement("dwSeverity"));
