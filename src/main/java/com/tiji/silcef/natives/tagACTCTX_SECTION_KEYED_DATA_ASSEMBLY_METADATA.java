...
public class tagACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA {
    ...
    private static final long lpInformation$OFFSET = $LAYOUT.byteOffset(groupElement("lpInformation"));
    ...
    private static final long ulSectionLength$OFFSET = $LAYOUT.byteOffset(groupElement("ulSectionLength"));
    ...
    private static final long lpSectionGlobalDataBase$OFFSET = $LAYOUT.byteOffset(groupElement("lpSectionGlobalDataBase"));
