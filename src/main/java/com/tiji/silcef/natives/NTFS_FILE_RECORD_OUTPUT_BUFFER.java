...
public class NTFS_FILE_RECORD_OUTPUT_BUFFER {
    ...
    private static final long FileRecordLength$OFFSET = $LAYOUT.byteOffset(groupElement("FileRecordLength"));
    ...
    private static final long FileRecordBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("FileRecordBuffer"));
    ...
    public static byte FileRecordBuffer(MemorySegment struct, long index0) {
        return (byte)FileRecordBuffer$ELEM_HANDLE.get(struct, FileRecordBuffer$OFFSET, index0);
    }
    ...
    public static void FileRecordBuffer(MemorySegment struct, long index0, byte fieldValue) {
        FileRecordBuffer$ELEM_HANDLE.set(struct, FileRecordBuffer$OFFSET, index0, fieldValue);
    }
