...
public class _PERF_BIN {
    ...
    private static final long NumberOfBins$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfBins"));
    ...
    private static final long TypeOfBin$OFFSET = $LAYOUT.byteOffset(groupElement("TypeOfBin"));
    ...
    private static final long BinsRanges$OFFSET = $LAYOUT.byteOffset(groupElement("BinsRanges"));
    ...
    public static MemorySegment BinsRanges(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)BinsRanges$ELEM_HANDLE.invokeExact(struct, BinsRanges$OFFSET, index0);
