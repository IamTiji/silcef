...
public class _CRYPT_PKCS12_PBE_PARAMS {
    ...
    private static final long iIterations$OFFSET = $LAYOUT.byteOffset(groupElement("iIterations"));
    ...
    private static final long cbSalt$OFFSET = $LAYOUT.byteOffset(groupElement("cbSalt"));
