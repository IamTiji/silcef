 ...
 * }
 */
public class _cef_select_client_certificate_callback_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_app_capi_h.C_POINTER.withName("select")
    ).withName("_cef_select_client_certificate_callback_t");
    ...
    public final static class select {
        ...
        private static final MethodHandle UP$MH = cef_app_capi_h.upcallHandle(select.Function.class, "apply", $DESC);
    ...
    private static final long select$OFFSET = $LAYOUT.byteOffset(groupElement("select"));
