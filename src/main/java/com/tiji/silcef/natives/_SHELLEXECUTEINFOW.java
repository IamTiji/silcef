...
public class _SHELLEXECUTEINFOW {
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$485:5"), groupElement("hIcon"));
    ...
    private static final long hMonitor$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$485:5"), groupElement("hMonitor"));
