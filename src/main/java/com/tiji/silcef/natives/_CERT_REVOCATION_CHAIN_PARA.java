...
public class _CERT_REVOCATION_CHAIN_PARA {
    ...
    private static final long hChainEngine$OFFSET = $LAYOUT.byteOffset(groupElement("hChainEngine"));
    ...
    private static final long hAdditionalStore$OFFSET = $LAYOUT.byteOffset(groupElement("hAdditionalStore"));
    ...
    private static final long dwChainFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwChainFlags"));
    ...
    private static final long pftCurrentTime$OFFSET = $LAYOUT.byteOffset(groupElement("pftCurrentTime"));
    ...
    private static final long cbMaxUrlRetrievalByteCount$OFFSET = $LAYOUT.byteOffset(groupElement("cbMaxUrlRetrievalByteCount"));
