...
public class tagNEWTEXTMETRICEXA {
    ...
    private static final long ntmTm$OFFSET = $LAYOUT.byteOffset(groupElement("ntmTm"));
    ...
    private static final long ntmFontSig$OFFSET = $LAYOUT.byteOffset(groupElement("ntmFontSig"));
