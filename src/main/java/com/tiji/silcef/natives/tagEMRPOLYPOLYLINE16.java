...
public class tagEMRPOLYPOLYLINE16 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("nPolys"),
        cef_render_handler_capi_h.C_LONG.withName("cpts"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_LONG).withName("aPolyCounts"),
    ...
    private static final long nPolys$OFFSET = $LAYOUT.byteOffset(groupElement("nPolys"));
    ...
    private static final long cpts$OFFSET = $LAYOUT.byteOffset(groupElement("cpts"));
    ...
    private static final long aPolyCounts$OFFSET = $LAYOUT.byteOffset(groupElement("aPolyCounts"));
    ...
    public static int aPolyCounts(MemorySegment struct, long index0) {
        return (int)aPolyCounts$ELEM_HANDLE.get(struct, aPolyCounts$OFFSET, index0);
    }
    ...
    public static void aPolyCounts(MemorySegment struct, long index0, int fieldValue) {
        aPolyCounts$ELEM_HANDLE.set(struct, aPolyCounts$OFFSET, index0, fieldValue);
    }
    ...
    private static final long apts$OFFSET = $LAYOUT.byteOffset(groupElement("apts"));
    ...
    public static MemorySegment apts(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)apts$ELEM_HANDLE.invokeExact(struct, apts$OFFSET, index0);
