 ...
 * }
 */
public final class FONTENUMPROCW {

    private FONTENUMPROCW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(FONTENUMPROCW.Function.class, "apply", $DESC);
