...
public class _CRYPTPROTECT_PROMPTSTRUCT {
    ...
    private static final long dwPromptFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwPromptFlags"));
    ...
    private static final long hwndApp$OFFSET = $LAYOUT.byteOffset(groupElement("hwndApp"));
    ...
    private static final long szPrompt$OFFSET = $LAYOUT.byteOffset(groupElement("szPrompt"));
