 ...
 *     void (*cont)(struct _cef_run_quick_menu_callback_t *, int, cef_event_flags_t) __attribute__((stdcall));
 *     void (*cancel)(struct _cef_run_quick_menu_callback_t *) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_run_quick_menu_callback_t {
    ...
    ).withName("_cef_run_quick_menu_callback_t");
