...
public class _CRYPT_RSA_SSA_PSS_PARAMETERS {
    ...
    private static final long MaskGenAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("MaskGenAlgorithm"));
    ...
    private static final long dwSaltLength$OFFSET = $LAYOUT.byteOffset(groupElement("dwSaltLength"));
    ...
    private static final long dwTrailerField$OFFSET = $LAYOUT.byteOffset(groupElement("dwTrailerField"));
