...
public class _CMSG_SIGNED_ENCODE_INFO {
    ...
    private static final long cSigners$OFFSET = $LAYOUT.byteOffset(groupElement("cSigners"));
    ...
    private static final long rgSigners$OFFSET = $LAYOUT.byteOffset(groupElement("rgSigners"));
    ...
    private static final long cCertEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("cCertEncoded"));
    ...
    private static final long rgCertEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("rgCertEncoded"));
    ...
    private static final long cCrlEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("cCrlEncoded"));
    ...
    private static final long rgCrlEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("rgCrlEncoded"));
