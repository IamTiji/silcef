...
public class tagPOLYTEXTW {
    ...
    private static final long lpstr$OFFSET = $LAYOUT.byteOffset(groupElement("lpstr"));
    ...
    private static final long uiFlags$OFFSET = $LAYOUT.byteOffset(groupElement("uiFlags"));
    ...
    private static final long pdx$OFFSET = $LAYOUT.byteOffset(groupElement("pdx"));
