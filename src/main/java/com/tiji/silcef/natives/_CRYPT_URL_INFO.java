...
public class _CRYPT_URL_INFO {
    ...
    private static final long cGroup$OFFSET = $LAYOUT.byteOffset(groupElement("cGroup"));
    ...
    private static final long rgcGroupEntry$OFFSET = $LAYOUT.byteOffset(groupElement("rgcGroupEntry"));
