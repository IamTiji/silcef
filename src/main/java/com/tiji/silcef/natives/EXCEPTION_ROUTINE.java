 ...
 * }
 */
public final class EXCEPTION_ROUTINE {

    private EXCEPTION_ROUTINE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(EXCEPTION_ROUTINE.Function.class, "apply", $DESC);
