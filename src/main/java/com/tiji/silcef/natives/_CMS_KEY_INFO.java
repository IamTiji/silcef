...
public class _CMS_KEY_INFO {
    ...
    private static final long pbOID$OFFSET = $LAYOUT.byteOffset(groupElement("pbOID"));
    ...
    private static final long cbOID$OFFSET = $LAYOUT.byteOffset(groupElement("cbOID"));
