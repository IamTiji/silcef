...
public class _CMSG_CNG_CONTENT_DECRYPT_INFO {
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("hNCryptKey"));
    ...
    private static final long hCNGContentEncryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("hCNGContentEncryptKey"));
