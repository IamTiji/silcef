...
public class _CRL_INFO {
    ...
    private static final long cCRLEntry$OFFSET = $LAYOUT.byteOffset(groupElement("cCRLEntry"));
    ...
    private static final long rgCRLEntry$OFFSET = $LAYOUT.byteOffset(groupElement("rgCRLEntry"));
