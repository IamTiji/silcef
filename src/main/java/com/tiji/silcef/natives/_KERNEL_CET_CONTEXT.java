...
public class _KERNEL_CET_CONTEXT {
    ...
    private static final OfShort AllFlags$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2797:5"), groupElement("AllFlags"));
    ...
    private static final long AllFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2797:5"), groupElement("AllFlags"));
