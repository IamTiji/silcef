 ...
 * }
 */
public final class PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC {

    private PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CRYPT_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC.Function.class, "apply", $DESC);
