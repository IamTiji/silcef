...
public class tagHANDLETABLE {
    ...
    private static final long objectHandle$OFFSET = $LAYOUT.byteOffset(groupElement("objectHandle"));
    ...
    public static MemorySegment objectHandle(MemorySegment struct, long index0) {
        return (MemorySegment)objectHandle$ELEM_HANDLE.get(struct, objectHandle$OFFSET, index0);
    }
    ...
    public static void objectHandle(MemorySegment struct, long index0, MemorySegment fieldValue) {
        objectHandle$ELEM_HANDLE.set(struct, objectHandle$OFFSET, index0, fieldValue);
    }
