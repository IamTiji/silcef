...
public class tagCBT_CREATEWNDA {
    ...
    private static final long lpcs$OFFSET = $LAYOUT.byteOffset(groupElement("lpcs"));
    ...
    private static final long hwndInsertAfter$OFFSET = $LAYOUT.byteOffset(groupElement("hwndInsertAfter"));
