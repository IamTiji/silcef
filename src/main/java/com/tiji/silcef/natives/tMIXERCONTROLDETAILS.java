...
public class tMIXERCONTROLDETAILS {
    ...
    private static final AddressLayout hwndOwner$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$2316:5"), groupElement("hwndOwner"));
    ...
    private static final long hwndOwner$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2316:5"), groupElement("hwndOwner"));
    ...
    private static final OfInt cMultipleItems$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2316:5"), groupElement("cMultipleItems"));
    ...
    private static final long cMultipleItems$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2316:5"), groupElement("cMultipleItems"));
    ...
    private static final long cbDetails$OFFSET = $LAYOUT.byteOffset(groupElement("cbDetails"));
    ...
    private static final long paDetails$OFFSET = $LAYOUT.byteOffset(groupElement("paDetails"));
