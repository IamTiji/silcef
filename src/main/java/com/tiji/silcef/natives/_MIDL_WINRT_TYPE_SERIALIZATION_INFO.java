...
public class _MIDL_WINRT_TYPE_SERIALIZATION_INFO {
    ...
    private static final long TypeFormatString$OFFSET = $LAYOUT.byteOffset(groupElement("TypeFormatString"));
    ...
    private static final long FormatStringSize$OFFSET = $LAYOUT.byteOffset(groupElement("FormatStringSize"));
    ...
    private static final long TypeOffset$OFFSET = $LAYOUT.byteOffset(groupElement("TypeOffset"));
