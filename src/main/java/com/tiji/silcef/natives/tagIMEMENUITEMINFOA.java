...
public class tagIMEMENUITEMINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(80, cef_render_handler_capi_h.C_CHAR).withName("szString"),
    ...
    private static final long szString$OFFSET = $LAYOUT.byteOffset(groupElement("szString"));
    ...
    public static byte szString(MemorySegment struct, long index0) {
        return (byte)szString$ELEM_HANDLE.get(struct, szString$OFFSET, index0);
    }
    ...
    public static void szString(MemorySegment struct, long index0, byte fieldValue) {
        szString$ELEM_HANDLE.set(struct, szString$OFFSET, index0, fieldValue);
    }
