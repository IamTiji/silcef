...
public class _RPC_BINDING_HANDLE_TEMPLATE_V1_A {
    ...
    private static final long NetworkAddress$OFFSET = $LAYOUT.byteOffset(groupElement("NetworkAddress"));
    ...
    private static final long StringEndpoint$OFFSET = $LAYOUT.byteOffset(groupElement("StringEndpoint"));
    ...
    private static final long ObjectUuid$OFFSET = $LAYOUT.byteOffset(groupElement("ObjectUuid"));
