...
public class tagLOCALESIGNATURE {
    ...
    private static final long lsUsb$OFFSET = $LAYOUT.byteOffset(groupElement("lsUsb"));
    ...
    public static int lsUsb(MemorySegment struct, long index0) {
        return (int)lsUsb$ELEM_HANDLE.get(struct, lsUsb$OFFSET, index0);
    }
    ...
    public static void lsUsb(MemorySegment struct, long index0, int fieldValue) {
        lsUsb$ELEM_HANDLE.set(struct, lsUsb$OFFSET, index0, fieldValue);
    }
    ...
    private static final long lsCsbDefault$OFFSET = $LAYOUT.byteOffset(groupElement("lsCsbDefault"));
    ...
    public static int lsCsbDefault(MemorySegment struct, long index0) {
        return (int)lsCsbDefault$ELEM_HANDLE.get(struct, lsCsbDefault$OFFSET, index0);
    }
    ...
    public static void lsCsbDefault(MemorySegment struct, long index0, int fieldValue) {
        lsCsbDefault$ELEM_HANDLE.set(struct, lsCsbDefault$OFFSET, index0, fieldValue);
    }
    ...
    private static final long lsCsbSupported$OFFSET = $LAYOUT.byteOffset(groupElement("lsCsbSupported"));
    ...
    public static int lsCsbSupported(MemorySegment struct, long index0) {
        return (int)lsCsbSupported$ELEM_HANDLE.get(struct, lsCsbSupported$OFFSET, index0);
    }
    ...
    public static void lsCsbSupported(MemorySegment struct, long index0, int fieldValue) {
        lsCsbSupported$ELEM_HANDLE.set(struct, lsCsbSupported$OFFSET, index0, fieldValue);
    }
