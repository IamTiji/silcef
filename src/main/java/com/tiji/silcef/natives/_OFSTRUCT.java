...
public class _OFSTRUCT {
    ...
    private static final long cBytes$OFFSET = $LAYOUT.byteOffset(groupElement("cBytes"));
    ...
    private static final long fFixedDisk$OFFSET = $LAYOUT.byteOffset(groupElement("fFixedDisk"));
    ...
    private static final long nErrCode$OFFSET = $LAYOUT.byteOffset(groupElement("nErrCode"));
    ...
    private static final long szPathName$OFFSET = $LAYOUT.byteOffset(groupElement("szPathName"));
    ...
    public static byte szPathName(MemorySegment struct, long index0) {
        return (byte)szPathName$ELEM_HANDLE.get(struct, szPathName$OFFSET, index0);
    }
    ...
    public static void szPathName(MemorySegment struct, long index0, byte fieldValue) {
        szPathName$ELEM_HANDLE.set(struct, szPathName$OFFSET, index0, fieldValue);
    }
