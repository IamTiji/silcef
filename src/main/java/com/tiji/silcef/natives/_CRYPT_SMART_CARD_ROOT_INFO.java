...
public class _CRYPT_SMART_CARD_ROOT_INFO {
    ...
    private static final long rgbCardID$OFFSET = $LAYOUT.byteOffset(groupElement("rgbCardID"));
    ...
    public static byte rgbCardID(MemorySegment struct, long index0) {
        return (byte)rgbCardID$ELEM_HANDLE.get(struct, rgbCardID$OFFSET, index0);
    }
    ...
    public static void rgbCardID(MemorySegment struct, long index0, byte fieldValue) {
        rgbCardID$ELEM_HANDLE.set(struct, rgbCardID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long luid$OFFSET = $LAYOUT.byteOffset(groupElement("luid"));
