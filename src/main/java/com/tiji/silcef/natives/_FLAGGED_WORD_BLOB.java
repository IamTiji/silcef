...
public class _FLAGGED_WORD_BLOB {
    ...
    private static final long asData$OFFSET = $LAYOUT.byteOffset(groupElement("asData"));
    ...
    public static short asData(MemorySegment struct, long index0) {
        return (short)asData$ELEM_HANDLE.get(struct, asData$OFFSET, index0);
    }
    ...
    public static void asData(MemorySegment struct, long index0, short fieldValue) {
        asData$ELEM_HANDLE.set(struct, asData$OFFSET, index0, fieldValue);
    }
