...
public class _SENDCMDINPARAMS {
    ...
    private static final long cBufferSize$OFFSET = $LAYOUT.byteOffset(groupElement("cBufferSize"));
    ...
    private static final long irDriveRegs$OFFSET = $LAYOUT.byteOffset(groupElement("irDriveRegs"));
    ...
    private static final long bDriveNumber$OFFSET = $LAYOUT.byteOffset(groupElement("bDriveNumber"));
    ...
    public static byte bReserved(MemorySegment struct, long index0) {
        return (byte)bReserved$ELEM_HANDLE.get(struct, bReserved$OFFSET, index0);
    }
    ...
    public static void bReserved(MemorySegment struct, long index0, byte fieldValue) {
        bReserved$ELEM_HANDLE.set(struct, bReserved$OFFSET, index0, fieldValue);
    }
    ...
    private static final long bBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("bBuffer"));
    ...
    public static byte bBuffer(MemorySegment struct, long index0) {
        return (byte)bBuffer$ELEM_HANDLE.get(struct, bBuffer$OFFSET, index0);
    }
    ...
    public static void bBuffer(MemorySegment struct, long index0, byte fieldValue) {
        bBuffer$ELEM_HANDLE.set(struct, bBuffer$OFFSET, index0, fieldValue);
    }
