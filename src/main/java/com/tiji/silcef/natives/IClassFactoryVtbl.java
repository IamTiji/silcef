...
public class IClassFactoryVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("LockServer")
     ...
     * }
     */
    public final static class LockServer {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LockServer.Function.class, "apply", $DESC);
    ...
    private static final long LockServer$OFFSET = $LAYOUT.byteOffset(groupElement("LockServer"));
