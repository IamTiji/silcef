...
public class _DISK_PERFORMANCE {
    ...
    private static final long BytesWritten$OFFSET = $LAYOUT.byteOffset(groupElement("BytesWritten"));
    ...
    private static final long ReadTime$OFFSET = $LAYOUT.byteOffset(groupElement("ReadTime"));
    ...
    private static final long WriteTime$OFFSET = $LAYOUT.byteOffset(groupElement("WriteTime"));
    ...
    private static final long IdleTime$OFFSET = $LAYOUT.byteOffset(groupElement("IdleTime"));
    ...
    private static final long ReadCount$OFFSET = $LAYOUT.byteOffset(groupElement("ReadCount"));
    ...
    private static final long WriteCount$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCount"));
    ...
    private static final long QueueDepth$OFFSET = $LAYOUT.byteOffset(groupElement("QueueDepth"));
    ...
    private static final long SplitCount$OFFSET = $LAYOUT.byteOffset(groupElement("SplitCount"));
    ...
    private static final long QueryTime$OFFSET = $LAYOUT.byteOffset(groupElement("QueryTime"));
    ...
    private static final long StorageDeviceNumber$OFFSET = $LAYOUT.byteOffset(groupElement("StorageDeviceNumber"));
    ...
    private static final long StorageManagerName$OFFSET = $LAYOUT.byteOffset(groupElement("StorageManagerName"));
    ...
    public static short StorageManagerName(MemorySegment struct, long index0) {
        return (short)StorageManagerName$ELEM_HANDLE.get(struct, StorageManagerName$OFFSET, index0);
    }
    ...
    public static void StorageManagerName(MemorySegment struct, long index0, short fieldValue) {
        StorageManagerName$ELEM_HANDLE.set(struct, StorageManagerName$OFFSET, index0, fieldValue);
    }
