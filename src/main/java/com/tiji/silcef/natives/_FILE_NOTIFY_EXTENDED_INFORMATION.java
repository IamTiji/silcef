...
public class _FILE_NOTIFY_EXTENDED_INFORMATION {
    ...
    private static final OfInt ReparsePointTag$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15407:5"), groupElement("ReparsePointTag"));
    ...
    private static final long ReparsePointTag$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15407:5"), groupElement("ReparsePointTag"));
    ...
    private static final OfInt EaSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15407:5"), groupElement("EaSize"));
    ...
    private static final long EaSize$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15407:5"), groupElement("EaSize"));
