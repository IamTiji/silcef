...
public class _CACHE_RELATIONSHIP {
    ...
    private static final GroupLayout GroupMask$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14038:5"), groupElement("GroupMask"));
    ...
    private static final long GroupMask$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14038:5"), groupElement("GroupMask"));
    ...
    private static final SequenceLayout GroupMasks$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14038:5"), groupElement("GroupMasks"));
    ...
    private static final long GroupMasks$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14038:5"), groupElement("GroupMasks"));
