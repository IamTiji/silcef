...
public class _DISPLAYCONFIG_GET_ADVANCED_COLOR_INFO {
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3170:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3170:5"), groupElement("value"));
