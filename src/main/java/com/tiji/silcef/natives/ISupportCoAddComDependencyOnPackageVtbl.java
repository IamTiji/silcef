...
/**
 * {@snippet lang=c :
 * struct ISupportCoAddComDependencyOnPackageVtbl {
 *     HRESULT (*QueryInterface)(ISupportCoAddComDependencyOnPackage *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportCoAddComDependencyOnPackage *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportCoAddComDependencyOnPackage *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportCoAddComDependencyOnPackageVtbl {
    ...
    ).withName("ISupportCoAddComDependencyOnPackageVtbl");
