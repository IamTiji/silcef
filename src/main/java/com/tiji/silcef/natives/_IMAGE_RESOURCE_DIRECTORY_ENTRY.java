...
public class _IMAGE_RESOURCE_DIRECTORY_ENTRY {
    ...
    private static final OfInt Name$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21185:5"), groupElement("Name"));
    ...
    private static final long Name$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21185:5"), groupElement("Name"));
    ...
    private static final OfShort Id$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$21185:5"), groupElement("Id"));
    ...
    private static final long Id$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21185:5"), groupElement("Id"));
    ...
    private static final OfInt OffsetToData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21193:5"), groupElement("OffsetToData"));
    ...
    private static final long OffsetToData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21193:5"), groupElement("OffsetToData"));
