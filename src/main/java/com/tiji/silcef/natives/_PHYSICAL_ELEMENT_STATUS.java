...
public class _PHYSICAL_ELEMENT_STATUS {
    ...
    private static final long ReturnedDescriptorCount$OFFSET = $LAYOUT.byteOffset(groupElement("ReturnedDescriptorCount"));
    ...
    private static final long ElementIdentifierBeingDepoped$OFFSET = $LAYOUT.byteOffset(groupElement("ElementIdentifierBeingDepoped"));
    ...
    private static final long Descriptors$OFFSET = $LAYOUT.byteOffset(groupElement("Descriptors"));
    ...
    public static MemorySegment Descriptors(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Descriptors$ELEM_HANDLE.invokeExact(struct, Descriptors$OFFSET, index0);
