...
public class _TOKEN_GROUPS_AND_PRIVILEGES {
    ...
    private static final long SidCount$OFFSET = $LAYOUT.byteOffset(groupElement("SidCount"));
    ...
    private static final long SidLength$OFFSET = $LAYOUT.byteOffset(groupElement("SidLength"));
    ...
    private static final long Sids$OFFSET = $LAYOUT.byteOffset(groupElement("Sids"));
    ...
    private static final long RestrictedSidCount$OFFSET = $LAYOUT.byteOffset(groupElement("RestrictedSidCount"));
    ...
    private static final long RestrictedSidLength$OFFSET = $LAYOUT.byteOffset(groupElement("RestrictedSidLength"));
    ...
    private static final long RestrictedSids$OFFSET = $LAYOUT.byteOffset(groupElement("RestrictedSids"));
    ...
    private static final long PrivilegeCount$OFFSET = $LAYOUT.byteOffset(groupElement("PrivilegeCount"));
    ...
    private static final long PrivilegeLength$OFFSET = $LAYOUT.byteOffset(groupElement("PrivilegeLength"));
