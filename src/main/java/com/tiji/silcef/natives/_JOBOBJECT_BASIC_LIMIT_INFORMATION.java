...
public class _JOBOBJECT_BASIC_LIMIT_INFORMATION {
    ...
    private static final long PerProcessUserTimeLimit$OFFSET = $LAYOUT.byteOffset(groupElement("PerProcessUserTimeLimit"));
    ...
    private static final long MinimumWorkingSetSize$OFFSET = $LAYOUT.byteOffset(groupElement("MinimumWorkingSetSize"));
    ...
    private static final long MaximumWorkingSetSize$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumWorkingSetSize"));
    ...
    private static final long ActiveProcessLimit$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveProcessLimit"));
    ...
    private static final long Affinity$OFFSET = $LAYOUT.byteOffset(groupElement("Affinity"));
    ...
    private static final long PriorityClass$OFFSET = $LAYOUT.byteOffset(groupElement("PriorityClass"));
    ...
    private static final long SchedulingClass$OFFSET = $LAYOUT.byteOffset(groupElement("SchedulingClass"));
