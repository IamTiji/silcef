...
public class _CMSG_STREAM_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cbContent"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("pfnStreamOutput"),
        cef_render_handler_capi_h.C_POINTER.withName("pvArg")
    ...
    private static final long cbContent$OFFSET = $LAYOUT.byteOffset(groupElement("cbContent"));
    ...
    private static final long pfnStreamOutput$OFFSET = $LAYOUT.byteOffset(groupElement("pfnStreamOutput"));
    ...
    private static final long pvArg$OFFSET = $LAYOUT.byteOffset(groupElement("pvArg"));
