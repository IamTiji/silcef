...
public class _SESSION_BUFFER {
    ...
    private static final long lsn$OFFSET = $LAYOUT.byteOffset(groupElement("lsn"));
    ...
    private static final long local_name$OFFSET = $LAYOUT.byteOffset(groupElement("local_name"));
    ...
    public static byte local_name(MemorySegment struct, long index0) {
        return (byte)local_name$ELEM_HANDLE.get(struct, local_name$OFFSET, index0);
    }
    ...
    public static void local_name(MemorySegment struct, long index0, byte fieldValue) {
        local_name$ELEM_HANDLE.set(struct, local_name$OFFSET, index0, fieldValue);
    }
    ...
    private static final long remote_name$OFFSET = $LAYOUT.byteOffset(groupElement("remote_name"));
    ...
    public static byte remote_name(MemorySegment struct, long index0) {
        return (byte)remote_name$ELEM_HANDLE.get(struct, remote_name$OFFSET, index0);
    }
    ...
    public static void remote_name(MemorySegment struct, long index0, byte fieldValue) {
        remote_name$ELEM_HANDLE.set(struct, remote_name$OFFSET, index0, fieldValue);
    }
    ...
    private static final long rcvs_outstanding$OFFSET = $LAYOUT.byteOffset(groupElement("rcvs_outstanding"));
    ...
    private static final long sends_outstanding$OFFSET = $LAYOUT.byteOffset(groupElement("sends_outstanding"));
