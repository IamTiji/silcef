...
public class ICallFactoryVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("CreateCall")
     ...
     * }
     */
    public final static class CreateCall {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(CreateCall.Function.class, "apply", $DESC);
    ...
    private static final long CreateCall$OFFSET = $LAYOUT.byteOffset(groupElement("CreateCall"));
