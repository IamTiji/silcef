 ...
 * }
 */
public final class PTERMINATION_HANDLER {

    private PTERMINATION_HANDLER() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PTERMINATION_HANDLER.Function.class, "apply", $DESC);
