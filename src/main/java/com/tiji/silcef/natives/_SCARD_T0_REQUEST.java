...
public class _SCARD_T0_REQUEST {
    ...
    private static final long ioRequest$OFFSET = $LAYOUT.byteOffset(groupElement("ioRequest"));
    ...
    private static final long bSw1$OFFSET = $LAYOUT.byteOffset(groupElement("bSw1"));
    ...
    private static final long bSw2$OFFSET = $LAYOUT.byteOffset(groupElement("bSw2"));
    ...
    private static final long CmdBytes$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$297:5"), groupElement("CmdBytes"));
    ...
    private static final long rgbHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$297:5"), groupElement("rgbHeader"));
    ...
    public static byte rgbHeader(MemorySegment struct, long index0) {
        return (byte)rgbHeader$ELEM_HANDLE.get(struct, rgbHeader$OFFSET, index0);
    }
    ...
    public static void rgbHeader(MemorySegment struct, long index0, byte fieldValue) {
        rgbHeader$ELEM_HANDLE.set(struct, rgbHeader$OFFSET, index0, fieldValue);
    }
