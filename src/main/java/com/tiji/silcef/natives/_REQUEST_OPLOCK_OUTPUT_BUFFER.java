...
public class _REQUEST_OPLOCK_OUTPUT_BUFFER {
    ...
    private static final long StructureLength$OFFSET = $LAYOUT.byteOffset(groupElement("StructureLength"));
    ...
    private static final long OriginalOplockLevel$OFFSET = $LAYOUT.byteOffset(groupElement("OriginalOplockLevel"));
    ...
    private static final long NewOplockLevel$OFFSET = $LAYOUT.byteOffset(groupElement("NewOplockLevel"));
    ...
    private static final long AccessMode$OFFSET = $LAYOUT.byteOffset(groupElement("AccessMode"));
    ...
    private static final long ShareMode$OFFSET = $LAYOUT.byteOffset(groupElement("ShareMode"));
