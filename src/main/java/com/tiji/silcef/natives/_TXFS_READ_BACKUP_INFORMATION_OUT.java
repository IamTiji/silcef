...
public class _TXFS_READ_BACKUP_INFORMATION_OUT {
    ...
    private static final OfInt BufferLength$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14105:5"), groupElement("BufferLength"));
    ...
    private static final long BufferLength$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14105:5"), groupElement("BufferLength"));
    ...
    private static final SequenceLayout Buffer$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14105:5"), groupElement("Buffer"));
    ...
    private static final long Buffer$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14105:5"), groupElement("Buffer"));
