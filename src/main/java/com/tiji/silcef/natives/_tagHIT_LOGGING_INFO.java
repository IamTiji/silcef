...
public class _tagHIT_LOGGING_INFO {
    ...
    private static final long lpszLoggedUrlName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszLoggedUrlName"));
    ...
    private static final long lpszExtendedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("lpszExtendedInfo"));
