...
public class _CRYPT_PKCS8_EXPORT_PARAMS {
    ...
    private static final long pszPrivateKeyObjId$OFFSET = $LAYOUT.byteOffset(groupElement("pszPrivateKeyObjId"));
    ...
    private static final long pEncryptPrivateKeyFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pEncryptPrivateKeyFunc"));
    ...
    private static final long pVoidEncryptFunc$OFFSET = $LAYOUT.byteOffset(groupElement("pVoidEncryptFunc"));
