...
public class tagMONHSZSTRUCTA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_CHAR).withName("str"),
    ...
    private static final long fsAction$OFFSET = $LAYOUT.byteOffset(groupElement("fsAction"));
    ...
    private static final long hsz$OFFSET = $LAYOUT.byteOffset(groupElement("hsz"));
    ...
    public static byte str(MemorySegment struct, long index0) {
        return (byte)str$ELEM_HANDLE.get(struct, str$OFFSET, index0);
    }
    ...
    public static void str(MemorySegment struct, long index0, byte fieldValue) {
        str$ELEM_HANDLE.set(struct, str$OFFSET, index0, fieldValue);
    }
