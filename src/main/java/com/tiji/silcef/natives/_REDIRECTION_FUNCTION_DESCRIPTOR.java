...
public class _REDIRECTION_FUNCTION_DESCRIPTOR {
    ...
    private static final long DllName$OFFSET = $LAYOUT.byteOffset(groupElement("DllName"));
    ...
    private static final long FunctionName$OFFSET = $LAYOUT.byteOffset(groupElement("FunctionName"));
    ...
    private static final long RedirectionTarget$OFFSET = $LAYOUT.byteOffset(groupElement("RedirectionTarget"));
