...
public class _CMSG_SIGNED_AND_ENVELOPED_ENCODE_INFO {
    ...
    private static final long SignedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("SignedInfo"));
    ...
    private static final long EnvelopedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("EnvelopedInfo"));
