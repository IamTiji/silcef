...
public class _PROCESSOR_NUMBER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_CHAR.withName("Number"),
    ...
    private static final OfByte Number_$LAYOUT = (OfByte)$LAYOUT.select(groupElement("Number"));
     ...
     * }
     */
    public static final OfByte Number_$layout() {
     ...
     * }
     */
    public static byte Number_(MemorySegment struct) {
     ...
     * }
     */
    public static void Number_(MemorySegment struct, byte fieldValue) {
