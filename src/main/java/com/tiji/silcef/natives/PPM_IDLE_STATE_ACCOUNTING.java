...
public class PPM_IDLE_STATE_ACCOUNTING {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(6, cef_render_handler_capi_h.C_LONG).withName("IdleTimeBuckets")
    ).withName("$anon$19080:9");
    ...
    public static int IdleTimeBuckets(MemorySegment struct, long index0) {
        return (int)IdleTimeBuckets$ELEM_HANDLE.get(struct, IdleTimeBuckets$OFFSET, index0);
    }
    ...
    public static void IdleTimeBuckets(MemorySegment struct, long index0, int fieldValue) {
        IdleTimeBuckets$ELEM_HANDLE.set(struct, IdleTimeBuckets$OFFSET, index0, fieldValue);
    }
