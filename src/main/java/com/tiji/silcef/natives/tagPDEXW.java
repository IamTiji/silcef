...
public class tagPDEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("Flags2"),
        cef_render_handler_capi_h.C_LONG.withName("ExclusionFlags"),
        cef_render_handler_capi_h.C_LONG.withName("nPageRanges"),
        cef_render_handler_capi_h.C_LONG.withName("nMaxPageRanges"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("lpPageRanges"),
        cef_render_handler_capi_h.C_LONG.withName("nMinPage"),
        cef_render_handler_capi_h.C_LONG.withName("nMaxPage"),
        cef_render_handler_capi_h.C_LONG.withName("nCopies"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("hInstance"),
        cef_render_handler_capi_h.C_POINTER.withName("lpPrintTemplateName"),
        cef_render_handler_capi_h.C_POINTER.withName("lpCallback"),
        cef_render_handler_capi_h.C_LONG.withName("nPropertyPages"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("lphPropertyPages"),
        cef_render_handler_capi_h.C_LONG.withName("nStartPage"),
        cef_render_handler_capi_h.C_LONG.withName("dwResultAction")
    ).withName("tagPDEXW");
    ...
    private static final long hDevMode$OFFSET = $LAYOUT.byteOffset(groupElement("hDevMode"));
    ...
    private static final long hDevNames$OFFSET = $LAYOUT.byteOffset(groupElement("hDevNames"));
    ...
    private static final long hDC$OFFSET = $LAYOUT.byteOffset(groupElement("hDC"));
    ...
    private static final long ExclusionFlags$OFFSET = $LAYOUT.byteOffset(groupElement("ExclusionFlags"));
    ...
    private static final long nPageRanges$OFFSET = $LAYOUT.byteOffset(groupElement("nPageRanges"));
    ...
    private static final long nMaxPageRanges$OFFSET = $LAYOUT.byteOffset(groupElement("nMaxPageRanges"));
    ...
    private static final long lpPageRanges$OFFSET = $LAYOUT.byteOffset(groupElement("lpPageRanges"));
    ...
    private static final long nMinPage$OFFSET = $LAYOUT.byteOffset(groupElement("nMinPage"));
    ...
    private static final long nMaxPage$OFFSET = $LAYOUT.byteOffset(groupElement("nMaxPage"));
    ...
    private static final long nCopies$OFFSET = $LAYOUT.byteOffset(groupElement("nCopies"));
    ...
    private static final long lpPrintTemplateName$OFFSET = $LAYOUT.byteOffset(groupElement("lpPrintTemplateName"));
    ...
    private static final long lpCallback$OFFSET = $LAYOUT.byteOffset(groupElement("lpCallback"));
    ...
    private static final long nPropertyPages$OFFSET = $LAYOUT.byteOffset(groupElement("nPropertyPages"));
    ...
    private static final long lphPropertyPages$OFFSET = $LAYOUT.byteOffset(groupElement("lphPropertyPages"));
    ...
    private static final long nStartPage$OFFSET = $LAYOUT.byteOffset(groupElement("nStartPage"));
    ...
    private static final long dwResultAction$OFFSET = $LAYOUT.byteOffset(groupElement("dwResultAction"));
