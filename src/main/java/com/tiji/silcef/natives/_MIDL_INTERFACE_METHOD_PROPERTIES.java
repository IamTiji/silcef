...
public class _MIDL_INTERFACE_METHOD_PROPERTIES {
    ...
    private static final long MethodCount$OFFSET = $LAYOUT.byteOffset(groupElement("MethodCount"));
    ...
    private static final long MethodProperties$OFFSET = $LAYOUT.byteOffset(groupElement("MethodProperties"));
