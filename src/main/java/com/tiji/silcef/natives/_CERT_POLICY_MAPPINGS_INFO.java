...
public class _CERT_POLICY_MAPPINGS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cPolicyMapping"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgPolicyMapping")
    ...
    private static final long cPolicyMapping$OFFSET = $LAYOUT.byteOffset(groupElement("cPolicyMapping"));
    ...
    private static final long rgPolicyMapping$OFFSET = $LAYOUT.byteOffset(groupElement("rgPolicyMapping"));
