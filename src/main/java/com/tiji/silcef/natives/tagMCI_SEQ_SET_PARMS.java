...
public class tagMCI_SEQ_SET_PARMS {
    ...
    private static final long dwTempo$OFFSET = $LAYOUT.byteOffset(groupElement("dwTempo"));
    ...
    private static final long dwPort$OFFSET = $LAYOUT.byteOffset(groupElement("dwPort"));
    ...
    private static final long dwSlave$OFFSET = $LAYOUT.byteOffset(groupElement("dwSlave"));
    ...
    private static final long dwMaster$OFFSET = $LAYOUT.byteOffset(groupElement("dwMaster"));
