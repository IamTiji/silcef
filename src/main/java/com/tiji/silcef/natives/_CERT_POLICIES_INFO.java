...
public class _CERT_POLICIES_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cPolicyInfo"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgPolicyInfo")
    ...
    private static final long cPolicyInfo$OFFSET = $LAYOUT.byteOffset(groupElement("cPolicyInfo"));
    ...
    private static final long rgPolicyInfo$OFFSET = $LAYOUT.byteOffset(groupElement("rgPolicyInfo"));
