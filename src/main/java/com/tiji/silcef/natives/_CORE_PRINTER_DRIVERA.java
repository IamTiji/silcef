...
public class _CORE_PRINTER_DRIVERA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("szPackageID"),
    ...
    private static final long CoreDriverGUID$OFFSET = $LAYOUT.byteOffset(groupElement("CoreDriverGUID"));
    ...
    private static final long szPackageID$OFFSET = $LAYOUT.byteOffset(groupElement("szPackageID"));
    ...
    public static byte szPackageID(MemorySegment struct, long index0) {
        return (byte)szPackageID$ELEM_HANDLE.get(struct, szPackageID$OFFSET, index0);
    }
    ...
    public static void szPackageID(MemorySegment struct, long index0, byte fieldValue) {
        szPackageID$ELEM_HANDLE.set(struct, szPackageID$OFFSET, index0, fieldValue);
    }
