...
public class _MIDL_INTERCEPTION_INFO {
    ...
    private static final long ProcFormatOffsetTable$OFFSET = $LAYOUT.byteOffset(groupElement("ProcFormatOffsetTable"));
    ...
    private static final long ProcCount$OFFSET = $LAYOUT.byteOffset(groupElement("ProcCount"));
