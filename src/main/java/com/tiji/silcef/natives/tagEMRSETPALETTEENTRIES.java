...
public class tagEMRSETPALETTEENTRIES {
    ...
    private static final long ihPal$OFFSET = $LAYOUT.byteOffset(groupElement("ihPal"));
    ...
    private static final long iStart$OFFSET = $LAYOUT.byteOffset(groupElement("iStart"));
    ...
    private static final long aPalEntries$OFFSET = $LAYOUT.byteOffset(groupElement("aPalEntries"));
    ...
    public static MemorySegment aPalEntries(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)aPalEntries$ELEM_HANDLE.invokeExact(struct, aPalEntries$OFFSET, index0);
