...
/**
 * {@snippet lang=c :
 * struct ISupportServerMustBeEqualOrGreaterPrivilegeActivation {
 *     struct ISupportServerMustBeEqualOrGreaterPrivilegeActivationVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportServerMustBeEqualOrGreaterPrivilegeActivation {
    ...
    ).withName("ISupportServerMustBeEqualOrGreaterPrivilegeActivation");
    ...
    private static final long lpVtbl$OFFSET = $LAYOUT.byteOffset(groupElement("lpVtbl"));
