...
public class tagKERNINGPAIR {
    ...
    private static final long wFirst$OFFSET = $LAYOUT.byteOffset(groupElement("wFirst"));
    ...
    private static final long iKernAmount$OFFSET = $LAYOUT.byteOffset(groupElement("iKernAmount"));
