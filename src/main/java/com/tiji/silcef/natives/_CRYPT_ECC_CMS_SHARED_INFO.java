...
public class _CRYPT_ECC_CMS_SHARED_INFO {
    ...
    private static final long EntityUInfo$OFFSET = $LAYOUT.byteOffset(groupElement("EntityUInfo"));
    ...
    private static final long rgbSuppPubInfo$OFFSET = $LAYOUT.byteOffset(groupElement("rgbSuppPubInfo"));
    ...
    public static byte rgbSuppPubInfo(MemorySegment struct, long index0) {
        return (byte)rgbSuppPubInfo$ELEM_HANDLE.get(struct, rgbSuppPubInfo$OFFSET, index0);
    }
    ...
    public static void rgbSuppPubInfo(MemorySegment struct, long index0, byte fieldValue) {
        rgbSuppPubInfo$ELEM_HANDLE.set(struct, rgbSuppPubInfo$OFFSET, index0, fieldValue);
    }
