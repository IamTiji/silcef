...
public class tagJOYCAPS2W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wXmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wXmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wYmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wYmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wZmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wZmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wNumButtons"),
        ...
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wRmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wRmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wUmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wUmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wVmin"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wVmax"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wCaps"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wMaxAxes"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wNumAxes"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("wMaxButtons"),
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_SHORT, 1)).withName("szRegKey"),
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_SHORT, 1)).withName("szOEMVxD"),
    ...
    public static short szPname(MemorySegment struct, long index0) {
        return (short)szPname$ELEM_HANDLE.get(struct, szPname$OFFSET, index0);
    }
    ...
    public static short szRegKey(MemorySegment struct, long index0) {
        return (short)szRegKey$ELEM_HANDLE.get(struct, szRegKey$OFFSET, index0);
    }
    ...
    public static short szOEMVxD(MemorySegment struct, long index0) {
        return (short)szOEMVxD$ELEM_HANDLE.get(struct, szOEMVxD$OFFSET, index0);
    }
