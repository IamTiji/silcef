...
public class _STORAGE_SPEC_VERSION {
    ...
    public static class MinorVersion {
        ...
        private static final OfByte SubMinor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2924:13"), groupElement("SubMinor"));
        ...
        private static final long SubMinor$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2924:13"), groupElement("SubMinor"));
        ...
        private static final OfByte Minor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2924:13"), groupElement("Minor"));
        ...
        private static final long Minor$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2924:13"), groupElement("Minor"));
        ...
        private static final long AsUshort$OFFSET = $LAYOUT.byteOffset(groupElement("AsUshort"));
    ...
    private static final GroupLayout MinorVersion$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2922:5"), groupElement("MinorVersion"));
    ...
    private static final long MinorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2922:5"), groupElement("MinorVersion"));
    ...
    private static final OfShort MajorVersion$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2922:5"), groupElement("MajorVersion"));
    ...
    private static final long MajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2922:5"), groupElement("MajorVersion"));
    ...
    private static final long AsUlong$OFFSET = $LAYOUT.byteOffset(groupElement("AsUlong"));
