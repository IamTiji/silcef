...
public class _SCRUB_PARITY_EXTENT_DATA {
    ...
    private static final long NumberOfParityExtents$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfParityExtents"));
    ...
    private static final long MaximumNumberOfParityExtents$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumNumberOfParityExtents"));
    ...
    private static final long ParityExtents$OFFSET = $LAYOUT.byteOffset(groupElement("ParityExtents"));
    ...
    public static MemorySegment ParityExtents(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)ParityExtents$ELEM_HANDLE.invokeExact(struct, ParityExtents$OFFSET, index0);
