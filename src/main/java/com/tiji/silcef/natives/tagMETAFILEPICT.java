...
public class tagMETAFILEPICT {
    ...
    private static final long mm$OFFSET = $LAYOUT.byteOffset(groupElement("mm"));
    ...
    private static final long xExt$OFFSET = $LAYOUT.byteOffset(groupElement("xExt"));
    ...
    private static final long yExt$OFFSET = $LAYOUT.byteOffset(groupElement("yExt"));
    ...
    private static final long hMF$OFFSET = $LAYOUT.byteOffset(groupElement("hMF"));
