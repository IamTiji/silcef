...
public class _IMAGE_DOS_HEADER {
    ...
    private static final long e_magic$OFFSET = $LAYOUT.byteOffset(groupElement("e_magic"));
    ...
    private static final long e_cblp$OFFSET = $LAYOUT.byteOffset(groupElement("e_cblp"));
    ...
    private static final long e_cp$OFFSET = $LAYOUT.byteOffset(groupElement("e_cp"));
    ...
    private static final long e_crlc$OFFSET = $LAYOUT.byteOffset(groupElement("e_crlc"));
    ...
    private static final long e_cparhdr$OFFSET = $LAYOUT.byteOffset(groupElement("e_cparhdr"));
    ...
    private static final long e_minalloc$OFFSET = $LAYOUT.byteOffset(groupElement("e_minalloc"));
    ...
    private static final long e_maxalloc$OFFSET = $LAYOUT.byteOffset(groupElement("e_maxalloc"));
    ...
    private static final long e_ss$OFFSET = $LAYOUT.byteOffset(groupElement("e_ss"));
    ...
    private static final long e_sp$OFFSET = $LAYOUT.byteOffset(groupElement("e_sp"));
    ...
    private static final long e_csum$OFFSET = $LAYOUT.byteOffset(groupElement("e_csum"));
    ...
    private static final long e_ip$OFFSET = $LAYOUT.byteOffset(groupElement("e_ip"));
    ...
    private static final long e_cs$OFFSET = $LAYOUT.byteOffset(groupElement("e_cs"));
    ...
    private static final long e_lfarlc$OFFSET = $LAYOUT.byteOffset(groupElement("e_lfarlc"));
    ...
    private static final long e_ovno$OFFSET = $LAYOUT.byteOffset(groupElement("e_ovno"));
    ...
    private static final long e_res$OFFSET = $LAYOUT.byteOffset(groupElement("e_res"));
    ...
    public static short e_res(MemorySegment struct, long index0) {
        return (short)e_res$ELEM_HANDLE.get(struct, e_res$OFFSET, index0);
    }
    ...
    public static void e_res(MemorySegment struct, long index0, short fieldValue) {
        e_res$ELEM_HANDLE.set(struct, e_res$OFFSET, index0, fieldValue);
    }
    ...
    private static final long e_oemid$OFFSET = $LAYOUT.byteOffset(groupElement("e_oemid"));
    ...
    private static final long e_oeminfo$OFFSET = $LAYOUT.byteOffset(groupElement("e_oeminfo"));
    ...
    private static final long e_res2$OFFSET = $LAYOUT.byteOffset(groupElement("e_res2"));
    ...
    public static short e_res2(MemorySegment struct, long index0) {
        return (short)e_res2$ELEM_HANDLE.get(struct, e_res2$OFFSET, index0);
    }
    ...
    public static void e_res2(MemorySegment struct, long index0, short fieldValue) {
        e_res2$ELEM_HANDLE.set(struct, e_res2$OFFSET, index0, fieldValue);
    }
    ...
    private static final long e_lfanew$OFFSET = $LAYOUT.byteOffset(groupElement("e_lfanew"));
