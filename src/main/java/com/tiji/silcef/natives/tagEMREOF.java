...
public class tagEMREOF {
    ...
    private static final long offPalEntries$OFFSET = $LAYOUT.byteOffset(groupElement("offPalEntries"));
    ...
    private static final long nSizeLast$OFFSET = $LAYOUT.byteOffset(groupElement("nSizeLast"));
