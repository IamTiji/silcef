...
public class _NDR_CS_SIZE_CONVERT_ROUTINES {
    ...
    private static final long pfnNetSize$OFFSET = $LAYOUT.byteOffset(groupElement("pfnNetSize"));
    ...
    private static final long pfnToNetCs$OFFSET = $LAYOUT.byteOffset(groupElement("pfnToNetCs"));
    ...
    private static final long pfnLocalSize$OFFSET = $LAYOUT.byteOffset(groupElement("pfnLocalSize"));
    ...
    private static final long pfnFromNetCs$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFromNetCs"));
