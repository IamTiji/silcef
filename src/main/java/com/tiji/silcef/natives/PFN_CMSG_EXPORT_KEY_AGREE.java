 ...
 * }
 */
public final class PFN_CMSG_EXPORT_KEY_AGREE {

    private PFN_CMSG_EXPORT_KEY_AGREE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CMSG_EXPORT_KEY_AGREE.Function.class, "apply", $DESC);
