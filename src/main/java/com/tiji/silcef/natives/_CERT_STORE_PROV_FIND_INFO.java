...
public class _CERT_STORE_PROV_FIND_INFO {
    ...
    private static final long dwFindFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwFindFlags"));
    ...
    private static final long dwFindType$OFFSET = $LAYOUT.byteOffset(groupElement("dwFindType"));
    ...
    private static final long pvFindPara$OFFSET = $LAYOUT.byteOffset(groupElement("pvFindPara"));
