...
public class DISPLAYCONFIG_SET_TARGET_PERSISTENCE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$3134:9"),
            cef_master_h.C_INT.withName("value")
        ).withName("$anon$3132:5")
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3132:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3132:5"), groupElement("value"));
