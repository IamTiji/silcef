...
public class _GP_LOG_PAGE_DESCRIPTOR {
    ...
    private static final long LogAddress$OFFSET = $LAYOUT.byteOffset(groupElement("LogAddress"));
    ...
    private static final long LogSectors$OFFSET = $LAYOUT.byteOffset(groupElement("LogSectors"));
