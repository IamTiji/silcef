...
public class IBindStatusCallbackExVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("GetBindInfoEx")
     ...
     * }
     */
    public final static class GetBindInfoEx {

        private GetBindInfoEx() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetBindInfoEx.Function.class, "apply", $DESC);
    ...
    private static final long GetBindInfoEx$OFFSET = $LAYOUT.byteOffset(groupElement("GetBindInfoEx"));
