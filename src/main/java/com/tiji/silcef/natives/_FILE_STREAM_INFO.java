...
public class _FILE_STREAM_INFO {
    ...
    private static final long StreamNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("StreamNameLength"));
    ...
    private static final long StreamSize$OFFSET = $LAYOUT.byteOffset(groupElement("StreamSize"));
    ...
    private static final long StreamAllocationSize$OFFSET = $LAYOUT.byteOffset(groupElement("StreamAllocationSize"));
    ...
    private static final long StreamName$OFFSET = $LAYOUT.byteOffset(groupElement("StreamName"));
    ...
    public static short StreamName(MemorySegment struct, long index0) {
        return (short)StreamName$ELEM_HANDLE.get(struct, StreamName$OFFSET, index0);
    }
    ...
    public static void StreamName(MemorySegment struct, long index0, short fieldValue) {
        StreamName$ELEM_HANDLE.set(struct, StreamName$OFFSET, index0, fieldValue);
    }
