...
public class _WIM_PROVIDER_OVERLAY_ENTRY {
    ...
    private static final long DataSourceId$OFFSET = $LAYOUT.byteOffset(groupElement("DataSourceId"));
    ...
    private static final long WimGuid$OFFSET = $LAYOUT.byteOffset(groupElement("WimGuid"));
    ...
    private static final long WimFileNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("WimFileNameOffset"));
    ...
    private static final long WimType$OFFSET = $LAYOUT.byteOffset(groupElement("WimType"));
    ...
    private static final long WimIndex$OFFSET = $LAYOUT.byteOffset(groupElement("WimIndex"));
