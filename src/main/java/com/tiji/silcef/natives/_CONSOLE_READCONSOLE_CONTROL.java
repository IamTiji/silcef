...
public class _CONSOLE_READCONSOLE_CONTROL {
    ...
    private static final long nLength$OFFSET = $LAYOUT.byteOffset(groupElement("nLength"));
    ...
    private static final long nInitialChars$OFFSET = $LAYOUT.byteOffset(groupElement("nInitialChars"));
    ...
    private static final long dwCtrlWakeupMask$OFFSET = $LAYOUT.byteOffset(groupElement("dwCtrlWakeupMask"));
