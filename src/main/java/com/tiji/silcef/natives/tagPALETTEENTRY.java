...
public class tagPALETTEENTRY {
    ...
    private static final long peRed$OFFSET = $LAYOUT.byteOffset(groupElement("peRed"));
    ...
    private static final long peGreen$OFFSET = $LAYOUT.byteOffset(groupElement("peGreen"));
    ...
    private static final long peBlue$OFFSET = $LAYOUT.byteOffset(groupElement("peBlue"));
    ...
    private static final long peFlags$OFFSET = $LAYOUT.byteOffset(groupElement("peFlags"));
