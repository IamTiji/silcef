 ...
 * }
 */
public final class LPHANDLER_FUNCTION {

    private LPHANDLER_FUNCTION() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPHANDLER_FUNCTION.Function.class, "apply", $DESC);
