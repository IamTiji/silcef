...
public class _EVENTSFORLOGFILE {
    ...
    private static final long ulSize$OFFSET = $LAYOUT.byteOffset(groupElement("ulSize"));
    ...
    private static final long szLogicalLogFile$OFFSET = $LAYOUT.byteOffset(groupElement("szLogicalLogFile"));
    ...
    public static short szLogicalLogFile(MemorySegment struct, long index0) {
        return (short)szLogicalLogFile$ELEM_HANDLE.get(struct, szLogicalLogFile$OFFSET, index0);
    }
    ...
    public static void szLogicalLogFile(MemorySegment struct, long index0, short fieldValue) {
        szLogicalLogFile$ELEM_HANDLE.set(struct, szLogicalLogFile$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ulNumRecords$OFFSET = $LAYOUT.byteOffset(groupElement("ulNumRecords"));
    ...
    private static final long pEventLogRecords$OFFSET = $LAYOUT.byteOffset(groupElement("pEventLogRecords"));
