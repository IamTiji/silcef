...
public class _IMAGE_AUX_SYMBOL_EX {
    ...
    public static class Sym {
        ...
        private static final long WeakDefaultSymIndex$OFFSET = $LAYOUT.byteOffset(groupElement("WeakDefaultSymIndex"));
        ...
        private static final long WeakSearchType$OFFSET = $LAYOUT.byteOffset(groupElement("WeakSearchType"));
    ...
    private static final GroupLayout TokenDef$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$20421:5"), groupElement("TokenDef"));
    ...
    private static final long TokenDef$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20421:5"), groupElement("TokenDef"));
    ...
    private static final SequenceLayout rgbReserved$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$20421:5"), groupElement("rgbReserved"));
    ...
    private static final long rgbReserved$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20421:5"), groupElement("rgbReserved"));
    ...
    public static byte rgbReserved(MemorySegment union, long index0) {
        return (byte)rgbReserved$ELEM_HANDLE.get(union, rgbReserved$OFFSET, index0);
    }
    ...
    public static void rgbReserved(MemorySegment union, long index0, byte fieldValue) {
        rgbReserved$ELEM_HANDLE.set(union, rgbReserved$OFFSET, index0, fieldValue);
    }
