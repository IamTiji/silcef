 ...
 * }
 */
public final class LANGGROUPLOCALE_ENUMPROCA {

    private LANGGROUPLOCALE_ENUMPROCA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LANGGROUPLOCALE_ENUMPROCA.Function.class, "apply", $DESC);
