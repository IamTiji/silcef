...
public class tagEXTLOGFONTW {
    ...
    private static final long elfLogFont$OFFSET = $LAYOUT.byteOffset(groupElement("elfLogFont"));
    ...
    private static final long elfFullName$OFFSET = $LAYOUT.byteOffset(groupElement("elfFullName"));
    ...
    public static short elfFullName(MemorySegment struct, long index0) {
        return (short)elfFullName$ELEM_HANDLE.get(struct, elfFullName$OFFSET, index0);
    }
    ...
    public static void elfFullName(MemorySegment struct, long index0, short fieldValue) {
        elfFullName$ELEM_HANDLE.set(struct, elfFullName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long elfStyle$OFFSET = $LAYOUT.byteOffset(groupElement("elfStyle"));
    ...
    public static short elfStyle(MemorySegment struct, long index0) {
        return (short)elfStyle$ELEM_HANDLE.get(struct, elfStyle$OFFSET, index0);
    }
    ...
    public static void elfStyle(MemorySegment struct, long index0, short fieldValue) {
        elfStyle$ELEM_HANDLE.set(struct, elfStyle$OFFSET, index0, fieldValue);
    }
    ...
    private static final long elfVersion$OFFSET = $LAYOUT.byteOffset(groupElement("elfVersion"));
    ...
    private static final long elfStyleSize$OFFSET = $LAYOUT.byteOffset(groupElement("elfStyleSize"));
    ...
    private static final long elfMatch$OFFSET = $LAYOUT.byteOffset(groupElement("elfMatch"));
    ...
    private static final long elfReserved$OFFSET = $LAYOUT.byteOffset(groupElement("elfReserved"));
    ...
    private static final long elfVendorId$OFFSET = $LAYOUT.byteOffset(groupElement("elfVendorId"));
    ...
    public static byte elfVendorId(MemorySegment struct, long index0) {
        return (byte)elfVendorId$ELEM_HANDLE.get(struct, elfVendorId$OFFSET, index0);
    }
    ...
    public static void elfVendorId(MemorySegment struct, long index0, byte fieldValue) {
        elfVendorId$ELEM_HANDLE.set(struct, elfVendorId$OFFSET, index0, fieldValue);
    }
    ...
    private static final long elfCulture$OFFSET = $LAYOUT.byteOffset(groupElement("elfCulture"));
    ...
    private static final long elfPanose$OFFSET = $LAYOUT.byteOffset(groupElement("elfPanose"));
