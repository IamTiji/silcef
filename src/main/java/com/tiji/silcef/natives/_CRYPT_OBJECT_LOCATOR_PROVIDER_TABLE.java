...
public class _CRYPT_OBJECT_LOCATOR_PROVIDER_TABLE {
    ...
    private static final long pfnGet$OFFSET = $LAYOUT.byteOffset(groupElement("pfnGet"));
    ...
    private static final long pfnRelease$OFFSET = $LAYOUT.byteOffset(groupElement("pfnRelease"));
    ...
    private static final long pfnFreePassword$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFreePassword"));
    ...
    private static final long pfnFreeIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFreeIdentifier"));
