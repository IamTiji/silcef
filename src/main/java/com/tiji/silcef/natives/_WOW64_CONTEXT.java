...
public class _WOW64_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("Dr0"),
        cef_master_h.C_LONG.withName("Dr1"),
        cef_master_h.C_LONG.withName("Dr2"),
        cef_master_h.C_LONG.withName("Dr3"),
        cef_master_h.C_LONG.withName("Dr6"),
        cef_master_h.C_LONG.withName("Dr7"),
        _WOW64_FLOATING_SAVE_AREA.layout().withName("FloatSave"),
        cef_master_h.C_LONG.withName("SegGs"),
        cef_master_h.C_LONG.withName("SegFs"),
        cef_master_h.C_LONG.withName("SegEs"),
        cef_master_h.C_LONG.withName("SegDs"),
        cef_master_h.C_LONG.withName("Edi"),
        cef_master_h.C_LONG.withName("Esi"),
        cef_master_h.C_LONG.withName("Ebx"),
        cef_master_h.C_LONG.withName("Edx"),
        cef_master_h.C_LONG.withName("Ecx"),
        cef_master_h.C_LONG.withName("Eax"),
        cef_master_h.C_LONG.withName("Ebp"),
        cef_master_h.C_LONG.withName("Eip"),
        cef_master_h.C_LONG.withName("SegCs"),
        cef_master_h.C_LONG.withName("EFlags"),
        cef_master_h.C_LONG.withName("Esp"),
        cef_master_h.C_LONG.withName("SegSs"),
        MemoryLayout.sequenceLayout(512, cef_master_h.C_CHAR).withName("ExtendedRegisters")
