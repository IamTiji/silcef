 ...
 * }
 */
public final class PTP_WAIT_CALLBACK {

    private PTP_WAIT_CALLBACK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PTP_WAIT_CALLBACK.Function.class, "apply", $DESC);
