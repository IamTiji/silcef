...
public class _EFS_VERSION_INFO {
    ...
    private static final long EfsVersion$OFFSET = $LAYOUT.byteOffset(groupElement("EfsVersion"));
    ...
    private static final long SubVersion$OFFSET = $LAYOUT.byteOffset(groupElement("SubVersion"));
