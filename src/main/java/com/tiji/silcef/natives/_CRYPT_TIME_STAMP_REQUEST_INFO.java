...
public class _CRYPT_TIME_STAMP_REQUEST_INFO {
    ...
    private static final long pszTimeStampAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("pszTimeStampAlgorithm"));
    ...
    private static final long pszContentType$OFFSET = $LAYOUT.byteOffset(groupElement("pszContentType"));
