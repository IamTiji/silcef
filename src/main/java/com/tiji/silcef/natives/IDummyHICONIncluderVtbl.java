...
public class IDummyHICONIncluderVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("Dummy")
    ...
    public final static class Dummy {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(Dummy.Function.class, "apply", $DESC);
