...
public class _CERT_REVOCATION_STATUS {
    ...
    private static final long dwIndex$OFFSET = $LAYOUT.byteOffset(groupElement("dwIndex"));
    ...
    private static final long dwReason$OFFSET = $LAYOUT.byteOffset(groupElement("dwReason"));
