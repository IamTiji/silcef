...
public class _IMAGE_RESOURCE_DIRECTORY {
    ...
    private static final long NumberOfNamedEntries$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfNamedEntries"));
    ...
    private static final long NumberOfIdEntries$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfIdEntries"));
