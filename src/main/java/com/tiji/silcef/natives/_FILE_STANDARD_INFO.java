...
public class _FILE_STANDARD_INFO {
    ...
    private static final long DeletePending$OFFSET = $LAYOUT.byteOffset(groupElement("DeletePending"));
    ...
    private static final long Directory$OFFSET = $LAYOUT.byteOffset(groupElement("Directory"));
