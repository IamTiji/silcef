...
public class DISPLAYCONFIG_ADAPTER_NAME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("adapterDevicePath")
    ...
    private static final long adapterDevicePath$OFFSET = $LAYOUT.byteOffset(groupElement("adapterDevicePath"));
    ...
    public static short adapterDevicePath(MemorySegment struct, long index0) {
        return (short)adapterDevicePath$ELEM_HANDLE.get(struct, adapterDevicePath$OFFSET, index0);
    }
    ...
    public static void adapterDevicePath(MemorySegment struct, long index0, short fieldValue) {
        adapterDevicePath$ELEM_HANDLE.set(struct, adapterDevicePath$OFFSET, index0, fieldValue);
    }
