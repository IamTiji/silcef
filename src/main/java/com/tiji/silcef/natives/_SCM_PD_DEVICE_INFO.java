...
public class _SCM_PD_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("UnsafeShutdownCount"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_LONG_LONG.withName("PersistentMemorySizeInBytes"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("VolatileMemorySizeInBytes"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("TotalMemorySizeInBytes"),
        cef_render_handler_capi_h.C_LONG.withName("SlotNumber"),
        cef_render_handler_capi_h.C_LONG.withName("DeviceHandle"),
        cef_render_handler_capi_h.C_SHORT.withName("PhysicalId"),
        cef_render_handler_capi_h.C_CHAR.withName("NumberOfFormatInterfaceCodes"),
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(8, cef_render_handler_capi_h.C_SHORT).withName("FormatInterfaceCodes"),
        cef_render_handler_capi_h.C_LONG.withName("VendorId"),
        cef_render_handler_capi_h.C_LONG.withName("ProductId"),
        cef_render_handler_capi_h.C_LONG.withName("SubsystemDeviceId"),
        cef_render_handler_capi_h.C_LONG.withName("SubsystemVendorId"),
        cef_render_handler_capi_h.C_CHAR.withName("ManufacturingLocation"),
        cef_render_handler_capi_h.C_CHAR.withName("ManufacturingWeek"),
        cef_render_handler_capi_h.C_CHAR.withName("ManufacturingYear"),
        MemoryLayout.paddingLayout(1),
        cef_render_handler_capi_h.C_LONG.withName("SerialNumber4Byte"),
        cef_render_handler_capi_h.C_LONG.withName("SerialNumberLengthInChars"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_CHAR).withName("SerialNumber"),
