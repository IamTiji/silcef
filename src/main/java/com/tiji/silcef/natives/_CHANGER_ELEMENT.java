...
public class _CHANGER_ELEMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_INT.withName("ElementType"),
        cef_render_handler_capi_h.C_LONG.withName("ElementAddress")
    ...
    private static final long ElementType$OFFSET = $LAYOUT.byteOffset(groupElement("ElementType"));
    ...
    private static final long ElementAddress$OFFSET = $LAYOUT.byteOffset(groupElement("ElementAddress"));
