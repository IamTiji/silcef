...
public class tagDROPSTRUCT {
    ...
    private static final long hwndSource$OFFSET = $LAYOUT.byteOffset(groupElement("hwndSource"));
    ...
    private static final long hwndSink$OFFSET = $LAYOUT.byteOffset(groupElement("hwndSink"));
    ...
    private static final long dwData$OFFSET = $LAYOUT.byteOffset(groupElement("dwData"));
    ...
    private static final long ptDrop$OFFSET = $LAYOUT.byteOffset(groupElement("ptDrop"));
    ...
    private static final long dwControlData$OFFSET = $LAYOUT.byteOffset(groupElement("dwControlData"));
