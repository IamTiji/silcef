...
public class _CERT_TRUST_LIST_INFO {
    ...
    private static final long pCtlEntry$OFFSET = $LAYOUT.byteOffset(groupElement("pCtlEntry"));
    ...
    private static final long pCtlContext$OFFSET = $LAYOUT.byteOffset(groupElement("pCtlContext"));
