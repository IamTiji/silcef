...
public class tagGLYPHSET {
    ...
    private static final long cbThis$OFFSET = $LAYOUT.byteOffset(groupElement("cbThis"));
    ...
    private static final long flAccel$OFFSET = $LAYOUT.byteOffset(groupElement("flAccel"));
    ...
    private static final long cGlyphsSupported$OFFSET = $LAYOUT.byteOffset(groupElement("cGlyphsSupported"));
    ...
    private static final long cRanges$OFFSET = $LAYOUT.byteOffset(groupElement("cRanges"));
    ...
    public static MemorySegment ranges(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)ranges$ELEM_HANDLE.invokeExact(struct, ranges$OFFSET, index0);
