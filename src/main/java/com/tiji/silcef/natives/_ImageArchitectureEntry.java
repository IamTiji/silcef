...
public class _ImageArchitectureEntry {
    ...
    private static final long FixupInstRVA$OFFSET = $LAYOUT.byteOffset(groupElement("FixupInstRVA"));
    ...
    private static final long NewInst$OFFSET = $LAYOUT.byteOffset(groupElement("NewInst"));
