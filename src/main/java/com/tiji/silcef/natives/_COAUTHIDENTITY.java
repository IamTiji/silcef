...
public class _COAUTHIDENTITY {
    ...
    private static final long UserLength$OFFSET = $LAYOUT.byteOffset(groupElement("UserLength"));
    ...
    private static final long DomainLength$OFFSET = $LAYOUT.byteOffset(groupElement("DomainLength"));
    ...
    private static final long PasswordLength$OFFSET = $LAYOUT.byteOffset(groupElement("PasswordLength"));
