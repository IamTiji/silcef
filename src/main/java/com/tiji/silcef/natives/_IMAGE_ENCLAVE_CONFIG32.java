...
public class _IMAGE_ENCLAVE_CONFIG32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("EnclaveSize"),
    ...
    private static final long MinimumRequiredConfigSize$OFFSET = $LAYOUT.byteOffset(groupElement("MinimumRequiredConfigSize"));
    ...
    private static final long PolicyFlags$OFFSET = $LAYOUT.byteOffset(groupElement("PolicyFlags"));
    ...
    private static final long NumberOfImports$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfImports"));
    ...
    private static final long ImportList$OFFSET = $LAYOUT.byteOffset(groupElement("ImportList"));
    ...
    private static final long ImportEntrySize$OFFSET = $LAYOUT.byteOffset(groupElement("ImportEntrySize"));
    ...
    private static final long FamilyID$OFFSET = $LAYOUT.byteOffset(groupElement("FamilyID"));
    ...
    public static byte FamilyID(MemorySegment struct, long index0) {
        return (byte)FamilyID$ELEM_HANDLE.get(struct, FamilyID$OFFSET, index0);
    }
    ...
    public static void FamilyID(MemorySegment struct, long index0, byte fieldValue) {
        FamilyID$ELEM_HANDLE.set(struct, FamilyID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ImageID$OFFSET = $LAYOUT.byteOffset(groupElement("ImageID"));
    ...
    public static byte ImageID(MemorySegment struct, long index0) {
        return (byte)ImageID$ELEM_HANDLE.get(struct, ImageID$OFFSET, index0);
    }
    ...
    public static void ImageID(MemorySegment struct, long index0, byte fieldValue) {
        ImageID$ELEM_HANDLE.set(struct, ImageID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ImageVersion$OFFSET = $LAYOUT.byteOffset(groupElement("ImageVersion"));
    ...
    private static final long SecurityVersion$OFFSET = $LAYOUT.byteOffset(groupElement("SecurityVersion"));
    ...
    private static final long EnclaveSize$OFFSET = $LAYOUT.byteOffset(groupElement("EnclaveSize"));
    ...
    private static final long NumberOfThreads$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfThreads"));
    ...
    private static final long EnclaveFlags$OFFSET = $LAYOUT.byteOffset(groupElement("EnclaveFlags"));
