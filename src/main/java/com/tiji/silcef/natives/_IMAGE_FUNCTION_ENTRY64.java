...
public class _IMAGE_FUNCTION_ENTRY64 {
    ...
    private static final long StartingAddress$OFFSET = $LAYOUT.byteOffset(groupElement("StartingAddress"));
    ...
    private static final long EndingAddress$OFFSET = $LAYOUT.byteOffset(groupElement("EndingAddress"));
    ...
    private static final OfLong EndOfPrologue$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21999:5"), groupElement("EndOfPrologue"));
    ...
    private static final long EndOfPrologue$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21999:5"), groupElement("EndOfPrologue"));
    ...
    private static final OfLong UnwindInfoAddress$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21999:5"), groupElement("UnwindInfoAddress"));
    ...
    private static final long UnwindInfoAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21999:5"), groupElement("UnwindInfoAddress"));
