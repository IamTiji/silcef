...
public class _FILE_REGION_OUTPUT {
    ...
    private static final long TotalRegionEntryCount$OFFSET = $LAYOUT.byteOffset(groupElement("TotalRegionEntryCount"));
    ...
    private static final long RegionEntryCount$OFFSET = $LAYOUT.byteOffset(groupElement("RegionEntryCount"));
    ...
    public static MemorySegment Region(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Region$ELEM_HANDLE.invokeExact(struct, Region$OFFSET, index0);
