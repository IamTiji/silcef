...
public class _STORAGE_ALLOCATE_BC_STREAM_INPUT {
    ...
    private static final long RequestsPerPeriod$OFFSET = $LAYOUT.byteOffset(groupElement("RequestsPerPeriod"));
    ...
    private static final long RetryFailures$OFFSET = $LAYOUT.byteOffset(groupElement("RetryFailures"));
    ...
    private static final long Discardable$OFFSET = $LAYOUT.byteOffset(groupElement("Discardable"));
    ...
    private static final long AccessType$OFFSET = $LAYOUT.byteOffset(groupElement("AccessType"));
