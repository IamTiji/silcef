...
public class tagOLEVERB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_LONG.withName("lVerb"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("lpszVerbName"),
        cef_master_h.C_LONG.withName("fuFlags"),
        cef_master_h.C_LONG.withName("grfAttribs")
    ).withName("tagOLEVERB");
