...
public class tagOLEVERB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("lVerb"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("lpszVerbName"),
        cef_render_handler_capi_h.C_LONG.withName("fuFlags"),
        cef_render_handler_capi_h.C_LONG.withName("grfAttribs")
    ).withName("tagOLEVERB");
    ...
    private static final long lVerb$OFFSET = $LAYOUT.byteOffset(groupElement("lVerb"));
    ...
    private static final long lpszVerbName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszVerbName"));
    ...
    private static final long fuFlags$OFFSET = $LAYOUT.byteOffset(groupElement("fuFlags"));
    ...
    private static final long grfAttribs$OFFSET = $LAYOUT.byteOffset(groupElement("grfAttribs"));
