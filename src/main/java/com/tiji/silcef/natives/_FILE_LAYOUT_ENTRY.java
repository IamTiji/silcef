...
public class _FILE_LAYOUT_ENTRY {
    ...
    private static final long NextFileOffset$OFFSET = $LAYOUT.byteOffset(groupElement("NextFileOffset"));
    ...
    private static final long FirstNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("FirstNameOffset"));
    ...
    private static final long FirstStreamOffset$OFFSET = $LAYOUT.byteOffset(groupElement("FirstStreamOffset"));
    ...
    private static final long ExtraInfoOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraInfoOffset"));
    ...
    private static final long ExtraInfoLength$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraInfoLength"));
