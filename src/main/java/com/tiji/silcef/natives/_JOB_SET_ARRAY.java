...
public class _JOB_SET_ARRAY {
    ...
    private static final long JobHandle$OFFSET = $LAYOUT.byteOffset(groupElement("JobHandle"));
    ...
    private static final long MemberLevel$OFFSET = $LAYOUT.byteOffset(groupElement("MemberLevel"));
