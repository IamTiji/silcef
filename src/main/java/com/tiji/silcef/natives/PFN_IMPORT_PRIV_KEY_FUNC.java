 ...
 * }
 */
public final class PFN_IMPORT_PRIV_KEY_FUNC {

    private PFN_IMPORT_PRIV_KEY_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_IMPORT_PRIV_KEY_FUNC.Function.class, "apply", $DESC);
