...
public class _NCRYPT_VBS_ROOT_KEY_ATTESTATION_CLAIM_DETAILS {
    ...
    private static final long ullTrustletId$OFFSET = $LAYOUT.byteOffset(groupElement("ullTrustletId"));
    ...
    private static final long ulTrustletSecurityVersion$OFFSET = $LAYOUT.byteOffset(groupElement("ulTrustletSecurityVersion"));
    ...
    private static final long ulTrustletDebuggable$OFFSET = $LAYOUT.byteOffset(groupElement("ulTrustletDebuggable"));
