...
public class ARRAY_INFO {
    ...
    private static final long BufferConformanceMark$OFFSET = $LAYOUT.byteOffset(groupElement("BufferConformanceMark"));
    ...
    private static final long BufferVarianceMark$OFFSET = $LAYOUT.byteOffset(groupElement("BufferVarianceMark"));
    ...
    private static final long MaxCountArray$OFFSET = $LAYOUT.byteOffset(groupElement("MaxCountArray"));
    ...
    private static final long OffsetArray$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetArray"));
    ...
    private static final long ActualCountArray$OFFSET = $LAYOUT.byteOffset(groupElement("ActualCountArray"));
