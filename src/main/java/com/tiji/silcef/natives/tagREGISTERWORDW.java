...
public class tagREGISTERWORDW {
    ...
    private static final long lpReading$OFFSET = $LAYOUT.byteOffset(groupElement("lpReading"));
    ...
    private static final long lpWord$OFFSET = $LAYOUT.byteOffset(groupElement("lpWord"));
