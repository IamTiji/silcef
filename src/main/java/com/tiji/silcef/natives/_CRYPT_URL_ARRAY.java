...
public class _CRYPT_URL_ARRAY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cUrl"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgwszUrl")
    ...
    private static final long cUrl$OFFSET = $LAYOUT.byteOffset(groupElement("cUrl"));
    ...
    private static final long rgwszUrl$OFFSET = $LAYOUT.byteOffset(groupElement("rgwszUrl"));
