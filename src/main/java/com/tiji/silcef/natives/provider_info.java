...
public class provider_info {
    ...
    private static final long pi_R0_1val$OFFSET = $LAYOUT.byteOffset(groupElement("pi_R0_1val"));
    ...
    private static final long pi_R0_allvals$OFFSET = $LAYOUT.byteOffset(groupElement("pi_R0_allvals"));
    ...
    private static final long pi_R3_1val$OFFSET = $LAYOUT.byteOffset(groupElement("pi_R3_1val"));
    ...
    private static final long pi_R3_allvals$OFFSET = $LAYOUT.byteOffset(groupElement("pi_R3_allvals"));
    ...
    private static final long pi_flags$OFFSET = $LAYOUT.byteOffset(groupElement("pi_flags"));
    ...
    private static final long pi_key_context$OFFSET = $LAYOUT.byteOffset(groupElement("pi_key_context"));
