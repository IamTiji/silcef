 ...
 * }
 */
public class _cef_scheme_handler_factory_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_app_capi_h.C_POINTER.withName("create")
    ).withName("_cef_scheme_handler_factory_t");
    ...
    public final static class create {
        ...
        private static final MethodHandle UP$MH = cef_app_capi_h.upcallHandle(create.Function.class, "apply", $DESC);
