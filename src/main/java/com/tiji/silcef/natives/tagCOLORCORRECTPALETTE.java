...
public class tagCOLORCORRECTPALETTE {
    ...
    private static final long ihPalette$OFFSET = $LAYOUT.byteOffset(groupElement("ihPalette"));
    ...
    private static final long nFirstEntry$OFFSET = $LAYOUT.byteOffset(groupElement("nFirstEntry"));
    ...
    private static final long nReserved$OFFSET = $LAYOUT.byteOffset(groupElement("nReserved"));
