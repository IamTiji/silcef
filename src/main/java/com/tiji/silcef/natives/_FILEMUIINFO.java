...
public class _FILEMUIINFO {
    ...
    private static final long dwVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersion"));
    ...
    private static final long dwFileType$OFFSET = $LAYOUT.byteOffset(groupElement("dwFileType"));
    ...
    private static final long pChecksum$OFFSET = $LAYOUT.byteOffset(groupElement("pChecksum"));
    ...
    public static byte pChecksum(MemorySegment struct, long index0) {
        return (byte)pChecksum$ELEM_HANDLE.get(struct, pChecksum$OFFSET, index0);
    }
    ...
    public static void pChecksum(MemorySegment struct, long index0, byte fieldValue) {
        pChecksum$ELEM_HANDLE.set(struct, pChecksum$OFFSET, index0, fieldValue);
    }
    ...
    private static final long pServiceChecksum$OFFSET = $LAYOUT.byteOffset(groupElement("pServiceChecksum"));
    ...
    public static byte pServiceChecksum(MemorySegment struct, long index0) {
        return (byte)pServiceChecksum$ELEM_HANDLE.get(struct, pServiceChecksum$OFFSET, index0);
    }
    ...
    public static void pServiceChecksum(MemorySegment struct, long index0, byte fieldValue) {
        pServiceChecksum$ELEM_HANDLE.set(struct, pServiceChecksum$OFFSET, index0, fieldValue);
    }
    ...
    private static final long dwLanguageNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwLanguageNameOffset"));
    ...
    private static final long dwTypeIDMainSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeIDMainSize"));
    ...
    private static final long dwTypeIDMainOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeIDMainOffset"));
    ...
    private static final long dwTypeNameMainOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeNameMainOffset"));
    ...
    private static final long dwTypeIDMUISize$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeIDMUISize"));
    ...
    private static final long dwTypeIDMUIOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeIDMUIOffset"));
    ...
    private static final long dwTypeNameMUIOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwTypeNameMUIOffset"));
    ...
    private static final long abBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("abBuffer"));
    ...
    public static byte abBuffer(MemorySegment struct, long index0) {
        return (byte)abBuffer$ELEM_HANDLE.get(struct, abBuffer$OFFSET, index0);
    }
    ...
    public static void abBuffer(MemorySegment struct, long index0, byte fieldValue) {
        abBuffer$ELEM_HANDLE.set(struct, abBuffer$OFFSET, index0, fieldValue);
    }
