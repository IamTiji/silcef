 ...
 * }
 */
public final class PFLS_CALLBACK_FUNCTION {

    private PFLS_CALLBACK_FUNCTION() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFLS_CALLBACK_FUNCTION.Function.class, "apply", $DESC);
