...
public class tagTouchPredictionParameters {
    ...
    private static final long dwLatency$OFFSET = $LAYOUT.byteOffset(groupElement("dwLatency"));
    ...
    private static final long dwSampleTime$OFFSET = $LAYOUT.byteOffset(groupElement("dwSampleTime"));
    ...
    private static final long bUseHWTimeStamp$OFFSET = $LAYOUT.byteOffset(groupElement("bUseHWTimeStamp"));
