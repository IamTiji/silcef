...
public class _SE_ACCESS_REPLY {
    ...
    private static final long ResultListCount$OFFSET = $LAYOUT.byteOffset(groupElement("ResultListCount"));
    ...
    private static final long GrantedAccess$OFFSET = $LAYOUT.byteOffset(groupElement("GrantedAccess"));
    ...
    private static final long AccessStatus$OFFSET = $LAYOUT.byteOffset(groupElement("AccessStatus"));
    ...
    private static final long AccessReason$OFFSET = $LAYOUT.byteOffset(groupElement("AccessReason"));
