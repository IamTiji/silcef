...
public class _CRYPT_AES_256_KEY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("Key"),
        MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_CHAR).withName("IV"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_CHAR)).withName("EncryptionState"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_CHAR)).withName("DecryptionState"),
    ...
    private static final long EncryptionState$OFFSET = $LAYOUT.byteOffset(groupElement("EncryptionState"));
    ...
    public static byte EncryptionState(MemorySegment struct, long index0, long index1) {
        return (byte)EncryptionState$ELEM_HANDLE.get(struct, EncryptionState$OFFSET, index0, index1);
    }
    ...
    public static void EncryptionState(MemorySegment struct, long index0, long index1, byte fieldValue) {
        EncryptionState$ELEM_HANDLE.set(struct, EncryptionState$OFFSET, index0, index1, fieldValue);
    }
    ...
    private static final long DecryptionState$OFFSET = $LAYOUT.byteOffset(groupElement("DecryptionState"));
    ...
    public static byte DecryptionState(MemorySegment struct, long index0, long index1) {
        return (byte)DecryptionState$ELEM_HANDLE.get(struct, DecryptionState$OFFSET, index0, index1);
    }
    ...
    public static void DecryptionState(MemorySegment struct, long index0, long index1, byte fieldValue) {
        DecryptionState$ELEM_HANDLE.set(struct, DecryptionState$OFFSET, index0, index1, fieldValue);
    }
    ...
    private static final long Feedback$OFFSET = $LAYOUT.byteOffset(groupElement("Feedback"));
    ...
    public static byte Feedback(MemorySegment struct, long index0) {
        return (byte)Feedback$ELEM_HANDLE.get(struct, Feedback$OFFSET, index0);
    }
    ...
    public static void Feedback(MemorySegment struct, long index0, byte fieldValue) {
        Feedback$ELEM_HANDLE.set(struct, Feedback$OFFSET, index0, fieldValue);
    }
