...
public class MENUITEMTEMPLATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_SHORT.withName("mtOption"),
        cef_render_handler_capi_h.C_SHORT.withName("mtID"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_SHORT).withName("mtString")
    ).withName("$anon$10526:9");
    ...
    private static final long mtOption$OFFSET = $LAYOUT.byteOffset(groupElement("mtOption"));
    ...
    private static final long mtID$OFFSET = $LAYOUT.byteOffset(groupElement("mtID"));
    ...
    private static final long mtString$OFFSET = $LAYOUT.byteOffset(groupElement("mtString"));
    ...
    public static short mtString(MemorySegment struct, long index0) {
        return (short)mtString$ELEM_HANDLE.get(struct, mtString$OFFSET, index0);
    }
    ...
    public static void mtString(MemorySegment struct, long index0, short fieldValue) {
        mtString$ELEM_HANDLE.set(struct, mtString$OFFSET, index0, fieldValue);
    }
