...
public class _IMAGE_LOAD_CONFIG_CODE_INTEGRITY {
    ...
    private static final long Catalog$OFFSET = $LAYOUT.byteOffset(groupElement("Catalog"));
    ...
    private static final long CatalogOffset$OFFSET = $LAYOUT.byteOffset(groupElement("CatalogOffset"));
