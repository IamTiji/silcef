...
public class midiproptimediv_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 1).withName("dwTimeDiv")
    ...
    private static final long dwTimeDiv$OFFSET = $LAYOUT.byteOffset(groupElement("dwTimeDiv"));
