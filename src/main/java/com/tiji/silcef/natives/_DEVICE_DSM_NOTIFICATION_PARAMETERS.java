...
public class _DEVICE_DSM_NOTIFICATION_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("NumFileTypeIDs"),
    ...
    private static final long NumFileTypeIDs$OFFSET = $LAYOUT.byteOffset(groupElement("NumFileTypeIDs"));
    ...
    private static final long FileTypeID$OFFSET = $LAYOUT.byteOffset(groupElement("FileTypeID"));
    ...
    public static MemorySegment FileTypeID(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)FileTypeID$ELEM_HANDLE.invokeExact(struct, FileTypeID$OFFSET, index0);
