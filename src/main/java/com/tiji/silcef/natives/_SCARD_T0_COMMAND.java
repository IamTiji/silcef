...
public class _SCARD_T0_COMMAND {
    ...
    private static final long bCla$OFFSET = $LAYOUT.byteOffset(groupElement("bCla"));
    ...
    private static final long bIns$OFFSET = $LAYOUT.byteOffset(groupElement("bIns"));
    ...
    private static final long bP1$OFFSET = $LAYOUT.byteOffset(groupElement("bP1"));
    ...
    private static final long bP2$OFFSET = $LAYOUT.byteOffset(groupElement("bP2"));
    ...
    private static final long bP3$OFFSET = $LAYOUT.byteOffset(groupElement("bP3"));
