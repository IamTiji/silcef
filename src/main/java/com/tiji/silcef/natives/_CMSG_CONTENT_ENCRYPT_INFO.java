...
public class _CMSG_CONTENT_ENCRYPT_INFO {
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("hCryptProv"));
    ...
    private static final long ContentEncryptionAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("ContentEncryptionAlgorithm"));
    ...
    private static final long pvEncryptionAuxInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pvEncryptionAuxInfo"));
    ...
    private static final long cRecipients$OFFSET = $LAYOUT.byteOffset(groupElement("cRecipients"));
    ...
    private static final long rgCmsRecipients$OFFSET = $LAYOUT.byteOffset(groupElement("rgCmsRecipients"));
    ...
    private static final long pfnAlloc$OFFSET = $LAYOUT.byteOffset(groupElement("pfnAlloc"));
    ...
    private static final long dwEncryptFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwEncryptFlags"));
    ...
    private static final OfLong hContentEncryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8636:5"), groupElement("hContentEncryptKey"));
    ...
    private static final long hContentEncryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8636:5"), groupElement("hContentEncryptKey"));
    ...
    private static final AddressLayout hCNGContentEncryptKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8636:5"), groupElement("hCNGContentEncryptKey"));
    ...
    private static final long hCNGContentEncryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8636:5"), groupElement("hCNGContentEncryptKey"));
    ...
    private static final long fCNG$OFFSET = $LAYOUT.byteOffset(groupElement("fCNG"));
    ...
    private static final long pbCNGContentEncryptKeyObject$OFFSET = $LAYOUT.byteOffset(groupElement("pbCNGContentEncryptKeyObject"));
    ...
    private static final long pbContentEncryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("pbContentEncryptKey"));
    ...
    private static final long cbContentEncryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("cbContentEncryptKey"));
