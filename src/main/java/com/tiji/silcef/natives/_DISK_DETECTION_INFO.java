...
public class _DISK_DETECTION_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$9738:17")
        ).withName("$anon$9737:9")
    ...
    private static final long SizeOfDetectInfo$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfDetectInfo"));
    ...
    private static final long DetectionType$OFFSET = $LAYOUT.byteOffset(groupElement("DetectionType"));
    ...
    private static final GroupLayout Int13$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9737:9"), groupElement("$anon$9738:17"), groupElement("Int13"));
    ...
    private static final long Int13$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9737:9"), groupElement("$anon$9738:17"), groupElement("Int13"));
    ...
    private static final GroupLayout ExInt13$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9737:9"), groupElement("$anon$9738:17"), groupElement("ExInt13"));
    ...
    private static final long ExInt13$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9737:9"), groupElement("$anon$9738:17"), groupElement("ExInt13"));
