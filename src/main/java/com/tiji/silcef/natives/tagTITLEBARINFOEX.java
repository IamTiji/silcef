...
public class tagTITLEBARINFOEX {
    ...
    private static final long rcTitleBar$OFFSET = $LAYOUT.byteOffset(groupElement("rcTitleBar"));
    ...
    private static final long rgrect$OFFSET = $LAYOUT.byteOffset(groupElement("rgrect"));
    ...
    public static MemorySegment rgrect(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)rgrect$ELEM_HANDLE.invokeExact(struct, rgrect$OFFSET, index0);
