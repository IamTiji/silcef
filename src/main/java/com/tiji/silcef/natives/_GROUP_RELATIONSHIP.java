...
public class _GROUP_RELATIONSHIP {
    ...
    private static final long MaximumGroupCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumGroupCount"));
    ...
    private static final long ActiveGroupCount$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveGroupCount"));
    ...
    private static final long GroupInfo$OFFSET = $LAYOUT.byteOffset(groupElement("GroupInfo"));
    ...
    public static MemorySegment GroupInfo(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)GroupInfo$ELEM_HANDLE.invokeExact(struct, GroupInfo$OFFSET, index0);
