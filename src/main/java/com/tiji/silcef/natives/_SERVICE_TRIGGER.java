...
public class _SERVICE_TRIGGER {
    ...
    private static final long dwTriggerType$OFFSET = $LAYOUT.byteOffset(groupElement("dwTriggerType"));
    ...
    private static final long dwAction$OFFSET = $LAYOUT.byteOffset(groupElement("dwAction"));
    ...
    private static final long pTriggerSubtype$OFFSET = $LAYOUT.byteOffset(groupElement("pTriggerSubtype"));
    ...
    private static final long cDataItems$OFFSET = $LAYOUT.byteOffset(groupElement("cDataItems"));
    ...
    private static final long pDataItems$OFFSET = $LAYOUT.byteOffset(groupElement("pDataItems"));
