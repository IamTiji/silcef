...
public class _FSCTL_OFFLOAD_READ_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("TokenTimeToLive"),
    ...
    private static final long TokenTimeToLive$OFFSET = $LAYOUT.byteOffset(groupElement("TokenTimeToLive"));
