...
public class _CERT_TEMPLATE_EXT {
    ...
    private static final long pszObjId$OFFSET = $LAYOUT.byteOffset(groupElement("pszObjId"));
    ...
    private static final long fMinorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("fMinorVersion"));
