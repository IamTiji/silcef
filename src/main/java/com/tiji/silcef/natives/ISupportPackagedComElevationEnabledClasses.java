...
/**
 * {@snippet lang=c :
 * struct ISupportPackagedComElevationEnabledClasses {
 *     struct ISupportPackagedComElevationEnabledClassesVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportPackagedComElevationEnabledClasses {
    ...
    ).withName("ISupportPackagedComElevationEnabledClasses");
