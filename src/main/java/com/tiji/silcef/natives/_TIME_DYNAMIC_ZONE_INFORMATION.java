...
public class _TIME_DYNAMIC_ZONE_INFORMATION {
    ...
    private static final long Bias$OFFSET = $LAYOUT.byteOffset(groupElement("Bias"));
    ...
    private static final long StandardName$OFFSET = $LAYOUT.byteOffset(groupElement("StandardName"));
    ...
    public static short StandardName(MemorySegment struct, long index0) {
        return (short)StandardName$ELEM_HANDLE.get(struct, StandardName$OFFSET, index0);
    }
    ...
    public static void StandardName(MemorySegment struct, long index0, short fieldValue) {
        StandardName$ELEM_HANDLE.set(struct, StandardName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long StandardDate$OFFSET = $LAYOUT.byteOffset(groupElement("StandardDate"));
    ...
    private static final long StandardBias$OFFSET = $LAYOUT.byteOffset(groupElement("StandardBias"));
    ...
    private static final long DaylightName$OFFSET = $LAYOUT.byteOffset(groupElement("DaylightName"));
    ...
    public static short DaylightName(MemorySegment struct, long index0) {
        return (short)DaylightName$ELEM_HANDLE.get(struct, DaylightName$OFFSET, index0);
    }
    ...
    public static void DaylightName(MemorySegment struct, long index0, short fieldValue) {
        DaylightName$ELEM_HANDLE.set(struct, DaylightName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long DaylightDate$OFFSET = $LAYOUT.byteOffset(groupElement("DaylightDate"));
    ...
    private static final long DaylightBias$OFFSET = $LAYOUT.byteOffset(groupElement("DaylightBias"));
    ...
    private static final long TimeZoneKeyName$OFFSET = $LAYOUT.byteOffset(groupElement("TimeZoneKeyName"));
    ...
    public static short TimeZoneKeyName(MemorySegment struct, long index0) {
        return (short)TimeZoneKeyName$ELEM_HANDLE.get(struct, TimeZoneKeyName$OFFSET, index0);
    }
    ...
    public static void TimeZoneKeyName(MemorySegment struct, long index0, short fieldValue) {
        TimeZoneKeyName$ELEM_HANDLE.set(struct, TimeZoneKeyName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long DynamicDaylightTimeDisabled$OFFSET = $LAYOUT.byteOffset(groupElement("DynamicDaylightTimeDisabled"));
