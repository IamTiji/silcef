...
public class _TOKEN_STATISTICS {
    ...
    private static final long TokenId$OFFSET = $LAYOUT.byteOffset(groupElement("TokenId"));
    ...
    private static final long ExpirationTime$OFFSET = $LAYOUT.byteOffset(groupElement("ExpirationTime"));
    ...
    private static final long DynamicCharged$OFFSET = $LAYOUT.byteOffset(groupElement("DynamicCharged"));
    ...
    private static final long DynamicAvailable$OFFSET = $LAYOUT.byteOffset(groupElement("DynamicAvailable"));
    ...
    private static final long ModifiedId$OFFSET = $LAYOUT.byteOffset(groupElement("ModifiedId"));
