...
public class tagENUMUILANG {
    ...
    private static final long NumOfEnumUILang$OFFSET = $LAYOUT.byteOffset(groupElement("NumOfEnumUILang"));
    ...
    private static final long SizeOfEnumUIBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfEnumUIBuffer"));
    ...
    private static final long pEnumUIBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pEnumUIBuffer"));
