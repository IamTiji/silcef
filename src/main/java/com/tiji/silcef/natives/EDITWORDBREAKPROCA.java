 ...
 * }
 */
public final class EDITWORDBREAKPROCA {

    private EDITWORDBREAKPROCA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(EDITWORDBREAKPROCA.Function.class, "apply", $DESC);
