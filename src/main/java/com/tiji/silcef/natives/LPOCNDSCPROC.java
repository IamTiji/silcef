 ...
 * }
 */
public final class LPOCNDSCPROC {

    private LPOCNDSCPROC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPOCNDSCPROC.Function.class, "apply", $DESC);
