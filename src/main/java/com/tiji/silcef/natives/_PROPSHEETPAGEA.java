...
public class _PROPSHEETPAGEA {
    ...
    private static final long pszTemplate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$225:5"), groupElement("pszTemplate"));
    ...
    private static final long pResource$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$225:5"), groupElement("pResource"));
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$225:5"), groupElement("hIcon"));
    ...
    private static final long pszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$225:5"), groupElement("pszIcon"));
    ...
    private static final long pszTitle$OFFSET = $LAYOUT.byteOffset(groupElement("pszTitle"));
    ...
    private static final long pfnDlgProc$OFFSET = $LAYOUT.byteOffset(groupElement("pfnDlgProc"));
    ...
    private static final long pcRefParent$OFFSET = $LAYOUT.byteOffset(groupElement("pcRefParent"));
    ...
    private static final long pszHeaderTitle$OFFSET = $LAYOUT.byteOffset(groupElement("pszHeaderTitle"));
    ...
    private static final long pszHeaderSubTitle$OFFSET = $LAYOUT.byteOffset(groupElement("pszHeaderSubTitle"));
    ...
    private static final long hActCtx$OFFSET = $LAYOUT.byteOffset(groupElement("hActCtx"));
    ...
    private static final long hbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$232:5"), groupElement("hbmHeader"));
    ...
    private static final long pszbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$232:5"), groupElement("pszbmHeader"));
