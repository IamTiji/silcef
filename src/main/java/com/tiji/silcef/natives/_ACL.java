...
public class _ACL {
    ...
    private static final long AclRevision$OFFSET = $LAYOUT.byteOffset(groupElement("AclRevision"));
    ...
    private static final long AclSize$OFFSET = $LAYOUT.byteOffset(groupElement("AclSize"));
    ...
    private static final long AceCount$OFFSET = $LAYOUT.byteOffset(groupElement("AceCount"));
    ...
    private static final long Sbz2$OFFSET = $LAYOUT.byteOffset(groupElement("Sbz2"));
