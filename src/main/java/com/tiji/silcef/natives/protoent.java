...
public class protoent {
    ...
    private static final long p_name$OFFSET = $LAYOUT.byteOffset(groupElement("p_name"));
    ...
    private static final long p_aliases$OFFSET = $LAYOUT.byteOffset(groupElement("p_aliases"));
    ...
    private static final long p_proto$OFFSET = $LAYOUT.byteOffset(groupElement("p_proto"));
