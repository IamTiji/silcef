...
public class tagMULTIKEYHELPW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_SHORT.withName("mkKeylist"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_SHORT).withName("szKeyphrase")
    ...
    private static final long mkSize$OFFSET = $LAYOUT.byteOffset(groupElement("mkSize"));
    ...
    private static final long mkKeylist$OFFSET = $LAYOUT.byteOffset(groupElement("mkKeylist"));
    ...
    private static final long szKeyphrase$OFFSET = $LAYOUT.byteOffset(groupElement("szKeyphrase"));
    ...
    public static short szKeyphrase(MemorySegment struct, long index0) {
        return (short)szKeyphrase$ELEM_HANDLE.get(struct, szKeyphrase$OFFSET, index0);
    }
    ...
    public static void szKeyphrase(MemorySegment struct, long index0, short fieldValue) {
        szKeyphrase$ELEM_HANDLE.set(struct, szKeyphrase$OFFSET, index0, fieldValue);
    }
