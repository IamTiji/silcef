...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_DUMP {
    ...
    private static final long dwReasonForCollection$OFFSET = $LAYOUT.byteOffset(groupElement("dwReasonForCollection"));
    ...
    private static final long cDriverName$OFFSET = $LAYOUT.byteOffset(groupElement("cDriverName"));
    ...
    public static byte cDriverName(MemorySegment struct, long index0) {
        return (byte)cDriverName$ELEM_HANDLE.get(struct, cDriverName$OFFSET, index0);
    }
    ...
    public static void cDriverName(MemorySegment struct, long index0, byte fieldValue) {
        cDriverName$ELEM_HANDLE.set(struct, cDriverName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long uiNumRecords$OFFSET = $LAYOUT.byteOffset(groupElement("uiNumRecords"));
    ...
    private static final long RecordArray$OFFSET = $LAYOUT.byteOffset(groupElement("RecordArray"));
    ...
    public static MemorySegment RecordArray(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)RecordArray$ELEM_HANDLE.invokeExact(struct, RecordArray$OFFSET, index0);
