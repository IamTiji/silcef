...
public class _tagStartParam {
    ...
    private static final long pIBindCtx$OFFSET = $LAYOUT.byteOffset(groupElement("pIBindCtx"));
    ...
    private static final long pItf$OFFSET = $LAYOUT.byteOffset(groupElement("pItf"));
