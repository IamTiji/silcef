...
public class _MOUSE_EVENT_RECORD {
    ...
    private static final long dwMousePosition$OFFSET = $LAYOUT.byteOffset(groupElement("dwMousePosition"));
    ...
    private static final long dwButtonState$OFFSET = $LAYOUT.byteOffset(groupElement("dwButtonState"));
    ...
    private static final long dwEventFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwEventFlags"));
