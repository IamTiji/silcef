...
public class _OCSP_CERT_ID {
    ...
    private static final long IssuerNameHash$OFFSET = $LAYOUT.byteOffset(groupElement("IssuerNameHash"));
    ...
    private static final long IssuerKeyHash$OFFSET = $LAYOUT.byteOffset(groupElement("IssuerKeyHash"));
