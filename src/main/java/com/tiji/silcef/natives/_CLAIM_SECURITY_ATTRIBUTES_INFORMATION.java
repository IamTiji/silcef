...
public class _CLAIM_SECURITY_ATTRIBUTES_INFORMATION {
    ...
    public static class Attribute {
        ...
        private static final long pAttributeV1$OFFSET = $LAYOUT.byteOffset(groupElement("pAttributeV1"));
    ...
    private static final long Attribute$OFFSET = $LAYOUT.byteOffset(groupElement("Attribute"));
