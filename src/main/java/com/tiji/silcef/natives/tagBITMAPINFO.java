...
public class tagBITMAPINFO {
    ...
    private static final long bmiHeader$OFFSET = $LAYOUT.byteOffset(groupElement("bmiHeader"));
    ...
    private static final long bmiColors$OFFSET = $LAYOUT.byteOffset(groupElement("bmiColors"));
    ...
    public static MemorySegment bmiColors(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)bmiColors$ELEM_HANDLE.invokeExact(struct, bmiColors$OFFSET, index0);
