...
public class _CMSG_MAIL_LIST_RECIPIENT_ENCODE_INFO {
    ...
    private static final OfLong hKeyEncryptionKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$7185:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final long hKeyEncryptionKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7185:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final AddressLayout pvKeyEncryptionKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7185:5"), groupElement("pvKeyEncryptionKey"));
    ...
    private static final long pvKeyEncryptionKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7185:5"), groupElement("pvKeyEncryptionKey"));
    ...
    private static final long KeyId$OFFSET = $LAYOUT.byteOffset(groupElement("KeyId"));
    ...
    private static final long pOtherAttr$OFFSET = $LAYOUT.byteOffset(groupElement("pOtherAttr"));
