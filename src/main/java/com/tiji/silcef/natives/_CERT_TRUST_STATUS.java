...
public class _CERT_TRUST_STATUS {
    ...
    private static final long dwErrorStatus$OFFSET = $LAYOUT.byteOffset(groupElement("dwErrorStatus"));
    ...
    private static final long dwInfoStatus$OFFSET = $LAYOUT.byteOffset(groupElement("dwInfoStatus"));
