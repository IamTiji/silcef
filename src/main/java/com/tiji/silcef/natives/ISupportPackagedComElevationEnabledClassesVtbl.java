...
/**
 * {@snippet lang=c :
 * struct ISupportPackagedComElevationEnabledClassesVtbl {
 *     HRESULT (*QueryInterface)(ISupportPackagedComElevationEnabledClasses *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportPackagedComElevationEnabledClasses *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportPackagedComElevationEnabledClasses *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportPackagedComElevationEnabledClassesVtbl {
    ...
    ).withName("ISupportPackagedComElevationEnabledClassesVtbl");
