...
public class tagPOINTER_DEVICE_PROPERTY {
    ...
    private static final long logicalMin$OFFSET = $LAYOUT.byteOffset(groupElement("logicalMin"));
    ...
    private static final long logicalMax$OFFSET = $LAYOUT.byteOffset(groupElement("logicalMax"));
    ...
    private static final long physicalMin$OFFSET = $LAYOUT.byteOffset(groupElement("physicalMin"));
    ...
    private static final long physicalMax$OFFSET = $LAYOUT.byteOffset(groupElement("physicalMax"));
    ...
    private static final long unitExponent$OFFSET = $LAYOUT.byteOffset(groupElement("unitExponent"));
    ...
    private static final long usagePageId$OFFSET = $LAYOUT.byteOffset(groupElement("usagePageId"));
    ...
    private static final long usageId$OFFSET = $LAYOUT.byteOffset(groupElement("usageId"));
