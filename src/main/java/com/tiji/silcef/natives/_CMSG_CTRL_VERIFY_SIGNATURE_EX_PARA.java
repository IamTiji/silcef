...
public class _CMSG_CTRL_VERIFY_SIGNATURE_EX_PARA {
    ...
    private static final long dwSignerType$OFFSET = $LAYOUT.byteOffset(groupElement("dwSignerType"));
    ...
    private static final long pvSigner$OFFSET = $LAYOUT.byteOffset(groupElement("pvSigner"));
