...
public class tagLOGPEN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_INT.withName("lopnStyle"),
        tagPOINT.layout().withName("lopnWidth"),
        cef_render_handler_capi_h.C_LONG.withName("lopnColor")
    ).withName("tagLOGPEN");
    ...
    private static final long lopnStyle$OFFSET = $LAYOUT.byteOffset(groupElement("lopnStyle"));
    ...
    private static final long lopnWidth$OFFSET = $LAYOUT.byteOffset(groupElement("lopnWidth"));
    ...
    private static final long lopnColor$OFFSET = $LAYOUT.byteOffset(groupElement("lopnColor"));
