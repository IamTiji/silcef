...
public class _FSCTL_OFFLOAD_WRITE_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG_LONG.withName("LengthWritten")
    ...
    private static final long LengthWritten$OFFSET = $LAYOUT.byteOffset(groupElement("LengthWritten"));
