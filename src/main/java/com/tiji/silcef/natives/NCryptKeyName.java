...
public class NCryptKeyName {
    ...
    private static final long pszName$OFFSET = $LAYOUT.byteOffset(groupElement("pszName"));
    ...
    private static final long dwLegacyKeySpec$OFFSET = $LAYOUT.byteOffset(groupElement("dwLegacyKeySpec"));
