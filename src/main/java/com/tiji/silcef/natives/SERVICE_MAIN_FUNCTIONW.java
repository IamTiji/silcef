 ...
 * }
 */
public final class SERVICE_MAIN_FUNCTIONW {

    private SERVICE_MAIN_FUNCTIONW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SERVICE_MAIN_FUNCTIONW.Function.class, "apply", $DESC);
