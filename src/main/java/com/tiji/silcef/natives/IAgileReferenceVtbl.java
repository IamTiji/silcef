...
public class IAgileReferenceVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("Resolve")
     ...
     * }
     */
    public final static class Resolve {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(Resolve.Function.class, "apply", $DESC);
