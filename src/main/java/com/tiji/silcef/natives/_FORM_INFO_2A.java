...
public class _FORM_INFO_2A {
    ...
    private static final long ImageableArea$OFFSET = $LAYOUT.byteOffset(groupElement("ImageableArea"));
    ...
    private static final long pKeyword$OFFSET = $LAYOUT.byteOffset(groupElement("pKeyword"));
    ...
    private static final long StringType$OFFSET = $LAYOUT.byteOffset(groupElement("StringType"));
    ...
    private static final long pMuiDll$OFFSET = $LAYOUT.byteOffset(groupElement("pMuiDll"));
    ...
    private static final long dwResourceId$OFFSET = $LAYOUT.byteOffset(groupElement("dwResourceId"));
    ...
    private static final long pDisplayName$OFFSET = $LAYOUT.byteOffset(groupElement("pDisplayName"));
