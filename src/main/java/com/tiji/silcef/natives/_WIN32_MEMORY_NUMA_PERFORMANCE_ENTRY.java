...
public class _WIN32_MEMORY_NUMA_PERFORMANCE_ENTRY {
    ...
    private static final long InitiatorNodeNumber$OFFSET = $LAYOUT.byteOffset(groupElement("InitiatorNodeNumber"));
    ...
    private static final long TargetNodeNumber$OFFSET = $LAYOUT.byteOffset(groupElement("TargetNodeNumber"));
    ...
    private static final long MinTransferSizeInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("MinTransferSizeInBytes"));
    ...
    private static final long EntryValue$OFFSET = $LAYOUT.byteOffset(groupElement("EntryValue"));
