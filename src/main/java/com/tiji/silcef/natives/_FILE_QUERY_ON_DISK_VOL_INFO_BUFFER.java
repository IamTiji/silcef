...
public class _FILE_QUERY_ON_DISK_VOL_INFO_BUFFER {
    ...
    private static final long DirectoryCount$OFFSET = $LAYOUT.byteOffset(groupElement("DirectoryCount"));
    ...
    private static final long FileCount$OFFSET = $LAYOUT.byteOffset(groupElement("FileCount"));
    ...
    private static final long FsFormatMajVersion$OFFSET = $LAYOUT.byteOffset(groupElement("FsFormatMajVersion"));
    ...
    private static final long FsFormatMinVersion$OFFSET = $LAYOUT.byteOffset(groupElement("FsFormatMinVersion"));
    ...
    private static final long FsFormatName$OFFSET = $LAYOUT.byteOffset(groupElement("FsFormatName"));
    ...
    public static short FsFormatName(MemorySegment struct, long index0) {
        return (short)FsFormatName$ELEM_HANDLE.get(struct, FsFormatName$OFFSET, index0);
    }
    ...
    public static void FsFormatName(MemorySegment struct, long index0, short fieldValue) {
        FsFormatName$ELEM_HANDLE.set(struct, FsFormatName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long LastUpdateTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastUpdateTime"));
    ...
    private static final long CopyrightInfo$OFFSET = $LAYOUT.byteOffset(groupElement("CopyrightInfo"));
    ...
    public static short CopyrightInfo(MemorySegment struct, long index0) {
        return (short)CopyrightInfo$ELEM_HANDLE.get(struct, CopyrightInfo$OFFSET, index0);
    }
    ...
    public static void CopyrightInfo(MemorySegment struct, long index0, short fieldValue) {
        CopyrightInfo$ELEM_HANDLE.set(struct, CopyrightInfo$OFFSET, index0, fieldValue);
    }
    ...
    private static final long AbstractInfo$OFFSET = $LAYOUT.byteOffset(groupElement("AbstractInfo"));
    ...
    public static short AbstractInfo(MemorySegment struct, long index0) {
        return (short)AbstractInfo$ELEM_HANDLE.get(struct, AbstractInfo$OFFSET, index0);
    }
    ...
    public static void AbstractInfo(MemorySegment struct, long index0, short fieldValue) {
        AbstractInfo$ELEM_HANDLE.set(struct, AbstractInfo$OFFSET, index0, fieldValue);
    }
    ...
    private static final long FormattingImplementationInfo$OFFSET = $LAYOUT.byteOffset(groupElement("FormattingImplementationInfo"));
    ...
    public static short FormattingImplementationInfo(MemorySegment struct, long index0) {
        return (short)FormattingImplementationInfo$ELEM_HANDLE.get(struct, FormattingImplementationInfo$OFFSET, index0);
    }
    ...
    public static void FormattingImplementationInfo(MemorySegment struct, long index0, short fieldValue) {
        FormattingImplementationInfo$ELEM_HANDLE.set(struct, FormattingImplementationInfo$OFFSET, index0, fieldValue);
    }
    ...
    private static final long LastModifyingImplementationInfo$OFFSET = $LAYOUT.byteOffset(groupElement("LastModifyingImplementationInfo"));
    ...
    public static short LastModifyingImplementationInfo(MemorySegment struct, long index0) {
        return (short)LastModifyingImplementationInfo$ELEM_HANDLE.get(struct, LastModifyingImplementationInfo$OFFSET, index0);
    }
    ...
    public static void LastModifyingImplementationInfo(MemorySegment struct, long index0, short fieldValue) {
        LastModifyingImplementationInfo$ELEM_HANDLE.set(struct, LastModifyingImplementationInfo$OFFSET, index0, fieldValue);
    }
