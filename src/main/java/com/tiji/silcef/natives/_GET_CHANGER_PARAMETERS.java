...
public class _GET_CHANGER_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_SHORT.withName("NumberTransportElements"),
        cef_master_h.C_SHORT.withName("NumberStorageElements"),
        cef_master_h.C_SHORT.withName("NumberCleanerSlots"),
        cef_master_h.C_SHORT.withName("NumberIEElements"),
        cef_master_h.C_SHORT.withName("NumberDataTransferElements"),
        cef_master_h.C_SHORT.withName("NumberOfDoors"),
        cef_master_h.C_SHORT.withName("FirstSlotNumber"),
        cef_master_h.C_SHORT.withName("FirstDriveNumber"),
        cef_master_h.C_SHORT.withName("FirstTransportNumber"),
        cef_master_h.C_SHORT.withName("FirstIEPortNumber"),
        cef_master_h.C_SHORT.withName("FirstCleanerSlotAddress"),
        cef_master_h.C_SHORT.withName("MagazineSize"),
        cef_master_h.C_LONG.withName("DriveCleanTimeout"),
        cef_master_h.C_LONG.withName("Features0"),
        cef_master_h.C_LONG.withName("Features1"),
        cef_master_h.C_CHAR.withName("MoveFromTransport"),
        cef_master_h.C_CHAR.withName("MoveFromSlot"),
        cef_master_h.C_CHAR.withName("MoveFromIePort"),
        cef_master_h.C_CHAR.withName("MoveFromDrive"),
        cef_master_h.C_CHAR.withName("ExchangeFromTransport"),
        cef_master_h.C_CHAR.withName("ExchangeFromSlot"),
        cef_master_h.C_CHAR.withName("ExchangeFromIePort"),
        cef_master_h.C_CHAR.withName("ExchangeFromDrive"),
        cef_master_h.C_CHAR.withName("LockUnlockCapabilities"),
        cef_master_h.C_CHAR.withName("PositionCapabilities"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_LONG).withName("Reserved2")
