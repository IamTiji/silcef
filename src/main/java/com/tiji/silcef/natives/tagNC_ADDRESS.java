...
public class tagNC_ADDRESS {
    ...
    private static final long pAddrInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pAddrInfo"));
    ...
    private static final long PortNumber$OFFSET = $LAYOUT.byteOffset(groupElement("PortNumber"));
    ...
    private static final long PrefixLength$OFFSET = $LAYOUT.byteOffset(groupElement("PrefixLength"));
