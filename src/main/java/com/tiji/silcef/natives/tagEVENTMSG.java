...
public class tagEVENTMSG {
    ...
    private static final long paramL$OFFSET = $LAYOUT.byteOffset(groupElement("paramL"));
    ...
    private static final long paramH$OFFSET = $LAYOUT.byteOffset(groupElement("paramH"));
