...
public class _NETINFOSTRUCT {
    ...
    private static final long cbStructure$OFFSET = $LAYOUT.byteOffset(groupElement("cbStructure"));
    ...
    private static final long dwProviderVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwProviderVersion"));
    ...
    private static final long dwCharacteristics$OFFSET = $LAYOUT.byteOffset(groupElement("dwCharacteristics"));
    ...
    private static final long dwHandle$OFFSET = $LAYOUT.byteOffset(groupElement("dwHandle"));
    ...
    private static final long wNetType$OFFSET = $LAYOUT.byteOffset(groupElement("wNetType"));
    ...
    private static final long dwPrinters$OFFSET = $LAYOUT.byteOffset(groupElement("dwPrinters"));
    ...
    private static final long dwDrives$OFFSET = $LAYOUT.byteOffset(groupElement("dwDrives"));
