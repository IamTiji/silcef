...
public class _STREAMS_QUERY_PARAMETERS_OUTPUT_BUFFER {
    ...
    private static final long OptimalWriteSize$OFFSET = $LAYOUT.byteOffset(groupElement("OptimalWriteSize"));
    ...
    private static final long StreamGranularitySize$OFFSET = $LAYOUT.byteOffset(groupElement("StreamGranularitySize"));
    ...
    private static final long StreamIdMin$OFFSET = $LAYOUT.byteOffset(groupElement("StreamIdMin"));
    ...
    private static final long StreamIdMax$OFFSET = $LAYOUT.byteOffset(groupElement("StreamIdMax"));
