...
public class _SYSTEM_LOGICAL_PROCESSOR_INFORMATION {
    ...
    private static final long ProcessorMask$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessorMask"));
    ...
    private static final GroupLayout ProcessorCore$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$13999:5"), groupElement("ProcessorCore"));
    ...
    private static final long ProcessorCore$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13999:5"), groupElement("ProcessorCore"));
    ...
    private static final GroupLayout NumaNode$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$13999:5"), groupElement("NumaNode"));
    ...
    private static final long NumaNode$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13999:5"), groupElement("NumaNode"));
    ...
    private static final GroupLayout Cache$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$13999:5"), groupElement("Cache"));
    ...
    private static final long Cache$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13999:5"), groupElement("Cache"));
    ...
    private static final SequenceLayout Reserved$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$13999:5"), groupElement("Reserved"));
    ...
    private static final long Reserved$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13999:5"), groupElement("Reserved"));
