...
public class _STORAGE_TEMPERATURE_DATA_DESCRIPTOR {
    ...
    private static final long CriticalTemperature$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalTemperature"));
    ...
    private static final long WarningTemperature$OFFSET = $LAYOUT.byteOffset(groupElement("WarningTemperature"));
    ...
    private static final long InfoCount$OFFSET = $LAYOUT.byteOffset(groupElement("InfoCount"));
    ...
    private static final long TemperatureInfo$OFFSET = $LAYOUT.byteOffset(groupElement("TemperatureInfo"));
    ...
    public static MemorySegment TemperatureInfo(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)TemperatureInfo$ELEM_HANDLE.invokeExact(struct, TemperatureInfo$OFFSET, index0);
