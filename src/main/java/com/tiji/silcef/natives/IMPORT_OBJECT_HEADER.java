...
public class IMPORT_OBJECT_HEADER {
    ...
    private static final OfShort Ordinal$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$22110:5"), groupElement("Ordinal"));
    ...
    private static final long Ordinal$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22110:5"), groupElement("Ordinal"));
    ...
    private static final OfShort Hint$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$22110:5"), groupElement("Hint"));
    ...
    private static final long Hint$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22110:5"), groupElement("Hint"));
