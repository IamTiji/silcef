...
public class _STREAM_LAYOUT_ENTRY {
    ...
    private static final long NextStreamOffset$OFFSET = $LAYOUT.byteOffset(groupElement("NextStreamOffset"));
    ...
    private static final long ExtentInformationOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ExtentInformationOffset"));
    ...
    private static final long StreamInformationOffset$OFFSET = $LAYOUT.byteOffset(groupElement("StreamInformationOffset"));
    ...
    private static final long AttributeTypeCode$OFFSET = $LAYOUT.byteOffset(groupElement("AttributeTypeCode"));
    ...
    private static final long AttributeFlags$OFFSET = $LAYOUT.byteOffset(groupElement("AttributeFlags"));
    ...
    private static final long StreamIdentifierLength$OFFSET = $LAYOUT.byteOffset(groupElement("StreamIdentifierLength"));
    ...
    private static final long StreamIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("StreamIdentifier"));
    ...
    public static short StreamIdentifier(MemorySegment struct, long index0) {
        return (short)StreamIdentifier$ELEM_HANDLE.get(struct, StreamIdentifier$OFFSET, index0);
    }
    ...
    public static void StreamIdentifier(MemorySegment struct, long index0, short fieldValue) {
        StreamIdentifier$ELEM_HANDLE.set(struct, StreamIdentifier$OFFSET, index0, fieldValue);
    }
