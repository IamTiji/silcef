...
public class _SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARA {
    ...
    private static final long rgpszHpkpValue$OFFSET = $LAYOUT.byteOffset(groupElement("rgpszHpkpValue"));
    ...
    public static MemorySegment rgpszHpkpValue(MemorySegment struct, long index0) {
        return (MemorySegment)rgpszHpkpValue$ELEM_HANDLE.get(struct, rgpszHpkpValue$OFFSET, index0);
    }
    ...
    public static void rgpszHpkpValue(MemorySegment struct, long index0, MemorySegment fieldValue) {
        rgpszHpkpValue$ELEM_HANDLE.set(struct, rgpszHpkpValue$OFFSET, index0, fieldValue);
    }
