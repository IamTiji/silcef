...
public class tagENUMLOGFONTEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_SHORT).withName("elfScript")
    ...
    private static final long elfScript$OFFSET = $LAYOUT.byteOffset(groupElement("elfScript"));
    ...
    public static short elfScript(MemorySegment struct, long index0) {
        return (short)elfScript$ELEM_HANDLE.get(struct, elfScript$OFFSET, index0);
    }
    ...
    public static void elfScript(MemorySegment struct, long index0, short fieldValue) {
        elfScript$ELEM_HANDLE.set(struct, elfScript$OFFSET, index0, fieldValue);
    }
