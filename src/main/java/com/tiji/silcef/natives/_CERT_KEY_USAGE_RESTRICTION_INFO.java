...
public class _CERT_KEY_USAGE_RESTRICTION_INFO {
    ...
    private static final long cCertPolicyId$OFFSET = $LAYOUT.byteOffset(groupElement("cCertPolicyId"));
    ...
    private static final long rgCertPolicyId$OFFSET = $LAYOUT.byteOffset(groupElement("rgCertPolicyId"));
    ...
    private static final long RestrictedKeyUsage$OFFSET = $LAYOUT.byteOffset(groupElement("RestrictedKeyUsage"));
