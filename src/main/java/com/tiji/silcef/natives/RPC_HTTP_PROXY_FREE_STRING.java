 ...
 * }
 */
public final class RPC_HTTP_PROXY_FREE_STRING {

    private RPC_HTTP_PROXY_FREE_STRING() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPC_HTTP_PROXY_FREE_STRING.Function.class, "apply", $DESC);
