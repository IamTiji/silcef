...
/**
 * {@snippet lang=c :
 * struct ISupportDoNotElevateServerActivation {
 *     struct ISupportDoNotElevateServerActivationVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportDoNotElevateServerActivation {
    ...
    ).withName("ISupportDoNotElevateServerActivation");
