...
public class _ACL_SIZE_INFORMATION {
    ...
    private static final long AclBytesInUse$OFFSET = $LAYOUT.byteOffset(groupElement("AclBytesInUse"));
    ...
    private static final long AclBytesFree$OFFSET = $LAYOUT.byteOffset(groupElement("AclBytesFree"));
