...
public class _tagCODEBASEHOLD {
    ...
    private static final long szDistUnit$OFFSET = $LAYOUT.byteOffset(groupElement("szDistUnit"));
    ...
    private static final long szCodeBase$OFFSET = $LAYOUT.byteOffset(groupElement("szCodeBase"));
    ...
    private static final long dwVersionMS$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersionMS"));
    ...
    private static final long dwVersionLS$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersionLS"));
