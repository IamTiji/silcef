...
public class tagICEXYZTRIPLE {
    ...
    private static final long ciexyzRed$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzRed"));
    ...
    private static final long ciexyzGreen$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzGreen"));
    ...
    private static final long ciexyzBlue$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzBlue"));
