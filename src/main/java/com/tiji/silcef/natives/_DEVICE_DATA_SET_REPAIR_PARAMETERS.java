...
public class _DEVICE_DATA_SET_REPAIR_PARAMETERS {
    ...
    private static final long NumberOfRepairCopies$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfRepairCopies"));
    ...
    private static final long SourceCopy$OFFSET = $LAYOUT.byteOffset(groupElement("SourceCopy"));
    ...
    private static final long RepairCopies$OFFSET = $LAYOUT.byteOffset(groupElement("RepairCopies"));
    ...
    public static int RepairCopies(MemorySegment struct, long index0) {
        return (int)RepairCopies$ELEM_HANDLE.get(struct, RepairCopies$OFFSET, index0);
    }
    ...
    public static void RepairCopies(MemorySegment struct, long index0, int fieldValue) {
        RepairCopies$ELEM_HANDLE.set(struct, RepairCopies$OFFSET, index0, fieldValue);
    }
