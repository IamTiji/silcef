...
public class _SCONTEXT_QUEUE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("NumberOfObjects"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("ArrayOfObjects")
    ...
    private static final long NumberOfObjects$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfObjects"));
    ...
    private static final long ArrayOfObjects$OFFSET = $LAYOUT.byteOffset(groupElement("ArrayOfObjects"));
