...
public class tagCSPLATFORM {
    ...
    private static final long dwVersionHi$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersionHi"));
    ...
    private static final long dwVersionLo$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersionLo"));
    ...
    private static final long dwProcessorArch$OFFSET = $LAYOUT.byteOffset(groupElement("dwProcessorArch"));
