...
public class READ_USN_JOURNAL_DATA_V1 {
    ...
    private static final long StartUsn$OFFSET = $LAYOUT.byteOffset(groupElement("StartUsn"));
    ...
    private static final long ReasonMask$OFFSET = $LAYOUT.byteOffset(groupElement("ReasonMask"));
    ...
    private static final long ReturnOnlyOnClose$OFFSET = $LAYOUT.byteOffset(groupElement("ReturnOnlyOnClose"));
    ...
    private static final long BytesToWaitFor$OFFSET = $LAYOUT.byteOffset(groupElement("BytesToWaitFor"));
    ...
    private static final long MinMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MinMajorVersion"));
    ...
    private static final long MaxMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MaxMajorVersion"));
