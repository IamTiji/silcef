...
public class _FILE_OBJECTID_BUFFER {
    ...
    public static byte ObjectId(MemorySegment struct, long index0) {
        return (byte)ObjectId$ELEM_HANDLE.get(struct, ObjectId$OFFSET, index0);
    }
    ...
    private static final SequenceLayout BirthVolumeId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("BirthVolumeId"));
    ...
    private static final long BirthVolumeId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("BirthVolumeId"));
    ...
    public static byte BirthVolumeId(MemorySegment struct, long index0) {
        return (byte)BirthVolumeId$ELEM_HANDLE.get(struct, BirthVolumeId$OFFSET, index0);
    }
    ...
    public static void BirthVolumeId(MemorySegment struct, long index0, byte fieldValue) {
        BirthVolumeId$ELEM_HANDLE.set(struct, BirthVolumeId$OFFSET, index0, fieldValue);
    }

    private static final SequenceLayout BirthObjectId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("BirthObjectId"));
    ...
    private static final long BirthObjectId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("BirthObjectId"));
    ...
    public static byte BirthObjectId(MemorySegment struct, long index0) {
        return (byte)BirthObjectId$ELEM_HANDLE.get(struct, BirthObjectId$OFFSET, index0);
    }
    ...
    public static void BirthObjectId(MemorySegment struct, long index0, byte fieldValue) {
        BirthObjectId$ELEM_HANDLE.set(struct, BirthObjectId$OFFSET, index0, fieldValue);
    }

    private static final SequenceLayout DomainId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("DomainId"));
    ...
    private static final long DomainId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12857:5"), groupElement("$anon$12858:9"), groupElement("DomainId"));
    ...
    public static byte DomainId(MemorySegment struct, long index0) {
        return (byte)DomainId$ELEM_HANDLE.get(struct, DomainId$OFFSET, index0);
    }
    ...
    public static void DomainId(MemorySegment struct, long index0, byte fieldValue) {
        DomainId$ELEM_HANDLE.set(struct, DomainId$OFFSET, index0, fieldValue);
    }

    private static final SequenceLayout ExtendedInfo$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12857:5"), groupElement("ExtendedInfo"));
    ...
    private static final long ExtendedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12857:5"), groupElement("ExtendedInfo"));
    ...
    public static byte ExtendedInfo(MemorySegment struct, long index0) {
        return (byte)ExtendedInfo$ELEM_HANDLE.get(struct, ExtendedInfo$OFFSET, index0);
    }
    ...
    public static void ExtendedInfo(MemorySegment struct, long index0, byte fieldValue) {
        ExtendedInfo$ELEM_HANDLE.set(struct, ExtendedInfo$OFFSET, index0, fieldValue);
    }
