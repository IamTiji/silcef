...
public class _BCRYPT_DSA_PARAMETER_HEADER_V2 {
    ...
    private static final long cbLength$OFFSET = $LAYOUT.byteOffset(groupElement("cbLength"));
    ...
    private static final long cbKeyLength$OFFSET = $LAYOUT.byteOffset(groupElement("cbKeyLength"));
