...
/**
 * {@snippet lang=c :
 * struct _CREATEFILE3_EXTENDED_PARAMETERS {
 *     DWORD dwSize;
 ...
 * }
 */
public class _CREATEFILE3_EXTENDED_PARAMETERS {
    ...
    ).withName("_CREATEFILE3_EXTENDED_PARAMETERS");
    ...
    private static final long dwSecurityQosFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwSecurityQosFlags"));
    ...
    private static final long lpSecurityAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("lpSecurityAttributes"));
    ...
    private static final long hTemplateFile$OFFSET = $LAYOUT.byteOffset(groupElement("hTemplateFile"));
