...
public class SYSTEM_BATTERY_STATE {
    ...
    private static final long AcOnLine$OFFSET = $LAYOUT.byteOffset(groupElement("AcOnLine"));
    ...
    private static final long BatteryPresent$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryPresent"));
    ...
    private static final long Charging$OFFSET = $LAYOUT.byteOffset(groupElement("Charging"));
    ...
    private static final long Discharging$OFFSET = $LAYOUT.byteOffset(groupElement("Discharging"));
    ...
    public static byte Spare1(MemorySegment struct, long index0) {
        return (byte)Spare1$ELEM_HANDLE.get(struct, Spare1$OFFSET, index0);
    }
    ...
    public static void Spare1(MemorySegment struct, long index0, byte fieldValue) {
        Spare1$ELEM_HANDLE.set(struct, Spare1$OFFSET, index0, fieldValue);
    }
    ...
    private static final long MaxCapacity$OFFSET = $LAYOUT.byteOffset(groupElement("MaxCapacity"));
    ...
    private static final long RemainingCapacity$OFFSET = $LAYOUT.byteOffset(groupElement("RemainingCapacity"));
    ...
    private static final long EstimatedTime$OFFSET = $LAYOUT.byteOffset(groupElement("EstimatedTime"));
    ...
    private static final long DefaultAlert1$OFFSET = $LAYOUT.byteOffset(groupElement("DefaultAlert1"));
    ...
    private static final long DefaultAlert2$OFFSET = $LAYOUT.byteOffset(groupElement("DefaultAlert2"));
