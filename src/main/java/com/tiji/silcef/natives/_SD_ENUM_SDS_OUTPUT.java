...
public class _SD_ENUM_SDS_OUTPUT {
    ...
    private static final long NumSDEntriesReturned$OFFSET = $LAYOUT.byteOffset(groupElement("NumSDEntriesReturned"));
    ...
    private static final long NumSDBytesReturned$OFFSET = $LAYOUT.byteOffset(groupElement("NumSDBytesReturned"));
    ...
    private static final long SDEntry$OFFSET = $LAYOUT.byteOffset(groupElement("SDEntry"));
    ...
    public static MemorySegment SDEntry(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)SDEntry$ELEM_HANDLE.invokeExact(struct, SDEntry$OFFSET, index0);
