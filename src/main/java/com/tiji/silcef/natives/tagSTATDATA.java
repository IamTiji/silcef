...
public class tagSTATDATA {
    ...
    private static final long formatetc$OFFSET = $LAYOUT.byteOffset(groupElement("formatetc"));
    ...
    private static final long advf$OFFSET = $LAYOUT.byteOffset(groupElement("advf"));
    ...
    private static final long pAdvSink$OFFSET = $LAYOUT.byteOffset(groupElement("pAdvSink"));
    ...
    private static final long dwConnection$OFFSET = $LAYOUT.byteOffset(groupElement("dwConnection"));
