...
public class tagACTCTXW {
    ...
    private static final long lpSource$OFFSET = $LAYOUT.byteOffset(groupElement("lpSource"));
    ...
    private static final long wProcessorArchitecture$OFFSET = $LAYOUT.byteOffset(groupElement("wProcessorArchitecture"));
    ...
    private static final long wLangId$OFFSET = $LAYOUT.byteOffset(groupElement("wLangId"));
    ...
    private static final long lpAssemblyDirectory$OFFSET = $LAYOUT.byteOffset(groupElement("lpAssemblyDirectory"));
    ...
    private static final long lpResourceName$OFFSET = $LAYOUT.byteOffset(groupElement("lpResourceName"));
    ...
    private static final long lpApplicationName$OFFSET = $LAYOUT.byteOffset(groupElement("lpApplicationName"));
    ...
    private static final long hModule$OFFSET = $LAYOUT.byteOffset(groupElement("hModule"));
