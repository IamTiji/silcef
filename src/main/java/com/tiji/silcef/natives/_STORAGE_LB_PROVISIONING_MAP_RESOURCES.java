...
public class _STORAGE_LB_PROVISIONING_MAP_RESOURCES {
    ...
    public static byte Reserved3(MemorySegment struct, long index0) {
        return (byte)Reserved3$ELEM_HANDLE.get(struct, Reserved3$OFFSET, index0);
    }
    ...
    public static void Reserved3(MemorySegment struct, long index0, byte fieldValue) {
        Reserved3$ELEM_HANDLE.set(struct, Reserved3$OFFSET, index0, fieldValue);
    }
    ...
    private static final long AvailableMappingResources$OFFSET = $LAYOUT.byteOffset(groupElement("AvailableMappingResources"));
    ...
    private static final long UsedMappingResources$OFFSET = $LAYOUT.byteOffset(groupElement("UsedMappingResources"));
