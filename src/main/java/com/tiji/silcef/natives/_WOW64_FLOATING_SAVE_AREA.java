...
public class _WOW64_FLOATING_SAVE_AREA {
    ...
    private static final long RegisterArea$OFFSET = $LAYOUT.byteOffset(groupElement("RegisterArea"));
    ...
    public static byte RegisterArea(MemorySegment struct, long index0) {
        return (byte)RegisterArea$ELEM_HANDLE.get(struct, RegisterArea$OFFSET, index0);
    }
    ...
    public static void RegisterArea(MemorySegment struct, long index0, byte fieldValue) {
        RegisterArea$ELEM_HANDLE.set(struct, RegisterArea$OFFSET, index0, fieldValue);
    }
    ...
    private static final long Cr0NpxState$OFFSET = $LAYOUT.byteOffset(groupElement("Cr0NpxState"));
