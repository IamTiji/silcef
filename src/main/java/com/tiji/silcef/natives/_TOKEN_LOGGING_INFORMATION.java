...
public class _TOKEN_LOGGING_INFORMATION {
    ...
    private static final long TokenElevation$OFFSET = $LAYOUT.byteOffset(groupElement("TokenElevation"));
    ...
    private static final long TokenElevationType$OFFSET = $LAYOUT.byteOffset(groupElement("TokenElevationType"));
    ...
    private static final long IntegrityLevel$OFFSET = $LAYOUT.byteOffset(groupElement("IntegrityLevel"));
    ...
    private static final long GroupsLength$OFFSET = $LAYOUT.byteOffset(groupElement("GroupsLength"));
