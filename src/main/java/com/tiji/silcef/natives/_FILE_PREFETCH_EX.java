...
public class _FILE_PREFETCH_EX {
    ...
    private static final long Prefetch$OFFSET = $LAYOUT.byteOffset(groupElement("Prefetch"));
    ...
    public static long Prefetch(MemorySegment struct, long index0) {
        return (long)Prefetch$ELEM_HANDLE.get(struct, Prefetch$OFFSET, index0);
    }
    ...
    public static void Prefetch(MemorySegment struct, long index0, long fieldValue) {
        Prefetch$ELEM_HANDLE.set(struct, Prefetch$OFFSET, index0, fieldValue);
    }
