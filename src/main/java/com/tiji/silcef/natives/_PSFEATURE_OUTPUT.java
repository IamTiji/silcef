...
public class _PSFEATURE_OUTPUT {
    ...
    private static final long bPageIndependent$OFFSET = $LAYOUT.byteOffset(groupElement("bPageIndependent"));
    ...
    private static final long bSetPageDevice$OFFSET = $LAYOUT.byteOffset(groupElement("bSetPageDevice"));
