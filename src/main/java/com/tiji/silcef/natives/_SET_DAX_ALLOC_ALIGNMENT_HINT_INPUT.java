...
public class _SET_DAX_ALLOC_ALIGNMENT_HINT_INPUT {
    ...
    private static final long AlignmentShift$OFFSET = $LAYOUT.byteOffset(groupElement("AlignmentShift"));
    ...
    private static final long FileOffsetToAlign$OFFSET = $LAYOUT.byteOffset(groupElement("FileOffsetToAlign"));
    ...
    private static final long FallbackAlignmentShift$OFFSET = $LAYOUT.byteOffset(groupElement("FallbackAlignmentShift"));
