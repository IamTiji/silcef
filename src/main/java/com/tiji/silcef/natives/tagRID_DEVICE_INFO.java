...
public class tagRID_DEVICE_INFO {
    ...
    private static final GroupLayout mouse$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15261:5"), groupElement("mouse"));
    ...
    private static final long mouse$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15261:5"), groupElement("mouse"));
    ...
    private static final GroupLayout keyboard$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15261:5"), groupElement("keyboard"));
    ...
    private static final long keyboard$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15261:5"), groupElement("keyboard"));
    ...
    private static final GroupLayout hid$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15261:5"), groupElement("hid"));
    ...
    private static final long hid$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15261:5"), groupElement("hid"));
