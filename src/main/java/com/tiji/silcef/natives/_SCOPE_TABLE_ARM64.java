...
public class _SCOPE_TABLE_ARM64 {
    ...
    public static class ScopeRecord {
        ...
        private static final long HandlerAddress$OFFSET = $LAYOUT.byteOffset(groupElement("HandlerAddress"));
        ...
        private static final long JumpTarget$OFFSET = $LAYOUT.byteOffset(groupElement("JumpTarget"));
    ...
    private static final long ScopeRecord$OFFSET = $LAYOUT.byteOffset(groupElement("ScopeRecord"));
    ...
    public static MemorySegment ScopeRecord(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)ScopeRecord$ELEM_HANDLE.invokeExact(struct, ScopeRecord$OFFSET, index0);
