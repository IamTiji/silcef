...
public class _REFS_SMR_VOLUME_INFO_OUTPUT {
    ...
    private static final long SizeOfRandomlyWritableTier$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfRandomlyWritableTier"));
    ...
    private static final long FreeSpaceInRandomlyWritableTier$OFFSET = $LAYOUT.byteOffset(groupElement("FreeSpaceInRandomlyWritableTier"));
    ...
    private static final long SizeofSMRTier$OFFSET = $LAYOUT.byteOffset(groupElement("SizeofSMRTier"));
    ...
    private static final long FreeSpaceInSMRTier$OFFSET = $LAYOUT.byteOffset(groupElement("FreeSpaceInSMRTier"));
    ...
    private static final long UsableFreeSpaceInSMRTier$OFFSET = $LAYOUT.byteOffset(groupElement("UsableFreeSpaceInSMRTier"));
    ...
    private static final long VolumeGcState$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeGcState"));
    ...
    private static final long VolumeGcLastStatus$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeGcLastStatus"));
    ...
    private static final long CurrentGcBandFillPercentage$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentGcBandFillPercentage"));
    ...
    public static long Unused(MemorySegment struct, long index0) {
        return (long)Unused$ELEM_HANDLE.get(struct, Unused$OFFSET, index0);
    }
    ...
    public static void Unused(MemorySegment struct, long index0, long fieldValue) {
        Unused$ELEM_HANDLE.set(struct, Unused$OFFSET, index0, fieldValue);
    }
