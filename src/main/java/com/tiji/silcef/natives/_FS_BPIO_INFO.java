...
public class _FS_BPIO_INFO {
    ...
    private static final long ActiveBypassIoCount$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveBypassIoCount"));
    ...
    private static final long StorageDriverNameLen$OFFSET = $LAYOUT.byteOffset(groupElement("StorageDriverNameLen"));
    ...
    private static final long StorageDriverName$OFFSET = $LAYOUT.byteOffset(groupElement("StorageDriverName"));
    ...
    public static short StorageDriverName(MemorySegment struct, long index0) {
        return (short)StorageDriverName$ELEM_HANDLE.get(struct, StorageDriverName$OFFSET, index0);
    }
    ...
    public static void StorageDriverName(MemorySegment struct, long index0, short fieldValue) {
        StorageDriverName$ELEM_HANDLE.set(struct, StorageDriverName$OFFSET, index0, fieldValue);
    }
