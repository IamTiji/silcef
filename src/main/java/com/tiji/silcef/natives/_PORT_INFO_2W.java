...
public class _PORT_INFO_2W {
    ...
    private static final long pDescription$OFFSET = $LAYOUT.byteOffset(groupElement("pDescription"));
    ...
    private static final long fPortType$OFFSET = $LAYOUT.byteOffset(groupElement("fPortType"));
