...
public class _IMAGE_NT_HEADERS64 {
    ...
    private static final long FileHeader$OFFSET = $LAYOUT.byteOffset(groupElement("FileHeader"));
    ...
    private static final long OptionalHeader$OFFSET = $LAYOUT.byteOffset(groupElement("OptionalHeader"));
