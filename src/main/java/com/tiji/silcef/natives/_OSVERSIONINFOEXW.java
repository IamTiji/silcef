...
public class _OSVERSIONINFOEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("szCSDVersion"),
    ...
    private static final long dwOSVersionInfoSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwOSVersionInfoSize"));
    ...
    private static final long dwMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwMajorVersion"));
    ...
    private static final long dwMinorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwMinorVersion"));
    ...
    private static final long dwBuildNumber$OFFSET = $LAYOUT.byteOffset(groupElement("dwBuildNumber"));
    ...
    private static final long dwPlatformId$OFFSET = $LAYOUT.byteOffset(groupElement("dwPlatformId"));
    ...
    private static final long szCSDVersion$OFFSET = $LAYOUT.byteOffset(groupElement("szCSDVersion"));
    ...
    public static short szCSDVersion(MemorySegment struct, long index0) {
        return (short)szCSDVersion$ELEM_HANDLE.get(struct, szCSDVersion$OFFSET, index0);
    }
    ...
    public static void szCSDVersion(MemorySegment struct, long index0, short fieldValue) {
        szCSDVersion$ELEM_HANDLE.set(struct, szCSDVersion$OFFSET, index0, fieldValue);
    }
    ...
    private static final long wServicePackMajor$OFFSET = $LAYOUT.byteOffset(groupElement("wServicePackMajor"));
    ...
    private static final long wServicePackMinor$OFFSET = $LAYOUT.byteOffset(groupElement("wServicePackMinor"));
    ...
    private static final long wSuiteMask$OFFSET = $LAYOUT.byteOffset(groupElement("wSuiteMask"));
    ...
    private static final long wProductType$OFFSET = $LAYOUT.byteOffset(groupElement("wProductType"));
