...
public class _OCSP_BASIC_RESPONSE_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("dwCertStatus"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            cef_render_handler_capi_h.C_POINTER.withName("pRevokedInfo")
        ).withName("$anon$5773:5"),
    ...
    private static final long CertId$OFFSET = $LAYOUT.byteOffset(groupElement("CertId"));
    ...
    private static final long dwCertStatus$OFFSET = $LAYOUT.byteOffset(groupElement("dwCertStatus"));
    ...
    private static final AddressLayout pRevokedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5773:5"), groupElement("pRevokedInfo"));
    ...
    private static final long pRevokedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5773:5"), groupElement("pRevokedInfo"));
