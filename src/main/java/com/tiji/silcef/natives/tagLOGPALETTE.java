...
public class tagLOGPALETTE {
    ...
    private static final long palVersion$OFFSET = $LAYOUT.byteOffset(groupElement("palVersion"));
    ...
    private static final long palNumEntries$OFFSET = $LAYOUT.byteOffset(groupElement("palNumEntries"));
    ...
    private static final long palPalEntry$OFFSET = $LAYOUT.byteOffset(groupElement("palPalEntry"));
    ...
    public static MemorySegment palPalEntry(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)palPalEntry$ELEM_HANDLE.invokeExact(struct, palPalEntry$OFFSET, index0);
