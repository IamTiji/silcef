 ...
 * }
 */
public final class PM_CLOSE_PROC {

    private PM_CLOSE_PROC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PM_CLOSE_PROC.Function.class, "apply", $DESC);
