...
public class _REPARSE_GUID_DATA_BUFFER {
    ...
    private static final long ReparseDataLength$OFFSET = $LAYOUT.byteOffset(groupElement("ReparseDataLength"));
    ...
    private static final long ReparseGuid$OFFSET = $LAYOUT.byteOffset(groupElement("ReparseGuid"));
    ...
    public static class GenericReparseBuffer {
        ...
        private static final long DataBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("DataBuffer"));
        ...
        public static byte DataBuffer(MemorySegment struct, long index0) {
            return (byte)DataBuffer$ELEM_HANDLE.get(struct, DataBuffer$OFFSET, index0);
        }
        ...
        public static void DataBuffer(MemorySegment struct, long index0, byte fieldValue) {
            DataBuffer$ELEM_HANDLE.set(struct, DataBuffer$OFFSET, index0, fieldValue);
        }
    ...
    private static final long GenericReparseBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("GenericReparseBuffer"));
