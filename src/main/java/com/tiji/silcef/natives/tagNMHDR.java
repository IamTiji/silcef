...
public class tagNMHDR {
    ...
    private static final long hwndFrom$OFFSET = $LAYOUT.byteOffset(groupElement("hwndFrom"));
    ...
    private static final long idFrom$OFFSET = $LAYOUT.byteOffset(groupElement("idFrom"));
