...
public class _STORAGE_READ_CAPACITY {
    ...
    private static final long BlockLength$OFFSET = $LAYOUT.byteOffset(groupElement("BlockLength"));
    ...
    private static final long NumberOfBlocks$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfBlocks"));
    ...
    private static final long DiskLength$OFFSET = $LAYOUT.byteOffset(groupElement("DiskLength"));
