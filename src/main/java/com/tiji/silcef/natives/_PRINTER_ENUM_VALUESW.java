...
public class _PRINTER_ENUM_VALUESW {
    ...
    private static final long pValueName$OFFSET = $LAYOUT.byteOffset(groupElement("pValueName"));
    ...
    private static final long cbValueName$OFFSET = $LAYOUT.byteOffset(groupElement("cbValueName"));
