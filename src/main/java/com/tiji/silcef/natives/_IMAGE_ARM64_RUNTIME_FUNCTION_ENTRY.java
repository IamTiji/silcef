...
public class _IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$21724:9")
        ).withName("$anon$21722:5")
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21722:5"), groupElement("UnwindData"));
    ...
    private static final long UnwindData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21722:5"), groupElement("UnwindData"));
