...
public class ALLOC_CONSOLE_OPTIONS {
    ...
    private static final long useShowWindow$OFFSET = $LAYOUT.byteOffset(groupElement("useShowWindow"));
    ...
    private static final long showWindow$OFFSET = $LAYOUT.byteOffset(groupElement("showWindow"));
