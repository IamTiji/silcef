...
public class tagWINDOWINFO {
    ...
    private static final long rcWindow$OFFSET = $LAYOUT.byteOffset(groupElement("rcWindow"));
    ...
    private static final long rcClient$OFFSET = $LAYOUT.byteOffset(groupElement("rcClient"));
    ...
    private static final long dwStyle$OFFSET = $LAYOUT.byteOffset(groupElement("dwStyle"));
    ...
    private static final long dwExStyle$OFFSET = $LAYOUT.byteOffset(groupElement("dwExStyle"));
    ...
    private static final long dwWindowStatus$OFFSET = $LAYOUT.byteOffset(groupElement("dwWindowStatus"));
    ...
    private static final long cxWindowBorders$OFFSET = $LAYOUT.byteOffset(groupElement("cxWindowBorders"));
    ...
    private static final long cyWindowBorders$OFFSET = $LAYOUT.byteOffset(groupElement("cyWindowBorders"));
    ...
    private static final long atomWindowType$OFFSET = $LAYOUT.byteOffset(groupElement("atomWindowType"));
    ...
    private static final long wCreatorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("wCreatorVersion"));
