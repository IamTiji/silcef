...
public class _WIN32_STREAM_ID {
    ...
    private static final long dwStreamId$OFFSET = $LAYOUT.byteOffset(groupElement("dwStreamId"));
    ...
    private static final long dwStreamAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("dwStreamAttributes"));
    ...
    private static final long dwStreamNameSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwStreamNameSize"));
    ...
    private static final long cStreamName$OFFSET = $LAYOUT.byteOffset(groupElement("cStreamName"));
    ...
    public static short cStreamName(MemorySegment struct, long index0) {
        return (short)cStreamName$ELEM_HANDLE.get(struct, cStreamName$OFFSET, index0);
    }
    ...
    public static void cStreamName(MemorySegment struct, long index0, short fieldValue) {
        cStreamName$ELEM_HANDLE.set(struct, cStreamName$OFFSET, index0, fieldValue);
    }
