...
public class _PROCESSOR_POWER_POLICY_INFO {
    ...
    private static final long DemoteLimit$OFFSET = $LAYOUT.byteOffset(groupElement("DemoteLimit"));
    ...
    private static final long PromoteLimit$OFFSET = $LAYOUT.byteOffset(groupElement("PromoteLimit"));
    ...
    public static byte Spare(MemorySegment struct, long index0) {
        return (byte)Spare$ELEM_HANDLE.get(struct, Spare$OFFSET, index0);
    }
    ...
    public static void Spare(MemorySegment struct, long index0, byte fieldValue) {
        Spare$ELEM_HANDLE.set(struct, Spare$OFFSET, index0, fieldValue);
    }
