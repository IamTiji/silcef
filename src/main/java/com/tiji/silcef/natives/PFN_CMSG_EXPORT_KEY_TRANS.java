 ...
 * }
 */
public final class PFN_CMSG_EXPORT_KEY_TRANS {

    private PFN_CMSG_EXPORT_KEY_TRANS() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CMSG_EXPORT_KEY_TRANS.Function.class, "apply", $DESC);
