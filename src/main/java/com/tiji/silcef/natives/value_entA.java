...
public class value_entA {
    ...
    private static final long ve_valuename$OFFSET = $LAYOUT.byteOffset(groupElement("ve_valuename"));
    ...
    private static final long ve_valuelen$OFFSET = $LAYOUT.byteOffset(groupElement("ve_valuelen"));
    ...
    private static final long ve_valueptr$OFFSET = $LAYOUT.byteOffset(groupElement("ve_valueptr"));
    ...
    private static final long ve_type$OFFSET = $LAYOUT.byteOffset(groupElement("ve_type"));
