...
public class _NT_TIB {
    ...
    private static final AddressLayout FiberData$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12775:5"), groupElement("FiberData"));
    ...
    private static final long FiberData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12775:5"), groupElement("FiberData"));
    ...
    private static final OfInt Version$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12775:5"), groupElement("Version"));
    ...
    private static final long Version$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12775:5"), groupElement("Version"));
