...
public class _SCM_PD_MANAGEMENT_STATUS {
    ...
    private static final long Health$OFFSET = $LAYOUT.byteOffset(groupElement("Health"));
    ...
    private static final long NumberOfOperationalStatus$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfOperationalStatus"));
    ...
    private static final long NumberOfAdditionalReasons$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfAdditionalReasons"));
    ...
    private static final long OperationalStatus$OFFSET = $LAYOUT.byteOffset(groupElement("OperationalStatus"));
    ...
    public static int OperationalStatus(MemorySegment struct, long index0) {
        return (int)OperationalStatus$ELEM_HANDLE.get(struct, OperationalStatus$OFFSET, index0);
    }
    ...
    public static void OperationalStatus(MemorySegment struct, long index0, int fieldValue) {
        OperationalStatus$ELEM_HANDLE.set(struct, OperationalStatus$OFFSET, index0, fieldValue);
    }
    ...
    private static final long AdditionalReasons$OFFSET = $LAYOUT.byteOffset(groupElement("AdditionalReasons"));
    ...
    public static int AdditionalReasons(MemorySegment struct, long index0) {
        return (int)AdditionalReasons$ELEM_HANDLE.get(struct, AdditionalReasons$OFFSET, index0);
    }
    ...
    public static void AdditionalReasons(MemorySegment struct, long index0, int fieldValue) {
        AdditionalReasons$ELEM_HANDLE.set(struct, AdditionalReasons$OFFSET, index0, fieldValue);
    }
