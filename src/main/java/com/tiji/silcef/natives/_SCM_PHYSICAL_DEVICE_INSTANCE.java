...
public class _SCM_PHYSICAL_DEVICE_INSTANCE {
    ...
    private static final long SymbolicLink$OFFSET = $LAYOUT.byteOffset(groupElement("SymbolicLink"));
    ...
    public static short SymbolicLink(MemorySegment struct, long index0) {
        return (short)SymbolicLink$ELEM_HANDLE.get(struct, SymbolicLink$OFFSET, index0);
    }
    ...
    public static void SymbolicLink(MemorySegment struct, long index0, short fieldValue) {
        SymbolicLink$ELEM_HANDLE.set(struct, SymbolicLink$OFFSET, index0, fieldValue);
    }
