...
public class _STORAGE_OFFLOAD_TOKEN {
    ...
    private static final long TokenType$OFFSET = $LAYOUT.byteOffset(groupElement("TokenType"));
    ...
    public static byte TokenType(MemorySegment struct, long index0) {
        return (byte)TokenType$ELEM_HANDLE.get(struct, TokenType$OFFSET, index0);
    }
    ...
    public static void TokenType(MemorySegment struct, long index0, byte fieldValue) {
        TokenType$ELEM_HANDLE.set(struct, TokenType$OFFSET, index0, fieldValue);
    }
    ...
    private static final long TokenIdLength$OFFSET = $LAYOUT.byteOffset(groupElement("TokenIdLength"));
    ...
    public static byte TokenIdLength(MemorySegment struct, long index0) {
        return (byte)TokenIdLength$ELEM_HANDLE.get(struct, TokenIdLength$OFFSET, index0);
    }
    ...
    public static void TokenIdLength(MemorySegment struct, long index0, byte fieldValue) {
        TokenIdLength$ELEM_HANDLE.set(struct, TokenIdLength$OFFSET, index0, fieldValue);
    }
    ...
    public static class StorageOffloadZeroDataToken {
        ...
        public static byte Reserved2(MemorySegment struct, long index0) {
            return (byte)Reserved2$ELEM_HANDLE.get(struct, Reserved2$OFFSET, index0);
        }
    ...
    private static final GroupLayout StorageOffloadZeroDataToken$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3890:5"), groupElement("StorageOffloadZeroDataToken"));
    ...
    private static final long StorageOffloadZeroDataToken$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3890:5"), groupElement("StorageOffloadZeroDataToken"));
    ...
    private static final SequenceLayout Token$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$3890:5"), groupElement("Token"));
    ...
    private static final long Token$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3890:5"), groupElement("Token"));
    ...
    public static byte Token(MemorySegment struct, long index0) {
        return (byte)Token$ELEM_HANDLE.get(struct, Token$OFFSET, index0);
    }
    ...
    public static void Token(MemorySegment struct, long index0, byte fieldValue) {
        Token$ELEM_HANDLE.set(struct, Token$OFFSET, index0, fieldValue);
    }
