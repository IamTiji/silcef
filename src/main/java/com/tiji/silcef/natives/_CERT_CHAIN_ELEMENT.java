...
public class _CERT_CHAIN_ELEMENT {
    ...
    private static final long pCertContext$OFFSET = $LAYOUT.byteOffset(groupElement("pCertContext"));
    ...
    private static final long pRevocationInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pRevocationInfo"));
    ...
    private static final long pIssuanceUsage$OFFSET = $LAYOUT.byteOffset(groupElement("pIssuanceUsage"));
    ...
    private static final long pApplicationUsage$OFFSET = $LAYOUT.byteOffset(groupElement("pApplicationUsage"));
    ...
    private static final long pwszExtendedErrorInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pwszExtendedErrorInfo"));
