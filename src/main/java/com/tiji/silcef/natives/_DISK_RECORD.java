...
public class _DISK_RECORD {
    ...
    private static final long ByteOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ByteOffset"));
    ...
    private static final long NumberOfBytes$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfBytes"));
    ...
    private static final long DeviceNumber$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceNumber"));
    ...
    private static final long ReadRequest$OFFSET = $LAYOUT.byteOffset(groupElement("ReadRequest"));
