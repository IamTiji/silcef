...
public class _DISK_PARTITION_INFO {
    ...
    private static final long SizeOfPartitionInfo$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfPartitionInfo"));
    ...
    private static final GroupLayout Mbr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9761:9"), groupElement("Mbr"));
    ...
    private static final long Mbr$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9761:9"), groupElement("Mbr"));
    ...
    public static class Gpt {
        ...
        private static final long DiskId$OFFSET = $LAYOUT.byteOffset(groupElement("DiskId"));
    ...
    private static final GroupLayout Gpt$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9761:9"), groupElement("Gpt"));
    ...
    private static final long Gpt$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9761:9"), groupElement("Gpt"));
