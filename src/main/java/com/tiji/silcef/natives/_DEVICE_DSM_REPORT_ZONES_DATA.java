...
public class _DEVICE_DSM_REPORT_ZONES_DATA {
    ...
    private static final long ZoneDescriptors$OFFSET = $LAYOUT.byteOffset(groupElement("ZoneDescriptors"));
    ...
    public static MemorySegment ZoneDescriptors(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)ZoneDescriptors$ELEM_HANDLE.invokeExact(struct, ZoneDescriptors$OFFSET, index0);
