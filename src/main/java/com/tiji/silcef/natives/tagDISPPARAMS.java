...
public class tagDISPPARAMS {
    ...
    private static final long rgvarg$OFFSET = $LAYOUT.byteOffset(groupElement("rgvarg"));
    ...
    private static final long rgdispidNamedArgs$OFFSET = $LAYOUT.byteOffset(groupElement("rgdispidNamedArgs"));
    ...
    private static final long cNamedArgs$OFFSET = $LAYOUT.byteOffset(groupElement("cNamedArgs"));
