...
public class tagACCEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_CHAR.withName("fVirt"),
        MemoryLayout.paddingLayout(1),
        cef_render_handler_capi_h.C_SHORT.withName("key"),
        cef_render_handler_capi_h.C_SHORT.withName("cmd")
    ).withName("tagACCEL");
    ...
    private static final long fVirt$OFFSET = $LAYOUT.byteOffset(groupElement("fVirt"));
    ...
    private static final long cmd$OFFSET = $LAYOUT.byteOffset(groupElement("cmd"));
