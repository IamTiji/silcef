...
public class _APPLICATIONLAUNCH_SETTING_VALUE {
    ...
    private static final long ActivationTime$OFFSET = $LAYOUT.byteOffset(groupElement("ActivationTime"));
    ...
    private static final long ButtonInstanceID$OFFSET = $LAYOUT.byteOffset(groupElement("ButtonInstanceID"));
