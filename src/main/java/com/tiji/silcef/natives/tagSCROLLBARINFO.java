...
public class tagSCROLLBARINFO {
    ...
    private static final long rcScrollBar$OFFSET = $LAYOUT.byteOffset(groupElement("rcScrollBar"));
    ...
    private static final long dxyLineButton$OFFSET = $LAYOUT.byteOffset(groupElement("dxyLineButton"));
    ...
    private static final long xyThumbTop$OFFSET = $LAYOUT.byteOffset(groupElement("xyThumbTop"));
    ...
    private static final long xyThumbBottom$OFFSET = $LAYOUT.byteOffset(groupElement("xyThumbBottom"));
    ...
    private static final long rgstate$OFFSET = $LAYOUT.byteOffset(groupElement("rgstate"));
    ...
    public static int rgstate(MemorySegment struct, long index0) {
        return (int)rgstate$ELEM_HANDLE.get(struct, rgstate$OFFSET, index0);
    }
    ...
    public static void rgstate(MemorySegment struct, long index0, int fieldValue) {
        rgstate$ELEM_HANDLE.set(struct, rgstate$OFFSET, index0, fieldValue);
    }
