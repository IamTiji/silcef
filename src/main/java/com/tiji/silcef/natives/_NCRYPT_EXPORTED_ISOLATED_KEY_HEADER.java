...
public class _NCRYPT_EXPORTED_ISOLATED_KEY_HEADER {
    ...
    private static final long KeyUsage$OFFSET = $LAYOUT.byteOffset(groupElement("KeyUsage"));
    ...
    private static final long cbAlgName$OFFSET = $LAYOUT.byteOffset(groupElement("cbAlgName"));
    ...
    private static final long cbAuthTag$OFFSET = $LAYOUT.byteOffset(groupElement("cbAuthTag"));
    ...
    private static final long cbWrappingKey$OFFSET = $LAYOUT.byteOffset(groupElement("cbWrappingKey"));
    ...
    private static final long cbIsolatedKey$OFFSET = $LAYOUT.byteOffset(groupElement("cbIsolatedKey"));
