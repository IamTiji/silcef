...
public class tagFILTERKEYS {
    ...
    private static final long iWaitMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iWaitMSec"));
    ...
    private static final long iDelayMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iDelayMSec"));
    ...
    private static final long iRepeatMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iRepeatMSec"));
    ...
    private static final long iBounceMSec$OFFSET = $LAYOUT.byteOffset(groupElement("iBounceMSec"));
