...
public class _ENCLAVE_CREATE_INFO_SGX {
    ...
    private static final long Secs$OFFSET = $LAYOUT.byteOffset(groupElement("Secs"));
    ...
    public static byte Secs(MemorySegment struct, long index0) {
        return (byte)Secs$ELEM_HANDLE.get(struct, Secs$OFFSET, index0);
    }
    ...
    public static void Secs(MemorySegment struct, long index0, byte fieldValue) {
        Secs$ELEM_HANDLE.set(struct, Secs$OFFSET, index0, fieldValue);
    }
