...
public class tagCONVCONTEXT {
    ...
    private static final long wCountryID$OFFSET = $LAYOUT.byteOffset(groupElement("wCountryID"));
    ...
    private static final long iCodePage$OFFSET = $LAYOUT.byteOffset(groupElement("iCodePage"));
    ...
    private static final long dwLangID$OFFSET = $LAYOUT.byteOffset(groupElement("dwLangID"));
    ...
    private static final long dwSecurity$OFFSET = $LAYOUT.byteOffset(groupElement("dwSecurity"));
    ...
    private static final long qos$OFFSET = $LAYOUT.byteOffset(groupElement("qos"));
