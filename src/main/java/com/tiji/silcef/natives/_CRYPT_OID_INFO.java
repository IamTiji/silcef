...
public class _CRYPT_OID_INFO {
    ...
    private static final long pszOID$OFFSET = $LAYOUT.byteOffset(groupElement("pszOID"));
    ...
    private static final long pwszName$OFFSET = $LAYOUT.byteOffset(groupElement("pwszName"));
    ...
    private static final long dwGroupId$OFFSET = $LAYOUT.byteOffset(groupElement("dwGroupId"));
    ...
    private static final OfInt dwValue$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6364:5"), groupElement("dwValue"));
    ...
    private static final long dwValue$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6364:5"), groupElement("dwValue"));
    ...
    private static final OfInt Algid$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6364:5"), groupElement("Algid"));
    ...
    private static final long Algid$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6364:5"), groupElement("Algid"));
    ...
    private static final OfInt dwLength$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$6364:5"), groupElement("dwLength"));
    ...
    private static final long dwLength$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6364:5"), groupElement("dwLength"));
    ...
    private static final long ExtraInfo$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraInfo"));
