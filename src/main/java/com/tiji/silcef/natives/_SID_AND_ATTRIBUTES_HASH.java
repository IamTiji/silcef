...
public class _SID_AND_ATTRIBUTES_HASH {
    ...
    private static final long SidAttr$OFFSET = $LAYOUT.byteOffset(groupElement("SidAttr"));
    ...
    public static long Hash(MemorySegment struct, long index0) {
        return (long)Hash$ELEM_HANDLE.get(struct, Hash$OFFSET, index0);
    }
    ...
    public static void Hash(MemorySegment struct, long index0, long fieldValue) {
        Hash$ELEM_HANDLE.set(struct, Hash$OFFSET, index0, fieldValue);
    }
