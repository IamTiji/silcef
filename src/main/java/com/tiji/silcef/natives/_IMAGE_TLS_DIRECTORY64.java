...
public class _IMAGE_TLS_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG_LONG, 4).withName("StartAddressOfRawData"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG_LONG, 4).withName("EndAddressOfRawData"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG_LONG, 4).withName("AddressOfIndex"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG_LONG, 4).withName("AddressOfCallBacks"),
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$21035:9")
        ).withName("$anon$21033:5")
    ...
    private static final long StartAddressOfRawData$OFFSET = $LAYOUT.byteOffset(groupElement("StartAddressOfRawData"));
    ...
    private static final long EndAddressOfRawData$OFFSET = $LAYOUT.byteOffset(groupElement("EndAddressOfRawData"));
    ...
    private static final long AddressOfIndex$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfIndex"));
    ...
    private static final long AddressOfCallBacks$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfCallBacks"));
    ...
    private static final long SizeOfZeroFill$OFFSET = $LAYOUT.byteOffset(groupElement("SizeOfZeroFill"));
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21033:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21033:5"), groupElement("Characteristics"));
