...
public class _cpinfoexW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_SHORT).withName("CodePageName")
    ).withName("_cpinfoexW");
    ...
    private static final long MaxCharSize$OFFSET = $LAYOUT.byteOffset(groupElement("MaxCharSize"));
    ...
    private static final long DefaultChar$OFFSET = $LAYOUT.byteOffset(groupElement("DefaultChar"));
    ...
    public static byte DefaultChar(MemorySegment struct, long index0) {
        return (byte)DefaultChar$ELEM_HANDLE.get(struct, DefaultChar$OFFSET, index0);
    }
    ...
    public static void DefaultChar(MemorySegment struct, long index0, byte fieldValue) {
        DefaultChar$ELEM_HANDLE.set(struct, DefaultChar$OFFSET, index0, fieldValue);
    }
    ...
    private static final long LeadByte$OFFSET = $LAYOUT.byteOffset(groupElement("LeadByte"));
    ...
    public static byte LeadByte(MemorySegment struct, long index0) {
        return (byte)LeadByte$ELEM_HANDLE.get(struct, LeadByte$OFFSET, index0);
    }
    ...
    public static void LeadByte(MemorySegment struct, long index0, byte fieldValue) {
        LeadByte$ELEM_HANDLE.set(struct, LeadByte$OFFSET, index0, fieldValue);
    }
    ...
    private static final long UnicodeDefaultChar$OFFSET = $LAYOUT.byteOffset(groupElement("UnicodeDefaultChar"));
    ...
    private static final long CodePageName$OFFSET = $LAYOUT.byteOffset(groupElement("CodePageName"));
    ...
    public static short CodePageName(MemorySegment struct, long index0) {
        return (short)CodePageName$ELEM_HANDLE.get(struct, CodePageName$OFFSET, index0);
    }
    ...
    public static void CodePageName(MemorySegment struct, long index0, short fieldValue) {
        CodePageName$ELEM_HANDLE.set(struct, CodePageName$OFFSET, index0, fieldValue);
    }
