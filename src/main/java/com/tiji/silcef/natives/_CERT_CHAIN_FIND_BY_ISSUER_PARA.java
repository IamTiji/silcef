...
public class _CERT_CHAIN_FIND_BY_ISSUER_PARA {
    ...
    private static final long pszUsageIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("pszUsageIdentifier"));
    ...
    private static final long dwAcquirePrivateKeyFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwAcquirePrivateKeyFlags"));
    ...
    private static final long cIssuer$OFFSET = $LAYOUT.byteOffset(groupElement("cIssuer"));
    ...
    private static final long rgIssuer$OFFSET = $LAYOUT.byteOffset(groupElement("rgIssuer"));
    ...
    private static final long pfnFindCallback$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFindCallback"));
    ...
    private static final long pvFindArg$OFFSET = $LAYOUT.byteOffset(groupElement("pvFindArg"));
