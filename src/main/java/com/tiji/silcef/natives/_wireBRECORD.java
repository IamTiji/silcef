...
public class _wireBRECORD {
    ...
    private static final long pRecInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pRecInfo"));
    ...
    private static final long pRecord$OFFSET = $LAYOUT.byteOffset(groupElement("pRecord"));
