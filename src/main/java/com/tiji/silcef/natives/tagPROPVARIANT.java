    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                ...
                cef_master_h.C_SHORT.withName("wReserved2"),
                cef_master_h.C_SHORT.withName("wReserved3"),
                MemoryLayout.unionLayout(
                    cef_master_h.C_CHAR.withName("cVal"),
                    cef_master_h.C_CHAR.withName("bVal"),
                    cef_master_h.C_SHORT.withName("iVal"),
                    cef_master_h.C_SHORT.withName("uiVal"),
                    cef_master_h.C_LONG.withName("lVal"),
                    cef_master_h.C_LONG.withName("ulVal"),
                    cef_master_h.C_INT.withName("intVal"),
                    cef_master_h.C_INT.withName("uintVal"),
                    _LARGE_INTEGER.layout().withName("hVal"),
                    _ULARGE_INTEGER.layout().withName("uhVal"),
                    cef_master_h.C_FLOAT.withName("fltVal"),
                    cef_master_h.C_DOUBLE.withName("dblVal"),
                    cef_master_h.C_SHORT.withName("boolVal"),
                    cef_master_h.C_SHORT.withName("__OBSOLETE__VARIANT_BOOL"),
                    cef_master_h.C_LONG.withName("scode"),
                    tagCY.layout().withName("cyVal"),
                    cef_master_h.C_DOUBLE.withName("date"),
                    _FILETIME.layout().withName("filetime"),
                    cef_master_h.C_POINTER.withName("puuid"),
                    cef_master_h.C_POINTER.withName("pclipdata"),
                    cef_master_h.C_POINTER.withName("bstrVal"),
                    tagBSTRBLOB.layout().withName("bstrblobVal"),
                    tagBLOB.layout().withName("blob"),
                    cef_master_h.C_POINTER.withName("pszVal"),
                    cef_master_h.C_POINTER.withName("pwszVal"),
                    cef_master_h.C_POINTER.withName("punkVal"),
                    cef_master_h.C_POINTER.withName("pdispVal"),
                    cef_master_h.C_POINTER.withName("pStream"),
                    cef_master_h.C_POINTER.withName("pStorage"),
                    cef_master_h.C_POINTER.withName("pVersionedStream"),
                    cef_master_h.C_POINTER.withName("parray"),
                    ...
                    cef_master_h.C_POINTER.withName("pcVal"),
                    cef_master_h.C_POINTER.withName("pbVal"),
                    cef_master_h.C_POINTER.withName("piVal"),
                    cef_master_h.C_POINTER.withName("puiVal"),
                    cef_master_h.C_POINTER.withName("plVal"),
                    cef_master_h.C_POINTER.withName("pulVal"),
                    cef_master_h.C_POINTER.withName("pintVal"),
                    cef_master_h.C_POINTER.withName("puintVal"),
                    cef_master_h.C_POINTER.withName("pfltVal"),
                    cef_master_h.C_POINTER.withName("pdblVal"),
                    cef_master_h.C_POINTER.withName("pboolVal"),
                    cef_master_h.C_POINTER.withName("pdecVal"),
                    cef_master_h.C_POINTER.withName("pscode"),
                    cef_master_h.C_POINTER.withName("pcyVal"),
                    cef_master_h.C_POINTER.withName("pdate"),
                    cef_master_h.C_POINTER.withName("pbstrVal"),
                    cef_master_h.C_POINTER.withName("ppunkVal"),
                    cef_master_h.C_POINTER.withName("ppdispVal"),
                    cef_master_h.C_POINTER.withName("pparray"),
                    cef_master_h.C_POINTER.withName("pvarVal")
