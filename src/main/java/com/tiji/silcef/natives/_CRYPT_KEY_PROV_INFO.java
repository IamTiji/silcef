...
public class _CRYPT_KEY_PROV_INFO {
    ...
    private static final long pwszContainerName$OFFSET = $LAYOUT.byteOffset(groupElement("pwszContainerName"));
    ...
    private static final long pwszProvName$OFFSET = $LAYOUT.byteOffset(groupElement("pwszProvName"));
    ...
    private static final long dwProvType$OFFSET = $LAYOUT.byteOffset(groupElement("dwProvType"));
    ...
    private static final long cProvParam$OFFSET = $LAYOUT.byteOffset(groupElement("cProvParam"));
    ...
    private static final long rgProvParam$OFFSET = $LAYOUT.byteOffset(groupElement("rgProvParam"));
