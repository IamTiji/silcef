...
public class BITMAPV5HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_LONG.withName("bV5Size"),
        cef_master_h.C_LONG.withName("bV5Width"),
        cef_master_h.C_LONG.withName("bV5Height"),
        cef_master_h.C_SHORT.withName("bV5Planes"),
        cef_master_h.C_SHORT.withName("bV5BitCount"),
        cef_master_h.C_LONG.withName("bV5Compression"),
        cef_master_h.C_LONG.withName("bV5SizeImage"),
        cef_master_h.C_LONG.withName("bV5XPelsPerMeter"),
        cef_master_h.C_LONG.withName("bV5YPelsPerMeter"),
        cef_master_h.C_LONG.withName("bV5ClrUsed"),
        cef_master_h.C_LONG.withName("bV5ClrImportant"),
        cef_master_h.C_LONG.withName("bV5RedMask"),
        cef_master_h.C_LONG.withName("bV5GreenMask"),
        cef_master_h.C_LONG.withName("bV5BlueMask"),
        cef_master_h.C_LONG.withName("bV5AlphaMask"),
        cef_master_h.C_LONG.withName("bV5CSType"),
        tagICEXYZTRIPLE.layout().withName("bV5Endpoints"),
        cef_master_h.C_LONG.withName("bV5GammaRed"),
        cef_master_h.C_LONG.withName("bV5GammaGreen"),
        cef_master_h.C_LONG.withName("bV5GammaBlue"),
        cef_master_h.C_LONG.withName("bV5Intent"),
        cef_master_h.C_LONG.withName("bV5ProfileData"),
        cef_master_h.C_LONG.withName("bV5ProfileSize"),
        cef_master_h.C_LONG.withName("bV5Reserved")
    ).withName("$anon$868:9");
