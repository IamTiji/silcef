...
public class tagTYPEDESC {
    ...
    private static final long lptdesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$653:36"), groupElement("lptdesc"));
    ...
    private static final long lpadesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$653:36"), groupElement("lpadesc"));
    ...
    private static final long hreftype$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$653:36"), groupElement("hreftype"));
