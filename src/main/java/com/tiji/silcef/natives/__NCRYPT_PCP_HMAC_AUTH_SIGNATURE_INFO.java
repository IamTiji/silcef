...
public class __NCRYPT_PCP_HMAC_AUTH_SIGNATURE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("iExpiration"),
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("pabNonce"),
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("pabPolicyRef"),
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("pabHMAC")
    ...
    private static final long iExpiration$OFFSET = $LAYOUT.byteOffset(groupElement("iExpiration"));
    ...
    private static final long pabNonce$OFFSET = $LAYOUT.byteOffset(groupElement("pabNonce"));
    ...
    public static byte pabNonce(MemorySegment struct, long index0) {
        return (byte)pabNonce$ELEM_HANDLE.get(struct, pabNonce$OFFSET, index0);
    }
    ...
    public static void pabNonce(MemorySegment struct, long index0, byte fieldValue) {
        pabNonce$ELEM_HANDLE.set(struct, pabNonce$OFFSET, index0, fieldValue);
    }
    ...
    private static final long pabPolicyRef$OFFSET = $LAYOUT.byteOffset(groupElement("pabPolicyRef"));
    ...
    public static byte pabPolicyRef(MemorySegment struct, long index0) {
        return (byte)pabPolicyRef$ELEM_HANDLE.get(struct, pabPolicyRef$OFFSET, index0);
    }
    ...
    public static void pabPolicyRef(MemorySegment struct, long index0, byte fieldValue) {
        pabPolicyRef$ELEM_HANDLE.set(struct, pabPolicyRef$OFFSET, index0, fieldValue);
    }
    ...
    private static final long pabHMAC$OFFSET = $LAYOUT.byteOffset(groupElement("pabHMAC"));
    ...
    public static byte pabHMAC(MemorySegment struct, long index0) {
        return (byte)pabHMAC$ELEM_HANDLE.get(struct, pabHMAC$OFFSET, index0);
    }
    ...
    public static void pabHMAC(MemorySegment struct, long index0, byte fieldValue) {
        pabHMAC$ELEM_HANDLE.set(struct, pabHMAC$OFFSET, index0, fieldValue);
    }
