...
public class tagRAWKEYBOARD {
    ...
    private static final long MakeCode$OFFSET = $LAYOUT.byteOffset(groupElement("MakeCode"));
    ...
    private static final long VKey$OFFSET = $LAYOUT.byteOffset(groupElement("VKey"));
    ...
    private static final long ExtraInformation$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraInformation"));
