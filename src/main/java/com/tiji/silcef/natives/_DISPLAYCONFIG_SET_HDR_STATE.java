...
/**
 * {@snippet lang=c :
 * struct _DISPLAYCONFIG_SET_HDR_STATE {
 ...
 * }
 */
public class _DISPLAYCONFIG_SET_HDR_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$3248:9"),
            cef_master_h.C_INT.withName("value")
        ).withName("$anon$3246:5")
    ).withName("_DISPLAYCONFIG_SET_HDR_STATE");
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3246:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3246:5"), groupElement("value"));
