...
public class tagWAVEOUTCAPS2W {
    ...
    private static final long dwFormats$OFFSET = $LAYOUT.byteOffset(groupElement("dwFormats"));
    ...
    private static final long wChannels$OFFSET = $LAYOUT.byteOffset(groupElement("wChannels"));
