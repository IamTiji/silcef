...
/**
 * {@snippet lang=c :
 * struct ISupportActivateAsActivatorPackagedVtbl {
 *     HRESULT (*QueryInterface)(ISupportActivateAsActivatorPackaged *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportActivateAsActivatorPackaged *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportActivateAsActivatorPackaged *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportActivateAsActivatorPackagedVtbl {
    ...
    ).withName("ISupportActivateAsActivatorPackagedVtbl");
