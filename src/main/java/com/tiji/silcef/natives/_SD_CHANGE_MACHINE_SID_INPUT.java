...
public class _SD_CHANGE_MACHINE_SID_INPUT {
    ...
    private static final long CurrentMachineSIDOffset$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentMachineSIDOffset"));
    ...
    private static final long CurrentMachineSIDLength$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentMachineSIDLength"));
    ...
    private static final long NewMachineSIDOffset$OFFSET = $LAYOUT.byteOffset(groupElement("NewMachineSIDOffset"));
    ...
    private static final long NewMachineSIDLength$OFFSET = $LAYOUT.byteOffset(groupElement("NewMachineSIDLength"));
