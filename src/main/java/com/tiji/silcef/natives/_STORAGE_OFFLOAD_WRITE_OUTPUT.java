...
public class _STORAGE_OFFLOAD_WRITE_OUTPUT {
    ...
    private static final long OffloadWriteFlags$OFFSET = $LAYOUT.byteOffset(groupElement("OffloadWriteFlags"));
    ...
    private static final long LengthCopied$OFFSET = $LAYOUT.byteOffset(groupElement("LengthCopied"));
