...
public class _IO_IRP_EXT_TRACK_OFFSET_HEADER {
    ...
    private static final long Validation$OFFSET = $LAYOUT.byteOffset(groupElement("Validation"));
    ...
    private static final long TrackedOffsetCallback$OFFSET = $LAYOUT.byteOffset(groupElement("TrackedOffsetCallback"));
