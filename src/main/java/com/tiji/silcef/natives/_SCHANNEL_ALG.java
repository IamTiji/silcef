...
public class _SCHANNEL_ALG {
    ...
    private static final long dwUse$OFFSET = $LAYOUT.byteOffset(groupElement("dwUse"));
    ...
    private static final long cBits$OFFSET = $LAYOUT.byteOffset(groupElement("cBits"));
