...
public class tagPROPSPEC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("ulKind"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            cef_render_handler_capi_h.C_LONG.withName("propid"),
            cef_render_handler_capi_h.C_POINTER.withName("lpwstr")
    ...
    private static final long ulKind$OFFSET = $LAYOUT.byteOffset(groupElement("ulKind"));
    ...
    private static final long propid$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$452:43"), groupElement("propid"));
    ...
    private static final long lpwstr$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$452:43"), groupElement("lpwstr"));
