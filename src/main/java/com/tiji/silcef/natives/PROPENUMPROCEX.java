 ...
 * }
 */
public final class PROPENUMPROCEX {

    private PROPENUMPROCEX() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PROPENUMPROCEX.Function.class, "apply", $DESC);
