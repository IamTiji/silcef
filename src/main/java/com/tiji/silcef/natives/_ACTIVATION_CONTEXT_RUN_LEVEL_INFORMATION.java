...
public class _ACTIVATION_CONTEXT_RUN_LEVEL_INFORMATION {
    ...
    private static final long RunLevel$OFFSET = $LAYOUT.byteOffset(groupElement("RunLevel"));
    ...
    private static final long UiAccess$OFFSET = $LAYOUT.byteOffset(groupElement("UiAccess"));
