...
public class _CRL_CONTEXT {
    ...
    private static final long pbCrlEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("pbCrlEncoded"));
    ...
    private static final long cbCrlEncoded$OFFSET = $LAYOUT.byteOffset(groupElement("cbCrlEncoded"));
