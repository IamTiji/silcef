...
public class _STORAGE_ADAPTER_SERIAL_NUMBER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("SerialNumber")
    ...
    public static short SerialNumber(MemorySegment struct, long index0) {
        return (short)SerialNumber$ELEM_HANDLE.get(struct, SerialNumber$OFFSET, index0);
    }
