...
public class _FULL_PTR_XLAT_TABLES {
    ...
    private static final long RefIdToPointer$OFFSET = $LAYOUT.byteOffset(groupElement("RefIdToPointer"));
    ...
    private static final long PointerToRefId$OFFSET = $LAYOUT.byteOffset(groupElement("PointerToRefId"));
    ...
    private static final long NextRefId$OFFSET = $LAYOUT.byteOffset(groupElement("NextRefId"));
    ...
    private static final long XlatSide$OFFSET = $LAYOUT.byteOffset(groupElement("XlatSide"));
