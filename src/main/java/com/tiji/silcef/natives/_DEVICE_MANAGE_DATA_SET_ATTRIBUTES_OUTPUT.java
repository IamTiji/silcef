...
public class _DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT {
    ...
    private static final long ExtendedError$OFFSET = $LAYOUT.byteOffset(groupElement("ExtendedError"));
    ...
    private static final long TargetDetailedError$OFFSET = $LAYOUT.byteOffset(groupElement("TargetDetailedError"));
    ...
    private static final long ReservedStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ReservedStatus"));
    ...
    private static final long OutputBlockOffset$OFFSET = $LAYOUT.byteOffset(groupElement("OutputBlockOffset"));
