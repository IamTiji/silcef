...
public class tagSTGMEDIUM {
    ...
    private static final long tymed$OFFSET = $LAYOUT.byteOffset(groupElement("tymed"));
    ...
    private static final AddressLayout hBitmap$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("hBitmap"));
    ...
    private static final long hBitmap$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("hBitmap"));
    ...
    private static final AddressLayout hMetaFilePict$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("hMetaFilePict"));
    ...
    private static final long hMetaFilePict$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("hMetaFilePict"));
    ...
    private static final AddressLayout hEnhMetaFile$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("hEnhMetaFile"));
    ...
    private static final long hEnhMetaFile$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("hEnhMetaFile"));
    ...
    private static final AddressLayout hGlobal$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("hGlobal"));
    ...
    private static final long hGlobal$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("hGlobal"));
    ...
    private static final AddressLayout lpszFileName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("lpszFileName"));
    ...
    private static final long lpszFileName$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("lpszFileName"));
    ...
    private static final AddressLayout pstm$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("pstm"));
    ...
    private static final long pstm$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("pstm"));
    ...
    private static final AddressLayout pstg$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12697:36"), groupElement("pstg"));
    ...
    private static final long pstg$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12697:36"), groupElement("pstg"));
    ...
    private static final long pUnkForRelease$OFFSET = $LAYOUT.byteOffset(groupElement("pUnkForRelease"));
