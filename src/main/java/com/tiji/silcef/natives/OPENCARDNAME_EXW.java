...
public class OPENCARDNAME_EXW {
    ...
    private static final long lpstrSearchDesc$OFFSET = $LAYOUT.byteOffset(groupElement("lpstrSearchDesc"));
    ...
    private static final long pOpenCardSearchCriteria$OFFSET = $LAYOUT.byteOffset(groupElement("pOpenCardSearchCriteria"));
