...
public class tagMCI_GETDEVCAPS_PARMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 1).withName("dwReturn"),
    ...
    private static final long dwReturn$OFFSET = $LAYOUT.byteOffset(groupElement("dwReturn"));
    ...
    private static final long dwItem$OFFSET = $LAYOUT.byteOffset(groupElement("dwItem"));
