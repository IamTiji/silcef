...
public class tagSTGOPTIONS {
    ...
    private static final long usVersion$OFFSET = $LAYOUT.byteOffset(groupElement("usVersion"));
    ...
    private static final long ulSectorSize$OFFSET = $LAYOUT.byteOffset(groupElement("ulSectorSize"));
    ...
    private static final long pwcsTemplateFile$OFFSET = $LAYOUT.byteOffset(groupElement("pwcsTemplateFile"));
