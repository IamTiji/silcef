...
public class tagPARAMDESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_POINTER.withName("pparamdescex"),
        cef_render_handler_capi_h.C_SHORT.withName("wParamFlags"),
    ...
    private static final long pparamdescex$OFFSET = $LAYOUT.byteOffset(groupElement("pparamdescex"));
    ...
    private static final long wParamFlags$OFFSET = $LAYOUT.byteOffset(groupElement("wParamFlags"));
