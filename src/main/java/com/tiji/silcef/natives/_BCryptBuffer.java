...
public class _BCryptBuffer {
    ...
    private static final long BufferType$OFFSET = $LAYOUT.byteOffset(groupElement("BufferType"));
    ...
    private static final long pvBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pvBuffer"));
