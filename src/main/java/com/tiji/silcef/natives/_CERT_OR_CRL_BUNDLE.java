...
public class _CERT_OR_CRL_BUNDLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cItem"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgItem")
    ...
    private static final long cItem$OFFSET = $LAYOUT.byteOffset(groupElement("cItem"));
    ...
    private static final long rgItem$OFFSET = $LAYOUT.byteOffset(groupElement("rgItem"));
