...
public class _DISPLAY_DEVICEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_SHORT).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("DeviceString"),
        cef_render_handler_capi_h.C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, cef_render_handler_capi_h.C_SHORT).withName("DeviceKey")
    ...
    public static short DeviceName(MemorySegment struct, long index0) {
        return (short)DeviceName$ELEM_HANDLE.get(struct, DeviceName$OFFSET, index0);
    }
    ...
    private static final long DeviceString$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceString"));
    ...
    public static short DeviceString(MemorySegment struct, long index0) {
        return (short)DeviceString$ELEM_HANDLE.get(struct, DeviceString$OFFSET, index0);
    }
    ...
    public static void DeviceString(MemorySegment struct, long index0, short fieldValue) {
        DeviceString$ELEM_HANDLE.set(struct, DeviceString$OFFSET, index0, fieldValue);
    }
    ...
    private static final long StateFlags$OFFSET = $LAYOUT.byteOffset(groupElement("StateFlags"));
    ...
    public static short DeviceID(MemorySegment struct, long index0) {
        return (short)DeviceID$ELEM_HANDLE.get(struct, DeviceID$OFFSET, index0);
    }
    ...
    public static void DeviceID(MemorySegment struct, long index0, short fieldValue) {
        DeviceID$ELEM_HANDLE.set(struct, DeviceID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long DeviceKey$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceKey"));
    ...
    public static short DeviceKey(MemorySegment struct, long index0) {
        return (short)DeviceKey$ELEM_HANDLE.get(struct, DeviceKey$OFFSET, index0);
    }
    ...
    public static void DeviceKey(MemorySegment struct, long index0, short fieldValue) {
        DeviceKey$ELEM_HANDLE.set(struct, DeviceKey$OFFSET, index0, fieldValue);
    }
