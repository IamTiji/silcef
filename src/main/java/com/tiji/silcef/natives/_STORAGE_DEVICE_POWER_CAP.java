...
public class _STORAGE_DEVICE_POWER_CAP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("Units"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_LONG_LONG.withName("MaxPower")
    ...
    private static final long Units$OFFSET = $LAYOUT.byteOffset(groupElement("Units"));
    ...
    private static final long MaxPower$OFFSET = $LAYOUT.byteOffset(groupElement("MaxPower"));
