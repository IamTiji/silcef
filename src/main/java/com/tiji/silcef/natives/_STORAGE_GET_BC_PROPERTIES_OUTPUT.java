...
public class _STORAGE_GET_BC_PROPERTIES_OUTPUT {
    ...
    private static final long MaximumRequestsPerPeriod$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumRequestsPerPeriod"));
    ...
    private static final long MinimumPeriod$OFFSET = $LAYOUT.byteOffset(groupElement("MinimumPeriod"));
    ...
    private static final long MaximumRequestSize$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumRequestSize"));
    ...
    private static final long EstimatedTimePerRequest$OFFSET = $LAYOUT.byteOffset(groupElement("EstimatedTimePerRequest"));
    ...
    private static final long NumOutStandingRequests$OFFSET = $LAYOUT.byteOffset(groupElement("NumOutStandingRequests"));
    ...
    private static final long RequestSize$OFFSET = $LAYOUT.byteOffset(groupElement("RequestSize"));
