...
public class _DEVICEDUMP_STORAGEDEVICE_DATA {
    ...
    private static final long SectionHeader$OFFSET = $LAYOUT.byteOffset(groupElement("SectionHeader"));
    ...
    private static final long dwBufferSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwBufferSize"));
    ...
    private static final long PublicData$OFFSET = $LAYOUT.byteOffset(groupElement("PublicData"));
    ...
    private static final long RestrictedData$OFFSET = $LAYOUT.byteOffset(groupElement("RestrictedData"));
    ...
    private static final long PrivateData$OFFSET = $LAYOUT.byteOffset(groupElement("PrivateData"));
