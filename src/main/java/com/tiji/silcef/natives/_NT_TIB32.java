...
public class _NT_TIB32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_LONG.withName("ExceptionList"),
        cef_master_h.C_LONG.withName("StackBase"),
        cef_master_h.C_LONG.withName("StackLimit"),
        cef_master_h.C_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            cef_master_h.C_LONG.withName("FiberData"),
            cef_master_h.C_LONG.withName("Version")
        ).withName("$anon$12797:5"),
        cef_master_h.C_LONG.withName("ArbitraryUserPointer"),
        cef_master_h.C_LONG.withName("Self")
    ).withName("_NT_TIB32");
