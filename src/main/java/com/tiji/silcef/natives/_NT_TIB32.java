...
public class _NT_TIB32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("ExceptionList"),
        cef_render_handler_capi_h.C_LONG.withName("StackBase"),
        cef_render_handler_capi_h.C_LONG.withName("StackLimit"),
        cef_render_handler_capi_h.C_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            cef_render_handler_capi_h.C_LONG.withName("FiberData"),
            cef_render_handler_capi_h.C_LONG.withName("Version")
        ).withName("$anon$12797:5"),
        cef_render_handler_capi_h.C_LONG.withName("ArbitraryUserPointer"),
        cef_render_handler_capi_h.C_LONG.withName("Self")
    ).withName("_NT_TIB32");
    ...
    private static final OfInt FiberData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12797:5"), groupElement("FiberData"));
    ...
    private static final long FiberData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12797:5"), groupElement("FiberData"));
    ...
    private static final OfInt Version$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12797:5"), groupElement("Version"));
    ...
    private static final long Version$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12797:5"), groupElement("Version"));
