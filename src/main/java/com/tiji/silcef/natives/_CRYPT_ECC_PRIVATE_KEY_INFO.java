...
public class _CRYPT_ECC_PRIVATE_KEY_INFO {
    ...
    private static final long szCurveOid$OFFSET = $LAYOUT.byteOffset(groupElement("szCurveOid"));
    ...
    private static final long PublicKey$OFFSET = $LAYOUT.byteOffset(groupElement("PublicKey"));
