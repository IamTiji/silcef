 ...
 * }
 */
public final class PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC {

    private PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CRYPT_SIGN_AND_ENCODE_HASH_FUNC.Function.class, "apply", $DESC);
