...
public class _DEVICE_MANAGE_DATA_SET_ATTRIBUTES {
    ...
    private static final long ParameterBlockOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ParameterBlockOffset"));
    ...
    private static final long DataSetRangesOffset$OFFSET = $LAYOUT.byteOffset(groupElement("DataSetRangesOffset"));
    ...
    private static final long DataSetRangesLength$OFFSET = $LAYOUT.byteOffset(groupElement("DataSetRangesLength"));
