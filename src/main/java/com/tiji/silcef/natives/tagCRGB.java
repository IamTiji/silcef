...
public class tagCRGB {
    ...
    private static final long bRed$OFFSET = $LAYOUT.byteOffset(groupElement("bRed"));
    ...
    private static final long bGreen$OFFSET = $LAYOUT.byteOffset(groupElement("bGreen"));
    ...
    private static final long bBlue$OFFSET = $LAYOUT.byteOffset(groupElement("bBlue"));
    ...
    private static final long bExtra$OFFSET = $LAYOUT.byteOffset(groupElement("bExtra"));
