 ...
 * }
 */
public final class RpcServerInterfaceGroupCreateW$IdleCallbackFn {

    private RpcServerInterfaceGroupCreateW$IdleCallbackFn() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RpcServerInterfaceGroupCreateW$IdleCallbackFn.Function.class, "apply", $DESC);
