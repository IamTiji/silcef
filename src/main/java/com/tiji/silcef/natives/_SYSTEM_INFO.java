...
public class _SYSTEM_INFO {
    ...
    private static final long dwOemId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$48:5"), groupElement("dwOemId"));
    ...
    private static final long wProcessorArchitecture$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$48:5"), groupElement("$anon$50:9"), groupElement("wProcessorArchitecture"));
    ...
    private static final long wReserved$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$48:5"), groupElement("$anon$50:9"), groupElement("wReserved"));
    ...
    private static final long dwPageSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwPageSize"));
    ...
    private static final long lpMinimumApplicationAddress$OFFSET = $LAYOUT.byteOffset(groupElement("lpMinimumApplicationAddress"));
    ...
    private static final long lpMaximumApplicationAddress$OFFSET = $LAYOUT.byteOffset(groupElement("lpMaximumApplicationAddress"));
    ...
    private static final long dwActiveProcessorMask$OFFSET = $LAYOUT.byteOffset(groupElement("dwActiveProcessorMask"));
    ...
    private static final long dwNumberOfProcessors$OFFSET = $LAYOUT.byteOffset(groupElement("dwNumberOfProcessors"));
    ...
    private static final long dwProcessorType$OFFSET = $LAYOUT.byteOffset(groupElement("dwProcessorType"));
    ...
    private static final long dwAllocationGranularity$OFFSET = $LAYOUT.byteOffset(groupElement("dwAllocationGranularity"));
    ...
    private static final long wProcessorLevel$OFFSET = $LAYOUT.byteOffset(groupElement("wProcessorLevel"));
    ...
    private static final long wProcessorRevision$OFFSET = $LAYOUT.byteOffset(groupElement("wProcessorRevision"));
