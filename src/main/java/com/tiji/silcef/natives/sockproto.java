...
public class sockproto {
    ...
    private static final long sp_family$OFFSET = $LAYOUT.byteOffset(groupElement("sp_family"));
    ...
    private static final long sp_protocol$OFFSET = $LAYOUT.byteOffset(groupElement("sp_protocol"));
