...
public class _DEVICE_POWER_DESCRIPTOR {
    ...
    private static final long DeviceAttentionSupported$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceAttentionSupported"));
    ...
    private static final long AsynchronousNotificationSupported$OFFSET = $LAYOUT.byteOffset(groupElement("AsynchronousNotificationSupported"));
    ...
    private static final long IdlePowerManagementEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("IdlePowerManagementEnabled"));
    ...
    private static final long D3ColdEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("D3ColdEnabled"));
    ...
    private static final long D3ColdSupported$OFFSET = $LAYOUT.byteOffset(groupElement("D3ColdSupported"));
    ...
    private static final long NoVerifyDuringIdlePower$OFFSET = $LAYOUT.byteOffset(groupElement("NoVerifyDuringIdlePower"));
    ...
    private static final long IdleTimeoutInMS$OFFSET = $LAYOUT.byteOffset(groupElement("IdleTimeoutInMS"));
