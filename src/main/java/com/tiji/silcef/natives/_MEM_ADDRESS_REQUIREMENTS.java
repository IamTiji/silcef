...
public class _MEM_ADDRESS_REQUIREMENTS {
    ...
    private static final long LowestStartingAddress$OFFSET = $LAYOUT.byteOffset(groupElement("LowestStartingAddress"));
    ...
    private static final long HighestEndingAddress$OFFSET = $LAYOUT.byteOffset(groupElement("HighestEndingAddress"));
