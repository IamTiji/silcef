...
public class IPersistMonikerVtbl {
     ...
     * }
     */
    public final static class GetCurMoniker {

        private GetCurMoniker() {
            // Should not be called directly
        }
    ...
    private static final long GetCurMoniker$OFFSET = $LAYOUT.byteOffset(groupElement("GetCurMoniker"));
