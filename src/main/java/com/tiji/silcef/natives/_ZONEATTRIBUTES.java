...
public class _ZONEATTRIBUTES {
    ...
    private static final long szDisplayName$OFFSET = $LAYOUT.byteOffset(groupElement("szDisplayName"));
    ...
    public static short szDisplayName(MemorySegment struct, long index0) {
        return (short)szDisplayName$ELEM_HANDLE.get(struct, szDisplayName$OFFSET, index0);
    }
    ...
    public static void szDisplayName(MemorySegment struct, long index0, short fieldValue) {
        szDisplayName$ELEM_HANDLE.set(struct, szDisplayName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long szDescription$OFFSET = $LAYOUT.byteOffset(groupElement("szDescription"));
    ...
    public static short szDescription(MemorySegment struct, long index0) {
        return (short)szDescription$ELEM_HANDLE.get(struct, szDescription$OFFSET, index0);
    }
    ...
    public static void szDescription(MemorySegment struct, long index0, short fieldValue) {
        szDescription$ELEM_HANDLE.set(struct, szDescription$OFFSET, index0, fieldValue);
    }
    ...
    private static final long szIconPath$OFFSET = $LAYOUT.byteOffset(groupElement("szIconPath"));
    ...
    public static short szIconPath(MemorySegment struct, long index0) {
        return (short)szIconPath$ELEM_HANDLE.get(struct, szIconPath$OFFSET, index0);
    }
    ...
    public static void szIconPath(MemorySegment struct, long index0, short fieldValue) {
        szIconPath$ELEM_HANDLE.set(struct, szIconPath$OFFSET, index0, fieldValue);
    }
    ...
    private static final long dwTemplateMinLevel$OFFSET = $LAYOUT.byteOffset(groupElement("dwTemplateMinLevel"));
    ...
    private static final long dwTemplateRecommended$OFFSET = $LAYOUT.byteOffset(groupElement("dwTemplateRecommended"));
    ...
    private static final long dwTemplateCurrentLevel$OFFSET = $LAYOUT.byteOffset(groupElement("dwTemplateCurrentLevel"));
