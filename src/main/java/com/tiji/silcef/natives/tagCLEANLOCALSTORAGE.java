...
public class tagCLEANLOCALSTORAGE {
    ...
    private static final long pInterface$OFFSET = $LAYOUT.byteOffset(groupElement("pInterface"));
    ...
    private static final long pStorage$OFFSET = $LAYOUT.byteOffset(groupElement("pStorage"));
