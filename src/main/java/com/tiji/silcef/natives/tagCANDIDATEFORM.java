...
public class tagCANDIDATEFORM {
    ...
    private static final long ptCurrentPos$OFFSET = $LAYOUT.byteOffset(groupElement("ptCurrentPos"));
    ...
    private static final long rcArea$OFFSET = $LAYOUT.byteOffset(groupElement("rcArea"));
