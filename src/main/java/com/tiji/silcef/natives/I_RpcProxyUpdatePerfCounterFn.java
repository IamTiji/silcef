 ...
 * }
 */
public final class I_RpcProxyUpdatePerfCounterFn {

    private I_RpcProxyUpdatePerfCounterFn() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(I_RpcProxyUpdatePerfCounterFn.Function.class, "apply", $DESC);
