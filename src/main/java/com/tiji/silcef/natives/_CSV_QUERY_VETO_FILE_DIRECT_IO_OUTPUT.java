...
public class _CSV_QUERY_VETO_FILE_DIRECT_IO_OUTPUT {
    ...
    private static final long VetoedFromAltitudeIntegral$OFFSET = $LAYOUT.byteOffset(groupElement("VetoedFromAltitudeIntegral"));
    ...
    private static final long VetoedFromAltitudeDecimal$OFFSET = $LAYOUT.byteOffset(groupElement("VetoedFromAltitudeDecimal"));
    ...
    public static short Reason(MemorySegment struct, long index0) {
        return (short)Reason$ELEM_HANDLE.get(struct, Reason$OFFSET, index0);
    }
    ...
    public static void Reason(MemorySegment struct, long index0, short fieldValue) {
        Reason$ELEM_HANDLE.set(struct, Reason$OFFSET, index0, fieldValue);
    }
