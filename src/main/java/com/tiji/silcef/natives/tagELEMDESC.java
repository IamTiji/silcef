...
public class tagELEMDESC {
    ...
    private static final long tdesc$OFFSET = $LAYOUT.byteOffset(groupElement("tdesc"));
    ...
    private static final long idldesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$733:5"), groupElement("idldesc"));
    ...
    private static final long paramdesc$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$733:5"), groupElement("paramdesc"));
