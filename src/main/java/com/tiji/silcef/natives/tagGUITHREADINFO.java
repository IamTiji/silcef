...
public class tagGUITHREADINFO {
    ...
    private static final long hwndActive$OFFSET = $LAYOUT.byteOffset(groupElement("hwndActive"));
    ...
    private static final long hwndFocus$OFFSET = $LAYOUT.byteOffset(groupElement("hwndFocus"));
    ...
    private static final long hwndCapture$OFFSET = $LAYOUT.byteOffset(groupElement("hwndCapture"));
    ...
    private static final long hwndMenuOwner$OFFSET = $LAYOUT.byteOffset(groupElement("hwndMenuOwner"));
    ...
    private static final long hwndMoveSize$OFFSET = $LAYOUT.byteOffset(groupElement("hwndMoveSize"));
    ...
    private static final long hwndCaret$OFFSET = $LAYOUT.byteOffset(groupElement("hwndCaret"));
    ...
    private static final long rcCaret$OFFSET = $LAYOUT.byteOffset(groupElement("rcCaret"));
