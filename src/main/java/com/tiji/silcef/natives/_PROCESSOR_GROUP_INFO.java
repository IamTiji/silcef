...
public class _PROCESSOR_GROUP_INFO {
    ...
    private static final long MaximumProcessorCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumProcessorCount"));
    ...
    private static final long ActiveProcessorCount$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveProcessorCount"));
    ...
    private static final long ActiveProcessorMask$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveProcessorMask"));
