...
public class _PERFORMANCE_DATA {
    ...
    private static final long HwCountersCount$OFFSET = $LAYOUT.byteOffset(groupElement("HwCountersCount"));
    ...
    private static final long ContextSwitchCount$OFFSET = $LAYOUT.byteOffset(groupElement("ContextSwitchCount"));
    ...
    private static final long WaitReasonBitMap$OFFSET = $LAYOUT.byteOffset(groupElement("WaitReasonBitMap"));
    ...
    private static final long CycleTime$OFFSET = $LAYOUT.byteOffset(groupElement("CycleTime"));
    ...
    private static final long RetryCount$OFFSET = $LAYOUT.byteOffset(groupElement("RetryCount"));
    ...
    private static final long HwCounters$OFFSET = $LAYOUT.byteOffset(groupElement("HwCounters"));
    ...
    public static MemorySegment HwCounters(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)HwCounters$ELEM_HANDLE.invokeExact(struct, HwCounters$OFFSET, index0);
