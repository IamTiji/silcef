...
public class _CERT_CREATE_CONTEXT_PARA {
    ...
    private static final long pvFree$OFFSET = $LAYOUT.byteOffset(groupElement("pvFree"));
    ...
    private static final long pfnSort$OFFSET = $LAYOUT.byteOffset(groupElement("pfnSort"));
    ...
    private static final long pvSort$OFFSET = $LAYOUT.byteOffset(groupElement("pvSort"));
