...
public class tagRID_DEVICE_INFO_HID {
    ...
    private static final long dwVendorId$OFFSET = $LAYOUT.byteOffset(groupElement("dwVendorId"));
    ...
    private static final long dwProductId$OFFSET = $LAYOUT.byteOffset(groupElement("dwProductId"));
    ...
    private static final long dwVersionNumber$OFFSET = $LAYOUT.byteOffset(groupElement("dwVersionNumber"));
    ...
    private static final long usUsagePage$OFFSET = $LAYOUT.byteOffset(groupElement("usUsagePage"));
    ...
    private static final long usUsage$OFFSET = $LAYOUT.byteOffset(groupElement("usUsage"));
