...
public class _DEVICE_LB_PROVISIONING_DESCRIPTOR {
    ...
    private static final long OptimalUnmapGranularity$OFFSET = $LAYOUT.byteOffset(groupElement("OptimalUnmapGranularity"));
    ...
    private static final long UnmapGranularityAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("UnmapGranularityAlignment"));
    ...
    private static final long MaxUnmapLbaCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxUnmapLbaCount"));
    ...
    private static final long MaxUnmapBlockDescriptorCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxUnmapBlockDescriptorCount"));
