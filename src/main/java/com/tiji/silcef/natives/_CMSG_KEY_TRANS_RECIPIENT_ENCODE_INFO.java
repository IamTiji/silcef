...
public class _CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO {
    ...
    private static final long RecipientPublicKey$OFFSET = $LAYOUT.byteOffset(groupElement("RecipientPublicKey"));
    ...
    private static final long RecipientId$OFFSET = $LAYOUT.byteOffset(groupElement("RecipientId"));
