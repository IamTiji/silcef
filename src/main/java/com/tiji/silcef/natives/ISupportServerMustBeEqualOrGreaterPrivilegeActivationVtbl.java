...
/**
 * {@snippet lang=c :
 * struct ISupportServerMustBeEqualOrGreaterPrivilegeActivationVtbl {
 *     HRESULT (*QueryInterface)(ISupportServerMustBeEqualOrGreaterPrivilegeActivation *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportServerMustBeEqualOrGreaterPrivilegeActivation *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportServerMustBeEqualOrGreaterPrivilegeActivation *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportServerMustBeEqualOrGreaterPrivilegeActivationVtbl {
    ...
    ).withName("ISupportServerMustBeEqualOrGreaterPrivilegeActivationVtbl");
