...
public class tagDESIGNVECTOR {
    ...
    private static final long dvReserved$OFFSET = $LAYOUT.byteOffset(groupElement("dvReserved"));
    ...
    private static final long dvNumAxes$OFFSET = $LAYOUT.byteOffset(groupElement("dvNumAxes"));
    ...
    private static final long dvValues$OFFSET = $LAYOUT.byteOffset(groupElement("dvValues"));
    ...
    public static int dvValues(MemorySegment struct, long index0) {
        return (int)dvValues$ELEM_HANDLE.get(struct, dvValues$OFFSET, index0);
    }
    ...
    public static void dvValues(MemorySegment struct, long index0, int fieldValue) {
        dvValues$ELEM_HANDLE.set(struct, dvValues$OFFSET, index0, fieldValue);
    }
