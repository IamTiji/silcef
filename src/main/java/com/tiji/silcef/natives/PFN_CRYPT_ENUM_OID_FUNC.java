 ...
 * }
 */
public final class PFN_CRYPT_ENUM_OID_FUNC {

    private PFN_CRYPT_ENUM_OID_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CRYPT_ENUM_OID_FUNC.Function.class, "apply", $DESC);
