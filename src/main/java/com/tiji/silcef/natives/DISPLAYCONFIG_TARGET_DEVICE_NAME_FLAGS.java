...
public class DISPLAYCONFIG_TARGET_DEVICE_NAME_FLAGS {
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3084:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3084:5"), groupElement("value"));
