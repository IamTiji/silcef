...
/**
 * {@snippet lang=c :
 * struct _cef_media_access_callback_t {
 *     cef_base_ref_counted_t base;
 *     void (*cont)(struct _cef_media_access_callback_t *, uint32_t) __attribute__((stdcall));
 *     void (*cancel)(struct _cef_media_access_callback_t *) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_media_access_callback_t {
    ...
    ).withName("_cef_media_access_callback_t");
