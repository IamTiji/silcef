...
public class tagCURSORSHAPE {
    ...
    private static final long cbWidth$OFFSET = $LAYOUT.byteOffset(groupElement("cbWidth"));
    ...
    private static final long BitsPixel$OFFSET = $LAYOUT.byteOffset(groupElement("BitsPixel"));
