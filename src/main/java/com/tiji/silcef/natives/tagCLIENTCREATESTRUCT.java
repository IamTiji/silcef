...
public class tagCLIENTCREATESTRUCT {
    ...
    private static final long hWindowMenu$OFFSET = $LAYOUT.byteOffset(groupElement("hWindowMenu"));
    ...
    private static final long idFirstChild$OFFSET = $LAYOUT.byteOffset(groupElement("idFirstChild"));
