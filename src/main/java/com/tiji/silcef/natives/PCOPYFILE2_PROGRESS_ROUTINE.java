 ...
 * }
 */
public final class PCOPYFILE2_PROGRESS_ROUTINE {

    private PCOPYFILE2_PROGRESS_ROUTINE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PCOPYFILE2_PROGRESS_ROUTINE.Function.class, "apply", $DESC);
