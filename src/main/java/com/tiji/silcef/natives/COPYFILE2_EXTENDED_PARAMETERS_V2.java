...
public class COPYFILE2_EXTENDED_PARAMETERS_V2 {
    ...
    private static final AddressLayout pProgressRoutineOld$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pProgressRoutineOld"));
     ...
     * }
     */
    public static final AddressLayout pProgressRoutineOld$layout() {
        return pProgressRoutineOld$LAYOUT;
    }

    private static final long pProgressRoutineOld$OFFSET = $LAYOUT.byteOffset(groupElement("pProgressRoutineOld"));
     ...
     * }
     */
    public static final long pProgressRoutineOld$offset() {
        return pProgressRoutineOld$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pProgressRoutineOld(MemorySegment struct) {
        return struct.get(pProgressRoutineOld$LAYOUT, pProgressRoutineOld$OFFSET);
    }
     ...
     * }
     */
    public static void pProgressRoutineOld(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pProgressRoutineOld$LAYOUT, pProgressRoutineOld$OFFSET, fieldValue);
    }

    private static final AddressLayout SourceOplockKeys$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("SourceOplockKeys"));
     ...
     * }
     */
    public static final AddressLayout SourceOplockKeys$layout() {
        return SourceOplockKeys$LAYOUT;
    }

    private static final long SourceOplockKeys$OFFSET = $LAYOUT.byteOffset(groupElement("SourceOplockKeys"));
     ...
     * }
     */
    public static final long SourceOplockKeys$offset() {
        return SourceOplockKeys$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment SourceOplockKeys(MemorySegment struct) {
        return struct.get(SourceOplockKeys$LAYOUT, SourceOplockKeys$OFFSET);
    }
     ...
     * }
     */
    public static void SourceOplockKeys(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(SourceOplockKeys$LAYOUT, SourceOplockKeys$OFFSET, fieldValue);
    }
