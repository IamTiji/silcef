...
public class _ASYNC_DUPLICATE_EXTENTS_STATUS {
    ...
    private static final long SourceFileOffset$OFFSET = $LAYOUT.byteOffset(groupElement("SourceFileOffset"));
    ...
    private static final long TargetFileOffset$OFFSET = $LAYOUT.byteOffset(groupElement("TargetFileOffset"));
    ...
    private static final long BytesDuplicated$OFFSET = $LAYOUT.byteOffset(groupElement("BytesDuplicated"));
