...
public class _IMAGE_OPTIONAL_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("SizeOfStackReserve"),
        cef_render_handler_capi_h.C_LONG.withName("SizeOfStackCommit"),
        cef_render_handler_capi_h.C_LONG.withName("SizeOfHeapReserve"),
        cef_render_handler_capi_h.C_LONG.withName("SizeOfHeapCommit"),
    ...
    private static final long BaseOfData$OFFSET = $LAYOUT.byteOffset(groupElement("BaseOfData"));
