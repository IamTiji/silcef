...
public class _IMAGE_ARM_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21691:5"), groupElement("UnwindData"));
    ...
    private static final long UnwindData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21691:5"), groupElement("UnwindData"));
