...
public class _DOC_INFO_2W {
    ...
    private static final long pDocName$OFFSET = $LAYOUT.byteOffset(groupElement("pDocName"));
    ...
    private static final long pOutputFile$OFFSET = $LAYOUT.byteOffset(groupElement("pOutputFile"));
