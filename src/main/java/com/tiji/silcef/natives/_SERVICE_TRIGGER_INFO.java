...
public class _SERVICE_TRIGGER_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cTriggers"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("pTriggers"),
    ...
    private static final long cTriggers$OFFSET = $LAYOUT.byteOffset(groupElement("cTriggers"));
    ...
    private static final long pTriggers$OFFSET = $LAYOUT.byteOffset(groupElement("pTriggers"));
