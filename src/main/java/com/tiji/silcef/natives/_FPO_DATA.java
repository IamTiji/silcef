...
public class _FPO_DATA {
    ...
    private static final long ulOffStart$OFFSET = $LAYOUT.byteOffset(groupElement("ulOffStart"));
    ...
    private static final long cbProcSize$OFFSET = $LAYOUT.byteOffset(groupElement("cbProcSize"));
    ...
    private static final long cdwLocals$OFFSET = $LAYOUT.byteOffset(groupElement("cdwLocals"));
    ...
    private static final long cdwParams$OFFSET = $LAYOUT.byteOffset(groupElement("cdwParams"));
