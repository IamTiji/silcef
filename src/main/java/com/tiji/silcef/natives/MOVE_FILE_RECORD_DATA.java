...
public class MOVE_FILE_RECORD_DATA {
    ...
    private static final long SourceFileRecord$OFFSET = $LAYOUT.byteOffset(groupElement("SourceFileRecord"));
    ...
    private static final long TargetFileRecord$OFFSET = $LAYOUT.byteOffset(groupElement("TargetFileRecord"));
