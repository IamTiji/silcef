...
public class _CERT_POLICY_CONSTRAINTS_INFO {
    ...
    private static final long fRequireExplicitPolicy$OFFSET = $LAYOUT.byteOffset(groupElement("fRequireExplicitPolicy"));
    ...
    private static final long dwRequireExplicitPolicySkipCerts$OFFSET = $LAYOUT.byteOffset(groupElement("dwRequireExplicitPolicySkipCerts"));
    ...
    private static final long fInhibitPolicyMapping$OFFSET = $LAYOUT.byteOffset(groupElement("fInhibitPolicyMapping"));
    ...
    private static final long dwInhibitPolicyMappingSkipCerts$OFFSET = $LAYOUT.byteOffset(groupElement("dwInhibitPolicyMappingSkipCerts"));
