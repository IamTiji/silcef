...
public class _TXFS_ROLLFORWARD_REDO_INFORMATION {
    ...
    private static final long LastVirtualClock$OFFSET = $LAYOUT.byteOffset(groupElement("LastVirtualClock"));
    ...
    private static final long LastRedoLsn$OFFSET = $LAYOUT.byteOffset(groupElement("LastRedoLsn"));
    ...
    private static final long HighestRecoveryLsn$OFFSET = $LAYOUT.byteOffset(groupElement("HighestRecoveryLsn"));
