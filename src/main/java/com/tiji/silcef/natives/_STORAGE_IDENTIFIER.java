...
public class _STORAGE_IDENTIFIER {
    ...
    private static final long CodeSet$OFFSET = $LAYOUT.byteOffset(groupElement("CodeSet"));
    ...
    private static final long IdentifierSize$OFFSET = $LAYOUT.byteOffset(groupElement("IdentifierSize"));
    ...
    private static final long NextOffset$OFFSET = $LAYOUT.byteOffset(groupElement("NextOffset"));
    ...
    private static final long Association$OFFSET = $LAYOUT.byteOffset(groupElement("Association"));
    ...
    public static byte Identifier(MemorySegment struct, long index0) {
        return (byte)Identifier$ELEM_HANDLE.get(struct, Identifier$OFFSET, index0);
    }
    ...
    public static void Identifier(MemorySegment struct, long index0, byte fieldValue) {
        Identifier$ELEM_HANDLE.set(struct, Identifier$OFFSET, index0, fieldValue);
    }
