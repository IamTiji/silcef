...
public class _FORMAT_EX_PARAMETERS {
    ...
    private static final long StartCylinderNumber$OFFSET = $LAYOUT.byteOffset(groupElement("StartCylinderNumber"));
    ...
    private static final long EndCylinderNumber$OFFSET = $LAYOUT.byteOffset(groupElement("EndCylinderNumber"));
    ...
    private static final long StartHeadNumber$OFFSET = $LAYOUT.byteOffset(groupElement("StartHeadNumber"));
    ...
    private static final long EndHeadNumber$OFFSET = $LAYOUT.byteOffset(groupElement("EndHeadNumber"));
    ...
    private static final long FormatGapLength$OFFSET = $LAYOUT.byteOffset(groupElement("FormatGapLength"));
    ...
    private static final long SectorNumber$OFFSET = $LAYOUT.byteOffset(groupElement("SectorNumber"));
    ...
    public static short SectorNumber(MemorySegment struct, long index0) {
        return (short)SectorNumber$ELEM_HANDLE.get(struct, SectorNumber$OFFSET, index0);
    }
    ...
    public static void SectorNumber(MemorySegment struct, long index0, short fieldValue) {
        SectorNumber$ELEM_HANDLE.set(struct, SectorNumber$OFFSET, index0, fieldValue);
    }
