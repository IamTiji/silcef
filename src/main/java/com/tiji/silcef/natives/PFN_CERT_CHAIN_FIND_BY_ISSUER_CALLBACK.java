 ...
 * }
 */
public final class PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK {

    private PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CERT_CHAIN_FIND_BY_ISSUER_CALLBACK.Function.class, "apply", $DESC);
