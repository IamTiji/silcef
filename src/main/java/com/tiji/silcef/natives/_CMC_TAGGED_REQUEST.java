...
public class _CMC_TAGGED_REQUEST {
    ...
    private static final long dwTaggedRequestChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwTaggedRequestChoice"));
    ...
    private static final AddressLayout pTaggedCertRequest$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5322:5"), groupElement("pTaggedCertRequest"));
    ...
    private static final long pTaggedCertRequest$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5322:5"), groupElement("pTaggedCertRequest"));
