...
public class _VIDEOPARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("dwOffset"),
        cef_master_h.C_LONG.withName("dwCommand"),
        cef_master_h.C_LONG.withName("dwFlags"),
        cef_master_h.C_LONG.withName("dwMode"),
        cef_master_h.C_LONG.withName("dwTVStandard"),
        cef_master_h.C_LONG.withName("dwAvailableModes"),
        cef_master_h.C_LONG.withName("dwAvailableTVStandard"),
        cef_master_h.C_LONG.withName("dwFlickerFilter"),
        cef_master_h.C_LONG.withName("dwOverScanX"),
        cef_master_h.C_LONG.withName("dwOverScanY"),
        cef_master_h.C_LONG.withName("dwMaxUnscaledX"),
        cef_master_h.C_LONG.withName("dwMaxUnscaledY"),
        cef_master_h.C_LONG.withName("dwPositionX"),
        cef_master_h.C_LONG.withName("dwPositionY"),
        cef_master_h.C_LONG.withName("dwBrightness"),
        cef_master_h.C_LONG.withName("dwContrast"),
        cef_master_h.C_LONG.withName("dwCPType"),
        cef_master_h.C_LONG.withName("dwCPCommand"),
        cef_master_h.C_LONG.withName("dwCPStandard"),
        cef_master_h.C_LONG.withName("dwCPKey"),
        cef_master_h.C_LONG.withName("bCP_APSTriggerBits"),
        MemoryLayout.sequenceLayout(256, cef_master_h.C_CHAR).withName("bOEMCopyProtection")
