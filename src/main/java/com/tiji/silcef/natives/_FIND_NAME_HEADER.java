...
public class _FIND_NAME_HEADER {
    ...
    private static final long node_count$OFFSET = $LAYOUT.byteOffset(groupElement("node_count"));
    ...
    private static final long unique_group$OFFSET = $LAYOUT.byteOffset(groupElement("unique_group"));
