...
public class _JOBOBJECT_IO_ATTRIBUTION_STATS {
    ...
    private static final long IoCount$OFFSET = $LAYOUT.byteOffset(groupElement("IoCount"));
    ...
    private static final long TotalNonOverlappedQueueTime$OFFSET = $LAYOUT.byteOffset(groupElement("TotalNonOverlappedQueueTime"));
    ...
    private static final long TotalNonOverlappedServiceTime$OFFSET = $LAYOUT.byteOffset(groupElement("TotalNonOverlappedServiceTime"));
