...
public class _GENERIC_MAPPING {
    ...
    private static final long GenericRead$OFFSET = $LAYOUT.byteOffset(groupElement("GenericRead"));
    ...
    private static final long GenericWrite$OFFSET = $LAYOUT.byteOffset(groupElement("GenericWrite"));
    ...
    private static final long GenericExecute$OFFSET = $LAYOUT.byteOffset(groupElement("GenericExecute"));
    ...
    private static final long GenericAll$OFFSET = $LAYOUT.byteOffset(groupElement("GenericAll"));
