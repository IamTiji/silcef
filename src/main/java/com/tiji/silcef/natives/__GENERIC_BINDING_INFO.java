...
public class __GENERIC_BINDING_INFO {
    ...
    private static final long pObj$OFFSET = $LAYOUT.byteOffset(groupElement("pObj"));
    ...
    private static final long pfnBind$OFFSET = $LAYOUT.byteOffset(groupElement("pfnBind"));
    ...
    private static final long pfnUnbind$OFFSET = $LAYOUT.byteOffset(groupElement("pfnUnbind"));
