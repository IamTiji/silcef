...
/**
 * {@snippet lang=c :
 * struct _DISPLAYCONFIG_SET_WCG_STATE {
 ...
 * }
 */
public class _DISPLAYCONFIG_SET_WCG_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$3263:9"),
            cef_render_handler_capi_h.C_INT.withName("value")
        ).withName("$anon$3261:5")
    ).withName("_DISPLAYCONFIG_SET_WCG_STATE");
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3261:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3261:5"), groupElement("value"));
