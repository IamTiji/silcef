...
public class _DEVICE_DATA_SET_SCRUB_EX_OUTPUT {
    ...
    private static final long BytesProcessed$OFFSET = $LAYOUT.byteOffset(groupElement("BytesProcessed"));
    ...
    private static final long BytesRepaired$OFFSET = $LAYOUT.byteOffset(groupElement("BytesRepaired"));
    ...
    private static final long BytesFailed$OFFSET = $LAYOUT.byteOffset(groupElement("BytesFailed"));
    ...
    private static final long ParityExtent$OFFSET = $LAYOUT.byteOffset(groupElement("ParityExtent"));
    ...
    private static final long BytesScrubbed$OFFSET = $LAYOUT.byteOffset(groupElement("BytesScrubbed"));
