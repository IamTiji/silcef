...
public class _IMAGE_RESOURCE_DIR_STRING_U {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_SHORT).withName("NameString")
    ...
    private static final long NameString$OFFSET = $LAYOUT.byteOffset(groupElement("NameString"));
    ...
    public static short NameString(MemorySegment struct, long index0) {
        return (short)NameString$ELEM_HANDLE.get(struct, NameString$OFFSET, index0);
    }
    ...
    public static void NameString(MemorySegment struct, long index0, short fieldValue) {
        NameString$ELEM_HANDLE.set(struct, NameString$OFFSET, index0, fieldValue);
    }
