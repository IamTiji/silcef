...
public class _CERT_LOGOTYPE_INFO {
    ...
    private static final long dwLogotypeInfoChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwLogotypeInfoChoice"));
    ...
    private static final AddressLayout pLogotypeDirectInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5603:5"), groupElement("pLogotypeDirectInfo"));
    ...
    private static final long pLogotypeDirectInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5603:5"), groupElement("pLogotypeDirectInfo"));
    ...
    private static final AddressLayout pLogotypeIndirectInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5603:5"), groupElement("pLogotypeIndirectInfo"));
    ...
    private static final long pLogotypeIndirectInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5603:5"), groupElement("pLogotypeIndirectInfo"));
