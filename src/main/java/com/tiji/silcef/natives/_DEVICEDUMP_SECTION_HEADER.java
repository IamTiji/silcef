...
public class _DEVICEDUMP_SECTION_HEADER {
    ...
    private static final long guidDeviceDataId$OFFSET = $LAYOUT.byteOffset(groupElement("guidDeviceDataId"));
    ...
    private static final long sOrganizationID$OFFSET = $LAYOUT.byteOffset(groupElement("sOrganizationID"));
    ...
    public static byte sOrganizationID(MemorySegment struct, long index0) {
        return (byte)sOrganizationID$ELEM_HANDLE.get(struct, sOrganizationID$OFFSET, index0);
    }
    ...
    public static void sOrganizationID(MemorySegment struct, long index0, byte fieldValue) {
        sOrganizationID$ELEM_HANDLE.set(struct, sOrganizationID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long dwFirmwareRevision$OFFSET = $LAYOUT.byteOffset(groupElement("dwFirmwareRevision"));
    ...
    private static final long sModelNumber$OFFSET = $LAYOUT.byteOffset(groupElement("sModelNumber"));
    ...
    public static byte sModelNumber(MemorySegment struct, long index0) {
        return (byte)sModelNumber$ELEM_HANDLE.get(struct, sModelNumber$OFFSET, index0);
    }
    ...
    public static void sModelNumber(MemorySegment struct, long index0, byte fieldValue) {
        sModelNumber$ELEM_HANDLE.set(struct, sModelNumber$OFFSET, index0, fieldValue);
    }
    ...
    private static final long szDeviceManufacturingID$OFFSET = $LAYOUT.byteOffset(groupElement("szDeviceManufacturingID"));
    ...
    public static byte szDeviceManufacturingID(MemorySegment struct, long index0) {
        return (byte)szDeviceManufacturingID$ELEM_HANDLE.get(struct, szDeviceManufacturingID$OFFSET, index0);
    }
    ...
    public static void szDeviceManufacturingID(MemorySegment struct, long index0, byte fieldValue) {
        szDeviceManufacturingID$ELEM_HANDLE.set(struct, szDeviceManufacturingID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long bRestrictedPrivateDataVersion$OFFSET = $LAYOUT.byteOffset(groupElement("bRestrictedPrivateDataVersion"));
    ...
    private static final long dwFirmwareIssueId$OFFSET = $LAYOUT.byteOffset(groupElement("dwFirmwareIssueId"));
    ...
    private static final long szIssueDescriptionString$OFFSET = $LAYOUT.byteOffset(groupElement("szIssueDescriptionString"));
    ...
    public static byte szIssueDescriptionString(MemorySegment struct, long index0) {
        return (byte)szIssueDescriptionString$ELEM_HANDLE.get(struct, szIssueDescriptionString$OFFSET, index0);
    }
    ...
    public static void szIssueDescriptionString(MemorySegment struct, long index0, byte fieldValue) {
        szIssueDescriptionString$ELEM_HANDLE.set(struct, szIssueDescriptionString$OFFSET, index0, fieldValue);
    }
