...
public class _AUTHENTICODE_TS_EXTRA_CERT_CHAIN_POLICY_PARA {
    ...
    private static final long dwRegPolicySettings$OFFSET = $LAYOUT.byteOffset(groupElement("dwRegPolicySettings"));
    ...
    private static final long fCommercial$OFFSET = $LAYOUT.byteOffset(groupElement("fCommercial"));
