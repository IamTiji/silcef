...
public class tagRAWMOUSE {
    ...
    private static final OfInt ulButtons$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15020:5"), groupElement("ulButtons"));
    ...
    private static final long ulButtons$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15020:5"), groupElement("ulButtons"));
    ...
    private static final OfShort usButtonFlags$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$15020:5"), groupElement("$anon$15022:9"), groupElement("usButtonFlags"));
    ...
    private static final long usButtonFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15020:5"), groupElement("$anon$15022:9"), groupElement("usButtonFlags"));
    ...
    private static final OfShort usButtonData$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$15020:5"), groupElement("$anon$15022:9"), groupElement("usButtonData"));
    ...
    private static final long usButtonData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15020:5"), groupElement("$anon$15022:9"), groupElement("usButtonData"));
