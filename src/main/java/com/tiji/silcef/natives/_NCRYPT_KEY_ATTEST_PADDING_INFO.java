...
public class _NCRYPT_KEY_ATTEST_PADDING_INFO {
    ...
    private static final long pbKeyBlob$OFFSET = $LAYOUT.byteOffset(groupElement("pbKeyBlob"));
    ...
    private static final long cbKeyBlob$OFFSET = $LAYOUT.byteOffset(groupElement("cbKeyBlob"));
    ...
    private static final long pbKeyAuth$OFFSET = $LAYOUT.byteOffset(groupElement("pbKeyAuth"));
    ...
    private static final long cbKeyAuth$OFFSET = $LAYOUT.byteOffset(groupElement("cbKeyAuth"));
