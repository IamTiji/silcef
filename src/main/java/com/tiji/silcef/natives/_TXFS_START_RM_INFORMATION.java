...
public class _TXFS_START_RM_INFORMATION {
    ...
    private static final long TmLogPathLength$OFFSET = $LAYOUT.byteOffset(groupElement("TmLogPathLength"));
    ...
    private static final long LogPathLength$OFFSET = $LAYOUT.byteOffset(groupElement("LogPathLength"));
    ...
    private static final long LogPath$OFFSET = $LAYOUT.byteOffset(groupElement("LogPath"));
    ...
    public static short LogPath(MemorySegment struct, long index0) {
        return (short)LogPath$ELEM_HANDLE.get(struct, LogPath$OFFSET, index0);
    }
    ...
    public static void LogPath(MemorySegment struct, long index0, short fieldValue) {
        LogPath$ELEM_HANDLE.set(struct, LogPath$OFFSET, index0, fieldValue);
    }
