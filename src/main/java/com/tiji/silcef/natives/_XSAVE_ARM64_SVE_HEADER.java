...
public class _XSAVE_ARM64_SVE_HEADER {
    ...
    private static final long VectorLength$OFFSET = $LAYOUT.byteOffset(groupElement("VectorLength"));
    ...
    private static final long VectorRegisterOffset$OFFSET = $LAYOUT.byteOffset(groupElement("VectorRegisterOffset"));
    ...
    private static final long PredicateRegisterOffset$OFFSET = $LAYOUT.byteOffset(groupElement("PredicateRegisterOffset"));
