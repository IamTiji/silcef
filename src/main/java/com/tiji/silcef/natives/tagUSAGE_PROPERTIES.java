...
public class tagUSAGE_PROPERTIES {
    ...
    private static final long page$OFFSET = $LAYOUT.byteOffset(groupElement("page"));
    ...
    private static final long logicalMinimum$OFFSET = $LAYOUT.byteOffset(groupElement("logicalMinimum"));
    ...
    private static final long logicalMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("logicalMaximum"));
    ...
    private static final long physicalMinimum$OFFSET = $LAYOUT.byteOffset(groupElement("physicalMinimum"));
    ...
    private static final long physicalMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("physicalMaximum"));
