...
/**
 * {@snippet lang=c :
 * struct ISupportCoAddComDependencyOnPackage {
 *     struct ISupportCoAddComDependencyOnPackageVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportCoAddComDependencyOnPackage {
    ...
    ).withName("ISupportCoAddComDependencyOnPackage");
