...
public class _HEAP_SUMMARY {
    ...
    private static final long cbAllocated$OFFSET = $LAYOUT.byteOffset(groupElement("cbAllocated"));
    ...
    private static final long cbCommitted$OFFSET = $LAYOUT.byteOffset(groupElement("cbCommitted"));
    ...
    private static final long cbReserved$OFFSET = $LAYOUT.byteOffset(groupElement("cbReserved"));
    ...
    private static final long cbMaxReserve$OFFSET = $LAYOUT.byteOffset(groupElement("cbMaxReserve"));
