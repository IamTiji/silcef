...
public class _RESUME_PERFORMANCE {
    ...
    private static final long PostTimeMs$OFFSET = $LAYOUT.byteOffset(groupElement("PostTimeMs"));
    ...
    private static final long TotalResumeTimeMs$OFFSET = $LAYOUT.byteOffset(groupElement("TotalResumeTimeMs"));
    ...
    private static final long ResumeCompleteTimestamp$OFFSET = $LAYOUT.byteOffset(groupElement("ResumeCompleteTimestamp"));
