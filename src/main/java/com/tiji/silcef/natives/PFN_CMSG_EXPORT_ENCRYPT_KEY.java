 ...
 * }
 */
public final class PFN_CMSG_EXPORT_ENCRYPT_KEY {

    private PFN_CMSG_EXPORT_ENCRYPT_KEY() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CMSG_EXPORT_ENCRYPT_KEY.Function.class, "apply", $DESC);
