...
public class _CRYPT_X942_OTHER_INFO {
    ...
    private static final long pszContentEncryptionObjId$OFFSET = $LAYOUT.byteOffset(groupElement("pszContentEncryptionObjId"));
    ...
    private static final long rgbCounter$OFFSET = $LAYOUT.byteOffset(groupElement("rgbCounter"));
    ...
    public static byte rgbCounter(MemorySegment struct, long index0) {
        return (byte)rgbCounter$ELEM_HANDLE.get(struct, rgbCounter$OFFSET, index0);
    }
    ...
    public static void rgbCounter(MemorySegment struct, long index0, byte fieldValue) {
        rgbCounter$ELEM_HANDLE.set(struct, rgbCounter$OFFSET, index0, fieldValue);
    }
    ...
    private static final long rgbKeyLength$OFFSET = $LAYOUT.byteOffset(groupElement("rgbKeyLength"));
    ...
    public static byte rgbKeyLength(MemorySegment struct, long index0) {
        return (byte)rgbKeyLength$ELEM_HANDLE.get(struct, rgbKeyLength$OFFSET, index0);
    }
    ...
    public static void rgbKeyLength(MemorySegment struct, long index0, byte fieldValue) {
        rgbKeyLength$ELEM_HANDLE.set(struct, rgbKeyLength$OFFSET, index0, fieldValue);
    }
    ...
    private static final long PubInfo$OFFSET = $LAYOUT.byteOffset(groupElement("PubInfo"));
