...
public class _CERT_ALT_NAME_INFO {
    ...
    private static final long cAltEntry$OFFSET = $LAYOUT.byteOffset(groupElement("cAltEntry"));
    ...
    private static final long rgAltEntry$OFFSET = $LAYOUT.byteOffset(groupElement("rgAltEntry"));
