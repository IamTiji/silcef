...
public class _CRYPT_SMIME_CAPABILITIES {
    ...
    private static final long cCapability$OFFSET = $LAYOUT.byteOffset(groupElement("cCapability"));
    ...
    private static final long rgCapability$OFFSET = $LAYOUT.byteOffset(groupElement("rgCapability"));
