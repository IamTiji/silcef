...
public class PrintNamedProperty {
    ...
    private static final long propertyName$OFFSET = $LAYOUT.byteOffset(groupElement("propertyName"));
    ...
    private static final long propertyValue$OFFSET = $LAYOUT.byteOffset(groupElement("propertyValue"));
