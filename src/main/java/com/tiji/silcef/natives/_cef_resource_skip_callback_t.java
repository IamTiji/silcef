 ...
 *     void (*cont)(struct _cef_resource_skip_callback_t *, int64_t) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_resource_skip_callback_t {
    ...
    ).withName("_cef_resource_skip_callback_t");
