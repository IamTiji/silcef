...
public class _DEVICE_INTERNAL_STATUS_DATA {
    ...
    private static final long T10VendorId$OFFSET = $LAYOUT.byteOffset(groupElement("T10VendorId"));
    ...
    private static final long DataSet1Length$OFFSET = $LAYOUT.byteOffset(groupElement("DataSet1Length"));
    ...
    private static final long DataSet2Length$OFFSET = $LAYOUT.byteOffset(groupElement("DataSet2Length"));
    ...
    private static final long DataSet3Length$OFFSET = $LAYOUT.byteOffset(groupElement("DataSet3Length"));
    ...
    private static final long DataSet4Length$OFFSET = $LAYOUT.byteOffset(groupElement("DataSet4Length"));
    ...
    private static final long StatusDataVersion$OFFSET = $LAYOUT.byteOffset(groupElement("StatusDataVersion"));
    ...
    private static final long ReasonIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("ReasonIdentifier"));
    ...
    public static byte ReasonIdentifier(MemorySegment struct, long index0) {
        return (byte)ReasonIdentifier$ELEM_HANDLE.get(struct, ReasonIdentifier$OFFSET, index0);
    }
    ...
    public static void ReasonIdentifier(MemorySegment struct, long index0, byte fieldValue) {
        ReasonIdentifier$ELEM_HANDLE.set(struct, ReasonIdentifier$OFFSET, index0, fieldValue);
    }
    ...
    private static final long StatusDataLength$OFFSET = $LAYOUT.byteOffset(groupElement("StatusDataLength"));
    ...
    private static final long StatusData$OFFSET = $LAYOUT.byteOffset(groupElement("StatusData"));
    ...
    public static byte StatusData(MemorySegment struct, long index0) {
        return (byte)StatusData$ELEM_HANDLE.get(struct, StatusData$OFFSET, index0);
    }
    ...
    public static void StatusData(MemorySegment struct, long index0, byte fieldValue) {
        StatusData$ELEM_HANDLE.set(struct, StatusData$OFFSET, index0, fieldValue);
    }
