...
public class PPM_WMI_PERF_STATES_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("MaxFrequency"),
        cef_render_handler_capi_h.C_LONG.withName("CurrentState"),
        cef_render_handler_capi_h.C_LONG.withName("MaxPerfState"),
        cef_render_handler_capi_h.C_LONG.withName("MinPerfState"),
        cef_render_handler_capi_h.C_LONG.withName("LowestPerfState"),
        cef_render_handler_capi_h.C_LONG.withName("ThermalConstraint"),
        cef_render_handler_capi_h.C_CHAR.withName("BusyAdjThreshold"),
        cef_render_handler_capi_h.C_CHAR.withName("PolicyType"),
        cef_render_handler_capi_h.C_CHAR.withName("Type"),
        cef_render_handler_capi_h.C_CHAR.withName("Reserved"),
        cef_render_handler_capi_h.C_LONG.withName("TimerInterval"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("TargetProcessors"),
        cef_render_handler_capi_h.C_LONG.withName("PStateHandler"),
        cef_render_handler_capi_h.C_LONG.withName("PStateContext"),
        cef_render_handler_capi_h.C_LONG.withName("TStateHandler"),
        cef_render_handler_capi_h.C_LONG.withName("TStateContext"),
        cef_render_handler_capi_h.C_LONG.withName("FeedbackHandler"),
    ...
    private static final long MaxFrequency$OFFSET = $LAYOUT.byteOffset(groupElement("MaxFrequency"));
    ...
    private static final long CurrentState$OFFSET = $LAYOUT.byteOffset(groupElement("CurrentState"));
    ...
    private static final long MaxPerfState$OFFSET = $LAYOUT.byteOffset(groupElement("MaxPerfState"));
    ...
    private static final long MinPerfState$OFFSET = $LAYOUT.byteOffset(groupElement("MinPerfState"));
    ...
    private static final long LowestPerfState$OFFSET = $LAYOUT.byteOffset(groupElement("LowestPerfState"));
    ...
    private static final long ThermalConstraint$OFFSET = $LAYOUT.byteOffset(groupElement("ThermalConstraint"));
    ...
    private static final long PolicyType$OFFSET = $LAYOUT.byteOffset(groupElement("PolicyType"));
    ...
    private static final long TimerInterval$OFFSET = $LAYOUT.byteOffset(groupElement("TimerInterval"));
    ...
    private static final long TargetProcessors$OFFSET = $LAYOUT.byteOffset(groupElement("TargetProcessors"));
    ...
    private static final long PStateHandler$OFFSET = $LAYOUT.byteOffset(groupElement("PStateHandler"));
    ...
    private static final long PStateContext$OFFSET = $LAYOUT.byteOffset(groupElement("PStateContext"));
    ...
    private static final long TStateHandler$OFFSET = $LAYOUT.byteOffset(groupElement("TStateHandler"));
    ...
    private static final long TStateContext$OFFSET = $LAYOUT.byteOffset(groupElement("TStateContext"));
    ...
    private static final long FeedbackHandler$OFFSET = $LAYOUT.byteOffset(groupElement("FeedbackHandler"));
    ...
    public static MemorySegment State(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)State$ELEM_HANDLE.invokeExact(struct, State$OFFSET, index0);
