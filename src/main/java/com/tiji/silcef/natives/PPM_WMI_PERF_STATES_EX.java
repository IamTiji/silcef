...
public class PPM_WMI_PERF_STATES_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("MaxFrequency"),
        cef_master_h.C_LONG.withName("CurrentState"),
        cef_master_h.C_LONG.withName("MaxPerfState"),
        cef_master_h.C_LONG.withName("MinPerfState"),
        cef_master_h.C_LONG.withName("LowestPerfState"),
        cef_master_h.C_LONG.withName("ThermalConstraint"),
        cef_master_h.C_CHAR.withName("BusyAdjThreshold"),
        cef_master_h.C_CHAR.withName("PolicyType"),
        cef_master_h.C_CHAR.withName("Type"),
        cef_master_h.C_CHAR.withName("Reserved"),
        cef_master_h.C_LONG.withName("TimerInterval"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("TargetProcessors"),
        cef_master_h.C_LONG.withName("PStateHandler"),
        cef_master_h.C_LONG.withName("PStateContext"),
        cef_master_h.C_LONG.withName("TStateHandler"),
        cef_master_h.C_LONG.withName("TStateContext"),
        cef_master_h.C_LONG.withName("FeedbackHandler"),
