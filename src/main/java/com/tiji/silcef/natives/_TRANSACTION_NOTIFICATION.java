...
public class _TRANSACTION_NOTIFICATION {
    ...
    private static final long TransactionKey$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionKey"));
    ...
    private static final long TransactionNotification$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionNotification"));
    ...
    private static final long TmVirtualClock$OFFSET = $LAYOUT.byteOffset(groupElement("TmVirtualClock"));
    ...
    private static final long ArgumentLength$OFFSET = $LAYOUT.byteOffset(groupElement("ArgumentLength"));
