...
public class IXMLDOMTextVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("put_data"),
        cef_render_handler_capi_h.C_POINTER.withName("get_length"),
        cef_render_handler_capi_h.C_POINTER.withName("substringData"),
        cef_render_handler_capi_h.C_POINTER.withName("appendData"),
        cef_render_handler_capi_h.C_POINTER.withName("insertData"),
        cef_render_handler_capi_h.C_POINTER.withName("deleteData"),
        cef_render_handler_capi_h.C_POINTER.withName("replaceData"),
        cef_render_handler_capi_h.C_POINTER.withName("splitText")
     ...
     * }
     */
    public final static class put_data {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(put_data.Function.class, "apply", $DESC);
    ...
    private static final long put_data$OFFSET = $LAYOUT.byteOffset(groupElement("put_data"));
    ...
    public final static class get_length {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(get_length.Function.class, "apply", $DESC);
     ...
     * }
     */
    public final static class substringData {

        private substringData() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(substringData.Function.class, "apply", $DESC);
    ...
    private static final long substringData$OFFSET = $LAYOUT.byteOffset(groupElement("substringData"));
     ...
     * }
     */
    public final static class appendData {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(appendData.Function.class, "apply", $DESC);
    ...
    private static final long appendData$OFFSET = $LAYOUT.byteOffset(groupElement("appendData"));
     ...
     * }
     */
    public final static class insertData {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(insertData.Function.class, "apply", $DESC);
    ...
    private static final long insertData$OFFSET = $LAYOUT.byteOffset(groupElement("insertData"));
     ...
     * }
     */
    public final static class deleteData {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(deleteData.Function.class, "apply", $DESC);
    ...
    private static final long deleteData$OFFSET = $LAYOUT.byteOffset(groupElement("deleteData"));
     ...
     * }
     */
    public final static class replaceData {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(replaceData.Function.class, "apply", $DESC);
    ...
    private static final long replaceData$OFFSET = $LAYOUT.byteOffset(groupElement("replaceData"));
     ...
     * }
     */
    public final static class splitText {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(splitText.Function.class, "apply", $DESC);
    ...
    private static final long splitText$OFFSET = $LAYOUT.byteOffset(groupElement("splitText"));
