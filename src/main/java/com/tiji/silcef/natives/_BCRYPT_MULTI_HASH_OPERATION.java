...
public class _BCRYPT_MULTI_HASH_OPERATION {
    ...
    private static final long iHash$OFFSET = $LAYOUT.byteOffset(groupElement("iHash"));
    ...
    private static final long hashOperation$OFFSET = $LAYOUT.byteOffset(groupElement("hashOperation"));
    ...
    private static final long pbBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pbBuffer"));
