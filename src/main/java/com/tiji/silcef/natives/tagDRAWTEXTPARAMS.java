...
public class tagDRAWTEXTPARAMS {
    ...
    private static final long iTabLength$OFFSET = $LAYOUT.byteOffset(groupElement("iTabLength"));
    ...
    private static final long iLeftMargin$OFFSET = $LAYOUT.byteOffset(groupElement("iLeftMargin"));
    ...
    private static final long iRightMargin$OFFSET = $LAYOUT.byteOffset(groupElement("iRightMargin"));
    ...
    private static final long uiLengthDrawn$OFFSET = $LAYOUT.byteOffset(groupElement("uiLengthDrawn"));
