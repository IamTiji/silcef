...
public class _SCARD_ATRMASK {
    ...
    private static final long rgbMask$OFFSET = $LAYOUT.byteOffset(groupElement("rgbMask"));
    ...
    public static byte rgbMask(MemorySegment struct, long index0) {
        return (byte)rgbMask$ELEM_HANDLE.get(struct, rgbMask$OFFSET, index0);
    }
    ...
    public static void rgbMask(MemorySegment struct, long index0, byte fieldValue) {
        rgbMask$ELEM_HANDLE.set(struct, rgbMask$OFFSET, index0, fieldValue);
    }
