...
public class _CRYPT_VERIFY_CERT_SIGN_WEAK_HASH_INFO {
    ...
    private static final long cCNGHashAlgid$OFFSET = $LAYOUT.byteOffset(groupElement("cCNGHashAlgid"));
    ...
    private static final long rgpwszCNGHashAlgid$OFFSET = $LAYOUT.byteOffset(groupElement("rgpwszCNGHashAlgid"));
    ...
    private static final long dwWeakIndex$OFFSET = $LAYOUT.byteOffset(groupElement("dwWeakIndex"));
