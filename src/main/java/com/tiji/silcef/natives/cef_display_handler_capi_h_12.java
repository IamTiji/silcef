...
class cef_display_handler_capi_h_12 extends cef_display_handler_capi_h_13 {

    cef_display_handler_capi_h_12() {
    ...
    public static MemorySegment GET_SYSTEM_WOW64_DIRECTORY_NAME_A_A() {
        class Holder {
            static final MemorySegment GET_SYSTEM_WOW64_DIRECTORY_NAME_A_A
                = cef_display_handler_capi_h.LIBRARY_ARENA.allocateFrom("GetSystemWow64DirectoryA");
        }
    ...
    public static MemorySegment GET_SYSTEM_WOW64_DIRECTORY_NAME_W_A() {
        class Holder {
            static final MemorySegment GET_SYSTEM_WOW64_DIRECTORY_NAME_W_A
                = cef_display_handler_capi_h.LIBRARY_ARENA.allocateFrom("GetSystemWow64DirectoryW");
        }
    ...
    private static final int ERROR_CLOUD_FILE_HYDRATION_NOT_AVAILABLE = (int)523L;
    /**
     * {@snippet lang=c :
     * #define ERROR_CLOUD_FILE_HYDRATION_NOT_AVAILABLE 523
     * }
     */
    public static int ERROR_CLOUD_FILE_HYDRATION_NOT_AVAILABLE() {
        return ERROR_CLOUD_FILE_HYDRATION_NOT_AVAILABLE;
    }
    private static final int ERROR_SYSTEM_FILE_NOT_SUPPORTED = (int)525L;
    /**
     * {@snippet lang=c :
     * #define ERROR_SYSTEM_FILE_NOT_SUPPORTED 525
     * }
     */
    public static int ERROR_SYSTEM_FILE_NOT_SUPPORTED() {
