...
public class _CMSG_KEY_AGREE_ENCRYPT_INFO {
    ...
    private static final long dwRecipientIndex$OFFSET = $LAYOUT.byteOffset(groupElement("dwRecipientIndex"));
    ...
    private static final long dwOriginatorChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwOriginatorChoice"));
    ...
    private static final GroupLayout OriginatorCertId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8809:5"), groupElement("OriginatorCertId"));
    ...
    private static final long OriginatorCertId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8809:5"), groupElement("OriginatorCertId"));
    ...
    private static final GroupLayout OriginatorPublicKeyInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8809:5"), groupElement("OriginatorPublicKeyInfo"));
    ...
    private static final long OriginatorPublicKeyInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8809:5"), groupElement("OriginatorPublicKeyInfo"));
    ...
    private static final long cKeyAgreeKeyEncryptInfo$OFFSET = $LAYOUT.byteOffset(groupElement("cKeyAgreeKeyEncryptInfo"));
    ...
    private static final long rgpKeyAgreeKeyEncryptInfo$OFFSET = $LAYOUT.byteOffset(groupElement("rgpKeyAgreeKeyEncryptInfo"));
