...
public class tagStorageLayout {
    ...
    private static final long pwcsElementName$OFFSET = $LAYOUT.byteOffset(groupElement("pwcsElementName"));
    ...
    private static final long cOffset$OFFSET = $LAYOUT.byteOffset(groupElement("cOffset"));
