...
public class tagHW_PROFILE_INFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(39, cef_render_handler_capi_h.C_SHORT).withName("szHwProfileGuid"),
        MemoryLayout.sequenceLayout(80, cef_render_handler_capi_h.C_SHORT).withName("szHwProfileName"),
    ...
    private static final long dwDockInfo$OFFSET = $LAYOUT.byteOffset(groupElement("dwDockInfo"));
    ...
    private static final long szHwProfileGuid$OFFSET = $LAYOUT.byteOffset(groupElement("szHwProfileGuid"));
    ...
    public static short szHwProfileGuid(MemorySegment struct, long index0) {
        return (short)szHwProfileGuid$ELEM_HANDLE.get(struct, szHwProfileGuid$OFFSET, index0);
    }
    ...
    public static void szHwProfileGuid(MemorySegment struct, long index0, short fieldValue) {
        szHwProfileGuid$ELEM_HANDLE.set(struct, szHwProfileGuid$OFFSET, index0, fieldValue);
    }
    ...
    private static final long szHwProfileName$OFFSET = $LAYOUT.byteOffset(groupElement("szHwProfileName"));
    ...
    public static short szHwProfileName(MemorySegment struct, long index0) {
        return (short)szHwProfileName$ELEM_HANDLE.get(struct, szHwProfileName$OFFSET, index0);
    }
    ...
    public static void szHwProfileName(MemorySegment struct, long index0, short fieldValue) {
        szHwProfileName$ELEM_HANDLE.set(struct, szHwProfileName$OFFSET, index0, fieldValue);
    }
