 ...
 * }
 */
public final class LPFNPSPCALLBACKW {

    private LPFNPSPCALLBACKW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPFNPSPCALLBACKW.Function.class, "apply", $DESC);
