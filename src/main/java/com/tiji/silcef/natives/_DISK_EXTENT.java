...
public class _DISK_EXTENT {
    ...
    private static final long DiskNumber$OFFSET = $LAYOUT.byteOffset(groupElement("DiskNumber"));
    ...
    private static final long ExtentLength$OFFSET = $LAYOUT.byteOffset(groupElement("ExtentLength"));
