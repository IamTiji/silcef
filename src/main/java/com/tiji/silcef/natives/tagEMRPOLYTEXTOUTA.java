...
public class tagEMRPOLYTEXTOUTA {
    ...
    private static final long iGraphicsMode$OFFSET = $LAYOUT.byteOffset(groupElement("iGraphicsMode"));
    ...
    private static final long exScale$OFFSET = $LAYOUT.byteOffset(groupElement("exScale"));
    ...
    private static final long eyScale$OFFSET = $LAYOUT.byteOffset(groupElement("eyScale"));
    ...
    private static final long cStrings$OFFSET = $LAYOUT.byteOffset(groupElement("cStrings"));
    ...
    private static final long aemrtext$OFFSET = $LAYOUT.byteOffset(groupElement("aemrtext"));
    ...
    public static MemorySegment aemrtext(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)aemrtext$ELEM_HANDLE.invokeExact(struct, aemrtext$OFFSET, index0);
