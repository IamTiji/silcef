...
public class _CERT_TPM_SPECIFICATION_INFO {
    ...
    private static final long pwszFamily$OFFSET = $LAYOUT.byteOffset(groupElement("pwszFamily"));
    ...
    private static final long dwRevision$OFFSET = $LAYOUT.byteOffset(groupElement("dwRevision"));
