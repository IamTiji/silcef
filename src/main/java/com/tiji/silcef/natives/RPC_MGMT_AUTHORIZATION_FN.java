 ...
 * }
 */
public final class RPC_MGMT_AUTHORIZATION_FN {

    private RPC_MGMT_AUTHORIZATION_FN() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPC_MGMT_AUTHORIZATION_FN.Function.class, "apply", $DESC);
