...
public class tagPAINTSTRUCT {
    ...
    private static final long fErase$OFFSET = $LAYOUT.byteOffset(groupElement("fErase"));
    ...
    private static final long rcPaint$OFFSET = $LAYOUT.byteOffset(groupElement("rcPaint"));
    ...
    private static final long fRestore$OFFSET = $LAYOUT.byteOffset(groupElement("fRestore"));
    ...
    private static final long fIncUpdate$OFFSET = $LAYOUT.byteOffset(groupElement("fIncUpdate"));
