...
public class _CRYPT_PROPERTY_REF {
    ...
    private static final long pszProperty$OFFSET = $LAYOUT.byteOffset(groupElement("pszProperty"));
    ...
    private static final long cbValue$OFFSET = $LAYOUT.byteOffset(groupElement("cbValue"));
    ...
    private static final long pbValue$OFFSET = $LAYOUT.byteOffset(groupElement("pbValue"));
