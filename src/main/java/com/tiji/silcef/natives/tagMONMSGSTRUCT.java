...
public class tagMONMSGSTRUCT {
    ...
    private static final long hwndTo$OFFSET = $LAYOUT.byteOffset(groupElement("hwndTo"));
    ...
    private static final long wMsg$OFFSET = $LAYOUT.byteOffset(groupElement("wMsg"));
    ...
    private static final long wParam$OFFSET = $LAYOUT.byteOffset(groupElement("wParam"));
    ...
    private static final long dmhd$OFFSET = $LAYOUT.byteOffset(groupElement("dmhd"));
