...
public class _MIDL_SERVER_INFO_ {
    ...
    private static final long pStubDesc$OFFSET = $LAYOUT.byteOffset(groupElement("pStubDesc"));
    ...
    private static final long ThunkTable$OFFSET = $LAYOUT.byteOffset(groupElement("ThunkTable"));
    ...
    private static final long pTransferSyntax$OFFSET = $LAYOUT.byteOffset(groupElement("pTransferSyntax"));
    ...
    private static final long nCount$OFFSET = $LAYOUT.byteOffset(groupElement("nCount"));
    ...
    private static final long pSyntaxInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pSyntaxInfo"));
