...
public class _JOBOBJECT_BASIC_PROCESS_ID_LIST {
    ...
    private static final long NumberOfAssignedProcesses$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfAssignedProcesses"));
    ...
    private static final long NumberOfProcessIdsInList$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfProcessIdsInList"));
    ...
    private static final long ProcessIdList$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessIdList"));
    ...
    public static long ProcessIdList(MemorySegment struct, long index0) {
        return (long)ProcessIdList$ELEM_HANDLE.get(struct, ProcessIdList$OFFSET, index0);
    }
    ...
    public static void ProcessIdList(MemorySegment struct, long index0, long fieldValue) {
        ProcessIdList$ELEM_HANDLE.set(struct, ProcessIdList$OFFSET, index0, fieldValue);
    }
