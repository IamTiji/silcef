...
public class COPYFILE2_MESSAGE {
    ...
    private static final long dwPadding$OFFSET = $LAYOUT.byteOffset(groupElement("dwPadding"));
    ...
    public static class Info {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ...
            COPYFILE2_MESSAGE.Info.Error_.layout().withName("Error")
        ).withName("$anon$5854:5");
        ...
        public static class ChunkStarted {
            ...
            private static final long dwStreamNumber$OFFSET = $LAYOUT.byteOffset(groupElement("dwStreamNumber"));
            ...
            private static final long hSourceFile$OFFSET = $LAYOUT.byteOffset(groupElement("hSourceFile"));
            ...
            private static final long hDestinationFile$OFFSET = $LAYOUT.byteOffset(groupElement("hDestinationFile"));
            ...
            private static final long uliChunkNumber$OFFSET = $LAYOUT.byteOffset(groupElement("uliChunkNumber"));
            ...
            private static final long uliChunkSize$OFFSET = $LAYOUT.byteOffset(groupElement("uliChunkSize"));
            ...
            private static final long uliStreamSize$OFFSET = $LAYOUT.byteOffset(groupElement("uliStreamSize"));
            ...
            private static final long uliTotalFileSize$OFFSET = $LAYOUT.byteOffset(groupElement("uliTotalFileSize"));
        ...
        private static final long ChunkStarted$OFFSET = $LAYOUT.byteOffset(groupElement("ChunkStarted"));
        ...
        public static class ChunkFinished {
            ...
            private static final long uliStreamBytesTransferred$OFFSET = $LAYOUT.byteOffset(groupElement("uliStreamBytesTransferred"));
            ...
            private static final long uliTotalBytesTransferred$OFFSET = $LAYOUT.byteOffset(groupElement("uliTotalBytesTransferred"));
        ...
        private static final long ChunkFinished$OFFSET = $LAYOUT.byteOffset(groupElement("ChunkFinished"));
        ...
        private static final long StreamStarted$OFFSET = $LAYOUT.byteOffset(groupElement("StreamStarted"));
        ...
        private static final long StreamFinished$OFFSET = $LAYOUT.byteOffset(groupElement("StreamFinished"));
        ...
        private static final long PollContinue$OFFSET = $LAYOUT.byteOffset(groupElement("PollContinue"));
        ...
        public static class Error_ {
            ...
            private static final long CopyPhase$OFFSET = $LAYOUT.byteOffset(groupElement("CopyPhase"));
            ...
            private static final long hrFailure$OFFSET = $LAYOUT.byteOffset(groupElement("hrFailure"));
        ...
        private static final GroupLayout Error_$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Error"));
         ...
         * }
         */
        public static final GroupLayout Error_$layout() {
            return Error_$LAYOUT;
        }

        private static final long Error_$OFFSET = $LAYOUT.byteOffset(groupElement("Error"));
         ...
         * }
         */
        public static final long Error_$offset() {
            return Error_$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment Error_(MemorySegment union) {
            return union.asSlice(Error_$OFFSET, Error_$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void Error_(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, Error_$OFFSET, Error_$LAYOUT.byteSize());
        }
