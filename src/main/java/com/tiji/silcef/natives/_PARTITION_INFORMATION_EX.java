...
public class _PARTITION_INFORMATION_EX {
    ...
    private static final long PartitionStyle$OFFSET = $LAYOUT.byteOffset(groupElement("PartitionStyle"));
    ...
    private static final long StartingOffset$OFFSET = $LAYOUT.byteOffset(groupElement("StartingOffset"));
    ...
    private static final long PartitionLength$OFFSET = $LAYOUT.byteOffset(groupElement("PartitionLength"));
    ...
    private static final long PartitionNumber$OFFSET = $LAYOUT.byteOffset(groupElement("PartitionNumber"));
    ...
    private static final long RewritePartition$OFFSET = $LAYOUT.byteOffset(groupElement("RewritePartition"));
    ...
    private static final long IsServicePartition$OFFSET = $LAYOUT.byteOffset(groupElement("IsServicePartition"));
    ...
    private static final GroupLayout Mbr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9628:5"), groupElement("Mbr"));
    ...
    private static final long Mbr$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9628:5"), groupElement("Mbr"));
    ...
    private static final GroupLayout Gpt$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9628:5"), groupElement("Gpt"));
    ...
    private static final long Gpt$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9628:5"), groupElement("Gpt"));
