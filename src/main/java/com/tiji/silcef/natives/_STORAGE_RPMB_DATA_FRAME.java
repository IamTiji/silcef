...
public class _STORAGE_RPMB_DATA_FRAME {
    ...
    private static final long Stuff$OFFSET = $LAYOUT.byteOffset(groupElement("Stuff"));
    ...
    public static byte Stuff(MemorySegment struct, long index0) {
        return (byte)Stuff$ELEM_HANDLE.get(struct, Stuff$OFFSET, index0);
    }
    ...
    public static void Stuff(MemorySegment struct, long index0, byte fieldValue) {
        Stuff$ELEM_HANDLE.set(struct, Stuff$OFFSET, index0, fieldValue);
    }
    ...
    private static final long KeyOrMAC$OFFSET = $LAYOUT.byteOffset(groupElement("KeyOrMAC"));
    ...
    public static byte KeyOrMAC(MemorySegment struct, long index0) {
        return (byte)KeyOrMAC$ELEM_HANDLE.get(struct, KeyOrMAC$OFFSET, index0);
    }
    ...
    public static void KeyOrMAC(MemorySegment struct, long index0, byte fieldValue) {
        KeyOrMAC$ELEM_HANDLE.set(struct, KeyOrMAC$OFFSET, index0, fieldValue);
    }
    ...
    private static final long Nonce$OFFSET = $LAYOUT.byteOffset(groupElement("Nonce"));
    ...
    public static byte Nonce(MemorySegment struct, long index0) {
        return (byte)Nonce$ELEM_HANDLE.get(struct, Nonce$OFFSET, index0);
    }
    ...
    public static void Nonce(MemorySegment struct, long index0, byte fieldValue) {
        Nonce$ELEM_HANDLE.set(struct, Nonce$OFFSET, index0, fieldValue);
    }
    ...
    private static final long WriteCounter$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCounter"));
    ...
    public static byte WriteCounter(MemorySegment struct, long index0) {
        return (byte)WriteCounter$ELEM_HANDLE.get(struct, WriteCounter$OFFSET, index0);
    }
    ...
    public static void WriteCounter(MemorySegment struct, long index0, byte fieldValue) {
        WriteCounter$ELEM_HANDLE.set(struct, WriteCounter$OFFSET, index0, fieldValue);
    }
    ...
    public static byte Address(MemorySegment struct, long index0) {
        return (byte)Address$ELEM_HANDLE.get(struct, Address$OFFSET, index0);
    }
    ...
    public static void Address(MemorySegment struct, long index0, byte fieldValue) {
        Address$ELEM_HANDLE.set(struct, Address$OFFSET, index0, fieldValue);
    }
    ...
    private static final long BlockCount$OFFSET = $LAYOUT.byteOffset(groupElement("BlockCount"));
    ...
    public static byte BlockCount(MemorySegment struct, long index0) {
        return (byte)BlockCount$ELEM_HANDLE.get(struct, BlockCount$OFFSET, index0);
    }
    ...
    public static void BlockCount(MemorySegment struct, long index0, byte fieldValue) {
        BlockCount$ELEM_HANDLE.set(struct, BlockCount$OFFSET, index0, fieldValue);
    }
    ...
    private static final long OperationResult$OFFSET = $LAYOUT.byteOffset(groupElement("OperationResult"));
    ...
    public static byte OperationResult(MemorySegment struct, long index0) {
        return (byte)OperationResult$ELEM_HANDLE.get(struct, OperationResult$OFFSET, index0);
    }
    ...
    public static void OperationResult(MemorySegment struct, long index0, byte fieldValue) {
        OperationResult$ELEM_HANDLE.set(struct, OperationResult$OFFSET, index0, fieldValue);
    }
    ...
    private static final long RequestOrResponseType$OFFSET = $LAYOUT.byteOffset(groupElement("RequestOrResponseType"));
    ...
    public static byte RequestOrResponseType(MemorySegment struct, long index0) {
        return (byte)RequestOrResponseType$ELEM_HANDLE.get(struct, RequestOrResponseType$OFFSET, index0);
    }
    ...
    public static void RequestOrResponseType(MemorySegment struct, long index0, byte fieldValue) {
        RequestOrResponseType$ELEM_HANDLE.set(struct, RequestOrResponseType$OFFSET, index0, fieldValue);
    }
