...
public class tagRID_DEVICE_INFO_MOUSE {
    ...
    private static final long dwNumberOfButtons$OFFSET = $LAYOUT.byteOffset(groupElement("dwNumberOfButtons"));
    ...
    private static final long fHasHorizontalWheel$OFFSET = $LAYOUT.byteOffset(groupElement("fHasHorizontalWheel"));
