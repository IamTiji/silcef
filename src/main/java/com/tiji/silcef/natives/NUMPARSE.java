...
public class NUMPARSE {
    ...
    private static final long cDig$OFFSET = $LAYOUT.byteOffset(groupElement("cDig"));
    ...
    private static final long dwInFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwInFlags"));
    ...
    private static final long dwOutFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwOutFlags"));
    ...
    private static final long cchUsed$OFFSET = $LAYOUT.byteOffset(groupElement("cchUsed"));
    ...
    private static final long nBaseShift$OFFSET = $LAYOUT.byteOffset(groupElement("nBaseShift"));
    ...
    private static final long nPwr10$OFFSET = $LAYOUT.byteOffset(groupElement("nPwr10"));
