...
public class _JOBOBJECT_EXTENDED_LIMIT_INFORMATION {
    ...
    private static final long BasicLimitInformation$OFFSET = $LAYOUT.byteOffset(groupElement("BasicLimitInformation"));
    ...
    private static final long IoInfo$OFFSET = $LAYOUT.byteOffset(groupElement("IoInfo"));
    ...
    private static final long ProcessMemoryLimit$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessMemoryLimit"));
    ...
    private static final long PeakProcessMemoryUsed$OFFSET = $LAYOUT.byteOffset(groupElement("PeakProcessMemoryUsed"));
    ...
    private static final long PeakJobMemoryUsed$OFFSET = $LAYOUT.byteOffset(groupElement("PeakJobMemoryUsed"));
