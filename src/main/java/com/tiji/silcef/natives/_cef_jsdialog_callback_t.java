 ...
 *     void (*cont)(struct _cef_jsdialog_callback_t *, int, const cef_string_t *) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_jsdialog_callback_t {
    ...
    ).withName("_cef_jsdialog_callback_t");
