...
public class _DRIVER_INFO_5W {
    ...
    private static final long dwDriverAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("dwDriverAttributes"));
    ...
    private static final long dwConfigVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwConfigVersion"));
    ...
    private static final long dwDriverVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwDriverVersion"));
