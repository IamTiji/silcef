...
public class _NCRYPT_TPM_PLATFORM_ATTESTATION_STATEMENT {
    ...
    private static final long pcrAlg$OFFSET = $LAYOUT.byteOffset(groupElement("pcrAlg"));
    ...
    private static final long cbQuote$OFFSET = $LAYOUT.byteOffset(groupElement("cbQuote"));
    ...
    private static final long cbPcrs$OFFSET = $LAYOUT.byteOffset(groupElement("cbPcrs"));
