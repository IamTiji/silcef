 ...
 * }
 */
public final class PFIBER_CALLOUT_ROUTINE {

    private PFIBER_CALLOUT_ROUTINE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFIBER_CALLOUT_ROUTINE.Function.class, "apply", $DESC);
