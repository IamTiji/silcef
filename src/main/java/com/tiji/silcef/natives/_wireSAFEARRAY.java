...
public class _wireSAFEARRAY {
    ...
    private static final long cDims$OFFSET = $LAYOUT.byteOffset(groupElement("cDims"));
    ...
    private static final long fFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("fFeatures"));
    ...
    private static final long cbElements$OFFSET = $LAYOUT.byteOffset(groupElement("cbElements"));
    ...
    private static final long cLocks$OFFSET = $LAYOUT.byteOffset(groupElement("cLocks"));
    ...
    private static final long uArrayStructs$OFFSET = $LAYOUT.byteOffset(groupElement("uArrayStructs"));
    ...
    private static final long rgsabound$OFFSET = $LAYOUT.byteOffset(groupElement("rgsabound"));
    ...
    public static MemorySegment rgsabound(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)rgsabound$ELEM_HANDLE.invokeExact(struct, rgsabound$OFFSET, index0);
