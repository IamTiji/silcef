...
public class _FILE_STORAGE_INFO {
    ...
    private static final long LogicalBytesPerSector$OFFSET = $LAYOUT.byteOffset(groupElement("LogicalBytesPerSector"));
    ...
    private static final long PhysicalBytesPerSectorForAtomicity$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalBytesPerSectorForAtomicity"));
    ...
    private static final long PhysicalBytesPerSectorForPerformance$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalBytesPerSectorForPerformance"));
    ...
    private static final long FileSystemEffectivePhysicalBytesPerSectorForAtomicity$OFFSET = $LAYOUT.byteOffset(groupElement("FileSystemEffectivePhysicalBytesPerSectorForAtomicity"));
    ...
    private static final long ByteOffsetForSectorAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("ByteOffsetForSectorAlignment"));
    ...
    private static final long ByteOffsetForPartitionAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("ByteOffsetForPartitionAlignment"));
