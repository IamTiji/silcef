...
public class _SET_PARTITION_INFORMATION_EX {
    ...
    private static final GroupLayout Mbr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9560:5"), groupElement("Mbr"));
    ...
    private static final long Mbr$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9560:5"), groupElement("Mbr"));
    ...
    private static final GroupLayout Gpt$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9560:5"), groupElement("Gpt"));
    ...
    private static final long Gpt$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9560:5"), groupElement("Gpt"));
