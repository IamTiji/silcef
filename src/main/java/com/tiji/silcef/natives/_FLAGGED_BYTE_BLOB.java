...
public class _FLAGGED_BYTE_BLOB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_CHAR).withName("abData"),
    ...
    private static final long abData$OFFSET = $LAYOUT.byteOffset(groupElement("abData"));
    ...
    public static byte abData(MemorySegment struct, long index0) {
        return (byte)abData$ELEM_HANDLE.get(struct, abData$OFFSET, index0);
    }
    ...
    public static void abData(MemorySegment struct, long index0, byte fieldValue) {
        abData$ELEM_HANDLE.set(struct, abData$OFFSET, index0, fieldValue);
    }
