...
public class tagEMRFRAMERGN {
    ...
    private static final long cbRgnData$OFFSET = $LAYOUT.byteOffset(groupElement("cbRgnData"));
    ...
    private static final long szlStroke$OFFSET = $LAYOUT.byteOffset(groupElement("szlStroke"));
    ...
    private static final long RgnData$OFFSET = $LAYOUT.byteOffset(groupElement("RgnData"));
    ...
    public static byte RgnData(MemorySegment struct, long index0) {
        return (byte)RgnData$ELEM_HANDLE.get(struct, RgnData$OFFSET, index0);
    }
    ...
    public static void RgnData(MemorySegment struct, long index0, byte fieldValue) {
        RgnData$ELEM_HANDLE.set(struct, RgnData$OFFSET, index0, fieldValue);
    }
