...
public class _CTL_FIND_SUBJECT_PARA {
    ...
    private static final long pUsagePara$OFFSET = $LAYOUT.byteOffset(groupElement("pUsagePara"));
    ...
    private static final long dwSubjectType$OFFSET = $LAYOUT.byteOffset(groupElement("dwSubjectType"));
    ...
    private static final long pvSubject$OFFSET = $LAYOUT.byteOffset(groupElement("pvSubject"));
