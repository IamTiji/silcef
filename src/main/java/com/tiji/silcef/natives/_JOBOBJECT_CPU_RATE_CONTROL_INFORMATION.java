...
public class _JOBOBJECT_CPU_RATE_CONTROL_INFORMATION {
    ...
    private static final OfInt CpuRate$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13519:5"), groupElement("CpuRate"));
    ...
    private static final long CpuRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13519:5"), groupElement("CpuRate"));
    ...
    private static final OfInt Weight$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13519:5"), groupElement("Weight"));
    ...
    private static final long Weight$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13519:5"), groupElement("Weight"));
    ...
    private static final OfShort MinRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13519:5"), groupElement("$anon$13522:9"), groupElement("MinRate"));
    ...
    private static final long MinRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13519:5"), groupElement("$anon$13522:9"), groupElement("MinRate"));
    ...
    private static final OfShort MaxRate$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$13519:5"), groupElement("$anon$13522:9"), groupElement("MaxRate"));
    ...
    private static final long MaxRate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$13519:5"), groupElement("$anon$13522:9"), groupElement("MaxRate"));
