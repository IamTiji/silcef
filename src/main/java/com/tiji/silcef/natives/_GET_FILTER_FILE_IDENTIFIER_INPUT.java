...
public class _GET_FILTER_FILE_IDENTIFIER_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_SHORT.withName("AltitudeLength"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_SHORT).withName("Altitude")
    ...
    private static final long AltitudeLength$OFFSET = $LAYOUT.byteOffset(groupElement("AltitudeLength"));
    ...
    private static final long Altitude$OFFSET = $LAYOUT.byteOffset(groupElement("Altitude"));
    ...
    public static short Altitude(MemorySegment struct, long index0) {
        return (short)Altitude$ELEM_HANDLE.get(struct, Altitude$OFFSET, index0);
    }
    ...
    public static void Altitude(MemorySegment struct, long index0, short fieldValue) {
        Altitude$ELEM_HANDLE.set(struct, Altitude$OFFSET, index0, fieldValue);
    }
