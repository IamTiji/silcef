...
public class _CROSS_CERT_DIST_POINTS_INFO {
    ...
    private static final long dwSyncDeltaTime$OFFSET = $LAYOUT.byteOffset(groupElement("dwSyncDeltaTime"));
    ...
    private static final long cDistPoint$OFFSET = $LAYOUT.byteOffset(groupElement("cDistPoint"));
    ...
    private static final long rgDistPoint$OFFSET = $LAYOUT.byteOffset(groupElement("rgDistPoint"));
