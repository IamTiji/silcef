...
public class _CONNECTDLGSTRUCTA {
    ...
    private static final long lpConnRes$OFFSET = $LAYOUT.byteOffset(groupElement("lpConnRes"));
    ...
    private static final long dwDevNum$OFFSET = $LAYOUT.byteOffset(groupElement("dwDevNum"));
