...
/**
 * {@snippet lang=c :
 * struct ISupportActivateAsActivatorPackaged {
 *     struct ISupportActivateAsActivatorPackagedVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportActivateAsActivatorPackaged {
    ...
    ).withName("ISupportActivateAsActivatorPackaged");
