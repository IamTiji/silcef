...
public class _NETRESOURCEA {
    ...
    private static final long dwScope$OFFSET = $LAYOUT.byteOffset(groupElement("dwScope"));
    ...
    private static final long dwDisplayType$OFFSET = $LAYOUT.byteOffset(groupElement("dwDisplayType"));
    ...
    private static final long dwUsage$OFFSET = $LAYOUT.byteOffset(groupElement("dwUsage"));
    ...
    private static final long lpLocalName$OFFSET = $LAYOUT.byteOffset(groupElement("lpLocalName"));
    ...
    private static final long lpRemoteName$OFFSET = $LAYOUT.byteOffset(groupElement("lpRemoteName"));
    ...
    private static final long lpComment$OFFSET = $LAYOUT.byteOffset(groupElement("lpComment"));
    ...
    private static final long lpProvider$OFFSET = $LAYOUT.byteOffset(groupElement("lpProvider"));
