...
public class tagHELPWININFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, cef_render_handler_capi_h.C_CHAR).withName("rgchMember"),
    ...
    private static final long wStructSize$OFFSET = $LAYOUT.byteOffset(groupElement("wStructSize"));
    ...
    private static final long wMax$OFFSET = $LAYOUT.byteOffset(groupElement("wMax"));
    ...
    private static final long rgchMember$OFFSET = $LAYOUT.byteOffset(groupElement("rgchMember"));
    ...
    public static byte rgchMember(MemorySegment struct, long index0) {
        return (byte)rgchMember$ELEM_HANDLE.get(struct, rgchMember$OFFSET, index0);
    }
    ...
    public static void rgchMember(MemorySegment struct, long index0, byte fieldValue) {
        rgchMember$ELEM_HANDLE.set(struct, rgchMember$OFFSET, index0, fieldValue);
    }
