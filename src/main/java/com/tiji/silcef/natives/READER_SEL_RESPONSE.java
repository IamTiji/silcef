...
public class READER_SEL_RESPONSE {
    ...
    private static final long cbCardNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("cbCardNameOffset"));
    ...
    private static final long cchCardNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("cchCardNameLength"));
