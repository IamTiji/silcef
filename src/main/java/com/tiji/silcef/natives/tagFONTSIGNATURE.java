...
public class tagFONTSIGNATURE {
    ...
    private static final long fsUsb$OFFSET = $LAYOUT.byteOffset(groupElement("fsUsb"));
    ...
    public static int fsUsb(MemorySegment struct, long index0) {
        return (int)fsUsb$ELEM_HANDLE.get(struct, fsUsb$OFFSET, index0);
    }
    ...
    public static void fsUsb(MemorySegment struct, long index0, int fieldValue) {
        fsUsb$ELEM_HANDLE.set(struct, fsUsb$OFFSET, index0, fieldValue);
    }
    ...
    private static final long fsCsb$OFFSET = $LAYOUT.byteOffset(groupElement("fsCsb"));
    ...
    public static int fsCsb(MemorySegment struct, long index0) {
        return (int)fsCsb$ELEM_HANDLE.get(struct, fsCsb$OFFSET, index0);
    }
    ...
    public static void fsCsb(MemorySegment struct, long index0, int fieldValue) {
        fsCsb$ELEM_HANDLE.set(struct, fsCsb$OFFSET, index0, fieldValue);
    }
