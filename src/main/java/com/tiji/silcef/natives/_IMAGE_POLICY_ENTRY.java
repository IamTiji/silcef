...
public class _IMAGE_POLICY_ENTRY {
    ...
    private static final long PolicyId$OFFSET = $LAYOUT.byteOffset(groupElement("PolicyId"));
    ...
    public static class u {
        ...
        private static final long BoolValue$OFFSET = $LAYOUT.byteOffset(groupElement("BoolValue"));
        ...
        private static final long Int8Value$OFFSET = $LAYOUT.byteOffset(groupElement("Int8Value"));
        ...
        private static final long UInt8Value$OFFSET = $LAYOUT.byteOffset(groupElement("UInt8Value"));
        ...
        private static final long Int16Value$OFFSET = $LAYOUT.byteOffset(groupElement("Int16Value"));
        ...
        private static final long UInt16Value$OFFSET = $LAYOUT.byteOffset(groupElement("UInt16Value"));
        ...
        private static final long Int32Value$OFFSET = $LAYOUT.byteOffset(groupElement("Int32Value"));
        ...
        private static final long UInt32Value$OFFSET = $LAYOUT.byteOffset(groupElement("UInt32Value"));
        ...
        private static final long Int64Value$OFFSET = $LAYOUT.byteOffset(groupElement("Int64Value"));
        ...
        private static final long UInt64Value$OFFSET = $LAYOUT.byteOffset(groupElement("UInt64Value"));
        ...
        private static final long AnsiStringValue$OFFSET = $LAYOUT.byteOffset(groupElement("AnsiStringValue"));
        ...
        private static final long UnicodeStringValue$OFFSET = $LAYOUT.byteOffset(groupElement("UnicodeStringValue"));
