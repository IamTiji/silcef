...
public class _CRYPT_PROVIDER_REG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cAliases"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgpszAliases"),
    ...
    private static final long cAliases$OFFSET = $LAYOUT.byteOffset(groupElement("cAliases"));
    ...
    private static final long rgpszAliases$OFFSET = $LAYOUT.byteOffset(groupElement("rgpszAliases"));
