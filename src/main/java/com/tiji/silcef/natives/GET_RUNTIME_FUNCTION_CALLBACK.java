 ...
 * }
 */
public final class GET_RUNTIME_FUNCTION_CALLBACK {

    private GET_RUNTIME_FUNCTION_CALLBACK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GET_RUNTIME_FUNCTION_CALLBACK.Function.class, "apply", $DESC);
