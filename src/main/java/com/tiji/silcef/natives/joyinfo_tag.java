...
public class joyinfo_tag {
    ...
    private static final long wXpos$OFFSET = $LAYOUT.byteOffset(groupElement("wXpos"));
    ...
    private static final long wYpos$OFFSET = $LAYOUT.byteOffset(groupElement("wYpos"));
    ...
    private static final long wZpos$OFFSET = $LAYOUT.byteOffset(groupElement("wZpos"));
    ...
    private static final long wButtons$OFFSET = $LAYOUT.byteOffset(groupElement("wButtons"));
