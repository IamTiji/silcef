...
public class tagTTPOLYCURVE {
    ...
    private static final long cpfx$OFFSET = $LAYOUT.byteOffset(groupElement("cpfx"));
    ...
    private static final long apfx$OFFSET = $LAYOUT.byteOffset(groupElement("apfx"));
    ...
    public static MemorySegment apfx(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)apfx$ELEM_HANDLE.invokeExact(struct, apfx$OFFSET, index0);
