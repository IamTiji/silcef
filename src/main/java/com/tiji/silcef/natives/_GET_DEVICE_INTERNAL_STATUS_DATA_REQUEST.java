...
public class _GET_DEVICE_INTERNAL_STATUS_DATA_REQUEST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("RequestDataType"),
        cef_render_handler_capi_h.C_INT.withName("RequestDataSet")
    ...
    private static final long RequestDataType$OFFSET = $LAYOUT.byteOffset(groupElement("RequestDataType"));
    ...
    private static final long RequestDataSet$OFFSET = $LAYOUT.byteOffset(groupElement("RequestDataSet"));
