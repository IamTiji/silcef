...
public class DISPLAYCONFIG_RATIONAL {
    ...
    private static final long Numerator$OFFSET = $LAYOUT.byteOffset(groupElement("Numerator"));
    ...
    private static final long Denominator$OFFSET = $LAYOUT.byteOffset(groupElement("Denominator"));
