...
public class tagCHOOSECOLORA {
    ...
    private static final long rgbResult$OFFSET = $LAYOUT.byteOffset(groupElement("rgbResult"));
    ...
    private static final long lpCustColors$OFFSET = $LAYOUT.byteOffset(groupElement("lpCustColors"));
