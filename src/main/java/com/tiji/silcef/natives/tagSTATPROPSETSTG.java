...
public class tagSTATPROPSETSTG {
    ...
    private static final long fmtid$OFFSET = $LAYOUT.byteOffset(groupElement("fmtid"));
    ...
    private static final long dwOSVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwOSVersion"));
