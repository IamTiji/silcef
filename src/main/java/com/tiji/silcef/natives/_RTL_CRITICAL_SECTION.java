...
public class _RTL_CRITICAL_SECTION {
    ...
    private static final long DebugInfo$OFFSET = $LAYOUT.byteOffset(groupElement("DebugInfo"));
    ...
    private static final long LockCount$OFFSET = $LAYOUT.byteOffset(groupElement("LockCount"));
    ...
    private static final long RecursionCount$OFFSET = $LAYOUT.byteOffset(groupElement("RecursionCount"));
    ...
    private static final long OwningThread$OFFSET = $LAYOUT.byteOffset(groupElement("OwningThread"));
    ...
    private static final long LockSemaphore$OFFSET = $LAYOUT.byteOffset(groupElement("LockSemaphore"));
    ...
    private static final long SpinCount$OFFSET = $LAYOUT.byteOffset(groupElement("SpinCount"));
