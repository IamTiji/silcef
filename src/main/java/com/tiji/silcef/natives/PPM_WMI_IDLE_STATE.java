...
public class PPM_WMI_IDLE_STATE {
    ...
    private static final long Latency$OFFSET = $LAYOUT.byteOffset(groupElement("Latency"));
    ...
    private static final long Power$OFFSET = $LAYOUT.byteOffset(groupElement("Power"));
    ...
    private static final long PromotePercent$OFFSET = $LAYOUT.byteOffset(groupElement("PromotePercent"));
    ...
    private static final long DemotePercent$OFFSET = $LAYOUT.byteOffset(groupElement("DemotePercent"));
    ...
    private static final long StateType$OFFSET = $LAYOUT.byteOffset(groupElement("StateType"));
    ...
    private static final long IdleHandler$OFFSET = $LAYOUT.byteOffset(groupElement("IdleHandler"));
