...
public class _NCryptAlgorithmName {
    ...
    private static final long dwClass$OFFSET = $LAYOUT.byteOffset(groupElement("dwClass"));
    ...
    private static final long dwAlgOperations$OFFSET = $LAYOUT.byteOffset(groupElement("dwAlgOperations"));
