...
public class _DEVICE_DSM_RANGE_ERROR_INFO {
    ...
    private static final long TotalNumberOfRanges$OFFSET = $LAYOUT.byteOffset(groupElement("TotalNumberOfRanges"));
    ...
    private static final long NumberOfRangesReturned$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfRangesReturned"));
