...
/**
 * {@snippet lang=c :
 * struct ISupportActivationFromPackage {
 *     struct ISupportActivationFromPackageVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportActivationFromPackage {
    ...
    ).withName("ISupportActivationFromPackage");
