...
public class tagINTERFACEDATA {
    ...
    private static final long pmethdata$OFFSET = $LAYOUT.byteOffset(groupElement("pmethdata"));
    ...
    private static final long cMembers$OFFSET = $LAYOUT.byteOffset(groupElement("cMembers"));
