 ...
 *     void (*cont)(struct _cef_callback_t *) __attribute__((stdcall));
 *     void (*cancel)(struct _cef_callback_t *) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_callback_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("cont"),
        cef_render_handler_capi_h.C_POINTER.withName("cancel")
    ).withName("_cef_callback_t");
    ...
    public final static class cont {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(cont.Function.class, "apply", $DESC);
