...
public class _FILE_QUERY_SPARING_BUFFER {
    ...
    private static final long SparingUnitBytes$OFFSET = $LAYOUT.byteOffset(groupElement("SparingUnitBytes"));
    ...
    private static final long SoftwareSparing$OFFSET = $LAYOUT.byteOffset(groupElement("SoftwareSparing"));
    ...
    private static final long TotalSpareBlocks$OFFSET = $LAYOUT.byteOffset(groupElement("TotalSpareBlocks"));
    ...
    private static final long FreeSpareBlocks$OFFSET = $LAYOUT.byteOffset(groupElement("FreeSpareBlocks"));
