...
public class _CMC_ADD_ATTRIBUTES_INFO {
    ...
    private static final long dwCmcDataReference$OFFSET = $LAYOUT.byteOffset(groupElement("dwCmcDataReference"));
    ...
    private static final long cCertReference$OFFSET = $LAYOUT.byteOffset(groupElement("cCertReference"));
    ...
    private static final long rgdwCertReference$OFFSET = $LAYOUT.byteOffset(groupElement("rgdwCertReference"));
    ...
    private static final long cAttribute$OFFSET = $LAYOUT.byteOffset(groupElement("cAttribute"));
    ...
    private static final long rgAttribute$OFFSET = $LAYOUT.byteOffset(groupElement("rgAttribute"));
