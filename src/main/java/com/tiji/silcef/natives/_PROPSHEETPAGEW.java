...
public class _PROPSHEETPAGEW {
    ...
    private static final long pszTemplate$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$271:5"), groupElement("pszTemplate"));
    ...
    private static final long pResource$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$271:5"), groupElement("pResource"));
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$271:5"), groupElement("hIcon"));
    ...
    private static final long pszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$271:5"), groupElement("pszIcon"));
    ...
    private static final long hbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$278:5"), groupElement("hbmHeader"));
    ...
    private static final long pszbmHeader$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$278:5"), groupElement("pszbmHeader"));
