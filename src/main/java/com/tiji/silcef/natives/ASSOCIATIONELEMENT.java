...
public class ASSOCIATIONELEMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_INT.withName("ac"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("hkClass"),
        cef_render_handler_capi_h.C_POINTER.withName("pszClass")
    ...
    private static final long ac$OFFSET = $LAYOUT.byteOffset(groupElement("ac"));
    ...
    private static final long hkClass$OFFSET = $LAYOUT.byteOffset(groupElement("hkClass"));
    ...
    private static final long pszClass$OFFSET = $LAYOUT.byteOffset(groupElement("pszClass"));
