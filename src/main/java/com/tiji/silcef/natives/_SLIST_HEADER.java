...
public class _SLIST_HEADER {
    ...
    private static final OfLong Alignment$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$22860:5"), groupElement("Alignment"));
    ...
    private static final long Alignment$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22860:5"), groupElement("Alignment"));
    ...
    private static final OfLong Region$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$22860:5"), groupElement("Region"));
    ...
    private static final long Region$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22860:5"), groupElement("Region"));
    ...
    private static final long HeaderX64$OFFSET = $LAYOUT.byteOffset(groupElement("HeaderX64"));
