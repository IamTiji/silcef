...
public class _QUERY_SERVICE_LOCK_STATUSW {
    ...
    private static final long fIsLocked$OFFSET = $LAYOUT.byteOffset(groupElement("fIsLocked"));
    ...
    private static final long lpLockOwner$OFFSET = $LAYOUT.byteOffset(groupElement("lpLockOwner"));
    ...
    private static final long dwLockDuration$OFFSET = $LAYOUT.byteOffset(groupElement("dwLockDuration"));
