...
public class _CRYPT_RC4_KEY_STATE {
    ...
    private static final long SBox$OFFSET = $LAYOUT.byteOffset(groupElement("SBox"));
    ...
    public static byte SBox(MemorySegment struct, long index0) {
        return (byte)SBox$ELEM_HANDLE.get(struct, SBox$OFFSET, index0);
    }
    ...
    public static void SBox(MemorySegment struct, long index0, byte fieldValue) {
        SBox$ELEM_HANDLE.set(struct, SBox$OFFSET, index0, fieldValue);
    }
    ...
    private static final long j$OFFSET = $LAYOUT.byteOffset(groupElement("j"));
