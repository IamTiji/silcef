...
public class _STORAGE_DEVICE_NUMBERS {
    ...
    private static final long NumberOfDevices$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfDevices"));
    ...
    public static MemorySegment Devices(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Devices$ELEM_HANDLE.invokeExact(struct, Devices$OFFSET, index0);
