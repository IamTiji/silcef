...
public class tagVARDESC {
    ...
    private static final long oInst$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$880:36"), groupElement("oInst"));
    ...
    private static final long lpvarValue$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$880:36"), groupElement("lpvarValue"));
    ...
    private static final long elemdescVar$OFFSET = $LAYOUT.byteOffset(groupElement("elemdescVar"));
    ...
    private static final long wVarFlags$OFFSET = $LAYOUT.byteOffset(groupElement("wVarFlags"));
    ...
    private static final long varkind$OFFSET = $LAYOUT.byteOffset(groupElement("varkind"));
