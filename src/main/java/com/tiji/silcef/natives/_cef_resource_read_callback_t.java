 ...
 *     void (*cont)(struct _cef_resource_read_callback_t *, int) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_resource_read_callback_t {
    ...
    ).withName("_cef_resource_read_callback_t");
