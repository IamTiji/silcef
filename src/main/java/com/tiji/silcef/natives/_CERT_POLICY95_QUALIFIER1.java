...
public class _CERT_POLICY95_QUALIFIER1 {
    ...
    private static final long pszPracticesReference$OFFSET = $LAYOUT.byteOffset(groupElement("pszPracticesReference"));
    ...
    private static final long pszNoticeIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("pszNoticeIdentifier"));
    ...
    private static final long pszNSINoticeIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("pszNSINoticeIdentifier"));
    ...
    private static final long cCPSURLs$OFFSET = $LAYOUT.byteOffset(groupElement("cCPSURLs"));
    ...
    private static final long rgCPSURLs$OFFSET = $LAYOUT.byteOffset(groupElement("rgCPSURLs"));
