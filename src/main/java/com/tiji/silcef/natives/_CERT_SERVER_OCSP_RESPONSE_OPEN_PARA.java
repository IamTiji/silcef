...
public class _CERT_SERVER_OCSP_RESPONSE_OPEN_PARA {
    ...
    private static final long pcbUsedSize$OFFSET = $LAYOUT.byteOffset(groupElement("pcbUsedSize"));
    ...
    private static final long pwszOcspDirectory$OFFSET = $LAYOUT.byteOffset(groupElement("pwszOcspDirectory"));
    ...
    private static final long pfnUpdateCallback$OFFSET = $LAYOUT.byteOffset(groupElement("pfnUpdateCallback"));
    ...
    private static final long pvUpdateCallbackArg$OFFSET = $LAYOUT.byteOffset(groupElement("pvUpdateCallbackArg"));
