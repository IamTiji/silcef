...
public class _devicemodeA {
    ...
    public static byte dmDeviceName(MemorySegment struct, long index0) {
        return (byte)dmDeviceName$ELEM_HANDLE.get(struct, dmDeviceName$OFFSET, index0);
    }
    ...
    private static final long dmOrientation$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmOrientation"));
    ...
    private static final long dmPaperSize$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperSize"));
    ...
    private static final long dmPaperLength$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperLength"));
    ...
    private static final long dmPaperWidth$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperWidth"));
    ...
    private static final long dmScale$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmScale"));
    ...
    private static final long dmCopies$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmCopies"));
    ...
    private static final long dmDefaultSource$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmDefaultSource"));
    ...
    private static final long dmPrintQuality$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPrintQuality"));
    ...
    private static final long dmPosition$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmPosition"));
    ...
    private static final long dmDisplayOrientation$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmDisplayOrientation"));
    ...
    private static final long dmDisplayFixedOutput$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmDisplayFixedOutput"));
    ...
    public static byte dmFormName(MemorySegment struct, long index0) {
        return (byte)dmFormName$ELEM_HANDLE.get(struct, dmFormName$OFFSET, index0);
    }
    ...
    private static final long dmDisplayFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2234:5"), groupElement("dmDisplayFlags"));
    ...
    private static final long dmNup$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2234:5"), groupElement("dmNup"));
