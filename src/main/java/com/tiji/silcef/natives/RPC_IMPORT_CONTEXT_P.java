...
public class RPC_IMPORT_CONTEXT_P {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_POINTER.withName("LookupContext"),
        cef_render_handler_capi_h.C_POINTER.withName("ProposedHandle"),
        cef_render_handler_capi_h.C_POINTER.withName("Bindings")
    ).withName("$anon$32:9");
    ...
    private static final long LookupContext$OFFSET = $LAYOUT.byteOffset(groupElement("LookupContext"));
    ...
    private static final long ProposedHandle$OFFSET = $LAYOUT.byteOffset(groupElement("ProposedHandle"));
    ...
    private static final long Bindings$OFFSET = $LAYOUT.byteOffset(groupElement("Bindings"));
