...
public class _TRANSACTION_LIST_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("NumberOfTransactions"),
    ...
    private static final long NumberOfTransactions$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfTransactions"));
    ...
    private static final long TransactionInformation$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionInformation"));
    ...
    public static MemorySegment TransactionInformation(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)TransactionInformation$ELEM_HANDLE.invokeExact(struct, TransactionInformation$OFFSET, index0);
