...
public class _MODEMSETTINGS {
    ...
    private static final long dwPreferredModemOptions$OFFSET = $LAYOUT.byteOffset(groupElement("dwPreferredModemOptions"));
    ...
    private static final long dwNegotiatedModemOptions$OFFSET = $LAYOUT.byteOffset(groupElement("dwNegotiatedModemOptions"));
    ...
    private static final long dwNegotiatedDCERate$OFFSET = $LAYOUT.byteOffset(groupElement("dwNegotiatedDCERate"));
