 ...
 * }
 */
public final class FONTENUMPROC {

    private FONTENUMPROC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(FONTENUMPROC.Function.class, "apply", $DESC);
