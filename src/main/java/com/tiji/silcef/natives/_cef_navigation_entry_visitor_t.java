 ...
 *     int (*visit)(struct _cef_navigation_entry_visitor_t *, struct _cef_navigation_entry_t *, int, int, int) __attribute__((stdcall));
 * }
 * }
 */
public class _cef_navigation_entry_visitor_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("visit")
    ).withName("_cef_navigation_entry_visitor_t");
    ...
    public final static class visit {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(visit.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(visit.Function fi, Arena arena) {
    ...
    private static final AddressLayout visit$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("visit"));
     ...
     * }
     */
    public static final AddressLayout visit$layout() {
        return visit$LAYOUT;
    }

    private static final long visit$OFFSET = $LAYOUT.byteOffset(groupElement("visit"));
     ...
     * }
     */
    public static MemorySegment visit(MemorySegment struct) {
        return struct.get(visit$LAYOUT, visit$OFFSET);
    }
     ...
     * }
     */
    public static void visit(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(visit$LAYOUT, visit$OFFSET, fieldValue);
    }
