...
public class tagINPUT {
    ...
    private static final GroupLayout mi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6161:5"), groupElement("mi"));
    ...
    private static final long mi$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6161:5"), groupElement("mi"));
    ...
    private static final GroupLayout ki$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6161:5"), groupElement("ki"));
    ...
    private static final long ki$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6161:5"), groupElement("ki"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6161:5"), groupElement("hi"));
    ...
    private static final long hi$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6161:5"), groupElement("hi"));
