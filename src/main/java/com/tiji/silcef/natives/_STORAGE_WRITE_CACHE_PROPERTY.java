...
public class _STORAGE_WRITE_CACHE_PROPERTY {
    ...
    private static final long WriteCacheType$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCacheType"));
    ...
    private static final long WriteCacheChangeable$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCacheChangeable"));
    ...
    private static final long WriteThroughSupported$OFFSET = $LAYOUT.byteOffset(groupElement("WriteThroughSupported"));
    ...
    private static final long FlushCacheSupported$OFFSET = $LAYOUT.byteOffset(groupElement("FlushCacheSupported"));
    ...
    private static final long UserDefinedPowerProtection$OFFSET = $LAYOUT.byteOffset(groupElement("UserDefinedPowerProtection"));
    ...
    private static final long NVCacheEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("NVCacheEnabled"));
