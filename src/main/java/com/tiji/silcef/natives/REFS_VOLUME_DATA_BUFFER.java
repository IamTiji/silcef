...
public class REFS_VOLUME_DATA_BUFFER {
    ...
    private static final long BytesPerPhysicalSector$OFFSET = $LAYOUT.byteOffset(groupElement("BytesPerPhysicalSector"));
    ...
    private static final long VolumeSerialNumber$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeSerialNumber"));
    ...
    private static final long NumberSectors$OFFSET = $LAYOUT.byteOffset(groupElement("NumberSectors"));
    ...
    private static final long TotalClusters$OFFSET = $LAYOUT.byteOffset(groupElement("TotalClusters"));
    ...
    private static final long FreeClusters$OFFSET = $LAYOUT.byteOffset(groupElement("FreeClusters"));
    ...
    private static final long TotalReserved$OFFSET = $LAYOUT.byteOffset(groupElement("TotalReserved"));
    ...
    private static final long BytesPerSector$OFFSET = $LAYOUT.byteOffset(groupElement("BytesPerSector"));
    ...
    private static final long BytesPerCluster$OFFSET = $LAYOUT.byteOffset(groupElement("BytesPerCluster"));
    ...
    private static final long MaximumSizeOfResidentFile$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumSizeOfResidentFile"));
    ...
    private static final long FastTierDataFillRatio$OFFSET = $LAYOUT.byteOffset(groupElement("FastTierDataFillRatio"));
    ...
    private static final long SlowTierDataFillRatio$OFFSET = $LAYOUT.byteOffset(groupElement("SlowTierDataFillRatio"));
    ...
    private static final long DestagesFastTierToSlowTierRate$OFFSET = $LAYOUT.byteOffset(groupElement("DestagesFastTierToSlowTierRate"));
    ...
    private static final long MetadataChecksumType$OFFSET = $LAYOUT.byteOffset(groupElement("MetadataChecksumType"));
    ...
    public static byte Reserved0(MemorySegment struct, long index0) {
        return (byte)Reserved0$ELEM_HANDLE.get(struct, Reserved0$OFFSET, index0);
    }
    ...
    public static void Reserved0(MemorySegment struct, long index0, byte fieldValue) {
        Reserved0$ELEM_HANDLE.set(struct, Reserved0$OFFSET, index0, fieldValue);
    }
    ...
    private static final long DriverMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("DriverMajorVersion"));
    ...
    private static final long DriverMinorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("DriverMinorVersion"));
    ...
    public static MemorySegment Reserved(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Reserved$ELEM_HANDLE.invokeExact(struct, Reserved$OFFSET, index0);
