...
public class _DISPLAYCONFIG_SET_ADVANCED_COLOR_STATE {
    ...
    private static final OfInt value$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$3191:5"), groupElement("value"));
    ...
    private static final long value$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3191:5"), groupElement("value"));
