...
public class tagEXTLOGPEN32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("elpHatch"),
    ...
    private static final long elpPenStyle$OFFSET = $LAYOUT.byteOffset(groupElement("elpPenStyle"));
    ...
    private static final long elpWidth$OFFSET = $LAYOUT.byteOffset(groupElement("elpWidth"));
    ...
    private static final long elpBrushStyle$OFFSET = $LAYOUT.byteOffset(groupElement("elpBrushStyle"));
    ...
    private static final long elpColor$OFFSET = $LAYOUT.byteOffset(groupElement("elpColor"));
    ...
    private static final long elpHatch$OFFSET = $LAYOUT.byteOffset(groupElement("elpHatch"));
    ...
    private static final long elpNumEntries$OFFSET = $LAYOUT.byteOffset(groupElement("elpNumEntries"));
    ...
    private static final long elpStyleEntry$OFFSET = $LAYOUT.byteOffset(groupElement("elpStyleEntry"));
    ...
    public static int elpStyleEntry(MemorySegment struct, long index0) {
        return (int)elpStyleEntry$ELEM_HANDLE.get(struct, elpStyleEntry$OFFSET, index0);
    }
    ...
    public static void elpStyleEntry(MemorySegment struct, long index0, int fieldValue) {
        elpStyleEntry$ELEM_HANDLE.set(struct, elpStyleEntry$OFFSET, index0, fieldValue);
    }
