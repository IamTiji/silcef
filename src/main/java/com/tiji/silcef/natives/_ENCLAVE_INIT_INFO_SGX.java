...
public class _ENCLAVE_INIT_INFO_SGX {
    ...
    private static final long SigStruct$OFFSET = $LAYOUT.byteOffset(groupElement("SigStruct"));
    ...
    public static byte SigStruct(MemorySegment struct, long index0) {
        return (byte)SigStruct$ELEM_HANDLE.get(struct, SigStruct$OFFSET, index0);
    }
    ...
    public static void SigStruct(MemorySegment struct, long index0, byte fieldValue) {
        SigStruct$ELEM_HANDLE.set(struct, SigStruct$OFFSET, index0, fieldValue);
    }
    ...
    private static final long EInitToken$OFFSET = $LAYOUT.byteOffset(groupElement("EInitToken"));
    ...
    public static byte EInitToken(MemorySegment struct, long index0) {
        return (byte)EInitToken$ELEM_HANDLE.get(struct, EInitToken$OFFSET, index0);
    }
    ...
    public static void EInitToken(MemorySegment struct, long index0, byte fieldValue) {
        EInitToken$ELEM_HANDLE.set(struct, EInitToken$OFFSET, index0, fieldValue);
    }
