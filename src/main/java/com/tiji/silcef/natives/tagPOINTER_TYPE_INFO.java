...
public class tagPOINTER_TYPE_INFO {
    ...
    private static final GroupLayout pointerInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6512:5"), groupElement("pointerInfo"));
    ...
    private static final long pointerInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6512:5"), groupElement("pointerInfo"));
    ...
    private static final GroupLayout touchInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6512:5"), groupElement("touchInfo"));
    ...
    private static final long touchInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6512:5"), groupElement("touchInfo"));
    ...
    private static final GroupLayout penInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6512:5"), groupElement("penInfo"));
    ...
    private static final long penInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6512:5"), groupElement("penInfo"));
