...
public class _CERT_CHAIN_POLICY_STATUS {
    ...
    private static final long lChainIndex$OFFSET = $LAYOUT.byteOffset(groupElement("lChainIndex"));
    ...
    private static final long lElementIndex$OFFSET = $LAYOUT.byteOffset(groupElement("lElementIndex"));
    ...
    private static final long pvExtraPolicyStatus$OFFSET = $LAYOUT.byteOffset(groupElement("pvExtraPolicyStatus"));
