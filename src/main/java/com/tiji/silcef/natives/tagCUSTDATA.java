...
public class tagCUSTDATA {
    ...
    private static final long cCustData$OFFSET = $LAYOUT.byteOffset(groupElement("cCustData"));
    ...
    private static final long prgCustData$OFFSET = $LAYOUT.byteOffset(groupElement("prgCustData"));
