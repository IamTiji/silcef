...
public class _ARM64_NT_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("Cpsr"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                ...
                cef_master_h.C_LONG_LONG.withName("X13"),
                cef_master_h.C_LONG_LONG.withName("X14"),
                cef_master_h.C_LONG_LONG.withName("X15"),
                cef_master_h.C_LONG_LONG.withName("X16"),
                cef_master_h.C_LONG_LONG.withName("X17"),
                cef_master_h.C_LONG_LONG.withName("X18"),
        ...
        cef_master_h.C_LONG.withName("Fpcr"),
        cef_master_h.C_LONG.withName("Fpsr"),
        MemoryLayout.sequenceLayout(8, cef_master_h.C_LONG).withName("Bcr"),
        MemoryLayout.sequenceLayout(8, cef_master_h.C_LONG_LONG).withName("Bvr"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_LONG).withName("Wcr"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_LONG_LONG).withName("Wvr")
