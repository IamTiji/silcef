...
public class tagMIXERCONTROLW {
    ...
    public static short szShortName(MemorySegment struct, long index0) {
        return (short)szShortName$ELEM_HANDLE.get(struct, szShortName$OFFSET, index0);
    }
    ...
    public static short szName(MemorySegment struct, long index0) {
        return (short)szName$ELEM_HANDLE.get(struct, szName$OFFSET, index0);
    }
    ...
    public static class Bounds {
        ...
        private static final OfInt lMinimum$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2089:9"), groupElement("lMinimum"));
        ...
        private static final long lMinimum$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2089:9"), groupElement("lMinimum"));
        ...
        private static final OfInt lMaximum$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2089:9"), groupElement("lMaximum"));
        ...
        private static final long lMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2089:9"), groupElement("lMaximum"));
        ...
        private static final OfInt dwMinimum$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2093:9"), groupElement("dwMinimum"));
        ...
        private static final long dwMinimum$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2093:9"), groupElement("dwMinimum"));
        ...
        private static final OfInt dwMaximum$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2093:9"), groupElement("dwMaximum"));
        ...
        private static final long dwMaximum$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2093:9"), groupElement("dwMaximum"));
