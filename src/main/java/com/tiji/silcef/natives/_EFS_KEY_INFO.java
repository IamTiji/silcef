...
public class _EFS_KEY_INFO {
    ...
    private static final long Entropy$OFFSET = $LAYOUT.byteOffset(groupElement("Entropy"));
    ...
    private static final long KeyLength$OFFSET = $LAYOUT.byteOffset(groupElement("KeyLength"));
