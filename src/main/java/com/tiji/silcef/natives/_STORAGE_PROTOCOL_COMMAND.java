...
public class _STORAGE_PROTOCOL_COMMAND {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("ReturnStatus"),
        cef_master_h.C_LONG.withName("ErrorCode"),
        cef_master_h.C_LONG.withName("CommandLength"),
        cef_master_h.C_LONG.withName("ErrorInfoLength"),
        cef_master_h.C_LONG.withName("DataToDeviceTransferLength"),
        cef_master_h.C_LONG.withName("DataFromDeviceTransferLength"),
        cef_master_h.C_LONG.withName("TimeOutValue"),
        cef_master_h.C_LONG.withName("ErrorInfoOffset"),
        cef_master_h.C_LONG.withName("DataToDeviceBufferOffset"),
        cef_master_h.C_LONG.withName("DataFromDeviceBufferOffset"),
        cef_master_h.C_LONG.withName("CommandSpecific"),
        cef_master_h.C_LONG.withName("Reserved0"),
        cef_master_h.C_LONG.withName("FixedProtocolReturnData"),
        cef_master_h.C_LONG.withName("FixedProtocolReturnData2"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_LONG).withName("Reserved1"),
        MemoryLayout.sequenceLayout(1, cef_master_h.C_CHAR).withName("Command"),
