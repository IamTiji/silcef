...
public class _STORAGE_PROTOCOL_COMMAND {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("ReturnStatus"),
        cef_render_handler_capi_h.C_LONG.withName("ErrorCode"),
        cef_render_handler_capi_h.C_LONG.withName("CommandLength"),
        cef_render_handler_capi_h.C_LONG.withName("ErrorInfoLength"),
        cef_render_handler_capi_h.C_LONG.withName("DataToDeviceTransferLength"),
        cef_render_handler_capi_h.C_LONG.withName("DataFromDeviceTransferLength"),
        cef_render_handler_capi_h.C_LONG.withName("TimeOutValue"),
        cef_render_handler_capi_h.C_LONG.withName("ErrorInfoOffset"),
        cef_render_handler_capi_h.C_LONG.withName("DataToDeviceBufferOffset"),
        cef_render_handler_capi_h.C_LONG.withName("DataFromDeviceBufferOffset"),
        cef_render_handler_capi_h.C_LONG.withName("CommandSpecific"),
        cef_render_handler_capi_h.C_LONG.withName("Reserved0"),
        cef_render_handler_capi_h.C_LONG.withName("FixedProtocolReturnData"),
        cef_render_handler_capi_h.C_LONG.withName("FixedProtocolReturnData2"),
        MemoryLayout.sequenceLayout(2, cef_render_handler_capi_h.C_LONG).withName("Reserved1"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.C_CHAR).withName("Command"),
    ...
    private static final long ReturnStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ReturnStatus"));
    ...
    private static final long ErrorCode$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorCode"));
    ...
    private static final long CommandLength$OFFSET = $LAYOUT.byteOffset(groupElement("CommandLength"));
    ...
    private static final long ErrorInfoLength$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorInfoLength"));
    ...
    private static final long DataToDeviceTransferLength$OFFSET = $LAYOUT.byteOffset(groupElement("DataToDeviceTransferLength"));
    ...
    private static final long DataFromDeviceTransferLength$OFFSET = $LAYOUT.byteOffset(groupElement("DataFromDeviceTransferLength"));
    ...
    private static final long TimeOutValue$OFFSET = $LAYOUT.byteOffset(groupElement("TimeOutValue"));
    ...
    private static final long ErrorInfoOffset$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorInfoOffset"));
    ...
    private static final long DataToDeviceBufferOffset$OFFSET = $LAYOUT.byteOffset(groupElement("DataToDeviceBufferOffset"));
    ...
    private static final long DataFromDeviceBufferOffset$OFFSET = $LAYOUT.byteOffset(groupElement("DataFromDeviceBufferOffset"));
    ...
    private static final long CommandSpecific$OFFSET = $LAYOUT.byteOffset(groupElement("CommandSpecific"));
    ...
    private static final OfInt FixedProtocolReturnData2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("FixedProtocolReturnData2"));
     ...
     * }
     */
    public static final OfInt FixedProtocolReturnData2$layout() {
        return FixedProtocolReturnData2$LAYOUT;
    }

    private static final long FixedProtocolReturnData2$OFFSET = $LAYOUT.byteOffset(groupElement("FixedProtocolReturnData2"));
     ...
     * }
     */
    public static final long FixedProtocolReturnData2$offset() {
        return FixedProtocolReturnData2$OFFSET;
    }
     ...
     * }
     */
    public static int FixedProtocolReturnData2(MemorySegment struct) {
        return struct.get(FixedProtocolReturnData2$LAYOUT, FixedProtocolReturnData2$OFFSET);
    }
     ...
     * }
     */
    public static void FixedProtocolReturnData2(MemorySegment struct, int fieldValue) {
        struct.set(FixedProtocolReturnData2$LAYOUT, FixedProtocolReturnData2$OFFSET, fieldValue);
    }
    ...
    public static int Reserved1(MemorySegment struct, long index0) {
        return (int)Reserved1$ELEM_HANDLE.get(struct, Reserved1$OFFSET, index0);
    }
    ...
    private static final long Command$OFFSET = $LAYOUT.byteOffset(groupElement("Command"));
    ...
    public static byte Command(MemorySegment struct, long index0) {
        return (byte)Command$ELEM_HANDLE.get(struct, Command$OFFSET, index0);
    }
    ...
    public static void Command(MemorySegment struct, long index0, byte fieldValue) {
        Command$ELEM_HANDLE.set(struct, Command$OFFSET, index0, fieldValue);
    }
