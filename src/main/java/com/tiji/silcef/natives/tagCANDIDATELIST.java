...
public class tagCANDIDATELIST {
    ...
    private static final long dwCount$OFFSET = $LAYOUT.byteOffset(groupElement("dwCount"));
    ...
    private static final long dwSelection$OFFSET = $LAYOUT.byteOffset(groupElement("dwSelection"));
    ...
    private static final long dwPageStart$OFFSET = $LAYOUT.byteOffset(groupElement("dwPageStart"));
    ...
    public static int dwOffset(MemorySegment struct, long index0) {
        return (int)dwOffset$ELEM_HANDLE.get(struct, dwOffset$OFFSET, index0);
    }
    ...
    public static void dwOffset(MemorySegment struct, long index0, int fieldValue) {
        dwOffset$ELEM_HANDLE.set(struct, dwOffset$OFFSET, index0, fieldValue);
    }
