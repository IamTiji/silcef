...
public class _ENCRYPTION_KEY_CTRL_INPUT {
    ...
    private static final long KeyOffset$OFFSET = $LAYOUT.byteOffset(groupElement("KeyOffset"));
    ...
    private static final long DplLock$OFFSET = $LAYOUT.byteOffset(groupElement("DplLock"));
    ...
    private static final long DplUserId$OFFSET = $LAYOUT.byteOffset(groupElement("DplUserId"));
    ...
    private static final long DplCredentialId$OFFSET = $LAYOUT.byteOffset(groupElement("DplCredentialId"));
