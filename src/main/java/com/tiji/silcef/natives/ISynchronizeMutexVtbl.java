...
public class ISynchronizeMutexVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("ReleaseMutex")
     ...
     * }
     */
    public final static class ReleaseMutex {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ReleaseMutex.Function.class, "apply", $DESC);
    ...
    private static final long ReleaseMutex$OFFSET = $LAYOUT.byteOffset(groupElement("ReleaseMutex"));
