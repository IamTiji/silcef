...
public class tagNEWTEXTMETRICW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_LONG.withName("tmHeight"),
        cef_master_h.C_LONG.withName("tmAscent"),
        cef_master_h.C_LONG.withName("tmDescent"),
        cef_master_h.C_LONG.withName("tmInternalLeading"),
        cef_master_h.C_LONG.withName("tmExternalLeading"),
        cef_master_h.C_LONG.withName("tmAveCharWidth"),
        cef_master_h.C_LONG.withName("tmMaxCharWidth"),
        cef_master_h.C_LONG.withName("tmWeight"),
        cef_master_h.C_LONG.withName("tmOverhang"),
        cef_master_h.C_LONG.withName("tmDigitizedAspectX"),
        cef_master_h.C_LONG.withName("tmDigitizedAspectY"),
        cef_master_h.C_SHORT.withName("tmFirstChar"),
        cef_master_h.C_SHORT.withName("tmLastChar"),
        cef_master_h.C_SHORT.withName("tmDefaultChar"),
        cef_master_h.C_SHORT.withName("tmBreakChar"),
        cef_master_h.C_CHAR.withName("tmItalic"),
        cef_master_h.C_CHAR.withName("tmUnderlined"),
        cef_master_h.C_CHAR.withName("tmStruckOut"),
        cef_master_h.C_CHAR.withName("tmPitchAndFamily"),
        cef_master_h.C_CHAR.withName("tmCharSet"),
        MemoryLayout.paddingLayout(3),
        cef_master_h.C_LONG.withName("ntmFlags"),
        cef_master_h.C_INT.withName("ntmSizeEM"),
        cef_master_h.C_INT.withName("ntmCellHeight"),
        cef_master_h.C_INT.withName("ntmAvgWidth")
