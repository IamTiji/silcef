...
public class _USER_MARSHAL_CB {
    ...
    private static final long pStubMsg$OFFSET = $LAYOUT.byteOffset(groupElement("pStubMsg"));
    ...
    private static final long pReserve$OFFSET = $LAYOUT.byteOffset(groupElement("pReserve"));
    ...
    private static final long CBType$OFFSET = $LAYOUT.byteOffset(groupElement("CBType"));
    ...
    private static final long pFormat$OFFSET = $LAYOUT.byteOffset(groupElement("pFormat"));
    ...
    private static final long pTypeFormat$OFFSET = $LAYOUT.byteOffset(groupElement("pTypeFormat"));
