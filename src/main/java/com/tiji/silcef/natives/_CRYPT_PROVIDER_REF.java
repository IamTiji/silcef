...
public class _CRYPT_PROVIDER_REF {
    ...
    private static final long dwInterface$OFFSET = $LAYOUT.byteOffset(groupElement("dwInterface"));
    ...
    private static final long pszFunction$OFFSET = $LAYOUT.byteOffset(groupElement("pszFunction"));
    ...
    private static final long cProperties$OFFSET = $LAYOUT.byteOffset(groupElement("cProperties"));
    ...
    private static final long rgpProperties$OFFSET = $LAYOUT.byteOffset(groupElement("rgpProperties"));
    ...
    private static final long pUM$OFFSET = $LAYOUT.byteOffset(groupElement("pUM"));
    ...
    private static final long pKM$OFFSET = $LAYOUT.byteOffset(groupElement("pKM"));
