...
public class tagEMRSETDIBITSTODEVICE {
    ...
    private static final long iStartScan$OFFSET = $LAYOUT.byteOffset(groupElement("iStartScan"));
    ...
    private static final long cScans$OFFSET = $LAYOUT.byteOffset(groupElement("cScans"));
