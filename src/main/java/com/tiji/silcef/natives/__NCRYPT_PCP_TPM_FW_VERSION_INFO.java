...
public class __NCRYPT_PCP_TPM_FW_VERSION_INFO {
    ...
    private static final long major1$OFFSET = $LAYOUT.byteOffset(groupElement("major1"));
    ...
    private static final long major2$OFFSET = $LAYOUT.byteOffset(groupElement("major2"));
    ...
    private static final long minor1$OFFSET = $LAYOUT.byteOffset(groupElement("minor1"));
    ...
    private static final long minor2$OFFSET = $LAYOUT.byteOffset(groupElement("minor2"));
