...
public class _SE_TOKEN_USER {
    ...
    private static final GroupLayout TokenUser$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$12116:5"), groupElement("TokenUser"));
    ...
    private static final long TokenUser$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12116:5"), groupElement("TokenUser"));
    ...
    private static final GroupLayout User$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$12116:5"), groupElement("User"));
    ...
    private static final long User$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12116:5"), groupElement("User"));
    ...
    private static final GroupLayout Sid$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$12121:5"), groupElement("Sid"));
    ...
    private static final long Sid$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12121:5"), groupElement("Sid"));
    ...
    private static final SequenceLayout Buffer$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12121:5"), groupElement("Buffer"));
    ...
    private static final long Buffer$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12121:5"), groupElement("Buffer"));
    ...
    public static byte Buffer(MemorySegment struct, long index0) {
        return (byte)Buffer$ELEM_HANDLE.get(struct, Buffer$OFFSET, index0);
    }
    ...
    public static void Buffer(MemorySegment struct, long index0, byte fieldValue) {
        Buffer$ELEM_HANDLE.set(struct, Buffer$OFFSET, index0, fieldValue);
    }
