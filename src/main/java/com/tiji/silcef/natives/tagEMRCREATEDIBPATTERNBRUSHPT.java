...
public class tagEMRCREATEDIBPATTERNBRUSHPT {
    ...
    private static final long ihBrush$OFFSET = $LAYOUT.byteOffset(groupElement("ihBrush"));
    ...
    private static final long iUsage$OFFSET = $LAYOUT.byteOffset(groupElement("iUsage"));
    ...
    private static final long offBmi$OFFSET = $LAYOUT.byteOffset(groupElement("offBmi"));
    ...
    private static final long cbBmi$OFFSET = $LAYOUT.byteOffset(groupElement("cbBmi"));
    ...
    private static final long offBits$OFFSET = $LAYOUT.byteOffset(groupElement("offBits"));
    ...
    private static final long cbBits$OFFSET = $LAYOUT.byteOffset(groupElement("cbBits"));
