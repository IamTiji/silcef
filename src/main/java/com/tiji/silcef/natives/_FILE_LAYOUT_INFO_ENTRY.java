...
public class _FILE_LAYOUT_INFO_ENTRY {
    ...
    private static final long BasicInformation$OFFSET = $LAYOUT.byteOffset(groupElement("BasicInformation"));
    ...
    private static final long OwnerId$OFFSET = $LAYOUT.byteOffset(groupElement("OwnerId"));
    ...
    private static final long StorageReserveId$OFFSET = $LAYOUT.byteOffset(groupElement("StorageReserveId"));
