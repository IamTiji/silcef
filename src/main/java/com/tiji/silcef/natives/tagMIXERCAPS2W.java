...
public class tagMIXERCAPS2W {
    ...
    private static final long fdwSupport$OFFSET = $LAYOUT.byteOffset(groupElement("fdwSupport"));
    ...
    private static final long cDestinations$OFFSET = $LAYOUT.byteOffset(groupElement("cDestinations"));
