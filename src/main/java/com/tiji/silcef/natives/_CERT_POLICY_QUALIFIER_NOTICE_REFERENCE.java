...
public class _CERT_POLICY_QUALIFIER_NOTICE_REFERENCE {
    ...
    private static final long pszOrganization$OFFSET = $LAYOUT.byteOffset(groupElement("pszOrganization"));
    ...
    private static final long cNoticeNumbers$OFFSET = $LAYOUT.byteOffset(groupElement("cNoticeNumbers"));
    ...
    private static final long rgNoticeNumbers$OFFSET = $LAYOUT.byteOffset(groupElement("rgNoticeNumbers"));
