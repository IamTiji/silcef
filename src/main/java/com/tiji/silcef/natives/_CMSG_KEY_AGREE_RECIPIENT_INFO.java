...
public class _CMSG_KEY_AGREE_RECIPIENT_INFO {
    ...
    private static final GroupLayout OriginatorCertId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$7993:5"), groupElement("OriginatorCertId"));
    ...
    private static final long OriginatorCertId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7993:5"), groupElement("OriginatorCertId"));
    ...
    private static final GroupLayout OriginatorPublicKeyInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$7993:5"), groupElement("OriginatorPublicKeyInfo"));
    ...
    private static final long OriginatorPublicKeyInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$7993:5"), groupElement("OriginatorPublicKeyInfo"));
