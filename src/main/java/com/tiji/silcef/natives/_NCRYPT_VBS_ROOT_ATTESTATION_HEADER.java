...
/**
 * {@snippet lang=c :
 * struct _NCRYPT_VBS_ROOT_ATTESTATION_HEADER {
 *     ULONG Magic;
 *     ULONG Version;
 *     ULONG cbAttributes;
 *     ULONG cbNonce;
 ...
 * }
 */
public class _NCRYPT_VBS_ROOT_ATTESTATION_HEADER {

    _NCRYPT_VBS_ROOT_ATTESTATION_HEADER() {
    ...
    private static final long cbReport$OFFSET = $LAYOUT.byteOffset(groupElement("cbReport"));
