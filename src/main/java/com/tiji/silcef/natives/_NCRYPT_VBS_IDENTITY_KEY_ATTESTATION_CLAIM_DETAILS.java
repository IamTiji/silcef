...
public class _NCRYPT_VBS_IDENTITY_KEY_ATTESTATION_CLAIM_DETAILS {
    ...
    private static final long ulKeyFlags$OFFSET = $LAYOUT.byteOffset(groupElement("ulKeyFlags"));
    ...
    private static final long pszSignatureHashAlg$OFFSET = $LAYOUT.byteOffset(groupElement("pszSignatureHashAlg"));
    ...
    private static final long ulPaddingScheme$OFFSET = $LAYOUT.byteOffset(groupElement("ulPaddingScheme"));
    ...
    private static final long pszPaddingHashAlg$OFFSET = $LAYOUT.byteOffset(groupElement("pszPaddingHashAlg"));
    ...
    private static final long ulPaddingSalt$OFFSET = $LAYOUT.byteOffset(groupElement("ulPaddingSalt"));
