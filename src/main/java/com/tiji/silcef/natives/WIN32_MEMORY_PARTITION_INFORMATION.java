...
public class WIN32_MEMORY_PARTITION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("NumaNode"),
        cef_master_h.C_LONG.withName("Channel"),
        cef_master_h.C_LONG.withName("NumberOfNumaNodes"),
        cef_master_h.C_LONG_LONG.withName("ResidentAvailablePages"),
        cef_master_h.C_LONG_LONG.withName("CommittedPages"),
        cef_master_h.C_LONG_LONG.withName("CommitLimit"),
        cef_master_h.C_LONG_LONG.withName("PeakCommitment"),
        cef_master_h.C_LONG_LONG.withName("TotalNumberOfPages"),
        cef_master_h.C_LONG_LONG.withName("AvailablePages"),
        cef_master_h.C_LONG_LONG.withName("ZeroPages"),
        cef_master_h.C_LONG_LONG.withName("FreePages"),
        cef_master_h.C_LONG_LONG.withName("StandbyPages"),
        MemoryLayout.sequenceLayout(16, cef_master_h.C_LONG_LONG).withName("Reserved"),
        cef_master_h.C_LONG_LONG.withName("MaximumCommitLimit"),
        cef_master_h.C_LONG_LONG.withName("Reserved2"),
        cef_master_h.C_LONG.withName("PartitionId"),
