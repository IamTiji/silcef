...
public class WIN32_MEMORY_PARTITION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("NumaNode"),
        cef_render_handler_capi_h.C_LONG.withName("Channel"),
        cef_render_handler_capi_h.C_LONG.withName("NumberOfNumaNodes"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("ResidentAvailablePages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("CommittedPages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("CommitLimit"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("PeakCommitment"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("TotalNumberOfPages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("AvailablePages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("ZeroPages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("FreePages"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("StandbyPages"),
        MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_LONG_LONG).withName("Reserved"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("MaximumCommitLimit"),
        cef_render_handler_capi_h.C_LONG_LONG.withName("Reserved2"),
        cef_render_handler_capi_h.C_LONG.withName("PartitionId"),
