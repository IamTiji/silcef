...
public class tagXFORM {
    ...
    private static final long eM11$OFFSET = $LAYOUT.byteOffset(groupElement("eM11"));
    ...
    private static final long eM12$OFFSET = $LAYOUT.byteOffset(groupElement("eM12"));
    ...
    private static final long eM21$OFFSET = $LAYOUT.byteOffset(groupElement("eM21"));
    ...
    private static final long eM22$OFFSET = $LAYOUT.byteOffset(groupElement("eM22"));
    ...
    private static final long eDy$OFFSET = $LAYOUT.byteOffset(groupElement("eDy"));
