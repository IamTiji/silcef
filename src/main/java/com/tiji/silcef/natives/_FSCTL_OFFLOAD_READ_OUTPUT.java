...
public class _FSCTL_OFFLOAD_READ_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG_LONG.withName("TransferLength"),
    ...
    private static final long TransferLength$OFFSET = $LAYOUT.byteOffset(groupElement("TransferLength"));
