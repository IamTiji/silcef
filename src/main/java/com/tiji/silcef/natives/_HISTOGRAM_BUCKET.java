...
public class _HISTOGRAM_BUCKET {
    ...
    private static final long Reads$OFFSET = $LAYOUT.byteOffset(groupElement("Reads"));
    ...
    private static final long Writes$OFFSET = $LAYOUT.byteOffset(groupElement("Writes"));
