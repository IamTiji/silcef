...
public class _GET_MEDIA_TYPES {
    ...
    private static final long MediaInfoCount$OFFSET = $LAYOUT.byteOffset(groupElement("MediaInfoCount"));
    ...
    private static final long MediaInfo$OFFSET = $LAYOUT.byteOffset(groupElement("MediaInfo"));
    ...
    public static MemorySegment MediaInfo(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)MediaInfo$ELEM_HANDLE.invokeExact(struct, MediaInfo$OFFSET, index0);
