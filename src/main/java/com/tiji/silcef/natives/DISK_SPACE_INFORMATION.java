...
public class DISK_SPACE_INFORMATION {
    ...
    private static final long ActualTotalAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("ActualTotalAllocationUnits"));
    ...
    private static final long ActualAvailableAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("ActualAvailableAllocationUnits"));
    ...
    private static final long ActualPoolUnavailableAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("ActualPoolUnavailableAllocationUnits"));
    ...
    private static final long CallerTotalAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("CallerTotalAllocationUnits"));
    ...
    private static final long CallerAvailableAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("CallerAvailableAllocationUnits"));
    ...
    private static final long CallerPoolUnavailableAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("CallerPoolUnavailableAllocationUnits"));
    ...
    private static final long UsedAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("UsedAllocationUnits"));
    ...
    private static final long TotalReservedAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("TotalReservedAllocationUnits"));
    ...
    private static final long VolumeStorageReserveAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeStorageReserveAllocationUnits"));
    ...
    private static final long AvailableCommittedAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("AvailableCommittedAllocationUnits"));
    ...
    private static final long PoolAvailableAllocationUnits$OFFSET = $LAYOUT.byteOffset(groupElement("PoolAvailableAllocationUnits"));
    ...
    private static final long SectorsPerAllocationUnit$OFFSET = $LAYOUT.byteOffset(groupElement("SectorsPerAllocationUnit"));
