...
public class _CRYPTNET_URL_CACHE_PRE_FETCH_INFO {
    ...
    private static final long dwObjectType$OFFSET = $LAYOUT.byteOffset(groupElement("dwObjectType"));
    ...
    private static final long ThisUpdateTime$OFFSET = $LAYOUT.byteOffset(groupElement("ThisUpdateTime"));
    ...
    private static final long NextUpdateTime$OFFSET = $LAYOUT.byteOffset(groupElement("NextUpdateTime"));
    ...
    private static final long PublishTime$OFFSET = $LAYOUT.byteOffset(groupElement("PublishTime"));
