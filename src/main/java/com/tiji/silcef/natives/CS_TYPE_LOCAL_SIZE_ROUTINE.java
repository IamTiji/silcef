 ...
 * }
 */
public final class CS_TYPE_LOCAL_SIZE_ROUTINE {

    private CS_TYPE_LOCAL_SIZE_ROUTINE() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(CS_TYPE_LOCAL_SIZE_ROUTINE.Function.class, "apply", $DESC);
