...
public class _BIN_COUNT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("BinCount"),
    ...
    private static final long BinRange$OFFSET = $LAYOUT.byteOffset(groupElement("BinRange"));
    ...
    private static final long BinCount$OFFSET = $LAYOUT.byteOffset(groupElement("BinCount"));
