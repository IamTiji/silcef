...
public class _CRYPT_GET_TIME_VALID_OBJECT_EXTRA_INFO {
    ...
    private static final long iDeltaCrlIndicator$OFFSET = $LAYOUT.byteOffset(groupElement("iDeltaCrlIndicator"));
    ...
    private static final long pMaxAgeTime$OFFSET = $LAYOUT.byteOffset(groupElement("pMaxAgeTime"));
    ...
    private static final long pChainPara$OFFSET = $LAYOUT.byteOffset(groupElement("pChainPara"));
    ...
    private static final long pDeltaCrlIndicator$OFFSET = $LAYOUT.byteOffset(groupElement("pDeltaCrlIndicator"));
