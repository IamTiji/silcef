...
public class _PROCESSOR_RELATIONSHIP {
    ...
    private static final long GroupMask$OFFSET = $LAYOUT.byteOffset(groupElement("GroupMask"));
    ...
    public static MemorySegment GroupMask(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)GroupMask$ELEM_HANDLE.invokeExact(struct, GroupMask$OFFSET, index0);
