 ...
 * }
 */
public final class PFN_FREE_ENCODED_OBJECT_FUNC {

    private PFN_FREE_ENCODED_OBJECT_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_FREE_ENCODED_OBJECT_FUNC.Function.class, "apply", $DESC);
