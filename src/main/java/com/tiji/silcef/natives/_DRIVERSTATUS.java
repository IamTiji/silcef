...
public class _DRIVERSTATUS {
    ...
    private static final long bDriverError$OFFSET = $LAYOUT.byteOffset(groupElement("bDriverError"));
    ...
    private static final long bIDEError$OFFSET = $LAYOUT.byteOffset(groupElement("bIDEError"));
