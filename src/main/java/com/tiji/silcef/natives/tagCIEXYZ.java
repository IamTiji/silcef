...
public class tagCIEXYZ {
    ...
    private static final long ciexyzX$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzX"));
    ...
    private static final long ciexyzY$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzY"));
    ...
    private static final long ciexyzZ$OFFSET = $LAYOUT.byteOffset(groupElement("ciexyzZ"));
