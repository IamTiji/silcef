...
public class _MIDL_STUBLESS_PROXY_INFO {
    ...
    private static final long ProcFormatString$OFFSET = $LAYOUT.byteOffset(groupElement("ProcFormatString"));
    ...
    private static final long FormatStringOffset$OFFSET = $LAYOUT.byteOffset(groupElement("FormatStringOffset"));
