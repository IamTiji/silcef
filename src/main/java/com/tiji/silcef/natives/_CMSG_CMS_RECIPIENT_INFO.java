...
public class _CMSG_CMS_RECIPIENT_INFO {
    ...
    private static final long dwRecipientChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwRecipientChoice"));
    ...
    private static final AddressLayout pKeyTrans$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8023:5"), groupElement("pKeyTrans"));
    ...
    private static final long pKeyTrans$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8023:5"), groupElement("pKeyTrans"));
    ...
    private static final AddressLayout pKeyAgree$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8023:5"), groupElement("pKeyAgree"));
    ...
    private static final long pKeyAgree$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8023:5"), groupElement("pKeyAgree"));
    ...
    private static final AddressLayout pMailList$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8023:5"), groupElement("pMailList"));
    ...
    private static final long pMailList$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8023:5"), groupElement("pMailList"));
