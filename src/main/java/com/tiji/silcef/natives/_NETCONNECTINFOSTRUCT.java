...
public class _NETCONNECTINFOSTRUCT {
    ...
    private static final long dwDelay$OFFSET = $LAYOUT.byteOffset(groupElement("dwDelay"));
    ...
    private static final long dwOptDataSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwOptDataSize"));
