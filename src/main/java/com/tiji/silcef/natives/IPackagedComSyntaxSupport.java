...
/**
 * {@snippet lang=c :
 * struct IPackagedComSyntaxSupport {
 *     struct IPackagedComSyntaxSupportVtbl *lpVtbl;
 * }
 * }
 */
public class IPackagedComSyntaxSupport {

    IPackagedComSyntaxSupport() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_POINTER.withName("lpVtbl")
    ).withName("IPackagedComSyntaxSupport");
