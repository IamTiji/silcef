...
public class IXMLDOMEntityVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("get_notationName")
     ...
     * }
     */
    public final static class get_notationName {

        private get_notationName() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(get_notationName.Function.class, "apply", $DESC);
    ...
    private static final long get_notationName$OFFSET = $LAYOUT.byteOffset(groupElement("get_notationName"));
