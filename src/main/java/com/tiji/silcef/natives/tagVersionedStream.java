...
public class tagVersionedStream {
    ...
    private static final long guidVersion$OFFSET = $LAYOUT.byteOffset(groupElement("guidVersion"));
    ...
    private static final long pStream$OFFSET = $LAYOUT.byteOffset(groupElement("pStream"));
