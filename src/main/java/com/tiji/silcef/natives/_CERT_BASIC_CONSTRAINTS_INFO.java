...
public class _CERT_BASIC_CONSTRAINTS_INFO {
    ...
    private static final long SubjectType$OFFSET = $LAYOUT.byteOffset(groupElement("SubjectType"));
    ...
    private static final long fPathLenConstraint$OFFSET = $LAYOUT.byteOffset(groupElement("fPathLenConstraint"));
    ...
    private static final long dwPathLenConstraint$OFFSET = $LAYOUT.byteOffset(groupElement("dwPathLenConstraint"));
    ...
    private static final long cSubtreesConstraint$OFFSET = $LAYOUT.byteOffset(groupElement("cSubtreesConstraint"));
    ...
    private static final long rgSubtreesConstraint$OFFSET = $LAYOUT.byteOffset(groupElement("rgSubtreesConstraint"));
