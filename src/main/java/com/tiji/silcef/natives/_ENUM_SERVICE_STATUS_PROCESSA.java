...
public class _ENUM_SERVICE_STATUS_PROCESSA {
    ...
    private static final long lpServiceName$OFFSET = $LAYOUT.byteOffset(groupElement("lpServiceName"));
    ...
    private static final long ServiceStatusProcess$OFFSET = $LAYOUT.byteOffset(groupElement("ServiceStatusProcess"));
