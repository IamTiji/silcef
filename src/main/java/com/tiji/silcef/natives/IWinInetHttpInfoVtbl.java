...
public class IWinInetHttpInfoVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("QueryOption"),
     ...
     * }
     */
    public final static class QueryOption {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(QueryOption.Function.class, "apply", $DESC);
    ...
    private static final long QueryOption$OFFSET = $LAYOUT.byteOffset(groupElement("QueryOption"));
