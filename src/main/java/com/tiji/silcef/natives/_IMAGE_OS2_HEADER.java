...
public class _IMAGE_OS2_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_SHORT.withName("ne_magic"),
        cef_render_handler_capi_h.C_CHAR.withName("ne_ver"),
        cef_render_handler_capi_h.C_CHAR.withName("ne_rev"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_enttab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cbenttab"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 2).withName("ne_crc"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_flags"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_autodata"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_heap"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_stack"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 2).withName("ne_csip"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 2).withName("ne_sssp"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cseg"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cmod"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cbnrestab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_segtab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_rsrctab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_restab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_modtab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_imptab"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_LONG, 2).withName("ne_nrestab"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cmovent"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_align"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_cres"),
        cef_render_handler_capi_h.C_CHAR.withName("ne_exetyp"),
        cef_render_handler_capi_h.C_CHAR.withName("ne_flagsothers"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_pretthunks"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_psegrefbytes"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_swaparea"),
        cef_render_handler_capi_h.C_SHORT.withName("ne_expver")
