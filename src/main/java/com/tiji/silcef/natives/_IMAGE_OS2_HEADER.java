...
public class _IMAGE_OS2_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_SHORT.withName("ne_magic"),
        cef_master_h.C_CHAR.withName("ne_ver"),
        cef_master_h.C_CHAR.withName("ne_rev"),
        cef_master_h.C_SHORT.withName("ne_enttab"),
        cef_master_h.C_SHORT.withName("ne_cbenttab"),
        cef_master_h.align(cef_master_h.C_LONG, 2).withName("ne_crc"),
        cef_master_h.C_SHORT.withName("ne_flags"),
        cef_master_h.C_SHORT.withName("ne_autodata"),
        cef_master_h.C_SHORT.withName("ne_heap"),
        cef_master_h.C_SHORT.withName("ne_stack"),
        cef_master_h.align(cef_master_h.C_LONG, 2).withName("ne_csip"),
        cef_master_h.align(cef_master_h.C_LONG, 2).withName("ne_sssp"),
        cef_master_h.C_SHORT.withName("ne_cseg"),
        cef_master_h.C_SHORT.withName("ne_cmod"),
        cef_master_h.C_SHORT.withName("ne_cbnrestab"),
        cef_master_h.C_SHORT.withName("ne_segtab"),
        cef_master_h.C_SHORT.withName("ne_rsrctab"),
        cef_master_h.C_SHORT.withName("ne_restab"),
        cef_master_h.C_SHORT.withName("ne_modtab"),
        cef_master_h.C_SHORT.withName("ne_imptab"),
        cef_master_h.align(cef_master_h.C_LONG, 2).withName("ne_nrestab"),
        cef_master_h.C_SHORT.withName("ne_cmovent"),
        cef_master_h.C_SHORT.withName("ne_align"),
        cef_master_h.C_SHORT.withName("ne_cres"),
        cef_master_h.C_CHAR.withName("ne_exetyp"),
        cef_master_h.C_CHAR.withName("ne_flagsothers"),
        cef_master_h.C_SHORT.withName("ne_pretthunks"),
        cef_master_h.C_SHORT.withName("ne_psegrefbytes"),
        cef_master_h.C_SHORT.withName("ne_swaparea"),
        cef_master_h.C_SHORT.withName("ne_expver")
