...
public class STORAGE_BREAK_RESERVATION_REQUEST {
    ...
    private static final long _unused$OFFSET = $LAYOUT.byteOffset(groupElement("_unused"));
    ...
    private static final long PathId$OFFSET = $LAYOUT.byteOffset(groupElement("PathId"));
