...
public class _CERT_ACCESS_DESCRIPTION {
    ...
    private static final long pszAccessMethod$OFFSET = $LAYOUT.byteOffset(groupElement("pszAccessMethod"));
    ...
    private static final long AccessLocation$OFFSET = $LAYOUT.byteOffset(groupElement("AccessLocation"));
