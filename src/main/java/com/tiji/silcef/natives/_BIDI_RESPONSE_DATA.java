...
public class _BIDI_RESPONSE_DATA {
    ...
    private static final long dwResult$OFFSET = $LAYOUT.byteOffset(groupElement("dwResult"));
    ...
    private static final long dwReqNumber$OFFSET = $LAYOUT.byteOffset(groupElement("dwReqNumber"));
    ...
    private static final long pSchema$OFFSET = $LAYOUT.byteOffset(groupElement("pSchema"));
