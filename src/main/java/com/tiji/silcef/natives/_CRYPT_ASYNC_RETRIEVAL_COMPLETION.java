...
public class _CRYPT_ASYNC_RETRIEVAL_COMPLETION {
    ...
    private static final long pfnCompletion$OFFSET = $LAYOUT.byteOffset(groupElement("pfnCompletion"));
    ...
    private static final long pvCompletion$OFFSET = $LAYOUT.byteOffset(groupElement("pvCompletion"));
