...
public class _STORAGE_ZONE_DESCRIPTOR {
    ...
    private static final long ZoneType$OFFSET = $LAYOUT.byteOffset(groupElement("ZoneType"));
    ...
    private static final long ZoneCondition$OFFSET = $LAYOUT.byteOffset(groupElement("ZoneCondition"));
    ...
    private static final long ResetWritePointerRecommend$OFFSET = $LAYOUT.byteOffset(groupElement("ResetWritePointerRecommend"));
    ...
    private static final long ZoneSize$OFFSET = $LAYOUT.byteOffset(groupElement("ZoneSize"));
    ...
    private static final long WritePointerOffset$OFFSET = $LAYOUT.byteOffset(groupElement("WritePointerOffset"));
