...
public class _XMIT_ROUTINE_QUINTUPLE {
    ...
    private static final long pfnTranslateToXmit$OFFSET = $LAYOUT.byteOffset(groupElement("pfnTranslateToXmit"));
    ...
    private static final long pfnTranslateFromXmit$OFFSET = $LAYOUT.byteOffset(groupElement("pfnTranslateFromXmit"));
    ...
    private static final long pfnFreeXmit$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFreeXmit"));
    ...
    private static final long pfnFreeInst$OFFSET = $LAYOUT.byteOffset(groupElement("pfnFreeInst"));
