...
public class _PARTITION_INFORMATION {
    ...
    private static final long HiddenSectors$OFFSET = $LAYOUT.byteOffset(groupElement("HiddenSectors"));
    ...
    private static final long PartitionType$OFFSET = $LAYOUT.byteOffset(groupElement("PartitionType"));
    ...
    private static final long BootIndicator$OFFSET = $LAYOUT.byteOffset(groupElement("BootIndicator"));
    ...
    private static final long RecognizedPartition$OFFSET = $LAYOUT.byteOffset(groupElement("RecognizedPartition"));
