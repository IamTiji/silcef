...
public class _CERT_STRONG_SIGN_PARA {
    ...
    private static final long dwInfoChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwInfoChoice"));
    ...
    private static final AddressLayout pvInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6725:5"), groupElement("pvInfo"));
    ...
    private static final long pvInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6725:5"), groupElement("pvInfo"));
    ...
    private static final AddressLayout pSerializedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6725:5"), groupElement("pSerializedInfo"));
    ...
    private static final long pSerializedInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6725:5"), groupElement("pSerializedInfo"));
    ...
    private static final AddressLayout pszOID$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6725:5"), groupElement("pszOID"));
    ...
    private static final long pszOID$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6725:5"), groupElement("pszOID"));
