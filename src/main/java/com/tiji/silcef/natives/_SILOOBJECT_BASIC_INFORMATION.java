...
public class _SILOOBJECT_BASIC_INFORMATION {
    ...
    private static final long SiloId$OFFSET = $LAYOUT.byteOffset(groupElement("SiloId"));
    ...
    private static final long SiloParentId$OFFSET = $LAYOUT.byteOffset(groupElement("SiloParentId"));
    ...
    private static final long NumberOfProcesses$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfProcesses"));
    ...
    private static final long IsInServerSilo$OFFSET = $LAYOUT.byteOffset(groupElement("IsInServerSilo"));
