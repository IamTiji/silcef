...
public class _FILE_STORAGE_TIER {
    ...
    public static short Name(MemorySegment struct, long index0) {
        return (short)Name$ELEM_HANDLE.get(struct, Name$OFFSET, index0);
    }
    ...
    private static final long ProvisionedCapacity$OFFSET = $LAYOUT.byteOffset(groupElement("ProvisionedCapacity"));
