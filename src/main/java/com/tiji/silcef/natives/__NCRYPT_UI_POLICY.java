...
public class __NCRYPT_UI_POLICY {
    ...
    private static final long pszCreationTitle$OFFSET = $LAYOUT.byteOffset(groupElement("pszCreationTitle"));
    ...
    private static final long pszFriendlyName$OFFSET = $LAYOUT.byteOffset(groupElement("pszFriendlyName"));
    ...
    private static final long pszDescription$OFFSET = $LAYOUT.byteOffset(groupElement("pszDescription"));
