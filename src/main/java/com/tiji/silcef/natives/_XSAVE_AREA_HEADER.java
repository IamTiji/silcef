...
public class _XSAVE_AREA_HEADER {
    ...
    private static final long CompactionMask$OFFSET = $LAYOUT.byteOffset(groupElement("CompactionMask"));
    ...
    public static long Reserved2(MemorySegment struct, long index0) {
        return (long)Reserved2$ELEM_HANDLE.get(struct, Reserved2$OFFSET, index0);
    }
