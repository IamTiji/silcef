...
public class _CERT_REVOCATION_CRL_INFO {
    ...
    private static final long pBaseCrlContext$OFFSET = $LAYOUT.byteOffset(groupElement("pBaseCrlContext"));
    ...
    private static final long pDeltaCrlContext$OFFSET = $LAYOUT.byteOffset(groupElement("pDeltaCrlContext"));
    ...
    private static final long pCrlEntry$OFFSET = $LAYOUT.byteOffset(groupElement("pCrlEntry"));
    ...
    private static final long fDeltaCrlEntry$OFFSET = $LAYOUT.byteOffset(groupElement("fDeltaCrlEntry"));
