...
public class FILE_ID_DESCRIPTOR {
    ...
    private static final GroupLayout FileId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9422:5"), groupElement("FileId"));
    ...
    private static final long FileId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9422:5"), groupElement("FileId"));
    ...
    private static final GroupLayout ObjectId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9422:5"), groupElement("ObjectId"));
    ...
    private static final long ObjectId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9422:5"), groupElement("ObjectId"));
    ...
    private static final GroupLayout ExtendedFileId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9422:5"), groupElement("ExtendedFileId"));
    ...
    private static final long ExtendedFileId$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9422:5"), groupElement("ExtendedFileId"));
