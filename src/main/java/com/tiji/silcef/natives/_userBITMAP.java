...
public class _userBITMAP {
    ...
    private static final long pBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pBuffer"));
    ...
    public static byte pBuffer(MemorySegment struct, long index0) {
        return (byte)pBuffer$ELEM_HANDLE.get(struct, pBuffer$OFFSET, index0);
    }
    ...
    public static void pBuffer(MemorySegment struct, long index0, byte fieldValue) {
        pBuffer$ELEM_HANDLE.set(struct, pBuffer$OFFSET, index0, fieldValue);
    }
