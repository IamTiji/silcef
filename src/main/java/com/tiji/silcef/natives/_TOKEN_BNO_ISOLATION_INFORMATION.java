...
public class _TOKEN_BNO_ISOLATION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_POINTER.withName("IsolationPrefix"),
        cef_render_handler_capi_h.C_CHAR.withName("IsolationEnabled"),
    ...
    private static final long IsolationPrefix$OFFSET = $LAYOUT.byteOffset(groupElement("IsolationPrefix"));
    ...
    private static final long IsolationEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("IsolationEnabled"));
