...
public class _XSTATE_CONFIGURATION {
    ...
    private static final long EnabledFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("EnabledFeatures"));
    ...
    private static final long EnabledVolatileFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("EnabledVolatileFeatures"));
    ...
    private static final OfInt ControlFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14477:5"), groupElement("ControlFlags"));
    ...
    private static final long ControlFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14477:5"), groupElement("ControlFlags"));
    ...
    public static MemorySegment Features(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Features$ELEM_HANDLE.invokeExact(struct, Features$OFFSET, index0);
    ...
    private static final long EnabledSupervisorFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("EnabledSupervisorFeatures"));
    ...
    private static final long AlignedFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("AlignedFeatures"));
    ...
    private static final long AllFeatureSize$OFFSET = $LAYOUT.byteOffset(groupElement("AllFeatureSize"));
    ...
    private static final long AllFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("AllFeatures"));
    ...
    public static int AllFeatures(MemorySegment struct, long index0) {
        return (int)AllFeatures$ELEM_HANDLE.get(struct, AllFeatures$OFFSET, index0);
    }
    ...
    public static void AllFeatures(MemorySegment struct, long index0, int fieldValue) {
        AllFeatures$ELEM_HANDLE.set(struct, AllFeatures$OFFSET, index0, fieldValue);
    }
    ...
    private static final long EnabledUserVisibleSupervisorFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("EnabledUserVisibleSupervisorFeatures"));
    ...
    private static final long ExtendedFeatureDisableFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("ExtendedFeatureDisableFeatures"));
    ...
    private static final long AllNonLargeFeatureSize$OFFSET = $LAYOUT.byteOffset(groupElement("AllNonLargeFeatureSize"));
    ...
    private static final OfShort MaxSveVectorLength$LAYOUT = (OfShort)$LAYOUT.select(groupElement("MaxSveVectorLength"));
     ...
     * }
     */
    public static final OfShort MaxSveVectorLength$layout() {
        return MaxSveVectorLength$LAYOUT;
    }

    private static final long MaxSveVectorLength$OFFSET = $LAYOUT.byteOffset(groupElement("MaxSveVectorLength"));
     ...
     * }
     */
    public static final long MaxSveVectorLength$offset() {
        return MaxSveVectorLength$OFFSET;
    }
     ...
     * }
     */
    public static short MaxSveVectorLength(MemorySegment struct) {
        return struct.get(MaxSveVectorLength$LAYOUT, MaxSveVectorLength$OFFSET);
    }
     ...
     * }
     */
    public static void MaxSveVectorLength(MemorySegment struct, short fieldValue) {
        struct.set(MaxSveVectorLength$LAYOUT, MaxSveVectorLength$OFFSET, fieldValue);
    }

    private static final OfShort Spare1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("Spare1"));
     ...
     * }
     */
    public static final OfShort Spare1$layout() {
        return Spare1$LAYOUT;
    }

    private static final long Spare1$OFFSET = $LAYOUT.byteOffset(groupElement("Spare1"));
     ...
     * }
     */
    public static short Spare1(MemorySegment struct) {
        return struct.get(Spare1$LAYOUT, Spare1$OFFSET);
    }
     ...
     * }
     */
    public static void Spare1(MemorySegment struct, short fieldValue) {
        struct.set(Spare1$LAYOUT, Spare1$OFFSET, fieldValue);
    }
