...
public class _PERF_DATA_BLOCK {
    ...
    public static short Signature(MemorySegment struct, long index0) {
        return (short)Signature$ELEM_HANDLE.get(struct, Signature$OFFSET, index0);
    }
    ...
    public static void Signature(MemorySegment struct, long index0, short fieldValue) {
        Signature$ELEM_HANDLE.set(struct, Signature$OFFSET, index0, fieldValue);
    }
    ...
    private static final long LittleEndian$OFFSET = $LAYOUT.byteOffset(groupElement("LittleEndian"));
    ...
    private static final long NumObjectTypes$OFFSET = $LAYOUT.byteOffset(groupElement("NumObjectTypes"));
    ...
    private static final long DefaultObject$OFFSET = $LAYOUT.byteOffset(groupElement("DefaultObject"));
    ...
    private static final long SystemTime$OFFSET = $LAYOUT.byteOffset(groupElement("SystemTime"));
    ...
    private static final long PerfTime100nSec$OFFSET = $LAYOUT.byteOffset(groupElement("PerfTime100nSec"));
    ...
    private static final long SystemNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("SystemNameLength"));
    ...
    private static final long SystemNameOffset$OFFSET = $LAYOUT.byteOffset(groupElement("SystemNameOffset"));
