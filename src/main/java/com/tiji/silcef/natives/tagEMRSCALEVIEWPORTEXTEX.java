...
public class tagEMRSCALEVIEWPORTEXTEX {
    ...
    private static final long xNum$OFFSET = $LAYOUT.byteOffset(groupElement("xNum"));
    ...
    private static final long xDenom$OFFSET = $LAYOUT.byteOffset(groupElement("xDenom"));
    ...
    private static final long yNum$OFFSET = $LAYOUT.byteOffset(groupElement("yNum"));
    ...
    private static final long yDenom$OFFSET = $LAYOUT.byteOffset(groupElement("yDenom"));
