...
public class _KEY_EVENT_RECORD {
    ...
    private static final long bKeyDown$OFFSET = $LAYOUT.byteOffset(groupElement("bKeyDown"));
    ...
    private static final long wRepeatCount$OFFSET = $LAYOUT.byteOffset(groupElement("wRepeatCount"));
    ...
    private static final long wVirtualKeyCode$OFFSET = $LAYOUT.byteOffset(groupElement("wVirtualKeyCode"));
    ...
    private static final long wVirtualScanCode$OFFSET = $LAYOUT.byteOffset(groupElement("wVirtualScanCode"));
    ...
    public static class uChar {
        ...
        private static final long UnicodeChar$OFFSET = $LAYOUT.byteOffset(groupElement("UnicodeChar"));
        ...
        private static final long AsciiChar$OFFSET = $LAYOUT.byteOffset(groupElement("AsciiChar"));
    ...
    private static final long uChar$OFFSET = $LAYOUT.byteOffset(groupElement("uChar"));
    ...
    private static final long dwControlKeyState$OFFSET = $LAYOUT.byteOffset(groupElement("dwControlKeyState"));
