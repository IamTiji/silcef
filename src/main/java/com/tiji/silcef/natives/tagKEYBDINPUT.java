...
public class tagKEYBDINPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_SHORT.withName("wVk"),
        cef_render_handler_capi_h.C_SHORT.withName("wScan"),
    ...
    private static final long wVk$OFFSET = $LAYOUT.byteOffset(groupElement("wVk"));
    ...
    private static final long wScan$OFFSET = $LAYOUT.byteOffset(groupElement("wScan"));
