...
public class _SI_COPYFILE {
    ...
    private static final long SourceFileNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("SourceFileNameLength"));
    ...
    private static final long DestinationFileNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("DestinationFileNameLength"));
    ...
    private static final long FileNameBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("FileNameBuffer"));
    ...
    public static short FileNameBuffer(MemorySegment struct, long index0) {
        return (short)FileNameBuffer$ELEM_HANDLE.get(struct, FileNameBuffer$OFFSET, index0);
    }
    ...
    public static void FileNameBuffer(MemorySegment struct, long index0, short fieldValue) {
        FileNameBuffer$ELEM_HANDLE.set(struct, FileNameBuffer$OFFSET, index0, fieldValue);
    }
