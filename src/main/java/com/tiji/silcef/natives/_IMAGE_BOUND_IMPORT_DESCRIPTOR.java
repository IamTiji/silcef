...
public class _IMAGE_BOUND_IMPORT_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_SHORT.withName("NumberOfModuleForwarderRefs")
    ...
    private static final long OffsetModuleName$OFFSET = $LAYOUT.byteOffset(groupElement("OffsetModuleName"));
    ...
    private static final long NumberOfModuleForwarderRefs$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfModuleForwarderRefs"));
