...
public class _HMAC_Info {
    ...
    private static final long HashAlgid$OFFSET = $LAYOUT.byteOffset(groupElement("HashAlgid"));
    ...
    private static final long pbInnerString$OFFSET = $LAYOUT.byteOffset(groupElement("pbInnerString"));
    ...
    private static final long cbInnerString$OFFSET = $LAYOUT.byteOffset(groupElement("cbInnerString"));
    ...
    private static final long pbOuterString$OFFSET = $LAYOUT.byteOffset(groupElement("pbOuterString"));
    ...
    private static final long cbOuterString$OFFSET = $LAYOUT.byteOffset(groupElement("cbOuterString"));
