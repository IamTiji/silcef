 ...
 * }
 */
public final class PFNSHOWSHAREFOLDERUIW {

    private PFNSHOWSHAREFOLDERUIW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFNSHOWSHAREFOLDERUIW.Function.class, "apply", $DESC);
