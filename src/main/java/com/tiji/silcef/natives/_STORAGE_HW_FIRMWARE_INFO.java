...
public class _STORAGE_HW_FIRMWARE_INFO {
    ...
    private static final long SlotCount$OFFSET = $LAYOUT.byteOffset(groupElement("SlotCount"));
    ...
    private static final long ActiveSlot$OFFSET = $LAYOUT.byteOffset(groupElement("ActiveSlot"));
    ...
    private static final long PendingActivateSlot$OFFSET = $LAYOUT.byteOffset(groupElement("PendingActivateSlot"));
    ...
    private static final long FirmwareShared$OFFSET = $LAYOUT.byteOffset(groupElement("FirmwareShared"));
    ...
    private static final long ImagePayloadAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("ImagePayloadAlignment"));
    ...
    private static final long ImagePayloadMaxSize$OFFSET = $LAYOUT.byteOffset(groupElement("ImagePayloadMaxSize"));
    ...
    public static MemorySegment Slot(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Slot$ELEM_HANDLE.invokeExact(struct, Slot$OFFSET, index0);
