...
public class _IMAGE_ROM_OPTIONAL_HEADER {
    ...
    private static final long BaseOfBss$OFFSET = $LAYOUT.byteOffset(groupElement("BaseOfBss"));
    ...
    private static final long GprMask$OFFSET = $LAYOUT.byteOffset(groupElement("GprMask"));
    ...
    private static final long CprMask$OFFSET = $LAYOUT.byteOffset(groupElement("CprMask"));
    ...
    public static int CprMask(MemorySegment struct, long index0) {
        return (int)CprMask$ELEM_HANDLE.get(struct, CprMask$OFFSET, index0);
    }
    ...
    public static void CprMask(MemorySegment struct, long index0, int fieldValue) {
        CprMask$ELEM_HANDLE.set(struct, CprMask$OFFSET, index0, fieldValue);
    }
    ...
    private static final long GpValue$OFFSET = $LAYOUT.byteOffset(groupElement("GpValue"));
