...
public class _BOOT_AREA_INFO {
    ...
    private static final long BootSectorCount$OFFSET = $LAYOUT.byteOffset(groupElement("BootSectorCount"));
    ...
    private static final long BootSectors$OFFSET = $LAYOUT.byteOffset(groupElement("BootSectors"));
    ...
    public static MemorySegment BootSectors(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)BootSectors$ELEM_HANDLE.invokeExact(struct, BootSectors$OFFSET, index0);
