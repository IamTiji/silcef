...
public class _DISK_CACHE_INFORMATION {
    ...
    private static final long ParametersSavable$OFFSET = $LAYOUT.byteOffset(groupElement("ParametersSavable"));
    ...
    private static final long ReadCacheEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("ReadCacheEnabled"));
    ...
    private static final long WriteCacheEnabled$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCacheEnabled"));
    ...
    private static final long ReadRetentionPriority$OFFSET = $LAYOUT.byteOffset(groupElement("ReadRetentionPriority"));
    ...
    private static final long WriteRetentionPriority$OFFSET = $LAYOUT.byteOffset(groupElement("WriteRetentionPriority"));
    ...
    private static final long DisablePrefetchTransferLength$OFFSET = $LAYOUT.byteOffset(groupElement("DisablePrefetchTransferLength"));
    ...
    private static final long PrefetchScalar$OFFSET = $LAYOUT.byteOffset(groupElement("PrefetchScalar"));
    ...
    public static class ScalarPrefetch {
        ...
        private static final long MaximumBlocks$OFFSET = $LAYOUT.byteOffset(groupElement("MaximumBlocks"));
    ...
    private static final GroupLayout ScalarPrefetch$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9906:5"), groupElement("ScalarPrefetch"));
    ...
    private static final long ScalarPrefetch$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9906:5"), groupElement("ScalarPrefetch"));
    ...
    private static final GroupLayout BlockPrefetch$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9906:5"), groupElement("BlockPrefetch"));
    ...
    private static final long BlockPrefetch$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9906:5"), groupElement("BlockPrefetch"));
