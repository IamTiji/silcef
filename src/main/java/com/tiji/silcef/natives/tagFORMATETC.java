...
public class tagFORMATETC {
    ...
    private static final long cfFormat$OFFSET = $LAYOUT.byteOffset(groupElement("cfFormat"));
    ...
    private static final long ptd$OFFSET = $LAYOUT.byteOffset(groupElement("ptd"));
    ...
    private static final long dwAspect$OFFSET = $LAYOUT.byteOffset(groupElement("dwAspect"));
    ...
    private static final long lindex$OFFSET = $LAYOUT.byteOffset(groupElement("lindex"));
