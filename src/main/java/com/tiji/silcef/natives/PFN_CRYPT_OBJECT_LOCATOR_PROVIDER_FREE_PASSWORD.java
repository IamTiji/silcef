 ...
 * }
 */
public final class PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD {

    private PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FREE_PASSWORD.Function.class, "apply", $DESC);
