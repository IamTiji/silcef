...
public class DISPLAYCONFIG_SOURCE_DEVICE_NAME {
    ...
    private static final long viewGdiDeviceName$OFFSET = $LAYOUT.byteOffset(groupElement("viewGdiDeviceName"));
    ...
    public static short viewGdiDeviceName(MemorySegment struct, long index0) {
        return (short)viewGdiDeviceName$ELEM_HANDLE.get(struct, viewGdiDeviceName$OFFSET, index0);
    }
    ...
    public static void viewGdiDeviceName(MemorySegment struct, long index0, short fieldValue) {
        viewGdiDeviceName$ELEM_HANDLE.set(struct, viewGdiDeviceName$OFFSET, index0, fieldValue);
    }
