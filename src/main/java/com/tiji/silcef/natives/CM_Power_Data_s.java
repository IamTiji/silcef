...
public class CM_Power_Data_s {
    ...
    private static final long PD_Size$OFFSET = $LAYOUT.byteOffset(groupElement("PD_Size"));
    ...
    private static final long PD_MostRecentPowerState$OFFSET = $LAYOUT.byteOffset(groupElement("PD_MostRecentPowerState"));
    ...
    private static final long PD_Capabilities$OFFSET = $LAYOUT.byteOffset(groupElement("PD_Capabilities"));
    ...
    private static final long PD_D1Latency$OFFSET = $LAYOUT.byteOffset(groupElement("PD_D1Latency"));
    ...
    private static final long PD_D2Latency$OFFSET = $LAYOUT.byteOffset(groupElement("PD_D2Latency"));
    ...
    private static final long PD_D3Latency$OFFSET = $LAYOUT.byteOffset(groupElement("PD_D3Latency"));
    ...
    private static final long PD_PowerStateMapping$OFFSET = $LAYOUT.byteOffset(groupElement("PD_PowerStateMapping"));
    ...
    public static int PD_PowerStateMapping(MemorySegment struct, long index0) {
        return (int)PD_PowerStateMapping$ELEM_HANDLE.get(struct, PD_PowerStateMapping$OFFSET, index0);
    }
    ...
    public static void PD_PowerStateMapping(MemorySegment struct, long index0, int fieldValue) {
        PD_PowerStateMapping$ELEM_HANDLE.set(struct, PD_PowerStateMapping$OFFSET, index0, fieldValue);
    }
    ...
    private static final long PD_DeepestSystemWake$OFFSET = $LAYOUT.byteOffset(groupElement("PD_DeepestSystemWake"));
