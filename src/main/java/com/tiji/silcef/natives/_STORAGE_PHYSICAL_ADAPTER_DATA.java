...
public class _STORAGE_PHYSICAL_ADAPTER_DATA {
    ...
    private static final long AdapterId$OFFSET = $LAYOUT.byteOffset(groupElement("AdapterId"));
    ...
    private static final long HealthStatus$OFFSET = $LAYOUT.byteOffset(groupElement("HealthStatus"));
    ...
    private static final long CommandProtocol$OFFSET = $LAYOUT.byteOffset(groupElement("CommandProtocol"));
    ...
    public static byte Vendor(MemorySegment struct, long index0) {
        return (byte)Vendor$ELEM_HANDLE.get(struct, Vendor$OFFSET, index0);
    }
    ...
    public static void Vendor(MemorySegment struct, long index0, byte fieldValue) {
        Vendor$ELEM_HANDLE.set(struct, Vendor$OFFSET, index0, fieldValue);
    }
    ...
    private static final long Model$OFFSET = $LAYOUT.byteOffset(groupElement("Model"));
    ...
    public static byte Model(MemorySegment struct, long index0) {
        return (byte)Model$ELEM_HANDLE.get(struct, Model$OFFSET, index0);
    }
    ...
    public static void Model(MemorySegment struct, long index0, byte fieldValue) {
        Model$ELEM_HANDLE.set(struct, Model$OFFSET, index0, fieldValue);
    }
    ...
    private static final long FirmwareRevision$OFFSET = $LAYOUT.byteOffset(groupElement("FirmwareRevision"));
    ...
    public static byte FirmwareRevision(MemorySegment struct, long index0) {
        return (byte)FirmwareRevision$ELEM_HANDLE.get(struct, FirmwareRevision$OFFSET, index0);
    }
    ...
    public static void FirmwareRevision(MemorySegment struct, long index0, byte fieldValue) {
        FirmwareRevision$ELEM_HANDLE.set(struct, FirmwareRevision$OFFSET, index0, fieldValue);
    }
    ...
    private static final long PhysicalLocation$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalLocation"));
    ...
    public static byte PhysicalLocation(MemorySegment struct, long index0) {
        return (byte)PhysicalLocation$ELEM_HANDLE.get(struct, PhysicalLocation$OFFSET, index0);
    }
    ...
    public static void PhysicalLocation(MemorySegment struct, long index0, byte fieldValue) {
        PhysicalLocation$ELEM_HANDLE.set(struct, PhysicalLocation$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ExpanderConnected$OFFSET = $LAYOUT.byteOffset(groupElement("ExpanderConnected"));
