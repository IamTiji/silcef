...
public class _OVERLAPPED {
    ...
    private static final long Offset$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$55:5"), groupElement("$anon$56:9"), groupElement("Offset"));
    ...
    private static final long OffsetHigh$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$55:5"), groupElement("$anon$56:9"), groupElement("OffsetHigh"));
    ...
    private static final long Pointer$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$55:5"), groupElement("Pointer"));
