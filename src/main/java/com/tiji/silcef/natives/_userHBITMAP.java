...
public class _userHBITMAP {
    ...
    private static final long fContext$OFFSET = $LAYOUT.byteOffset(groupElement("fContext"));
    ...
    public static class __MIDL_IWinTypes_0007 {
        ...
        private static final long hInproc$OFFSET = $LAYOUT.byteOffset(groupElement("hInproc"));
        ...
        private static final long hRemote$OFFSET = $LAYOUT.byteOffset(groupElement("hRemote"));
        ...
        private static final long hInproc64$OFFSET = $LAYOUT.byteOffset(groupElement("hInproc64"));
