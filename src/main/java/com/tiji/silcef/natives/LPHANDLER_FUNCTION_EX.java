 ...
 * }
 */
public final class LPHANDLER_FUNCTION_EX {

    private LPHANDLER_FUNCTION_EX() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPHANDLER_FUNCTION_EX.Function.class, "apply", $DESC);
