...
public class _STORAGE_DEVICE_ID_DESCRIPTOR {
    ...
    private static final long NumberOfIdentifiers$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfIdentifiers"));
    ...
    private static final long Identifiers$OFFSET = $LAYOUT.byteOffset(groupElement("Identifiers"));
    ...
    public static byte Identifiers(MemorySegment struct, long index0) {
        return (byte)Identifiers$ELEM_HANDLE.get(struct, Identifiers$OFFSET, index0);
    }
    ...
    public static void Identifiers(MemorySegment struct, long index0, byte fieldValue) {
        Identifiers$ELEM_HANDLE.set(struct, Identifiers$OFFSET, index0, fieldValue);
    }
