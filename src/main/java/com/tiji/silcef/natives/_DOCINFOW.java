...
public class _DOCINFOW {
    ...
    private static final long lpszDocName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszDocName"));
    ...
    private static final long lpszOutput$OFFSET = $LAYOUT.byteOffset(groupElement("lpszOutput"));
    ...
    private static final long lpszDatatype$OFFSET = $LAYOUT.byteOffset(groupElement("lpszDatatype"));
    ...
    private static final long fwType$OFFSET = $LAYOUT.byteOffset(groupElement("fwType"));
