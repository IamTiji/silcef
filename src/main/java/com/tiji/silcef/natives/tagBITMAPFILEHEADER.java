...
public class tagBITMAPFILEHEADER {
    ...
    private static final long bfType$OFFSET = $LAYOUT.byteOffset(groupElement("bfType"));
    ...
    private static final long bfSize$OFFSET = $LAYOUT.byteOffset(groupElement("bfSize"));
    ...
    private static final long bfReserved1$OFFSET = $LAYOUT.byteOffset(groupElement("bfReserved1"));
    ...
    private static final long bfReserved2$OFFSET = $LAYOUT.byteOffset(groupElement("bfReserved2"));
    ...
    private static final long bfOffBits$OFFSET = $LAYOUT.byteOffset(groupElement("bfOffBits"));
