...
public class _FS_BPIO_OUTPUT {
    ...
    private static final long OutFlags$OFFSET = $LAYOUT.byteOffset(groupElement("OutFlags"));
    ...
    private static final GroupLayout Enable$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17601:5"), groupElement("Enable"));
    ...
    private static final long Enable$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$17601:5"), groupElement("Enable"));
    ...
    private static final GroupLayout Query$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17601:5"), groupElement("Query"));
    ...
    private static final long Query$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$17601:5"), groupElement("Query"));
    ...
    private static final GroupLayout VolumeStackResume$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17601:5"), groupElement("VolumeStackResume"));
    ...
    private static final long VolumeStackResume$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$17601:5"), groupElement("VolumeStackResume"));
    ...
    private static final GroupLayout StreamResume$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17601:5"), groupElement("StreamResume"));
    ...
    private static final long StreamResume$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$17601:5"), groupElement("StreamResume"));
    ...
    private static final GroupLayout GetInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17601:5"), groupElement("GetInfo"));
    ...
    private static final long GetInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$17601:5"), groupElement("GetInfo"));
