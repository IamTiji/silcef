...
public class _MEMORYSTATUS {
    ...
    private static final long dwTotalPhys$OFFSET = $LAYOUT.byteOffset(groupElement("dwTotalPhys"));
    ...
    private static final long dwAvailPhys$OFFSET = $LAYOUT.byteOffset(groupElement("dwAvailPhys"));
    ...
    private static final long dwTotalPageFile$OFFSET = $LAYOUT.byteOffset(groupElement("dwTotalPageFile"));
    ...
    private static final long dwAvailPageFile$OFFSET = $LAYOUT.byteOffset(groupElement("dwAvailPageFile"));
    ...
    private static final long dwTotalVirtual$OFFSET = $LAYOUT.byteOffset(groupElement("dwTotalVirtual"));
    ...
    private static final long dwAvailVirtual$OFFSET = $LAYOUT.byteOffset(groupElement("dwAvailVirtual"));
