...
public class _CSV_QUERY_VOLUME_REDIRECT_STATE {
    ...
    private static final long IsDiskConnected$OFFSET = $LAYOUT.byteOffset(groupElement("IsDiskConnected"));
    ...
    private static final long ClusterEnableDirectIo$OFFSET = $LAYOUT.byteOffset(groupElement("ClusterEnableDirectIo"));
