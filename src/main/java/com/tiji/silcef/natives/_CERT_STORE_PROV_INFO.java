...
public class _CERT_STORE_PROV_INFO {
    ...
    private static final long cStoreProvFunc$OFFSET = $LAYOUT.byteOffset(groupElement("cStoreProvFunc"));
    ...
    private static final long rgpvStoreProvFunc$OFFSET = $LAYOUT.byteOffset(groupElement("rgpvStoreProvFunc"));
    ...
    private static final long hStoreProv$OFFSET = $LAYOUT.byteOffset(groupElement("hStoreProv"));
    ...
    private static final long dwStoreProvFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwStoreProvFlags"));
    ...
    private static final long hStoreProvFuncAddr2$OFFSET = $LAYOUT.byteOffset(groupElement("hStoreProvFuncAddr2"));
