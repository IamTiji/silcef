...
public class _IO_COUNTERS {
    ...
    private static final long ReadOperationCount$OFFSET = $LAYOUT.byteOffset(groupElement("ReadOperationCount"));
    ...
    private static final long WriteOperationCount$OFFSET = $LAYOUT.byteOffset(groupElement("WriteOperationCount"));
    ...
    private static final long OtherOperationCount$OFFSET = $LAYOUT.byteOffset(groupElement("OtherOperationCount"));
    ...
    private static final long ReadTransferCount$OFFSET = $LAYOUT.byteOffset(groupElement("ReadTransferCount"));
    ...
    private static final long WriteTransferCount$OFFSET = $LAYOUT.byteOffset(groupElement("WriteTransferCount"));
    ...
    private static final long OtherTransferCount$OFFSET = $LAYOUT.byteOffset(groupElement("OtherTransferCount"));
