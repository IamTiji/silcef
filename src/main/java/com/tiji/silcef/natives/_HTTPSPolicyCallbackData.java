...
public class _HTTPSPolicyCallbackData {
    ...
    private static final OfInt cbStruct$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20436:5"), groupElement("cbStruct"));
    ...
    private static final long cbStruct$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20436:5"), groupElement("cbStruct"));
    ...
    private static final OfInt cbSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20436:5"), groupElement("cbSize"));
    ...
    private static final long cbSize$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20436:5"), groupElement("cbSize"));
    ...
    private static final long dwAuthType$OFFSET = $LAYOUT.byteOffset(groupElement("dwAuthType"));
    ...
    private static final long fdwChecks$OFFSET = $LAYOUT.byteOffset(groupElement("fdwChecks"));
    ...
    private static final long pwszServerName$OFFSET = $LAYOUT.byteOffset(groupElement("pwszServerName"));
