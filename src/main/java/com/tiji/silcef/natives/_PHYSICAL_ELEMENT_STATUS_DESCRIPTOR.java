...
public class _PHYSICAL_ELEMENT_STATUS_DESCRIPTOR {
    ...
    private static final long ElementIdentifier$OFFSET = $LAYOUT.byteOffset(groupElement("ElementIdentifier"));
    ...
    private static final long PhysicalElementType$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalElementType"));
    ...
    private static final long PhysicalElementHealth$OFFSET = $LAYOUT.byteOffset(groupElement("PhysicalElementHealth"));
    ...
    private static final long AssociatedCapacity$OFFSET = $LAYOUT.byteOffset(groupElement("AssociatedCapacity"));
