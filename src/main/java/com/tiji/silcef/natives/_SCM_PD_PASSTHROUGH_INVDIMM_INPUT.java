...
public class _SCM_PD_PASSTHROUGH_INVDIMM_INPUT {
    ...
    private static final long OpcodeParametersLength$OFFSET = $LAYOUT.byteOffset(groupElement("OpcodeParametersLength"));
    ...
    private static final long OpcodeParameters$OFFSET = $LAYOUT.byteOffset(groupElement("OpcodeParameters"));
    ...
    public static byte OpcodeParameters(MemorySegment struct, long index0) {
        return (byte)OpcodeParameters$ELEM_HANDLE.get(struct, OpcodeParameters$OFFSET, index0);
    }
    ...
    public static void OpcodeParameters(MemorySegment struct, long index0, byte fieldValue) {
        OpcodeParameters$ELEM_HANDLE.set(struct, OpcodeParameters$OFFSET, index0, fieldValue);
    }
