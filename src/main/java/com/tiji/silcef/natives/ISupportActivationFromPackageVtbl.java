...
/**
 * {@snippet lang=c :
 * struct ISupportActivationFromPackageVtbl {
 *     HRESULT (*QueryInterface)(ISupportActivationFromPackage *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportActivationFromPackage *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportActivationFromPackage *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportActivationFromPackageVtbl {
    ...
    ).withName("ISupportActivationFromPackageVtbl");
