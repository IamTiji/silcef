...
public class tagEMRPOLYDRAW16 {
    ...
    private static final long abTypes$OFFSET = $LAYOUT.byteOffset(groupElement("abTypes"));
    ...
    public static byte abTypes(MemorySegment struct, long index0) {
        return (byte)abTypes$ELEM_HANDLE.get(struct, abTypes$OFFSET, index0);
    }
    ...
    public static void abTypes(MemorySegment struct, long index0, byte fieldValue) {
        abTypes$ELEM_HANDLE.set(struct, abTypes$OFFSET, index0, fieldValue);
    }
