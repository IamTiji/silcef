...
public class _IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    ...
    private static final long EpilogueCount$OFFSET = $LAYOUT.byteOffset(groupElement("EpilogueCount"));
    ...
    private static final long EpilogueByteCount$OFFSET = $LAYOUT.byteOffset(groupElement("EpilogueByteCount"));
    ...
    private static final long BranchDescriptorElementSize$OFFSET = $LAYOUT.byteOffset(groupElement("BranchDescriptorElementSize"));
    ...
    private static final long BranchDescriptorCount$OFFSET = $LAYOUT.byteOffset(groupElement("BranchDescriptorCount"));
