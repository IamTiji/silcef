 ...
 *     ULONG dwMagic;
 *     ULONG cbParameterSet;
 *     ULONG cbKey;
 * }
 * }
 */
public class BCRYPT_MLKEM_KEY_BLOB {
    ...
    ).withName("BCRYPT_MLKEM_KEY_BLOB");
    ...
    private static final OfInt cbParameterSet$LAYOUT = (OfInt)$LAYOUT.select(groupElement("cbParameterSet"));
     ...
     * }
     */
    public static final OfInt cbParameterSet$layout() {
        return cbParameterSet$LAYOUT;
    }

    private static final long cbParameterSet$OFFSET = $LAYOUT.byteOffset(groupElement("cbParameterSet"));
     ...
     * }
     */
    public static final long cbParameterSet$offset() {
        return cbParameterSet$OFFSET;
    }
     ...
     * }
     */
    public static int cbParameterSet(MemorySegment struct) {
        return struct.get(cbParameterSet$LAYOUT, cbParameterSet$OFFSET);
    }
     ...
     * }
     */
    public static void cbParameterSet(MemorySegment struct, int fieldValue) {
        struct.set(cbParameterSet$LAYOUT, cbParameterSet$OFFSET, fieldValue);
    }
