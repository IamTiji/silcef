...
public class tagMENUINFO {
    ...
    private static final long cyMax$OFFSET = $LAYOUT.byteOffset(groupElement("cyMax"));
    ...
    private static final long hbrBack$OFFSET = $LAYOUT.byteOffset(groupElement("hbrBack"));
    ...
    private static final long dwMenuData$OFFSET = $LAYOUT.byteOffset(groupElement("dwMenuData"));
