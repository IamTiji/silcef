...
public class _FILE_COMPRESSION_INFO {
    ...
    private static final long CompressedFileSize$OFFSET = $LAYOUT.byteOffset(groupElement("CompressedFileSize"));
    ...
    private static final long CompressionUnitShift$OFFSET = $LAYOUT.byteOffset(groupElement("CompressionUnitShift"));
