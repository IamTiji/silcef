...
public class _PACKEDEVENTINFO {
    ...
    private static final long ulNumEventsForLogFile$OFFSET = $LAYOUT.byteOffset(groupElement("ulNumEventsForLogFile"));
    ...
    private static final long ulOffsets$OFFSET = $LAYOUT.byteOffset(groupElement("ulOffsets"));
