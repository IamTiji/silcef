...
public class _CERT_ALT_NAME_ENTRY {
    ...
    private static final long dwAltNameChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwAltNameChoice"));
    ...
    private static final AddressLayout pOtherName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("pOtherName"));
    ...
    private static final long pOtherName$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("pOtherName"));
    ...
    private static final AddressLayout pwszRfc822Name$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("pwszRfc822Name"));
    ...
    private static final long pwszRfc822Name$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("pwszRfc822Name"));
    ...
    private static final AddressLayout pwszDNSName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("pwszDNSName"));
    ...
    private static final long pwszDNSName$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("pwszDNSName"));
    ...
    private static final GroupLayout DirectoryName$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("DirectoryName"));
    ...
    private static final long DirectoryName$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("DirectoryName"));
    ...
    private static final AddressLayout pwszURL$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("pwszURL"));
    ...
    private static final long pwszURL$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("pwszURL"));
    ...
    private static final GroupLayout IPAddress$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("IPAddress"));
    ...
    private static final long IPAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("IPAddress"));
    ...
    private static final AddressLayout pszRegisteredID$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$4048:5"), groupElement("pszRegisteredID"));
    ...
    private static final long pszRegisteredID$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4048:5"), groupElement("pszRegisteredID"));
