...
public class _STORAGE_QUERY_DEPENDENT_VOLUME_RESPONSE {
    ...
    private static final long ResponseLevel$OFFSET = $LAYOUT.byteOffset(groupElement("ResponseLevel"));
    ...
    private static final long NumberEntries$OFFSET = $LAYOUT.byteOffset(groupElement("NumberEntries"));
    ...
    private static final SequenceLayout Lev1Depends$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14654:5"), groupElement("Lev1Depends"));
    ...
    private static final long Lev1Depends$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14654:5"), groupElement("Lev1Depends"));
    ...
    private static final SequenceLayout Lev2Depends$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$14654:5"), groupElement("Lev2Depends"));
    ...
    private static final long Lev2Depends$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14654:5"), groupElement("Lev2Depends"));
