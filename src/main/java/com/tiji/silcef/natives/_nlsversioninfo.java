...
public class _nlsversioninfo {
    ...
    private static final long dwNLSVersionInfoSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwNLSVersionInfoSize"));
    ...
    private static final long dwNLSVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwNLSVersion"));
    ...
    private static final long dwDefinedVersion$OFFSET = $LAYOUT.byteOffset(groupElement("dwDefinedVersion"));
    ...
    private static final long dwEffectiveId$OFFSET = $LAYOUT.byteOffset(groupElement("dwEffectiveId"));
    ...
    private static final long guidCustomVersion$OFFSET = $LAYOUT.byteOffset(groupElement("guidCustomVersion"));
