...
public class _QUOTA_LIMITS_EX {
    ...
    private static final long PagedPoolLimit$OFFSET = $LAYOUT.byteOffset(groupElement("PagedPoolLimit"));
    ...
    private static final long NonPagedPoolLimit$OFFSET = $LAYOUT.byteOffset(groupElement("NonPagedPoolLimit"));
    ...
    private static final long PagefileLimit$OFFSET = $LAYOUT.byteOffset(groupElement("PagefileLimit"));
    ...
    private static final long TimeLimit$OFFSET = $LAYOUT.byteOffset(groupElement("TimeLimit"));
    ...
    private static final long WorkingSetLimit$OFFSET = $LAYOUT.byteOffset(groupElement("WorkingSetLimit"));
    ...
    private static final long CpuRateLimit$OFFSET = $LAYOUT.byteOffset(groupElement("CpuRateLimit"));
