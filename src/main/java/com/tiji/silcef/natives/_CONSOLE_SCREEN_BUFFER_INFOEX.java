...
public class _CONSOLE_SCREEN_BUFFER_INFOEX {
    ...
    private static final long dwCursorPosition$OFFSET = $LAYOUT.byteOffset(groupElement("dwCursorPosition"));
    ...
    private static final long wAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("wAttributes"));
    ...
    private static final long srWindow$OFFSET = $LAYOUT.byteOffset(groupElement("srWindow"));
    ...
    private static final long dwMaximumWindowSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwMaximumWindowSize"));
    ...
    private static final long wPopupAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("wPopupAttributes"));
    ...
    private static final long bFullscreenSupported$OFFSET = $LAYOUT.byteOffset(groupElement("bFullscreenSupported"));
    ...
    private static final long ColorTable$OFFSET = $LAYOUT.byteOffset(groupElement("ColorTable"));
    ...
    public static int ColorTable(MemorySegment struct, long index0) {
        return (int)ColorTable$ELEM_HANDLE.get(struct, ColorTable$OFFSET, index0);
    }
    ...
    public static void ColorTable(MemorySegment struct, long index0, int fieldValue) {
        ColorTable$ELEM_HANDLE.set(struct, ColorTable$OFFSET, index0, fieldValue);
    }
