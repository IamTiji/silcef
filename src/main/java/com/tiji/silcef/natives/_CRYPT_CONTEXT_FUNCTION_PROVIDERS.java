...
public class _CRYPT_CONTEXT_FUNCTION_PROVIDERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("cProviders"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("rgpszProviders")
    ...
    private static final long cProviders$OFFSET = $LAYOUT.byteOffset(groupElement("cProviders"));
    ...
    private static final long rgpszProviders$OFFSET = $LAYOUT.byteOffset(groupElement("rgpszProviders"));
