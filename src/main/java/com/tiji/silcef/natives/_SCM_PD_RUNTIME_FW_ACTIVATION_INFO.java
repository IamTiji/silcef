...
public class _SCM_PD_RUNTIME_FW_ACTIVATION_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("LastFirmwareActivationStatus"),
    ...
    private static final long LastFirmwareActivationStatus$OFFSET = $LAYOUT.byteOffset(groupElement("LastFirmwareActivationStatus"));
