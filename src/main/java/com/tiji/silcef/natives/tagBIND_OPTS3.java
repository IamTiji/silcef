...
public class tagBIND_OPTS3 {
    ...
    private static final long grfFlags$OFFSET = $LAYOUT.byteOffset(groupElement("grfFlags"));
    ...
    private static final long grfMode$OFFSET = $LAYOUT.byteOffset(groupElement("grfMode"));
    ...
    private static final long dwTickCountDeadline$OFFSET = $LAYOUT.byteOffset(groupElement("dwTickCountDeadline"));
    ...
    private static final long dwTrackFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwTrackFlags"));
    ...
    private static final long dwClassContext$OFFSET = $LAYOUT.byteOffset(groupElement("dwClassContext"));
    ...
    private static final long pServerInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pServerInfo"));
