...
public class _ENLISTMENT_BASIC_INFORMATION {
    ...
    private static final long EnlistmentId$OFFSET = $LAYOUT.byteOffset(groupElement("EnlistmentId"));
    ...
    private static final long TransactionId$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionId"));
    ...
    private static final long ResourceManagerId$OFFSET = $LAYOUT.byteOffset(groupElement("ResourceManagerId"));
