...
public class _SERVICE_FAILURE_ACTIONSW {
    ...
    private static final long dwResetPeriod$OFFSET = $LAYOUT.byteOffset(groupElement("dwResetPeriod"));
    ...
    private static final long lpRebootMsg$OFFSET = $LAYOUT.byteOffset(groupElement("lpRebootMsg"));
    ...
    private static final long lpCommand$OFFSET = $LAYOUT.byteOffset(groupElement("lpCommand"));
    ...
    private static final long cActions$OFFSET = $LAYOUT.byteOffset(groupElement("cActions"));
    ...
    private static final long lpsaActions$OFFSET = $LAYOUT.byteOffset(groupElement("lpsaActions"));
