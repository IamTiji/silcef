 ...
 * }
 */
public final class SC_NOTIFICATION_CALLBACK {

    private SC_NOTIFICATION_CALLBACK() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SC_NOTIFICATION_CALLBACK.Function.class, "apply", $DESC);
