...
public class tagTLIBATTR {
    ...
    private static final long syskind$OFFSET = $LAYOUT.byteOffset(groupElement("syskind"));
    ...
    private static final long wLibFlags$OFFSET = $LAYOUT.byteOffset(groupElement("wLibFlags"));
