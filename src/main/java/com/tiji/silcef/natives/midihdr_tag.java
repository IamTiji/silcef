...
public class midihdr_tag {
    ...
    private static final long dwBufferLength$OFFSET = $LAYOUT.byteOffset(groupElement("dwBufferLength"));
    ...
    private static final long dwBytesRecorded$OFFSET = $LAYOUT.byteOffset(groupElement("dwBytesRecorded"));
    ...
    private static final long lpNext$OFFSET = $LAYOUT.byteOffset(groupElement("lpNext"));
    ...
    public static long dwReserved(MemorySegment struct, long index0) {
        return (long)dwReserved$ELEM_HANDLE.get(struct, dwReserved$OFFSET, index0);
    }
