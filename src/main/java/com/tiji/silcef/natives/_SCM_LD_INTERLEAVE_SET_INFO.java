...
public class _SCM_LD_INTERLEAVE_SET_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("InterleaveSetSize"),
    ...
    private static final long InterleaveSetSize$OFFSET = $LAYOUT.byteOffset(groupElement("InterleaveSetSize"));
    ...
    private static final long InterleaveSet$OFFSET = $LAYOUT.byteOffset(groupElement("InterleaveSet"));
    ...
    public static MemorySegment InterleaveSet(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)InterleaveSet$ELEM_HANDLE.invokeExact(struct, InterleaveSet$OFFSET, index0);
