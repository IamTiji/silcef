...
public class tagDEBUGHOOKINFO {
    ...
    private static final long idThread$OFFSET = $LAYOUT.byteOffset(groupElement("idThread"));
    ...
    private static final long idThreadInstaller$OFFSET = $LAYOUT.byteOffset(groupElement("idThreadInstaller"));
