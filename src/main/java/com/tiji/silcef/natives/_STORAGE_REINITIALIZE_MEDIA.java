...
public class _STORAGE_REINITIALIZE_MEDIA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_LONG.withName("TimeoutInSeconds"),
    ...
    private static final long TimeoutInSeconds$OFFSET = $LAYOUT.byteOffset(groupElement("TimeoutInSeconds"));
    ...
    private static final long SanitizeOption$OFFSET = $LAYOUT.byteOffset(groupElement("SanitizeOption"));
