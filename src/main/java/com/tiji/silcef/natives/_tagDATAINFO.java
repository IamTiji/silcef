...
public class _tagDATAINFO {
    ...
    private static final long ulTotalSize$OFFSET = $LAYOUT.byteOffset(groupElement("ulTotalSize"));
    ...
    private static final long ulavrPacketSize$OFFSET = $LAYOUT.byteOffset(groupElement("ulavrPacketSize"));
    ...
    private static final long ulConnectSpeed$OFFSET = $LAYOUT.byteOffset(groupElement("ulConnectSpeed"));
    ...
    private static final long ulProcessorSpeed$OFFSET = $LAYOUT.byteOffset(groupElement("ulProcessorSpeed"));
