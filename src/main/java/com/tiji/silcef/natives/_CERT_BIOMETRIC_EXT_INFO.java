...
public class _CERT_BIOMETRIC_EXT_INFO {
    ...
    private static final long cBiometricData$OFFSET = $LAYOUT.byteOffset(groupElement("cBiometricData"));
    ...
    private static final long rgBiometricData$OFFSET = $LAYOUT.byteOffset(groupElement("rgBiometricData"));
