...
public class tagMINIMIZEDMETRICS {
    ...
    private static final long iHorzGap$OFFSET = $LAYOUT.byteOffset(groupElement("iHorzGap"));
    ...
    private static final long iVertGap$OFFSET = $LAYOUT.byteOffset(groupElement("iVertGap"));
    ...
    private static final long iArrange$OFFSET = $LAYOUT.byteOffset(groupElement("iArrange"));
