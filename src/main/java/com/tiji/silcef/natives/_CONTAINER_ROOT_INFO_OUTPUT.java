...
public class _CONTAINER_ROOT_INFO_OUTPUT {
    ...
    private static final long ContainerRootIdLength$OFFSET = $LAYOUT.byteOffset(groupElement("ContainerRootIdLength"));
    ...
    private static final long ContainerRootId$OFFSET = $LAYOUT.byteOffset(groupElement("ContainerRootId"));
    ...
    public static byte ContainerRootId(MemorySegment struct, long index0) {
        return (byte)ContainerRootId$ELEM_HANDLE.get(struct, ContainerRootId$OFFSET, index0);
    }
    ...
    public static void ContainerRootId(MemorySegment struct, long index0, byte fieldValue) {
        ContainerRootId$ELEM_HANDLE.set(struct, ContainerRootId$OFFSET, index0, fieldValue);
    }
