...
public class tagENUMLOGFONTEXDVW {
    ...
    private static final long elfEnumLogfontEx$OFFSET = $LAYOUT.byteOffset(groupElement("elfEnumLogfontEx"));
    ...
    private static final long elfDesignVector$OFFSET = $LAYOUT.byteOffset(groupElement("elfDesignVector"));
