...
public class _VIRTUALIZATION_INSTANCE_INFO_INPUT_EX {
    ...
    private static final long NotificationInfoSize$OFFSET = $LAYOUT.byteOffset(groupElement("NotificationInfoSize"));
    ...
    private static final long NotificationInfoOffset$OFFSET = $LAYOUT.byteOffset(groupElement("NotificationInfoOffset"));
    ...
    private static final long ProviderMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("ProviderMajorVersion"));
