...
public class _IMAGE_RELOCATION {
    ...
    private static final OfInt VirtualAddress$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20459:5"), groupElement("VirtualAddress"));
    ...
    private static final long VirtualAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20459:5"), groupElement("VirtualAddress"));
    ...
    private static final OfInt RelocCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20459:5"), groupElement("RelocCount"));
    ...
    private static final long RelocCount$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$20459:5"), groupElement("RelocCount"));
    ...
    private static final long SymbolTableIndex$OFFSET = $LAYOUT.byteOffset(groupElement("SymbolTableIndex"));
