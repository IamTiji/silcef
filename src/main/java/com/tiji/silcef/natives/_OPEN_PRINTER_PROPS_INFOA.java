...
public class _OPEN_PRINTER_PROPS_INFOA {
    ...
    private static final long pszSheetName$OFFSET = $LAYOUT.byteOffset(groupElement("pszSheetName"));
    ...
    private static final long uSheetIndex$OFFSET = $LAYOUT.byteOffset(groupElement("uSheetIndex"));
    ...
    private static final long bModal$OFFSET = $LAYOUT.byteOffset(groupElement("bModal"));
