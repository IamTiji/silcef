 ...
 * }
 */
public final class ENUMRESNAMEPROCA {

    private ENUMRESNAMEPROCA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ENUMRESNAMEPROCA.Function.class, "apply", $DESC);
