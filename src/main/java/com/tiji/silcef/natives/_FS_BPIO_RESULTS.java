...
public class _FS_BPIO_RESULTS {
    ...
    private static final long OpStatus$OFFSET = $LAYOUT.byteOffset(groupElement("OpStatus"));
    ...
    private static final long FailingDriverNameLen$OFFSET = $LAYOUT.byteOffset(groupElement("FailingDriverNameLen"));
    ...
    private static final long FailingDriverName$OFFSET = $LAYOUT.byteOffset(groupElement("FailingDriverName"));
    ...
    public static short FailingDriverName(MemorySegment struct, long index0) {
        return (short)FailingDriverName$ELEM_HANDLE.get(struct, FailingDriverName$OFFSET, index0);
    }
    ...
    public static void FailingDriverName(MemorySegment struct, long index0, short fieldValue) {
        FailingDriverName$ELEM_HANDLE.set(struct, FailingDriverName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long FailureReasonLen$OFFSET = $LAYOUT.byteOffset(groupElement("FailureReasonLen"));
    ...
    private static final long FailureReason$OFFSET = $LAYOUT.byteOffset(groupElement("FailureReason"));
    ...
    public static short FailureReason(MemorySegment struct, long index0) {
        return (short)FailureReason$ELEM_HANDLE.get(struct, FailureReason$OFFSET, index0);
    }
    ...
    public static void FailureReason(MemorySegment struct, long index0, short fieldValue) {
        FailureReason$ELEM_HANDLE.set(struct, FailureReason$OFFSET, index0, fieldValue);
    }
