...
public class ICancelMethodCallsVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("TestCancel")
     ...
     * }
     */
    public final static class TestCancel {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(TestCancel.Function.class, "apply", $DESC);
    ...
    private static final long TestCancel$OFFSET = $LAYOUT.byteOffset(groupElement("TestCancel"));
