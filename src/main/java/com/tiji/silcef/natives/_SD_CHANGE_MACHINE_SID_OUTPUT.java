...
public class _SD_CHANGE_MACHINE_SID_OUTPUT {
    ...
    private static final long NumSDChangedSuccess$OFFSET = $LAYOUT.byteOffset(groupElement("NumSDChangedSuccess"));
    ...
    private static final long NumSDChangedFail$OFFSET = $LAYOUT.byteOffset(groupElement("NumSDChangedFail"));
    ...
    private static final long NumMftSDChangedSuccess$OFFSET = $LAYOUT.byteOffset(groupElement("NumMftSDChangedSuccess"));
    ...
    private static final long NumMftSDChangedFail$OFFSET = $LAYOUT.byteOffset(groupElement("NumMftSDChangedFail"));
    ...
    private static final long NumMftSDTotal$OFFSET = $LAYOUT.byteOffset(groupElement("NumMftSDTotal"));
