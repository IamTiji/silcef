...
public class _PSFEATURE_CUSTPAPER {
    ...
    private static final long lOrientation$OFFSET = $LAYOUT.byteOffset(groupElement("lOrientation"));
    ...
    private static final long lWidth$OFFSET = $LAYOUT.byteOffset(groupElement("lWidth"));
    ...
    private static final long lHeight$OFFSET = $LAYOUT.byteOffset(groupElement("lHeight"));
    ...
    private static final long lWidthOffset$OFFSET = $LAYOUT.byteOffset(groupElement("lWidthOffset"));
    ...
    private static final long lHeightOffset$OFFSET = $LAYOUT.byteOffset(groupElement("lHeightOffset"));
