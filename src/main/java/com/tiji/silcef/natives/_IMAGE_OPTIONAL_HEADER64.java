...
public class _IMAGE_OPTIONAL_HEADER64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("FileAlignment"),
        cef_master_h.C_SHORT.withName("MajorOperatingSystemVersion"),
        cef_master_h.C_SHORT.withName("MinorOperatingSystemVersion"),
        cef_master_h.C_SHORT.withName("MajorImageVersion"),
        cef_master_h.C_SHORT.withName("MinorImageVersion"),
        cef_master_h.C_SHORT.withName("MajorSubsystemVersion"),
        cef_master_h.C_SHORT.withName("MinorSubsystemVersion"),
        cef_master_h.C_LONG.withName("Win32VersionValue"),
        cef_master_h.C_LONG.withName("SizeOfImage"),
        cef_master_h.C_LONG.withName("SizeOfHeaders"),
        cef_master_h.C_LONG.withName("CheckSum"),
        cef_master_h.C_SHORT.withName("Subsystem"),
        cef_master_h.C_SHORT.withName("DllCharacteristics"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SizeOfStackReserve"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SizeOfStackCommit"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SizeOfHeapReserve"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SizeOfHeapCommit"),
        cef_master_h.C_LONG.withName("LoaderFlags"),
        cef_master_h.C_LONG.withName("NumberOfRvaAndSizes"),
