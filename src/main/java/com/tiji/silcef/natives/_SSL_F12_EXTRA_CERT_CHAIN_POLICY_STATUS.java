...
public class _SSL_F12_EXTRA_CERT_CHAIN_POLICY_STATUS {
    ...
    private static final long dwErrorLevel$OFFSET = $LAYOUT.byteOffset(groupElement("dwErrorLevel"));
    ...
    private static final long dwErrorCategory$OFFSET = $LAYOUT.byteOffset(groupElement("dwErrorCategory"));
    ...
    private static final long wszErrorText$OFFSET = $LAYOUT.byteOffset(groupElement("wszErrorText"));
    ...
    public static short wszErrorText(MemorySegment struct, long index0) {
        return (short)wszErrorText$ELEM_HANDLE.get(struct, wszErrorText$OFFSET, index0);
    }
    ...
    public static void wszErrorText(MemorySegment struct, long index0, short fieldValue) {
        wszErrorText$ELEM_HANDLE.set(struct, wszErrorText$OFFSET, index0, fieldValue);
    }
