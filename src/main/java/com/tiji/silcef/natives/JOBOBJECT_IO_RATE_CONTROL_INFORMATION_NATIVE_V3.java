...
public class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V3 {
    ...
    private static final long MaxIops$OFFSET = $LAYOUT.byteOffset(groupElement("MaxIops"));
    ...
    private static final long MaxBandwidth$OFFSET = $LAYOUT.byteOffset(groupElement("MaxBandwidth"));
    ...
    private static final long ReservationIops$OFFSET = $LAYOUT.byteOffset(groupElement("ReservationIops"));
    ...
    private static final long VolumeName$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeName"));
    ...
    private static final long BaseIoSize$OFFSET = $LAYOUT.byteOffset(groupElement("BaseIoSize"));
    ...
    private static final long ControlFlags$OFFSET = $LAYOUT.byteOffset(groupElement("ControlFlags"));
    ...
    private static final long VolumeNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("VolumeNameLength"));
    ...
    private static final long CriticalReservationIops$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalReservationIops"));
    ...
    private static final long ReservationBandwidth$OFFSET = $LAYOUT.byteOffset(groupElement("ReservationBandwidth"));
    ...
    private static final long CriticalReservationBandwidth$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalReservationBandwidth"));
    ...
    private static final long MaxTimePercent$OFFSET = $LAYOUT.byteOffset(groupElement("MaxTimePercent"));
    ...
    private static final long ReservationTimePercent$OFFSET = $LAYOUT.byteOffset(groupElement("ReservationTimePercent"));
    ...
    private static final long CriticalReservationTimePercent$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalReservationTimePercent"));
    ...
    private static final long SoftMaxIops$OFFSET = $LAYOUT.byteOffset(groupElement("SoftMaxIops"));
    ...
    private static final long SoftMaxBandwidth$OFFSET = $LAYOUT.byteOffset(groupElement("SoftMaxBandwidth"));
    ...
    private static final long SoftMaxTimePercent$OFFSET = $LAYOUT.byteOffset(groupElement("SoftMaxTimePercent"));
    ...
    private static final long LimitExcessNotifyIops$OFFSET = $LAYOUT.byteOffset(groupElement("LimitExcessNotifyIops"));
    ...
    private static final long LimitExcessNotifyBandwidth$OFFSET = $LAYOUT.byteOffset(groupElement("LimitExcessNotifyBandwidth"));
    ...
    private static final long LimitExcessNotifyTimePercent$OFFSET = $LAYOUT.byteOffset(groupElement("LimitExcessNotifyTimePercent"));
