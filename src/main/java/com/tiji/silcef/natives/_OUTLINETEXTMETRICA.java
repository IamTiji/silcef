...
public class _OUTLINETEXTMETRICA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_INT.withName("otmSize"),
        tagTEXTMETRICA.layout().withName("otmTextMetrics"),
        cef_master_h.C_CHAR.withName("otmFiller"),
        tagPANOSE.layout().withName("otmPanoseNumber"),
        MemoryLayout.paddingLayout(1),
        cef_master_h.C_INT.withName("otmfsSelection"),
        cef_master_h.C_INT.withName("otmfsType"),
        cef_master_h.C_INT.withName("otmsCharSlopeRise"),
        cef_master_h.C_INT.withName("otmsCharSlopeRun"),
        cef_master_h.C_INT.withName("otmItalicAngle"),
        cef_master_h.C_INT.withName("otmEMSquare"),
        cef_master_h.C_INT.withName("otmAscent"),
        cef_master_h.C_INT.withName("otmDescent"),
        cef_master_h.C_INT.withName("otmLineGap"),
        cef_master_h.C_INT.withName("otmsCapEmHeight"),
        cef_master_h.C_INT.withName("otmsXHeight"),
        tagRECT.layout().withName("otmrcFontBox"),
        cef_master_h.C_INT.withName("otmMacAscent"),
        cef_master_h.C_INT.withName("otmMacDescent"),
        cef_master_h.C_INT.withName("otmMacLineGap"),
        cef_master_h.C_INT.withName("otmusMinimumPPEM"),
        ...
        cef_master_h.C_INT.withName("otmsStrikeoutSize"),
        cef_master_h.C_INT.withName("otmsStrikeoutPosition"),
        cef_master_h.C_INT.withName("otmsUnderscoreSize"),
        cef_master_h.C_INT.withName("otmsUnderscorePosition"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("otmpFamilyName"),
        cef_master_h.C_POINTER.withName("otmpFaceName"),
        cef_master_h.C_POINTER.withName("otmpStyleName"),
        cef_master_h.C_POINTER.withName("otmpFullName")
