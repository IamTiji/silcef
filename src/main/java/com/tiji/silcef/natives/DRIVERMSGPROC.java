 ...
 * }
 */
public final class DRIVERMSGPROC {

    private DRIVERMSGPROC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(DRIVERMSGPROC.Function.class, "apply", $DESC);
