...
public class _KCRM_MARSHAL_HEADER {
    ...
    private static final long VersionMajor$OFFSET = $LAYOUT.byteOffset(groupElement("VersionMajor"));
    ...
    private static final long VersionMinor$OFFSET = $LAYOUT.byteOffset(groupElement("VersionMinor"));
    ...
    private static final long NumProtocols$OFFSET = $LAYOUT.byteOffset(groupElement("NumProtocols"));
