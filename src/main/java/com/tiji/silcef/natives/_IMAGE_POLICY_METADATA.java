...
public class _IMAGE_POLICY_METADATA {
    ...
    private static final long ApplicationId$OFFSET = $LAYOUT.byteOffset(groupElement("ApplicationId"));
    ...
    private static final long Policies$OFFSET = $LAYOUT.byteOffset(groupElement("Policies"));
