...
public class _FILE_NOTIFY_FULL_INFORMATION {
    ...
    private static final long CreationTime$OFFSET = $LAYOUT.byteOffset(groupElement("CreationTime"));
    ...
    private static final long LastModificationTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastModificationTime"));
    ...
    private static final long LastChangeTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastChangeTime"));
    ...
    private static final long LastAccessTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastAccessTime"));
    ...
    private static final long AllocatedLength$OFFSET = $LAYOUT.byteOffset(groupElement("AllocatedLength"));
    ...
    private static final long FileSize$OFFSET = $LAYOUT.byteOffset(groupElement("FileSize"));
    ...
    private static final long FileAttributes$OFFSET = $LAYOUT.byteOffset(groupElement("FileAttributes"));
    ...
    private static final OfInt ReparsePointTag$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15435:5"), groupElement("ReparsePointTag"));
    ...
    private static final long ReparsePointTag$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15435:5"), groupElement("ReparsePointTag"));
    ...
    private static final OfInt EaSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15435:5"), groupElement("EaSize"));
    ...
    private static final long EaSize$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15435:5"), groupElement("EaSize"));
    ...
    private static final long FileId$OFFSET = $LAYOUT.byteOffset(groupElement("FileId"));
    ...
    private static final long ParentFileId$OFFSET = $LAYOUT.byteOffset(groupElement("ParentFileId"));
    ...
    private static final long FileNameLength$OFFSET = $LAYOUT.byteOffset(groupElement("FileNameLength"));
    ...
    private static final OfByte FileNameFlags$LAYOUT = (OfByte)$LAYOUT.select(groupElement("FileNameFlags"));
     ...
     * }
     */
    public static final OfByte FileNameFlags$layout() {
        return FileNameFlags$LAYOUT;
    }

    private static final long FileNameFlags$OFFSET = $LAYOUT.byteOffset(groupElement("FileNameFlags"));
     ...
     * }
     */
    public static final long FileNameFlags$offset() {
        return FileNameFlags$OFFSET;
    }
     ...
     * }
     */
    public static byte FileNameFlags(MemorySegment struct) {
        return struct.get(FileNameFlags$LAYOUT, FileNameFlags$OFFSET);
    }
     ...
     * }
     */
    public static void FileNameFlags(MemorySegment struct, byte fieldValue) {
        struct.set(FileNameFlags$LAYOUT, FileNameFlags$OFFSET, fieldValue);
    }
    ...
    public static short FileName(MemorySegment struct, long index0) {
        return (short)FileName$ELEM_HANDLE.get(struct, FileName$OFFSET, index0);
    }
    ...
    public static void FileName(MemorySegment struct, long index0, short fieldValue) {
        FileName$ELEM_HANDLE.set(struct, FileName$OFFSET, index0, fieldValue);
    }
