...
public class _UMS_SYSTEM_THREAD_INFORMATION {
    ...
    private static final OfInt ThreadUmsFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1639:5"), groupElement("ThreadUmsFlags"));
    ...
    private static final long ThreadUmsFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1639:5"), groupElement("ThreadUmsFlags"));
