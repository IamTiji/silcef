...
public class tagCOMPAREITEMSTRUCT {
    ...
    private static final long itemID1$OFFSET = $LAYOUT.byteOffset(groupElement("itemID1"));
    ...
    private static final long itemData1$OFFSET = $LAYOUT.byteOffset(groupElement("itemData1"));
    ...
    private static final long itemID2$OFFSET = $LAYOUT.byteOffset(groupElement("itemID2"));
    ...
    private static final long itemData2$OFFSET = $LAYOUT.byteOffset(groupElement("itemData2"));
    ...
    private static final long dwLocaleId$OFFSET = $LAYOUT.byteOffset(groupElement("dwLocaleId"));
