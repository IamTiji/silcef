...
public class _DEVICE_WRITE_AGGREGATION_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_CHAR.withName("BenefitsFromWriteAggregation"),
    ...
    private static final long BenefitsFromWriteAggregation$OFFSET = $LAYOUT.byteOffset(groupElement("BenefitsFromWriteAggregation"));
