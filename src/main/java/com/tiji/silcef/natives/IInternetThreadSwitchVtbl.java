...
public class IInternetThreadSwitchVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("Prepare"),
    ...
    public final static class Prepare {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(Prepare.Function.class, "apply", $DESC);
