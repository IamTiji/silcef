...
public class tagPOINTER_TOUCH_INFO {
    ...
    private static final long pointerInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pointerInfo"));
    ...
    private static final long touchFlags$OFFSET = $LAYOUT.byteOffset(groupElement("touchFlags"));
    ...
    private static final long touchMask$OFFSET = $LAYOUT.byteOffset(groupElement("touchMask"));
    ...
    private static final long rcContact$OFFSET = $LAYOUT.byteOffset(groupElement("rcContact"));
    ...
    private static final long rcContactRaw$OFFSET = $LAYOUT.byteOffset(groupElement("rcContactRaw"));
