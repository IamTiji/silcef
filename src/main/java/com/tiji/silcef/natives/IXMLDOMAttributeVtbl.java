...
public class IXMLDOMAttributeVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("put_value")
     ...
     * }
     */
    public final static class put_value {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(put_value.Function.class, "apply", $DESC);
    ...
    private static final long put_value$OFFSET = $LAYOUT.byteOffset(groupElement("put_value"));
