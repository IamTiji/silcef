...
public class _IMAGE_DYNAMIC_RELOCATION32_V2 {
    ...
    private static final long FixupInfoSize$OFFSET = $LAYOUT.byteOffset(groupElement("FixupInfoSize"));
    ...
    private static final long Symbol$OFFSET = $LAYOUT.byteOffset(groupElement("Symbol"));
    ...
    private static final long SymbolGroup$OFFSET = $LAYOUT.byteOffset(groupElement("SymbolGroup"));
