...
public class DISPLAYCONFIG_VIDEO_SIGNAL_INFO {
    ...
    private static final long hSyncFreq$OFFSET = $LAYOUT.byteOffset(groupElement("hSyncFreq"));
    ...
    private static final long vSyncFreq$OFFSET = $LAYOUT.byteOffset(groupElement("vSyncFreq"));
    ...
    private static final long activeSize$OFFSET = $LAYOUT.byteOffset(groupElement("activeSize"));
    ...
    private static final long AdditionalSignalInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2854:5"), groupElement("AdditionalSignalInfo"));
    ...
    private static final long videoStandard$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2854:5"), groupElement("videoStandard"));
    ...
    private static final long scanLineOrdering$OFFSET = $LAYOUT.byteOffset(groupElement("scanLineOrdering"));
