...
public class _CRL_DIST_POINT_NAME {
    ...
    private static final long dwDistPointNameChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwDistPointNameChoice"));
    ...
    private static final GroupLayout FullName$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$4520:5"), groupElement("FullName"));
    ...
    private static final long FullName$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4520:5"), groupElement("FullName"));
