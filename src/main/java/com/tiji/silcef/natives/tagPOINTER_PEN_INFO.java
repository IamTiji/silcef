...
public class tagPOINTER_PEN_INFO {
    ...
    private static final long penFlags$OFFSET = $LAYOUT.byteOffset(groupElement("penFlags"));
    ...
    private static final long penMask$OFFSET = $LAYOUT.byteOffset(groupElement("penMask"));
    ...
    private static final long tiltX$OFFSET = $LAYOUT.byteOffset(groupElement("tiltX"));
    ...
    private static final long tiltY$OFFSET = $LAYOUT.byteOffset(groupElement("tiltY"));
