...
public class _OCSP_REQUEST_INFO {
    ...
    private static final long pRequestorName$OFFSET = $LAYOUT.byteOffset(groupElement("pRequestorName"));
    ...
    private static final long cRequestEntry$OFFSET = $LAYOUT.byteOffset(groupElement("cRequestEntry"));
    ...
    private static final long rgRequestEntry$OFFSET = $LAYOUT.byteOffset(groupElement("rgRequestEntry"));
