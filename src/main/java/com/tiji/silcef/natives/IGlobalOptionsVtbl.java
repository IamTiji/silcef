...
public class IGlobalOptionsVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("Query")
    ...
    public final static class Query {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(Query.Function.class, "apply", $DESC);
