...
public class _ASSEMBLY_FILE_DETAILED_INFORMATION {
    ...
    private static final long ulFilenameLength$OFFSET = $LAYOUT.byteOffset(groupElement("ulFilenameLength"));
    ...
    private static final long ulPathLength$OFFSET = $LAYOUT.byteOffset(groupElement("ulPathLength"));
    ...
    private static final long lpFileName$OFFSET = $LAYOUT.byteOffset(groupElement("lpFileName"));
    ...
    private static final long lpFilePath$OFFSET = $LAYOUT.byteOffset(groupElement("lpFilePath"));
