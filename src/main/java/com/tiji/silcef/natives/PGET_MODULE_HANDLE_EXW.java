 ...
 * }
 */
public final class PGET_MODULE_HANDLE_EXW {

    private PGET_MODULE_HANDLE_EXW() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PGET_MODULE_HANDLE_EXW.Function.class, "apply", $DESC);
