...
public class _ICONINFOEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("szModName"),
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("szResName"),
    ...
    private static final long fIcon$OFFSET = $LAYOUT.byteOffset(groupElement("fIcon"));
    ...
    private static final long xHotspot$OFFSET = $LAYOUT.byteOffset(groupElement("xHotspot"));
    ...
    private static final long yHotspot$OFFSET = $LAYOUT.byteOffset(groupElement("yHotspot"));
    ...
    private static final long hbmMask$OFFSET = $LAYOUT.byteOffset(groupElement("hbmMask"));
    ...
    private static final long hbmColor$OFFSET = $LAYOUT.byteOffset(groupElement("hbmColor"));
    ...
    private static final long wResID$OFFSET = $LAYOUT.byteOffset(groupElement("wResID"));
    ...
    private static final long szModName$OFFSET = $LAYOUT.byteOffset(groupElement("szModName"));
    ...
    public static byte szModName(MemorySegment struct, long index0) {
        return (byte)szModName$ELEM_HANDLE.get(struct, szModName$OFFSET, index0);
    }
    ...
    public static void szModName(MemorySegment struct, long index0, byte fieldValue) {
        szModName$ELEM_HANDLE.set(struct, szModName$OFFSET, index0, fieldValue);
    }
    ...
    private static final long szResName$OFFSET = $LAYOUT.byteOffset(groupElement("szResName"));
    ...
    public static byte szResName(MemorySegment struct, long index0) {
        return (byte)szResName$ELEM_HANDLE.get(struct, szResName$OFFSET, index0);
    }
    ...
    public static void szResName(MemorySegment struct, long index0, byte fieldValue) {
        szResName$ELEM_HANDLE.set(struct, szResName$OFFSET, index0, fieldValue);
    }
