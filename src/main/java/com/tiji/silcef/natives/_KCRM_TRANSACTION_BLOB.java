...
public class _KCRM_TRANSACTION_BLOB {
    ...
    private static final long UOW$OFFSET = $LAYOUT.byteOffset(groupElement("UOW"));
    ...
    private static final long TmIdentity$OFFSET = $LAYOUT.byteOffset(groupElement("TmIdentity"));
    ...
    private static final long IsolationLevel$OFFSET = $LAYOUT.byteOffset(groupElement("IsolationLevel"));
    ...
    private static final long IsolationFlags$OFFSET = $LAYOUT.byteOffset(groupElement("IsolationFlags"));
    ...
    public static short Description(MemorySegment struct, long index0) {
        return (short)Description$ELEM_HANDLE.get(struct, Description$OFFSET, index0);
    }
