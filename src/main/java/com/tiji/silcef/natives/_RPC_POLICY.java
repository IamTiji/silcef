...
public class _RPC_POLICY {
    ...
    private static final long EndpointFlags$OFFSET = $LAYOUT.byteOffset(groupElement("EndpointFlags"));
    ...
    private static final long NICFlags$OFFSET = $LAYOUT.byteOffset(groupElement("NICFlags"));
