...
public class FLASHWINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("uCount"),
        cef_render_handler_capi_h.C_LONG.withName("dwTimeout"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$4689:9");
    ...
    private static final long uCount$OFFSET = $LAYOUT.byteOffset(groupElement("uCount"));
    ...
    private static final long dwTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("dwTimeout"));
