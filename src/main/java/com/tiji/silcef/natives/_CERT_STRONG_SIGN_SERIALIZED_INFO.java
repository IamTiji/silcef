...
public class _CERT_STRONG_SIGN_SERIALIZED_INFO {
    ...
    private static final long pwszCNGSignHashAlgids$OFFSET = $LAYOUT.byteOffset(groupElement("pwszCNGSignHashAlgids"));
    ...
    private static final long pwszCNGPubKeyMinBitLengths$OFFSET = $LAYOUT.byteOffset(groupElement("pwszCNGPubKeyMinBitLengths"));
