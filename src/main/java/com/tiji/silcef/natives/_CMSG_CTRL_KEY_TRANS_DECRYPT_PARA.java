...
public class _CMSG_CTRL_KEY_TRANS_DECRYPT_PARA {
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8238:5"), groupElement("hCryptProv"));
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8238:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8238:5"), groupElement("hNCryptKey"));
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8238:5"), groupElement("hNCryptKey"));
    ...
    private static final long pKeyTrans$OFFSET = $LAYOUT.byteOffset(groupElement("pKeyTrans"));
