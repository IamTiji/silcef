...
public class _STORAGE_ACCESS_ALIGNMENT_DESCRIPTOR {
    ...
    private static final long BytesPerCacheLine$OFFSET = $LAYOUT.byteOffset(groupElement("BytesPerCacheLine"));
    ...
    private static final long BytesOffsetForCacheAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("BytesOffsetForCacheAlignment"));
    ...
    private static final long BytesPerLogicalSector$OFFSET = $LAYOUT.byteOffset(groupElement("BytesPerLogicalSector"));
    ...
    private static final long BytesOffsetForSectorAlignment$OFFSET = $LAYOUT.byteOffset(groupElement("BytesOffsetForSectorAlignment"));
