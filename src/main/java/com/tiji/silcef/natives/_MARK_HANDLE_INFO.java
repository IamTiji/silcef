...
public class _MARK_HANDLE_INFO {
    ...
    private static final OfInt UsnSourceInfo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12234:5"), groupElement("UsnSourceInfo"));
    ...
    private static final long UsnSourceInfo$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12234:5"), groupElement("UsnSourceInfo"));
    ...
    private static final OfInt CopyNumber$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12234:5"), groupElement("CopyNumber"));
    ...
    private static final long CopyNumber$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$12234:5"), groupElement("CopyNumber"));
