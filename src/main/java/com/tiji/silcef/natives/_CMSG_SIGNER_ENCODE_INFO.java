...
public class _CMSG_SIGNER_ENCODE_INFO {
    ...
    private static final long pCertInfo$OFFSET = $LAYOUT.byteOffset(groupElement("pCertInfo"));
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6926:5"), groupElement("hCryptProv"));
    ...
    private static final long hCryptProv$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6926:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6926:5"), groupElement("hNCryptKey"));
    ...
    private static final long hNCryptKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6926:5"), groupElement("hNCryptKey"));
