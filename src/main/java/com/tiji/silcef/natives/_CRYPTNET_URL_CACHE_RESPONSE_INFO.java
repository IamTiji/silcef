...
public class _CRYPTNET_URL_CACHE_RESPONSE_INFO {
    ...
    private static final long wResponseType$OFFSET = $LAYOUT.byteOffset(groupElement("wResponseType"));
    ...
    private static final long wResponseFlags$OFFSET = $LAYOUT.byteOffset(groupElement("wResponseFlags"));
    ...
    private static final long LastModifiedTime$OFFSET = $LAYOUT.byteOffset(groupElement("LastModifiedTime"));
    ...
    private static final long dwMaxAge$OFFSET = $LAYOUT.byteOffset(groupElement("dwMaxAge"));
    ...
    private static final long pwszETag$OFFSET = $LAYOUT.byteOffset(groupElement("pwszETag"));
    ...
    private static final long dwProxyId$OFFSET = $LAYOUT.byteOffset(groupElement("dwProxyId"));
