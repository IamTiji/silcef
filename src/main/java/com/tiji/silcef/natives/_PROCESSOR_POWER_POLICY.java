...
public class _PROCESSOR_POWER_POLICY {
    ...
    private static final long PolicyCount$OFFSET = $LAYOUT.byteOffset(groupElement("PolicyCount"));
    ...
    public static MemorySegment Policy(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Policy$ELEM_HANDLE.invokeExact(struct, Policy$OFFSET, index0);
