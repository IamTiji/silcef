...
public class _CERT_AUTHORITY_KEY_ID_INFO {
    ...
    private static final long CertIssuer$OFFSET = $LAYOUT.byteOffset(groupElement("CertIssuer"));
    ...
    private static final long CertSerialNumber$OFFSET = $LAYOUT.byteOffset(groupElement("CertSerialNumber"));
