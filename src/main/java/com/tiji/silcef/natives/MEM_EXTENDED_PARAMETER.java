...
public class MEM_EXTENDED_PARAMETER {
    ...
    private static final OfLong ULong64$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$15053:5"), groupElement("ULong64"));
    ...
    private static final long ULong64$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15053:5"), groupElement("ULong64"));
    ...
    private static final AddressLayout Pointer$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$15053:5"), groupElement("Pointer"));
    ...
    private static final long Pointer$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15053:5"), groupElement("Pointer"));
    ...
    private static final OfLong Size$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$15053:5"), groupElement("Size"));
    ...
    private static final long Size$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15053:5"), groupElement("Size"));
    ...
    private static final AddressLayout Handle$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$15053:5"), groupElement("Handle"));
    ...
    private static final long Handle$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15053:5"), groupElement("Handle"));
    ...
    private static final OfInt ULong$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$15053:5"), groupElement("ULong"));
    ...
    private static final long ULong$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$15053:5"), groupElement("ULong"));
