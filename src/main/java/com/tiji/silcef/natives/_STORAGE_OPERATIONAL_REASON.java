...
public class _STORAGE_OPERATIONAL_REASON {
    ...
    public static class RawBytes {
        ...
        public static class ScsiSenseKey {
            ...
            private static final long SenseKey$OFFSET = $LAYOUT.byteOffset(groupElement("SenseKey"));
            ...
            private static final long ASC$OFFSET = $LAYOUT.byteOffset(groupElement("ASC"));
            ...
            private static final long ASCQ$OFFSET = $LAYOUT.byteOffset(groupElement("ASCQ"));
        ...
        private static final long ScsiSenseKey$OFFSET = $LAYOUT.byteOffset(groupElement("ScsiSenseKey"));
        ...
        public static class NVDIMM_N {
            ...
            private static final long CriticalHealth$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalHealth"));
            ...
            private static final long ModuleHealth$OFFSET = $LAYOUT.byteOffset(groupElement("ModuleHealth"));
            ...
            public static byte ModuleHealth(MemorySegment struct, long index0) {
                return (byte)ModuleHealth$ELEM_HANDLE.get(struct, ModuleHealth$OFFSET, index0);
            }
            ...
            public static void ModuleHealth(MemorySegment struct, long index0, byte fieldValue) {
                ModuleHealth$ELEM_HANDLE.set(struct, ModuleHealth$OFFSET, index0, fieldValue);
            }
            ...
            private static final long ErrorThresholdStatus$OFFSET = $LAYOUT.byteOffset(groupElement("ErrorThresholdStatus"));
        ...
        private static final long NVDIMM_N$OFFSET = $LAYOUT.byteOffset(groupElement("NVDIMM_N"));
    ...
    private static final long RawBytes$OFFSET = $LAYOUT.byteOffset(groupElement("RawBytes"));
