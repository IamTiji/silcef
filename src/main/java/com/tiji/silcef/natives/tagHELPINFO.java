...
public class tagHELPINFO {
    ...
    private static final long iContextType$OFFSET = $LAYOUT.byteOffset(groupElement("iContextType"));
    ...
    private static final long iCtrlId$OFFSET = $LAYOUT.byteOffset(groupElement("iCtrlId"));
    ...
    private static final long hItemHandle$OFFSET = $LAYOUT.byteOffset(groupElement("hItemHandle"));
    ...
    private static final long dwContextId$OFFSET = $LAYOUT.byteOffset(groupElement("dwContextId"));
