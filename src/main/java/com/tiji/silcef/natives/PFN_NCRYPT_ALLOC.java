 ...
 * }
 */
public final class PFN_NCRYPT_ALLOC {

    private PFN_NCRYPT_ALLOC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_NCRYPT_ALLOC.Function.class, "apply", $DESC);
