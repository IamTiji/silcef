...
public class val_context {
    ...
    private static final long valuelen$OFFSET = $LAYOUT.byteOffset(groupElement("valuelen"));
    ...
    private static final long value_context$OFFSET = $LAYOUT.byteOffset(groupElement("value_context"));
    ...
    private static final long val_buff_ptr$OFFSET = $LAYOUT.byteOffset(groupElement("val_buff_ptr"));
