...
public class tagPDEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("Flags2"),
        cef_master_h.C_LONG.withName("ExclusionFlags"),
        cef_master_h.C_LONG.withName("nPageRanges"),
        cef_master_h.C_LONG.withName("nMaxPageRanges"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("lpPageRanges"),
        cef_master_h.C_LONG.withName("nMinPage"),
        cef_master_h.C_LONG.withName("nMaxPage"),
        cef_master_h.C_LONG.withName("nCopies"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("hInstance"),
        cef_master_h.C_POINTER.withName("lpPrintTemplateName"),
        cef_master_h.C_POINTER.withName("lpCallback"),
        cef_master_h.C_LONG.withName("nPropertyPages"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("lphPropertyPages"),
        cef_master_h.C_LONG.withName("nStartPage"),
        cef_master_h.C_LONG.withName("dwResultAction")
    ).withName("tagPDEXA");
