...
public class _CERT_FORTEZZA_DATA_PROP {
    ...
    private static final long CertIndex$OFFSET = $LAYOUT.byteOffset(groupElement("CertIndex"));
    ...
    private static final long CertLabel$OFFSET = $LAYOUT.byteOffset(groupElement("CertLabel"));
    ...
    public static byte CertLabel(MemorySegment struct, long index0) {
        return (byte)CertLabel$ELEM_HANDLE.get(struct, CertLabel$OFFSET, index0);
    }
    ...
    public static void CertLabel(MemorySegment struct, long index0, byte fieldValue) {
        CertLabel$ELEM_HANDLE.set(struct, CertLabel$OFFSET, index0, fieldValue);
    }
