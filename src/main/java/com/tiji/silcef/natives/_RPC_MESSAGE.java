...
public class _RPC_MESSAGE {
    ...
    private static final long DataRepresentation$OFFSET = $LAYOUT.byteOffset(groupElement("DataRepresentation"));
    ...
    private static final long ProcNum$OFFSET = $LAYOUT.byteOffset(groupElement("ProcNum"));
    ...
    private static final long TransferSyntax$OFFSET = $LAYOUT.byteOffset(groupElement("TransferSyntax"));
    ...
    private static final long ReservedForRuntime$OFFSET = $LAYOUT.byteOffset(groupElement("ReservedForRuntime"));
    ...
    private static final long ManagerEpv$OFFSET = $LAYOUT.byteOffset(groupElement("ManagerEpv"));
    ...
    private static final long ImportContext$OFFSET = $LAYOUT.byteOffset(groupElement("ImportContext"));
    ...
    private static final long RpcFlags$OFFSET = $LAYOUT.byteOffset(groupElement("RpcFlags"));
