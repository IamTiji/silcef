...
public class _PRIVILEGE_SET {
    ...
    private static final long Privilege$OFFSET = $LAYOUT.byteOffset(groupElement("Privilege"));
    ...
    public static MemorySegment Privilege(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Privilege$ELEM_HANDLE.invokeExact(struct, Privilege$OFFSET, index0);
