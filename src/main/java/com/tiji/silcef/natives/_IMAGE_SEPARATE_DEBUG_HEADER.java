...
public class _IMAGE_SEPARATE_DEBUG_HEADER {
    ...
    private static final long ExportedNamesSize$OFFSET = $LAYOUT.byteOffset(groupElement("ExportedNamesSize"));
    ...
    private static final long DebugDirectorySize$OFFSET = $LAYOUT.byteOffset(groupElement("DebugDirectorySize"));
