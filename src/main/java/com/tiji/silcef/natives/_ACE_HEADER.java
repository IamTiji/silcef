...
public class _ACE_HEADER {
    ...
    private static final long AceType$OFFSET = $LAYOUT.byteOffset(groupElement("AceType"));
    ...
    private static final long AceFlags$OFFSET = $LAYOUT.byteOffset(groupElement("AceFlags"));
    ...
    private static final long AceSize$OFFSET = $LAYOUT.byteOffset(groupElement("AceSize"));
