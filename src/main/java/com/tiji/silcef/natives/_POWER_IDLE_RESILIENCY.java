...
public class _POWER_IDLE_RESILIENCY {
    ...
    private static final long CoalescingTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("CoalescingTimeout"));
    ...
    private static final long IdleResiliencyPeriod$OFFSET = $LAYOUT.byteOffset(groupElement("IdleResiliencyPeriod"));
