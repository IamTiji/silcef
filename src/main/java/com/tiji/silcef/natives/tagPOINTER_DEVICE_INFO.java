...
public class tagPOINTER_DEVICE_INFO {
    ...
    private static final long displayOrientation$OFFSET = $LAYOUT.byteOffset(groupElement("displayOrientation"));
    ...
    private static final long pointerDeviceType$OFFSET = $LAYOUT.byteOffset(groupElement("pointerDeviceType"));
    ...
    private static final long monitor$OFFSET = $LAYOUT.byteOffset(groupElement("monitor"));
    ...
    private static final long startingCursorId$OFFSET = $LAYOUT.byteOffset(groupElement("startingCursorId"));
    ...
    private static final long maxActiveContacts$OFFSET = $LAYOUT.byteOffset(groupElement("maxActiveContacts"));
    ...
    private static final long productString$OFFSET = $LAYOUT.byteOffset(groupElement("productString"));
    ...
    public static short productString(MemorySegment struct, long index0) {
        return (short)productString$ELEM_HANDLE.get(struct, productString$OFFSET, index0);
    }
    ...
    public static void productString(MemorySegment struct, long index0, short fieldValue) {
        productString$ELEM_HANDLE.set(struct, productString$OFFSET, index0, fieldValue);
    }
