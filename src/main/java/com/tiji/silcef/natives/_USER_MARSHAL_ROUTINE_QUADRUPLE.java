...
public class _USER_MARSHAL_ROUTINE_QUADRUPLE {
    ...
    private static final long pfnBufferSize$OFFSET = $LAYOUT.byteOffset(groupElement("pfnBufferSize"));
    ...
    private static final long pfnMarshall$OFFSET = $LAYOUT.byteOffset(groupElement("pfnMarshall"));
    ...
    private static final long pfnUnmarshall$OFFSET = $LAYOUT.byteOffset(groupElement("pfnUnmarshall"));
