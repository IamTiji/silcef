...
public class USN_TRACK_MODIFIED_RANGES {
    ...
    private static final long ChunkSize$OFFSET = $LAYOUT.byteOffset(groupElement("ChunkSize"));
    ...
    private static final long FileSizeThreshold$OFFSET = $LAYOUT.byteOffset(groupElement("FileSizeThreshold"));
