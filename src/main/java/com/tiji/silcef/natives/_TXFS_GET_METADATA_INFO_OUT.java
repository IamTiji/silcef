...
public class _TXFS_GET_METADATA_INFO_OUT {
    ...
    private static final long TxfFileId$OFFSET = $LAYOUT.byteOffset(groupElement("TxfFileId"));
    ...
    private static final long LockingTransaction$OFFSET = $LAYOUT.byteOffset(groupElement("LockingTransaction"));
    ...
    private static final long LastLsn$OFFSET = $LAYOUT.byteOffset(groupElement("LastLsn"));
    ...
    private static final long TransactionState$OFFSET = $LAYOUT.byteOffset(groupElement("TransactionState"));
