...
public class _BIDI_REQUEST_CONTAINER {
    ...
    private static final long aData$OFFSET = $LAYOUT.byteOffset(groupElement("aData"));
    ...
    public static MemorySegment aData(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)aData$ELEM_HANDLE.invokeExact(struct, aData$OFFSET, index0);
