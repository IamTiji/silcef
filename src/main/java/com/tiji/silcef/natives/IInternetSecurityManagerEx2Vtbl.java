...
public class IInternetSecurityManagerEx2Vtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("SetSecuritySite"),
        cef_render_handler_capi_h.C_POINTER.withName("GetSecuritySite"),
        cef_render_handler_capi_h.C_POINTER.withName("MapUrlToZone"),
        cef_render_handler_capi_h.C_POINTER.withName("GetSecurityId"),
        cef_render_handler_capi_h.C_POINTER.withName("ProcessUrlAction"),
        cef_render_handler_capi_h.C_POINTER.withName("QueryCustomPolicy"),
        cef_render_handler_capi_h.C_POINTER.withName("SetZoneMapping"),
        cef_render_handler_capi_h.C_POINTER.withName("GetZoneMappings"),
        cef_render_handler_capi_h.C_POINTER.withName("ProcessUrlActionEx"),
        cef_render_handler_capi_h.C_POINTER.withName("MapUrlToZoneEx2"),
        cef_render_handler_capi_h.C_POINTER.withName("ProcessUrlActionEx2"),
        cef_render_handler_capi_h.C_POINTER.withName("GetSecurityIdEx2"),
        cef_render_handler_capi_h.C_POINTER.withName("QueryCustomPolicyEx2")
     ...
     * }
     */
    public final static class SetSecuritySite {

        private SetSecuritySite() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SetSecuritySite.Function.class, "apply", $DESC);
    ...
    private static final long SetSecuritySite$OFFSET = $LAYOUT.byteOffset(groupElement("SetSecuritySite"));
     ...
     * }
     */
    public final static class GetSecuritySite {

        private GetSecuritySite() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetSecuritySite.Function.class, "apply", $DESC);
    ...
    private static final long GetSecuritySite$OFFSET = $LAYOUT.byteOffset(groupElement("GetSecuritySite"));
     ...
     * }
     */
    public final static class MapUrlToZone {

        private MapUrlToZone() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(MapUrlToZone.Function.class, "apply", $DESC);
    ...
    private static final long MapUrlToZone$OFFSET = $LAYOUT.byteOffset(groupElement("MapUrlToZone"));
     ...
     * }
     */
    public final static class GetSecurityId {

        private GetSecurityId() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetSecurityId.Function.class, "apply", $DESC);
    ...
    private static final long GetSecurityId$OFFSET = $LAYOUT.byteOffset(groupElement("GetSecurityId"));
     ...
     * }
     */
    public final static class ProcessUrlAction {

        private ProcessUrlAction() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ProcessUrlAction.Function.class, "apply", $DESC);
    ...
    private static final long ProcessUrlAction$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessUrlAction"));
     ...
     * }
     */
    public final static class QueryCustomPolicy {

        private QueryCustomPolicy() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(QueryCustomPolicy.Function.class, "apply", $DESC);
    ...
    private static final long QueryCustomPolicy$OFFSET = $LAYOUT.byteOffset(groupElement("QueryCustomPolicy"));
     ...
     * }
     */
    public final static class SetZoneMapping {

        private SetZoneMapping() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(SetZoneMapping.Function.class, "apply", $DESC);
    ...
    private static final long SetZoneMapping$OFFSET = $LAYOUT.byteOffset(groupElement("SetZoneMapping"));
     ...
     * }
     */
    public final static class GetZoneMappings {

        private GetZoneMappings() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetZoneMappings.Function.class, "apply", $DESC);
    ...
    private static final long GetZoneMappings$OFFSET = $LAYOUT.byteOffset(groupElement("GetZoneMappings"));
     ...
     * }
     */
    public final static class ProcessUrlActionEx {

        private ProcessUrlActionEx() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ProcessUrlActionEx.Function.class, "apply", $DESC);
    ...
    private static final long ProcessUrlActionEx$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessUrlActionEx"));
     ...
     * }
     */
    public final static class MapUrlToZoneEx2 {

        private MapUrlToZoneEx2() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(MapUrlToZoneEx2.Function.class, "apply", $DESC);
    ...
    private static final long MapUrlToZoneEx2$OFFSET = $LAYOUT.byteOffset(groupElement("MapUrlToZoneEx2"));
     ...
     * }
     */
    public final static class ProcessUrlActionEx2 {

        private ProcessUrlActionEx2() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(ProcessUrlActionEx2.Function.class, "apply", $DESC);
    ...
    private static final long ProcessUrlActionEx2$OFFSET = $LAYOUT.byteOffset(groupElement("ProcessUrlActionEx2"));
     ...
     * }
     */
    public final static class GetSecurityIdEx2 {

        private GetSecurityIdEx2() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetSecurityIdEx2.Function.class, "apply", $DESC);
    ...
    private static final long GetSecurityIdEx2$OFFSET = $LAYOUT.byteOffset(groupElement("GetSecurityIdEx2"));
     ...
     * }
     */
    public final static class QueryCustomPolicyEx2 {

        private QueryCustomPolicyEx2() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(QueryCustomPolicyEx2.Function.class, "apply", $DESC);
    ...
    private static final long QueryCustomPolicyEx2$OFFSET = $LAYOUT.byteOffset(groupElement("QueryCustomPolicyEx2"));
