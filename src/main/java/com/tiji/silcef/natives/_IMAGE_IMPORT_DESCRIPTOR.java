...
public class _IMAGE_IMPORT_DESCRIPTOR {
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21084:5"), groupElement("Characteristics"));
    ...
    private static final long Characteristics$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21084:5"), groupElement("Characteristics"));
    ...
    private static final OfInt OriginalFirstThunk$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21084:5"), groupElement("OriginalFirstThunk"));
    ...
    private static final long OriginalFirstThunk$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21084:5"), groupElement("OriginalFirstThunk"));
    ...
    private static final long ForwarderChain$OFFSET = $LAYOUT.byteOffset(groupElement("ForwarderChain"));
    ...
    private static final long FirstThunk$OFFSET = $LAYOUT.byteOffset(groupElement("FirstThunk"));
