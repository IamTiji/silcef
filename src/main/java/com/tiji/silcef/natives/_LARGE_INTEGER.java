...
public class _LARGE_INTEGER {
    ...
    private static final OfInt LowPart$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$929:5"), groupElement("LowPart"));
    ...
    private static final long LowPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$929:5"), groupElement("LowPart"));
    ...
    private static final OfInt HighPart$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$929:5"), groupElement("HighPart"));
    ...
    private static final long HighPart$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$929:5"), groupElement("HighPart"));
