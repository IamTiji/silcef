...
public class tagEMREXTCREATEFONTINDIRECTW {
    ...
    private static final long ihFont$OFFSET = $LAYOUT.byteOffset(groupElement("ihFont"));
    ...
    private static final long elfw$OFFSET = $LAYOUT.byteOffset(groupElement("elfw"));
