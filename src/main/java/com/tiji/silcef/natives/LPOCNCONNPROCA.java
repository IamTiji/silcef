 ...
 * }
 */
public final class LPOCNCONNPROCA {

    private LPOCNCONNPROCA() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(LPOCNCONNPROCA.Function.class, "apply", $DESC);
