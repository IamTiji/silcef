...
public class _CRL_REVOCATION_INFO {
    ...
    private static final long pCrlContext$OFFSET = $LAYOUT.byteOffset(groupElement("pCrlContext"));
    ...
    private static final long pCrlIssuerChain$OFFSET = $LAYOUT.byteOffset(groupElement("pCrlIssuerChain"));
