...
public class _CERT_QC_STATEMENTS_EXT_INFO {
    ...
    private static final long cStatement$OFFSET = $LAYOUT.byteOffset(groupElement("cStatement"));
    ...
    private static final long rgStatement$OFFSET = $LAYOUT.byteOffset(groupElement("rgStatement"));
