...
public class _CERT_LOGOTYPE_EXT_INFO {
    ...
    private static final long cCommunityLogo$OFFSET = $LAYOUT.byteOffset(groupElement("cCommunityLogo"));
    ...
    private static final long rgCommunityLogo$OFFSET = $LAYOUT.byteOffset(groupElement("rgCommunityLogo"));
    ...
    private static final long pIssuerLogo$OFFSET = $LAYOUT.byteOffset(groupElement("pIssuerLogo"));
    ...
    private static final long pSubjectLogo$OFFSET = $LAYOUT.byteOffset(groupElement("pSubjectLogo"));
    ...
    private static final long cOtherLogo$OFFSET = $LAYOUT.byteOffset(groupElement("cOtherLogo"));
    ...
    private static final long rgOtherLogo$OFFSET = $LAYOUT.byteOffset(groupElement("rgOtherLogo"));
