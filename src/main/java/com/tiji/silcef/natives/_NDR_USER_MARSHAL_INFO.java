...
public class _NDR_USER_MARSHAL_INFO {
    ...
    private static final long InformationLevel$OFFSET = $LAYOUT.byteOffset(groupElement("InformationLevel"));
    ...
    private static final GroupLayout Level1$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3144:5"), groupElement("Level1"));
    ...
    private static final long Level1$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$3144:5"), groupElement("Level1"));
