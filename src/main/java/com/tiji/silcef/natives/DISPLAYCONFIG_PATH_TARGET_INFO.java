...
public class DISPLAYCONFIG_PATH_TARGET_INFO {
    ...
    private static final long modeInfoIdx$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$2977:5"), groupElement("modeInfoIdx"));
    ...
    private static final long scaling$OFFSET = $LAYOUT.byteOffset(groupElement("scaling"));
    ...
    private static final long targetAvailable$OFFSET = $LAYOUT.byteOffset(groupElement("targetAvailable"));
