...
public class tagRemSNB {
    ...
    private static final long ulCntStr$OFFSET = $LAYOUT.byteOffset(groupElement("ulCntStr"));
    ...
    private static final long ulCntChar$OFFSET = $LAYOUT.byteOffset(groupElement("ulCntChar"));
    ...
    private static final long rgString$OFFSET = $LAYOUT.byteOffset(groupElement("rgString"));
    ...
    public static short rgString(MemorySegment struct, long index0) {
        return (short)rgString$ELEM_HANDLE.get(struct, rgString$OFFSET, index0);
    }
    ...
    public static void rgString(MemorySegment struct, long index0, short fieldValue) {
        rgString$ELEM_HANDLE.set(struct, rgString$OFFSET, index0, fieldValue);
    }
