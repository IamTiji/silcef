...
public class NTFS_EXTENDED_VOLUME_DATA {
    ...
    private static final long LfsMajorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("LfsMajorVersion"));
    ...
    private static final long LfsMinorVersion$OFFSET = $LAYOUT.byteOffset(groupElement("LfsMinorVersion"));
    ...
    private static final long MaxDeviceTrimExtentCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxDeviceTrimExtentCount"));
    ...
    private static final long MaxDeviceTrimByteCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxDeviceTrimByteCount"));
    ...
    private static final long MaxVolumeTrimExtentCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxVolumeTrimExtentCount"));
    ...
    private static final long MaxVolumeTrimByteCount$OFFSET = $LAYOUT.byteOffset(groupElement("MaxVolumeTrimByteCount"));
