...
public class tagDEVNAMES {
    ...
    private static final long wDriverOffset$OFFSET = $LAYOUT.byteOffset(groupElement("wDriverOffset"));
    ...
    private static final long wDeviceOffset$OFFSET = $LAYOUT.byteOffset(groupElement("wDeviceOffset"));
    ...
    private static final long wOutputOffset$OFFSET = $LAYOUT.byteOffset(groupElement("wOutputOffset"));
    ...
    private static final long wDefault$OFFSET = $LAYOUT.byteOffset(groupElement("wDefault"));
