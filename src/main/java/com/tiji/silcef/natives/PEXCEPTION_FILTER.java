 ...
 * }
 */
public final class PEXCEPTION_FILTER {

    private PEXCEPTION_FILTER() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PEXCEPTION_FILTER.Function.class, "apply", $DESC);
