...
public class tagRPCOLEMESSAGE {
    ...
    private static final long cbBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("cbBuffer"));
    ...
    private static final long iMethod$OFFSET = $LAYOUT.byteOffset(groupElement("iMethod"));
    ...
    public static MemorySegment reserved2(MemorySegment struct, long index0) {
        return (MemorySegment)reserved2$ELEM_HANDLE.get(struct, reserved2$OFFSET, index0);
    }
