...
public class _CHANGER_ELEMENT_STATUS_EX {
    ...
    private static final long SrcElementAddress$OFFSET = $LAYOUT.byteOffset(groupElement("SrcElementAddress"));
    ...
    private static final long ExceptionCode$OFFSET = $LAYOUT.byteOffset(groupElement("ExceptionCode"));
    ...
    private static final long TargetId$OFFSET = $LAYOUT.byteOffset(groupElement("TargetId"));
    ...
    private static final long Lun$OFFSET = $LAYOUT.byteOffset(groupElement("Lun"));
    ...
    private static final long PrimaryVolumeID$OFFSET = $LAYOUT.byteOffset(groupElement("PrimaryVolumeID"));
    ...
    public static byte PrimaryVolumeID(MemorySegment struct, long index0) {
        return (byte)PrimaryVolumeID$ELEM_HANDLE.get(struct, PrimaryVolumeID$OFFSET, index0);
    }
    ...
    public static void PrimaryVolumeID(MemorySegment struct, long index0, byte fieldValue) {
        PrimaryVolumeID$ELEM_HANDLE.set(struct, PrimaryVolumeID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long AlternateVolumeID$OFFSET = $LAYOUT.byteOffset(groupElement("AlternateVolumeID"));
    ...
    public static byte AlternateVolumeID(MemorySegment struct, long index0) {
        return (byte)AlternateVolumeID$ELEM_HANDLE.get(struct, AlternateVolumeID$OFFSET, index0);
    }
    ...
    public static void AlternateVolumeID(MemorySegment struct, long index0, byte fieldValue) {
        AlternateVolumeID$ELEM_HANDLE.set(struct, AlternateVolumeID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long VendorIdentification$OFFSET = $LAYOUT.byteOffset(groupElement("VendorIdentification"));
    ...
    public static byte VendorIdentification(MemorySegment struct, long index0) {
        return (byte)VendorIdentification$ELEM_HANDLE.get(struct, VendorIdentification$OFFSET, index0);
    }
    ...
    public static void VendorIdentification(MemorySegment struct, long index0, byte fieldValue) {
        VendorIdentification$ELEM_HANDLE.set(struct, VendorIdentification$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ProductIdentification$OFFSET = $LAYOUT.byteOffset(groupElement("ProductIdentification"));
    ...
    public static byte ProductIdentification(MemorySegment struct, long index0) {
        return (byte)ProductIdentification$ELEM_HANDLE.get(struct, ProductIdentification$OFFSET, index0);
    }
    ...
    public static void ProductIdentification(MemorySegment struct, long index0, byte fieldValue) {
        ProductIdentification$ELEM_HANDLE.set(struct, ProductIdentification$OFFSET, index0, fieldValue);
    }
