...
public class PROCESSOR_PERFSTATE_POLICY {
    ...
    private static final OfByte Spare$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$19469:5"), groupElement("Spare"));
    ...
    private static final long Spare$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19469:5"), groupElement("Spare"));
    ...
    private static final GroupLayout Flags$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$19469:5"), groupElement("Flags"));
    ...
    private static final long Flags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$19469:5"), groupElement("Flags"));
