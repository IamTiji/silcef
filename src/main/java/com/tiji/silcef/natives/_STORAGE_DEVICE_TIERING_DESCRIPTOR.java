...
public class _STORAGE_DEVICE_TIERING_DESCRIPTOR {
    ...
    private static final long TotalNumberOfTiers$OFFSET = $LAYOUT.byteOffset(groupElement("TotalNumberOfTiers"));
    ...
    private static final long NumberOfTiersReturned$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfTiersReturned"));
    ...
    private static final long Tiers$OFFSET = $LAYOUT.byteOffset(groupElement("Tiers"));
    ...
    public static MemorySegment Tiers(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Tiers$ELEM_HANDLE.invokeExact(struct, Tiers$OFFSET, index0);
