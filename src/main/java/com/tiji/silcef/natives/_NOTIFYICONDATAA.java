...
public class _NOTIFYICONDATAA {
    ...
    public static byte szTip(MemorySegment struct, long index0) {
        return (byte)szTip$ELEM_HANDLE.get(struct, szTip$OFFSET, index0);
    }
    ...
    public static byte szInfo(MemorySegment struct, long index0) {
        return (byte)szInfo$ELEM_HANDLE.get(struct, szInfo$OFFSET, index0);
    }
    ...
    private static final OfInt uTimeout$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1027:5"), groupElement("uTimeout"));
    ...
    private static final long uTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1027:5"), groupElement("uTimeout"));
    ...
    private static final OfInt uVersion$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1027:5"), groupElement("uVersion"));
    ...
    private static final long uVersion$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$1027:5"), groupElement("uVersion"));
    ...
    public static byte szInfoTitle(MemorySegment struct, long index0) {
        return (byte)szInfoTitle$ELEM_HANDLE.get(struct, szInfoTitle$OFFSET, index0);
    }
