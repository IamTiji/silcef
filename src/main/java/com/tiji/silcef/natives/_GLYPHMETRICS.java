...
public class _GLYPHMETRICS {
    ...
    private static final long gmBlackBoxX$OFFSET = $LAYOUT.byteOffset(groupElement("gmBlackBoxX"));
    ...
    private static final long gmBlackBoxY$OFFSET = $LAYOUT.byteOffset(groupElement("gmBlackBoxY"));
    ...
    private static final long gmptGlyphOrigin$OFFSET = $LAYOUT.byteOffset(groupElement("gmptGlyphOrigin"));
    ...
    private static final long gmCellIncX$OFFSET = $LAYOUT.byteOffset(groupElement("gmCellIncX"));
    ...
    private static final long gmCellIncY$OFFSET = $LAYOUT.byteOffset(groupElement("gmCellIncY"));
