...
public class _CPS_URLS {
    ...
    private static final long pszURL$OFFSET = $LAYOUT.byteOffset(groupElement("pszURL"));
    ...
    private static final long pAlgorithm$OFFSET = $LAYOUT.byteOffset(groupElement("pAlgorithm"));
    ...
    private static final long pDigest$OFFSET = $LAYOUT.byteOffset(groupElement("pDigest"));
