...
public class _DEVICE_DATA_SET_TOPOLOGY_ID_QUERY_OUTPUT {
    ...
    private static final long TopologyRangeBytes$OFFSET = $LAYOUT.byteOffset(groupElement("TopologyRangeBytes"));
    ...
    private static final long TopologyId$OFFSET = $LAYOUT.byteOffset(groupElement("TopologyId"));
    ...
    public static byte TopologyId(MemorySegment struct, long index0) {
        return (byte)TopologyId$ELEM_HANDLE.get(struct, TopologyId$OFFSET, index0);
    }
    ...
    public static void TopologyId(MemorySegment struct, long index0, byte fieldValue) {
        TopologyId$ELEM_HANDLE.set(struct, TopologyId$OFFSET, index0, fieldValue);
    }
