...
public class _PRINTER_INFO_5W {
    ...
    private static final long DeviceNotSelectedTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceNotSelectedTimeout"));
    ...
    private static final long TransmissionRetryTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("TransmissionRetryTimeout"));
