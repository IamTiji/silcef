...
/**
 * {@snippet lang=c :
 * struct ISupportDoNotElevateServerActivationVtbl {
 *     HRESULT (*QueryInterface)(ISupportDoNotElevateServerActivation *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISupportDoNotElevateServerActivation *) __attribute__((stdcall));
 *     ULONG (*Release)(ISupportDoNotElevateServerActivation *) __attribute__((stdcall));
 * }
 * }
 */
public class ISupportDoNotElevateServerActivationVtbl {
    ...
    ).withName("ISupportDoNotElevateServerActivationVtbl");
