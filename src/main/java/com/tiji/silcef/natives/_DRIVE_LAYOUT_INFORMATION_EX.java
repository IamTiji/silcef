...
public class _DRIVE_LAYOUT_INFORMATION_EX {
    ...
    private static final GroupLayout Mbr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9681:5"), groupElement("Mbr"));
    ...
    private static final long Mbr$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9681:5"), groupElement("Mbr"));
    ...
    private static final GroupLayout Gpt$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9681:5"), groupElement("Gpt"));
    ...
    private static final long Gpt$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9681:5"), groupElement("Gpt"));
    ...
    private static final long PartitionEntry$OFFSET = $LAYOUT.byteOffset(groupElement("PartitionEntry"));
    ...
    public static MemorySegment PartitionEntry(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)PartitionEntry$ELEM_HANDLE.invokeExact(struct, PartitionEntry$OFFSET, index0);
