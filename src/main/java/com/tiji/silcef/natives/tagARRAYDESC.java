...
public class tagARRAYDESC {
    ...
    private static final long tdescElem$OFFSET = $LAYOUT.byteOffset(groupElement("tdescElem"));
    ...
    private static final long rgbounds$OFFSET = $LAYOUT.byteOffset(groupElement("rgbounds"));
    ...
    public static MemorySegment rgbounds(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)rgbounds$ELEM_HANDLE.invokeExact(struct, rgbounds$OFFSET, index0);
