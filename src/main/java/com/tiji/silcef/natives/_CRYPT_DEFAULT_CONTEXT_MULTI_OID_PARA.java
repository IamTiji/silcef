...
public class _CRYPT_DEFAULT_CONTEXT_MULTI_OID_PARA {
    ...
    private static final long cOID$OFFSET = $LAYOUT.byteOffset(groupElement("cOID"));
    ...
    private static final long rgpszOID$OFFSET = $LAYOUT.byteOffset(groupElement("rgpszOID"));
