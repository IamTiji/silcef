...
public class hostent {
    ...
    private static final long h_name$OFFSET = $LAYOUT.byteOffset(groupElement("h_name"));
    ...
    private static final long h_aliases$OFFSET = $LAYOUT.byteOffset(groupElement("h_aliases"));
    ...
    private static final long h_addrtype$OFFSET = $LAYOUT.byteOffset(groupElement("h_addrtype"));
    ...
    private static final long h_length$OFFSET = $LAYOUT.byteOffset(groupElement("h_length"));
    ...
    private static final long h_addr_list$OFFSET = $LAYOUT.byteOffset(groupElement("h_addr_list"));
