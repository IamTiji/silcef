...
public class _SECURITY_CAPABILITIES {
    ...
    private static final long AppContainerSid$OFFSET = $LAYOUT.byteOffset(groupElement("AppContainerSid"));
    ...
    private static final long CapabilityCount$OFFSET = $LAYOUT.byteOffset(groupElement("CapabilityCount"));
