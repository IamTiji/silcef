...
public class tagCREATESTRUCTW {
    ...
    private static final long lpCreateParams$OFFSET = $LAYOUT.byteOffset(groupElement("lpCreateParams"));
    ...
    private static final long hMenu$OFFSET = $LAYOUT.byteOffset(groupElement("hMenu"));
    ...
    private static final long lpszName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszName"));
    ...
    private static final long lpszClass$OFFSET = $LAYOUT.byteOffset(groupElement("lpszClass"));
