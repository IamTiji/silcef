...
public class _BCRYPT_OID_LIST {
    ...
    private static final long dwOIDCount$OFFSET = $LAYOUT.byteOffset(groupElement("dwOIDCount"));
    ...
    private static final long pOIDs$OFFSET = $LAYOUT.byteOffset(groupElement("pOIDs"));
