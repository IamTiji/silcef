...
public class _PRIVKEYVER3 {
    ...
    private static final long bitlenP$OFFSET = $LAYOUT.byteOffset(groupElement("bitlenP"));
    ...
    private static final long bitlenQ$OFFSET = $LAYOUT.byteOffset(groupElement("bitlenQ"));
    ...
    private static final long bitlenJ$OFFSET = $LAYOUT.byteOffset(groupElement("bitlenJ"));
    ...
    private static final long bitlenX$OFFSET = $LAYOUT.byteOffset(groupElement("bitlenX"));
    ...
    private static final long DSSSeed$OFFSET = $LAYOUT.byteOffset(groupElement("DSSSeed"));
