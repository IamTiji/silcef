...
public class _CRYPT_PASSWORD_CREDENTIALSW {
    ...
    private static final long pszUsername$OFFSET = $LAYOUT.byteOffset(groupElement("pszUsername"));
    ...
    private static final long pszPassword$OFFSET = $LAYOUT.byteOffset(groupElement("pszPassword"));
