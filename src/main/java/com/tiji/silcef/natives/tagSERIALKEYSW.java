...
public class tagSERIALKEYSW {
    ...
    private static final long lpszActivePort$OFFSET = $LAYOUT.byteOffset(groupElement("lpszActivePort"));
    ...
    private static final long lpszPort$OFFSET = $LAYOUT.byteOffset(groupElement("lpszPort"));
    ...
    private static final long iBaudRate$OFFSET = $LAYOUT.byteOffset(groupElement("iBaudRate"));
    ...
    private static final long iPortState$OFFSET = $LAYOUT.byteOffset(groupElement("iPortState"));
    ...
    private static final long iActive$OFFSET = $LAYOUT.byteOffset(groupElement("iActive"));
