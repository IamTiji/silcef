...
/**
 * {@snippet lang=c :
 * struct ISupportPackagedComRegistrationVisibility {
 *     struct ISupportPackagedComRegistrationVisibilityVtbl *lpVtbl;
 * }
 * }
 */
public class ISupportPackagedComRegistrationVisibility {
    ...
    ).withName("ISupportPackagedComRegistrationVisibility");
