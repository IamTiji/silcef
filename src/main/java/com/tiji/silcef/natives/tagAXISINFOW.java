...
public class tagAXISINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("axMinValue"),
        cef_render_handler_capi_h.C_LONG.withName("axMaxValue"),
        MemoryLayout.sequenceLayout(16, cef_render_handler_capi_h.C_SHORT).withName("axAxisName")
    ...
    private static final long axMinValue$OFFSET = $LAYOUT.byteOffset(groupElement("axMinValue"));
    ...
    private static final long axMaxValue$OFFSET = $LAYOUT.byteOffset(groupElement("axMaxValue"));
    ...
    private static final long axAxisName$OFFSET = $LAYOUT.byteOffset(groupElement("axAxisName"));
    ...
    public static short axAxisName(MemorySegment struct, long index0) {
        return (short)axAxisName$ELEM_HANDLE.get(struct, axAxisName$OFFSET, index0);
    }
    ...
    public static void axAxisName(MemorySegment struct, long index0, short fieldValue) {
        axAxisName$ELEM_HANDLE.set(struct, axAxisName$OFFSET, index0, fieldValue);
    }
