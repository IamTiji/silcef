...
public class _TXFS_LIST_TRANSACTION_LOCKED_FILES {
    ...
    private static final long KtmTransaction$OFFSET = $LAYOUT.byteOffset(groupElement("KtmTransaction"));
    ...
    private static final long NumberOfFiles$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfFiles"));
    ...
    private static final long BufferSizeRequired$OFFSET = $LAYOUT.byteOffset(groupElement("BufferSizeRequired"));
