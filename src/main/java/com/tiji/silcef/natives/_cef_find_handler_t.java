 ...
 * }
 */
public class _cef_find_handler_t {
     ...
     * }
     */
    public final static class on_find_result {

        private on_find_result() {
            // Should not be called directly
        }
         ...
         */
        public static MemorySegment allocate(on_find_result.Function fi, Arena arena) {
    ...
    private static final AddressLayout on_find_result$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("on_find_result"));
     ...
     * }
     */
    public static final AddressLayout on_find_result$layout() {
        return on_find_result$LAYOUT;
    }

    private static final long on_find_result$OFFSET = $LAYOUT.byteOffset(groupElement("on_find_result"));
     ...
     * }
     */
    public static final long on_find_result$offset() {
        return on_find_result$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment on_find_result(MemorySegment struct) {
        return struct.get(on_find_result$LAYOUT, on_find_result$OFFSET);
    }
     ...
     * }
     */
    public static void on_find_result(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(on_find_result$LAYOUT, on_find_result$OFFSET, fieldValue);
    }
