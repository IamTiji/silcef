...
public class _KTMOBJECT_CURSOR {
    ...
    private static final long LastQuery$OFFSET = $LAYOUT.byteOffset(groupElement("LastQuery"));
    ...
    private static final long ObjectIdCount$OFFSET = $LAYOUT.byteOffset(groupElement("ObjectIdCount"));
    ...
    private static final long ObjectIds$OFFSET = $LAYOUT.byteOffset(groupElement("ObjectIds"));
    ...
    public static MemorySegment ObjectIds(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)ObjectIds$ELEM_HANDLE.invokeExact(struct, ObjectIds$OFFSET, index0);
