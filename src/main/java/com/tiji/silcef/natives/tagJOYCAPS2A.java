...
public class tagJOYCAPS2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, cef_render_handler_capi_h.C_CHAR).withName("szRegKey"),
        MemoryLayout.sequenceLayout(260, cef_render_handler_capi_h.C_CHAR).withName("szOEMVxD"),
