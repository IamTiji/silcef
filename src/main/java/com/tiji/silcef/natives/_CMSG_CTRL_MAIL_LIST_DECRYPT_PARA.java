...
public class _CMSG_CTRL_MAIL_LIST_DECRYPT_PARA {
    ...
    private static final long pMailList$OFFSET = $LAYOUT.byteOffset(groupElement("pMailList"));
    ...
    private static final OfLong hKeyEncryptionKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8329:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final long hKeyEncryptionKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8329:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final AddressLayout pvKeyEncryptionKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8329:5"), groupElement("pvKeyEncryptionKey"));
    ...
    private static final long pvKeyEncryptionKey$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$8329:5"), groupElement("pvKeyEncryptionKey"));
