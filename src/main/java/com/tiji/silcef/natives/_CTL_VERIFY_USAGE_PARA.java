...
public class _CTL_VERIFY_USAGE_PARA {
    ...
    private static final long cCtlStore$OFFSET = $LAYOUT.byteOffset(groupElement("cCtlStore"));
    ...
    private static final long rghCtlStore$OFFSET = $LAYOUT.byteOffset(groupElement("rghCtlStore"));
    ...
    private static final long cSignerStore$OFFSET = $LAYOUT.byteOffset(groupElement("cSignerStore"));
    ...
    private static final long rghSignerStore$OFFSET = $LAYOUT.byteOffset(groupElement("rghSignerStore"));
