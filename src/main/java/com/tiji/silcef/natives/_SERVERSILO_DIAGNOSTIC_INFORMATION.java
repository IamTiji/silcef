...
public class _SERVERSILO_DIAGNOSTIC_INFORMATION {
    ...
    private static final long ReportId$OFFSET = $LAYOUT.byteOffset(groupElement("ReportId"));
    ...
    private static final long CriticalProcessName$OFFSET = $LAYOUT.byteOffset(groupElement("CriticalProcessName"));
    ...
    public static short CriticalProcessName(MemorySegment struct, long index0) {
        return (short)CriticalProcessName$ELEM_HANDLE.get(struct, CriticalProcessName$OFFSET, index0);
    }
    ...
    public static void CriticalProcessName(MemorySegment struct, long index0, short fieldValue) {
        CriticalProcessName$ELEM_HANDLE.set(struct, CriticalProcessName$OFFSET, index0, fieldValue);
    }
