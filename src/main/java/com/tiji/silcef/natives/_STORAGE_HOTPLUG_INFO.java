...
public class _STORAGE_HOTPLUG_INFO {
    ...
    private static final long MediaRemovable$OFFSET = $LAYOUT.byteOffset(groupElement("MediaRemovable"));
    ...
    private static final long MediaHotplug$OFFSET = $LAYOUT.byteOffset(groupElement("MediaHotplug"));
    ...
    private static final long DeviceHotplug$OFFSET = $LAYOUT.byteOffset(groupElement("DeviceHotplug"));
    ...
    private static final long WriteCacheEnableOverride$OFFSET = $LAYOUT.byteOffset(groupElement("WriteCacheEnableOverride"));
