...
public class _SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
    ...
    private static final GroupLayout Processor$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14062:5"), groupElement("Processor"));
    ...
    private static final long Processor$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14062:5"), groupElement("Processor"));
    ...
    private static final GroupLayout NumaNode$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14062:5"), groupElement("NumaNode"));
    ...
    private static final long NumaNode$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14062:5"), groupElement("NumaNode"));
    ...
    private static final GroupLayout Cache$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14062:5"), groupElement("Cache"));
    ...
    private static final long Cache$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14062:5"), groupElement("Cache"));
    ...
    private static final GroupLayout Group$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$14062:5"), groupElement("Group"));
    ...
    private static final long Group$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$14062:5"), groupElement("Group"));
