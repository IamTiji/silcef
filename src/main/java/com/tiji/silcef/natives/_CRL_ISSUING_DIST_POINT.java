...
public class _CRL_ISSUING_DIST_POINT {
    ...
    private static final long DistPointName$OFFSET = $LAYOUT.byteOffset(groupElement("DistPointName"));
    ...
    private static final long fOnlyContainsUserCerts$OFFSET = $LAYOUT.byteOffset(groupElement("fOnlyContainsUserCerts"));
    ...
    private static final long fOnlyContainsCACerts$OFFSET = $LAYOUT.byteOffset(groupElement("fOnlyContainsCACerts"));
    ...
    private static final long OnlySomeReasonFlags$OFFSET = $LAYOUT.byteOffset(groupElement("OnlySomeReasonFlags"));
    ...
    private static final long fIndirectCRL$OFFSET = $LAYOUT.byteOffset(groupElement("fIndirectCRL"));
