...
public class _CERT_LOGOTYPE_IMAGE_INFO {
    ...
    private static final long dwLogotypeImageInfoChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwLogotypeImageInfoChoice"));
    ...
    private static final long dwFileSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwFileSize"));
    ...
    private static final long dwLogotypeImageResolutionChoice$OFFSET = $LAYOUT.byteOffset(groupElement("dwLogotypeImageResolutionChoice"));
    ...
    private static final OfInt dwNumBits$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5547:5"), groupElement("dwNumBits"));
    ...
    private static final long dwNumBits$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5547:5"), groupElement("dwNumBits"));
    ...
    private static final OfInt dwTableSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$5547:5"), groupElement("dwTableSize"));
    ...
    private static final long dwTableSize$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$5547:5"), groupElement("dwTableSize"));
    ...
    private static final long pwszLanguage$OFFSET = $LAYOUT.byteOffset(groupElement("pwszLanguage"));
