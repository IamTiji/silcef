...
public class _ARM64_NT_NEON128 {
    ...
    private static final OfLong Low$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6783:5"), groupElement("Low"));
    ...
    private static final long Low$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6783:5"), groupElement("Low"));
    ...
    private static final OfLong High$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6783:5"), groupElement("High"));
    ...
    private static final long High$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$6783:5"), groupElement("High"));
