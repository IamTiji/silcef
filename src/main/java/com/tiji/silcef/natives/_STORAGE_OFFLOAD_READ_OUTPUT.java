...
public class _STORAGE_OFFLOAD_READ_OUTPUT {
    ...
    private static final long OffloadReadFlags$OFFSET = $LAYOUT.byteOffset(groupElement("OffloadReadFlags"));
    ...
    private static final long LengthProtected$OFFSET = $LAYOUT.byteOffset(groupElement("LengthProtected"));
    ...
    private static final long TokenLength$OFFSET = $LAYOUT.byteOffset(groupElement("TokenLength"));
