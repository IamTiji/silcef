...
public class _ADMINISTRATOR_POWER_POLICY {
    ...
    private static final long MinVideoTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("MinVideoTimeout"));
    ...
    private static final long MaxVideoTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("MaxVideoTimeout"));
    ...
    private static final long MinSpindownTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("MinSpindownTimeout"));
    ...
    private static final long MaxSpindownTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("MaxSpindownTimeout"));
