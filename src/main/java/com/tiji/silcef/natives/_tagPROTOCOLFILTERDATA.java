...
public class _tagPROTOCOLFILTERDATA {
    ...
    private static final long pProtocolSink$OFFSET = $LAYOUT.byteOffset(groupElement("pProtocolSink"));
    ...
    private static final long pProtocol$OFFSET = $LAYOUT.byteOffset(groupElement("pProtocol"));
    ...
    private static final long dwFilterFlags$OFFSET = $LAYOUT.byteOffset(groupElement("dwFilterFlags"));
