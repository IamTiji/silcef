...
public class _IMAGE_COFF_SYMBOLS_HEADER {
    ...
    private static final long LvaToFirstSymbol$OFFSET = $LAYOUT.byteOffset(groupElement("LvaToFirstSymbol"));
    ...
    private static final long LvaToFirstLinenumber$OFFSET = $LAYOUT.byteOffset(groupElement("LvaToFirstLinenumber"));
    ...
    private static final long RvaToFirstByteOfCode$OFFSET = $LAYOUT.byteOffset(groupElement("RvaToFirstByteOfCode"));
    ...
    private static final long RvaToLastByteOfCode$OFFSET = $LAYOUT.byteOffset(groupElement("RvaToLastByteOfCode"));
    ...
    private static final long RvaToFirstByteOfData$OFFSET = $LAYOUT.byteOffset(groupElement("RvaToFirstByteOfData"));
    ...
    private static final long RvaToLastByteOfData$OFFSET = $LAYOUT.byteOffset(groupElement("RvaToLastByteOfData"));
