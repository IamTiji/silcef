...
public class _SCARD_IO_REQUEST {
    ...
    private static final long dwProtocol$OFFSET = $LAYOUT.byteOffset(groupElement("dwProtocol"));
    ...
    private static final long cbPciLength$OFFSET = $LAYOUT.byteOffset(groupElement("cbPciLength"));
