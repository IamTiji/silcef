...
public class PPM_IDLESTATE_EVENT {
    ...
    private static final long NewState$OFFSET = $LAYOUT.byteOffset(groupElement("NewState"));
    ...
    private static final long Processors$OFFSET = $LAYOUT.byteOffset(groupElement("Processors"));
