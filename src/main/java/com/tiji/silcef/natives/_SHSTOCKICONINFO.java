...
public class _SHSTOCKICONINFO {
    ...
    private static final long iSysImageIndex$OFFSET = $LAYOUT.byteOffset(groupElement("iSysImageIndex"));
    ...
    private static final long szPath$OFFSET = $LAYOUT.byteOffset(groupElement("szPath"));
    ...
    public static short szPath(MemorySegment struct, long index0) {
        return (short)szPath$ELEM_HANDLE.get(struct, szPath$OFFSET, index0);
    }
    ...
    public static void szPath(MemorySegment struct, long index0, short fieldValue) {
        szPath$ELEM_HANDLE.set(struct, szPath$OFFSET, index0, fieldValue);
    }
