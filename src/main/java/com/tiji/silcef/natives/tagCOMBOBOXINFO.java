...
public class tagCOMBOBOXINFO {
    ...
    private static final long rcButton$OFFSET = $LAYOUT.byteOffset(groupElement("rcButton"));
    ...
    private static final long stateButton$OFFSET = $LAYOUT.byteOffset(groupElement("stateButton"));
    ...
    private static final long hwndCombo$OFFSET = $LAYOUT.byteOffset(groupElement("hwndCombo"));
    ...
    private static final long hwndList$OFFSET = $LAYOUT.byteOffset(groupElement("hwndList"));
