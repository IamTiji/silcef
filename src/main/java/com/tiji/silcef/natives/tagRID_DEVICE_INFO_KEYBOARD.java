...
public class tagRID_DEVICE_INFO_KEYBOARD {
    ...
    private static final long dwSubType$OFFSET = $LAYOUT.byteOffset(groupElement("dwSubType"));
    ...
    private static final long dwKeyboardMode$OFFSET = $LAYOUT.byteOffset(groupElement("dwKeyboardMode"));
    ...
    private static final long dwNumberOfFunctionKeys$OFFSET = $LAYOUT.byteOffset(groupElement("dwNumberOfFunctionKeys"));
    ...
    private static final long dwNumberOfIndicators$OFFSET = $LAYOUT.byteOffset(groupElement("dwNumberOfIndicators"));
    ...
    private static final long dwNumberOfKeysTotal$OFFSET = $LAYOUT.byteOffset(groupElement("dwNumberOfKeysTotal"));
