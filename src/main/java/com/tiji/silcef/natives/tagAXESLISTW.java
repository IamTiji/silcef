...
public class tagAXESLISTW {
    ...
    private static final long axlReserved$OFFSET = $LAYOUT.byteOffset(groupElement("axlReserved"));
    ...
    private static final long axlNumAxes$OFFSET = $LAYOUT.byteOffset(groupElement("axlNumAxes"));
    ...
    private static final long axlAxisInfo$OFFSET = $LAYOUT.byteOffset(groupElement("axlAxisInfo"));
    ...
    public static MemorySegment axlAxisInfo(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)axlAxisInfo$ELEM_HANDLE.invokeExact(struct, axlAxisInfo$OFFSET, index0);
