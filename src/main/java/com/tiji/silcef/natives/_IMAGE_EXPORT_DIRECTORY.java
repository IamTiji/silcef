...
public class _IMAGE_EXPORT_DIRECTORY {
    ...
    private static final long NumberOfFunctions$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfFunctions"));
    ...
    private static final long NumberOfNames$OFFSET = $LAYOUT.byteOffset(groupElement("NumberOfNames"));
    ...
    private static final long AddressOfFunctions$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfFunctions"));
    ...
    private static final long AddressOfNames$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfNames"));
    ...
    private static final long AddressOfNameOrdinals$OFFSET = $LAYOUT.byteOffset(groupElement("AddressOfNameOrdinals"));
