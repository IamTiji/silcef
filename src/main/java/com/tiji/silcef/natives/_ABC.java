...
public class _ABC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_INT.withName("abcA"),
        cef_render_handler_capi_h.C_INT.withName("abcB"),
        cef_render_handler_capi_h.C_INT.withName("abcC")
    ).withName("_ABC");
    ...
    private static final long abcA$OFFSET = $LAYOUT.byteOffset(groupElement("abcA"));
    ...
    private static final long abcB$OFFSET = $LAYOUT.byteOffset(groupElement("abcB"));
    ...
    private static final long abcC$OFFSET = $LAYOUT.byteOffset(groupElement("abcC"));
