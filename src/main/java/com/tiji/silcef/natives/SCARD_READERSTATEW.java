...
public class SCARD_READERSTATEW {
    ...
    private static final long szReader$OFFSET = $LAYOUT.byteOffset(groupElement("szReader"));
    ...
    private static final long dwEventState$OFFSET = $LAYOUT.byteOffset(groupElement("dwEventState"));
    ...
    private static final long cbAtr$OFFSET = $LAYOUT.byteOffset(groupElement("cbAtr"));
    ...
    private static final long rgbAtr$OFFSET = $LAYOUT.byteOffset(groupElement("rgbAtr"));
    ...
    public static byte rgbAtr(MemorySegment struct, long index0) {
        return (byte)rgbAtr$ELEM_HANDLE.get(struct, rgbAtr$OFFSET, index0);
    }
    ...
    public static void rgbAtr(MemorySegment struct, long index0, byte fieldValue) {
        rgbAtr$ELEM_HANDLE.set(struct, rgbAtr$OFFSET, index0, fieldValue);
    }
