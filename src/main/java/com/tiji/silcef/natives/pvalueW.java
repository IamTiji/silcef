...
public class pvalueW {
    ...
    private static final long pv_valuename$OFFSET = $LAYOUT.byteOffset(groupElement("pv_valuename"));
    ...
    private static final long pv_valuelen$OFFSET = $LAYOUT.byteOffset(groupElement("pv_valuelen"));
    ...
    private static final long pv_value_context$OFFSET = $LAYOUT.byteOffset(groupElement("pv_value_context"));
    ...
    private static final long pv_type$OFFSET = $LAYOUT.byteOffset(groupElement("pv_type"));
