...
public class _CERT_REGISTRY_STORE_CLIENT_GPT_PARA {
    ...
    private static final long hKeyBase$OFFSET = $LAYOUT.byteOffset(groupElement("hKeyBase"));
    ...
    private static final long pwszRegPath$OFFSET = $LAYOUT.byteOffset(groupElement("pwszRegPath"));
