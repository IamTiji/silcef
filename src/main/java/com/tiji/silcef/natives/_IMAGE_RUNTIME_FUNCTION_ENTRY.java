...
public class _IMAGE_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final long BeginAddress$OFFSET = $LAYOUT.byteOffset(groupElement("BeginAddress"));
    ...
    private static final long EndAddress$OFFSET = $LAYOUT.byteOffset(groupElement("EndAddress"));
    ...
    private static final OfInt UnwindInfoAddress$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21784:5"), groupElement("UnwindInfoAddress"));
    ...
    private static final long UnwindInfoAddress$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21784:5"), groupElement("UnwindInfoAddress"));
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$21784:5"), groupElement("UnwindData"));
    ...
    private static final long UnwindData$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$21784:5"), groupElement("UnwindData"));
