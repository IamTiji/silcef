...
public class _CMS_DH_KEY_INFO {
    ...
    private static final long Algid$OFFSET = $LAYOUT.byteOffset(groupElement("Algid"));
    ...
    private static final long pszContentEncObjId$OFFSET = $LAYOUT.byteOffset(groupElement("pszContentEncObjId"));
    ...
    private static final long pReserved$OFFSET = $LAYOUT.byteOffset(groupElement("pReserved"));
