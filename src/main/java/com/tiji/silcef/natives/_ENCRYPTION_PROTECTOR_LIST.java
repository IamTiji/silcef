...
public class _ENCRYPTION_PROTECTOR_LIST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.C_LONG.withName("nProtectors"),
        MemoryLayout.paddingLayout(4),
        cef_render_handler_capi_h.C_POINTER.withName("pProtectors")
    ...
    private static final long nProtectors$OFFSET = $LAYOUT.byteOffset(groupElement("nProtectors"));
    ...
    private static final long pProtectors$OFFSET = $LAYOUT.byteOffset(groupElement("pProtectors"));
