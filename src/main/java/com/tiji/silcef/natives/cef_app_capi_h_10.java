...
class cef_app_capi_h_10 extends cef_app_capi_h_11 {
    ...
    private static final int ERROR_VSMIDK_KEYGEN_FAILURE = (int)4563L;
    /**
     * {@snippet lang=c :
     * #define ERROR_VSMIDK_KEYGEN_FAILURE 4563
     * }
     */
    public static int ERROR_VSMIDK_KEYGEN_FAILURE() {
        return ERROR_VSMIDK_KEYGEN_FAILURE;
    }
    private static final int ERROR_VSMIDK_EXPORT_FAILURE = (int)4564L;
    /**
     * {@snippet lang=c :
     * #define ERROR_VSMIDK_EXPORT_FAILURE 4564
     * }
     */
    public static int ERROR_VSMIDK_EXPORT_FAILURE() {
        return ERROR_VSMIDK_EXPORT_FAILURE;
    }
    private static final int ERROR_VSMIDK_MODULUS_MISMATCH = (int)4565L;
    /**
     * {@snippet lang=c :
     * #define ERROR_VSMIDK_MODULUS_MISMATCH 4565
     * }
     */
    public static int ERROR_VSMIDK_MODULUS_MISMATCH() {
    ...
    private static final int ERROR_CAMERA_INVALID_CONFIGURATION = (int)6350L;
    /**
     * {@snippet lang=c :
     * #define ERROR_CAMERA_INVALID_CONFIGURATION 6350
     * }
     */
    public static int ERROR_CAMERA_INVALID_CONFIGURATION() {
        return ERROR_CAMERA_INVALID_CONFIGURATION;
    }
    private static final int ERROR_CAMERA_INSUFFICIENT_BANDWIDTH = (int)6351L;
    /**
     * {@snippet lang=c :
     * #define ERROR_CAMERA_INSUFFICIENT_BANDWIDTH 6351
     * }
     */
    public static int ERROR_CAMERA_INSUFFICIENT_BANDWIDTH() {
