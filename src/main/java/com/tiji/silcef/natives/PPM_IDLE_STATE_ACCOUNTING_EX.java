...
public class PPM_IDLE_STATE_ACCOUNTING_EX {
    ...
    private static final long TotalTime$OFFSET = $LAYOUT.byteOffset(groupElement("TotalTime"));
    ...
    private static final long IdleTransitions$OFFSET = $LAYOUT.byteOffset(groupElement("IdleTransitions"));
    ...
    private static final long FailedTransitions$OFFSET = $LAYOUT.byteOffset(groupElement("FailedTransitions"));
    ...
    private static final long InvalidBucketIndex$OFFSET = $LAYOUT.byteOffset(groupElement("InvalidBucketIndex"));
    ...
    private static final long MinTimeUs$OFFSET = $LAYOUT.byteOffset(groupElement("MinTimeUs"));
    ...
    private static final long MaxTimeUs$OFFSET = $LAYOUT.byteOffset(groupElement("MaxTimeUs"));
    ...
    private static final long CancelledTransitions$OFFSET = $LAYOUT.byteOffset(groupElement("CancelledTransitions"));
    ...
    private static final long IdleTimeBuckets$OFFSET = $LAYOUT.byteOffset(groupElement("IdleTimeBuckets"));
    ...
    public static MemorySegment IdleTimeBuckets(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)IdleTimeBuckets$ELEM_HANDLE.invokeExact(struct, IdleTimeBuckets$OFFSET, index0);
