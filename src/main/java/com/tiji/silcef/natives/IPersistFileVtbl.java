...
public class IPersistFileVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("GetCurFile")
     ...
     * }
     */
    public final static class GetCurFile {
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(GetCurFile.Function.class, "apply", $DESC);
    ...
    private static final long GetCurFile$OFFSET = $LAYOUT.byteOffset(groupElement("GetCurFile"));
