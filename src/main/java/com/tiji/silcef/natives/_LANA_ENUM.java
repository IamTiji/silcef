...
public class _LANA_ENUM {
    ...
    private static final long lana$OFFSET = $LAYOUT.byteOffset(groupElement("lana"));
    ...
    public static byte lana(MemorySegment struct, long index0) {
        return (byte)lana$ELEM_HANDLE.get(struct, lana$OFFSET, index0);
    }
    ...
    public static void lana(MemorySegment struct, long index0, byte fieldValue) {
        lana$ELEM_HANDLE.set(struct, lana$OFFSET, index0, fieldValue);
    }
