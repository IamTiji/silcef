...
public class _IMAGE_HOT_PATCH_INFO {
    ...
    private static final long SequenceNumber$OFFSET = $LAYOUT.byteOffset(groupElement("SequenceNumber"));
    ...
    private static final long BaseImageList$OFFSET = $LAYOUT.byteOffset(groupElement("BaseImageList"));
    ...
    private static final long BaseImageCount$OFFSET = $LAYOUT.byteOffset(groupElement("BaseImageCount"));
    ...
    private static final long ExtraPatchSize$OFFSET = $LAYOUT.byteOffset(groupElement("ExtraPatchSize"));
    ...
    private static final OfInt MinSequenceNumber$LAYOUT = (OfInt)$LAYOUT.select(groupElement("MinSequenceNumber"));
     ...
     * }
     */
    public static final OfInt MinSequenceNumber$layout() {
        return MinSequenceNumber$LAYOUT;
    }

    private static final long MinSequenceNumber$OFFSET = $LAYOUT.byteOffset(groupElement("MinSequenceNumber"));
     ...
     * }
     */
    public static final long MinSequenceNumber$offset() {
        return MinSequenceNumber$OFFSET;
    }
     ...
     * }
     */
    public static int MinSequenceNumber(MemorySegment struct) {
        return struct.get(MinSequenceNumber$LAYOUT, MinSequenceNumber$OFFSET);
    }
     ...
     * }
     */
    public static void MinSequenceNumber(MemorySegment struct, int fieldValue) {
        struct.set(MinSequenceNumber$LAYOUT, MinSequenceNumber$OFFSET, fieldValue);
    }
