...
public class _GLYPHMETRICSFLOAT {
    ...
    private static final long gmfBlackBoxX$OFFSET = $LAYOUT.byteOffset(groupElement("gmfBlackBoxX"));
    ...
    private static final long gmfBlackBoxY$OFFSET = $LAYOUT.byteOffset(groupElement("gmfBlackBoxY"));
    ...
    private static final long gmfptGlyphOrigin$OFFSET = $LAYOUT.byteOffset(groupElement("gmfptGlyphOrigin"));
    ...
    private static final long gmfCellIncX$OFFSET = $LAYOUT.byteOffset(groupElement("gmfCellIncX"));
    ...
    private static final long gmfCellIncY$OFFSET = $LAYOUT.byteOffset(groupElement("gmfCellIncY"));
