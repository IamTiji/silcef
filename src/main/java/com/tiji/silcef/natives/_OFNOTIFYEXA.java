...
public class _OFNOTIFYEXA {
    ...
    private static final long lpOFN$OFFSET = $LAYOUT.byteOffset(groupElement("lpOFN"));
    ...
    private static final long psf$OFFSET = $LAYOUT.byteOffset(groupElement("psf"));
    ...
    private static final long pidl$OFFSET = $LAYOUT.byteOffset(groupElement("pidl"));
