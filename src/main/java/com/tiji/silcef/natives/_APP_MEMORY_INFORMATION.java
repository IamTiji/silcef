...
public class _APP_MEMORY_INFORMATION {
    ...
    private static final long AvailableCommit$OFFSET = $LAYOUT.byteOffset(groupElement("AvailableCommit"));
    ...
    private static final long PrivateCommitUsage$OFFSET = $LAYOUT.byteOffset(groupElement("PrivateCommitUsage"));
    ...
    private static final long PeakPrivateCommitUsage$OFFSET = $LAYOUT.byteOffset(groupElement("PeakPrivateCommitUsage"));
    ...
    private static final long TotalCommitUsage$OFFSET = $LAYOUT.byteOffset(groupElement("TotalCommitUsage"));
