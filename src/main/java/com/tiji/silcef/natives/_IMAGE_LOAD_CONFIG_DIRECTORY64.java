...
public class _IMAGE_LOAD_CONFIG_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_LONG.withName("GlobalFlagsClear"),
        cef_master_h.C_LONG.withName("GlobalFlagsSet"),
        cef_master_h.C_LONG.withName("CriticalSectionDefaultTimeout"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("DeCommitFreeBlockThreshold"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("DeCommitTotalFreeThreshold"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("LockPrefixTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("MaximumAllocationSize"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("VirtualMemoryThreshold"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("ProcessAffinityMask"),
        cef_master_h.C_LONG.withName("ProcessHeapFlags"),
        cef_master_h.C_SHORT.withName("CSDVersion"),
        cef_master_h.C_SHORT.withName("DependentLoadFlags"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("EditList"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SecurityCookie"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SEHandlerTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("SEHandlerCount"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardCFCheckFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardCFDispatchFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardCFFunctionTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardCFFunctionCount"),
        cef_master_h.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryCount"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardLongJumpTargetTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardLongJumpTargetCount"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("DynamicValueRelocTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("CHPEMetadataPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardRFFailureRoutine"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardRFFailureRoutineFunctionPointer"),
        cef_master_h.C_LONG.withName("DynamicValueRelocTableOffset"),
        cef_master_h.C_SHORT.withName("DynamicValueRelocTableSection"),
        cef_master_h.C_SHORT.withName("Reserved2"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardRFVerifyStackPointerFunctionPointer"),
        cef_master_h.C_LONG.withName("HotPatchTableOffset"),
        cef_master_h.C_LONG.withName("Reserved3"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("EnclaveConfigurationPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("VolatileMetadataPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardEHContinuationTable"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardEHContinuationCount"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardXFGCheckFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardXFGDispatchFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardXFGTableDispatchFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("CastGuardOsDeterminedFailureMode"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("GuardMemcpyFunctionPointer"),
        cef_master_h.align(cef_master_h.C_LONG_LONG, 4).withName("UmaFunctionPointers")
