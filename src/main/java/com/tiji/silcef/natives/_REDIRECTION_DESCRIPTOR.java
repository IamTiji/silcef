...
public class _REDIRECTION_DESCRIPTOR {
    ...
    private static final long FunctionCount$OFFSET = $LAYOUT.byteOffset(groupElement("FunctionCount"));
    ...
    private static final long Redirections$OFFSET = $LAYOUT.byteOffset(groupElement("Redirections"));
