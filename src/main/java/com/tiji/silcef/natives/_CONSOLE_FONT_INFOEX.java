...
public class _CONSOLE_FONT_INFOEX {
    ...
    private static final long nFont$OFFSET = $LAYOUT.byteOffset(groupElement("nFont"));
    ...
    private static final long dwFontSize$OFFSET = $LAYOUT.byteOffset(groupElement("dwFontSize"));
    ...
    private static final long FaceName$OFFSET = $LAYOUT.byteOffset(groupElement("FaceName"));
    ...
    public static short FaceName(MemorySegment struct, long index0) {
        return (short)FaceName$ELEM_HANDLE.get(struct, FaceName$OFFSET, index0);
    }
    ...
    public static void FaceName(MemorySegment struct, long index0, short fieldValue) {
        FaceName$ELEM_HANDLE.set(struct, FaceName$OFFSET, index0, fieldValue);
    }
