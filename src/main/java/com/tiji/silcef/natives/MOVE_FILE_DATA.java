...
public class MOVE_FILE_DATA {
    ...
    private static final long FileHandle$OFFSET = $LAYOUT.byteOffset(groupElement("FileHandle"));
    ...
    private static final long StartingLcn$OFFSET = $LAYOUT.byteOffset(groupElement("StartingLcn"));
    ...
    private static final long ClusterCount$OFFSET = $LAYOUT.byteOffset(groupElement("ClusterCount"));
