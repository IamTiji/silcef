...
public class tagTOUCHINPUT {
    ...
    private static final long hSource$OFFSET = $LAYOUT.byteOffset(groupElement("hSource"));
    ...
    private static final long dwMask$OFFSET = $LAYOUT.byteOffset(groupElement("dwMask"));
    ...
    private static final long dwExtraInfo$OFFSET = $LAYOUT.byteOffset(groupElement("dwExtraInfo"));
    ...
    private static final long cxContact$OFFSET = $LAYOUT.byteOffset(groupElement("cxContact"));
    ...
    private static final long cyContact$OFFSET = $LAYOUT.byteOffset(groupElement("cyContact"));
