...
public class PPM_WMI_PERF_STATE {
    ...
    private static final long Frequency$OFFSET = $LAYOUT.byteOffset(groupElement("Frequency"));
    ...
    private static final long PercentFrequency$OFFSET = $LAYOUT.byteOffset(groupElement("PercentFrequency"));
    ...
    private static final long IncreaseLevel$OFFSET = $LAYOUT.byteOffset(groupElement("IncreaseLevel"));
    ...
    private static final long DecreaseLevel$OFFSET = $LAYOUT.byteOffset(groupElement("DecreaseLevel"));
    ...
    private static final long Control$OFFSET = $LAYOUT.byteOffset(groupElement("Control"));
