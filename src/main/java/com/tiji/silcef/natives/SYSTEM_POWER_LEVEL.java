...
public class SYSTEM_POWER_LEVEL {
    ...
    private static final long BatteryLevel$OFFSET = $LAYOUT.byteOffset(groupElement("BatteryLevel"));
    ...
    private static final long PowerPolicy$OFFSET = $LAYOUT.byteOffset(groupElement("PowerPolicy"));
    ...
    private static final long MinSystemState$OFFSET = $LAYOUT.byteOffset(groupElement("MinSystemState"));
