...
public class tagRECONVERTSTRING {
    ...
    private static final long dwStrLen$OFFSET = $LAYOUT.byteOffset(groupElement("dwStrLen"));
    ...
    private static final long dwStrOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwStrOffset"));
    ...
    private static final long dwCompStrLen$OFFSET = $LAYOUT.byteOffset(groupElement("dwCompStrLen"));
    ...
    private static final long dwCompStrOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwCompStrOffset"));
    ...
    private static final long dwTargetStrLen$OFFSET = $LAYOUT.byteOffset(groupElement("dwTargetStrLen"));
    ...
    private static final long dwTargetStrOffset$OFFSET = $LAYOUT.byteOffset(groupElement("dwTargetStrOffset"));
