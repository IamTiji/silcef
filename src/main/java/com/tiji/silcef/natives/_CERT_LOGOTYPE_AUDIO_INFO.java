...
public class _CERT_LOGOTYPE_AUDIO_INFO {
    ...
    private static final long dwPlayTime$OFFSET = $LAYOUT.byteOffset(groupElement("dwPlayTime"));
    ...
    private static final long dwChannels$OFFSET = $LAYOUT.byteOffset(groupElement("dwChannels"));
    ...
    private static final long dwSampleRate$OFFSET = $LAYOUT.byteOffset(groupElement("dwSampleRate"));
