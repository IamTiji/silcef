 ...
 * }
 */
public final class PFN_CMSG_IMPORT_MAIL_LIST {

    private PFN_CMSG_IMPORT_MAIL_LIST() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CMSG_IMPORT_MAIL_LIST.Function.class, "apply", $DESC);
