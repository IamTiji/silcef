...
public class _RPC_BINDING_HANDLE_SECURITY_V1_A {
    ...
    private static final long ServerPrincName$OFFSET = $LAYOUT.byteOffset(groupElement("ServerPrincName"));
    ...
    private static final long AuthnLevel$OFFSET = $LAYOUT.byteOffset(groupElement("AuthnLevel"));
    ...
    private static final long AuthnSvc$OFFSET = $LAYOUT.byteOffset(groupElement("AuthnSvc"));
    ...
    private static final long AuthIdentity$OFFSET = $LAYOUT.byteOffset(groupElement("AuthIdentity"));
    ...
    private static final long SecurityQos$OFFSET = $LAYOUT.byteOffset(groupElement("SecurityQos"));
