...
public class tagGCP_RESULTSW {
    ...
    private static final long lpOutString$OFFSET = $LAYOUT.byteOffset(groupElement("lpOutString"));
    ...
    private static final long lpOrder$OFFSET = $LAYOUT.byteOffset(groupElement("lpOrder"));
    ...
    private static final long lpDx$OFFSET = $LAYOUT.byteOffset(groupElement("lpDx"));
    ...
    private static final long lpCaretPos$OFFSET = $LAYOUT.byteOffset(groupElement("lpCaretPos"));
    ...
    private static final long lpGlyphs$OFFSET = $LAYOUT.byteOffset(groupElement("lpGlyphs"));
    ...
    private static final long nGlyphs$OFFSET = $LAYOUT.byteOffset(groupElement("nGlyphs"));
    ...
    private static final long nMaxFit$OFFSET = $LAYOUT.byteOffset(groupElement("nMaxFit"));
