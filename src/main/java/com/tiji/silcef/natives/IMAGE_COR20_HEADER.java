...
public class IMAGE_COR20_HEADER {
    ...
    private static final long MajorRuntimeVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MajorRuntimeVersion"));
    ...
    private static final long MinorRuntimeVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MinorRuntimeVersion"));
    ...
    private static final OfInt EntryPointToken$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$22198:5"), groupElement("EntryPointToken"));
    ...
    private static final long EntryPointToken$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22198:5"), groupElement("EntryPointToken"));
    ...
    private static final OfInt EntryPointRVA$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$22198:5"), groupElement("EntryPointRVA"));
    ...
    private static final long EntryPointRVA$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$22198:5"), groupElement("EntryPointRVA"));
    ...
    private static final long Resources$OFFSET = $LAYOUT.byteOffset(groupElement("Resources"));
    ...
    private static final long StrongNameSignature$OFFSET = $LAYOUT.byteOffset(groupElement("StrongNameSignature"));
    ...
    private static final long CodeManagerTable$OFFSET = $LAYOUT.byteOffset(groupElement("CodeManagerTable"));
    ...
    private static final long VTableFixups$OFFSET = $LAYOUT.byteOffset(groupElement("VTableFixups"));
    ...
    private static final long ExportAddressTableJumps$OFFSET = $LAYOUT.byteOffset(groupElement("ExportAddressTableJumps"));
    ...
    private static final long ManagedNativeHeader$OFFSET = $LAYOUT.byteOffset(groupElement("ManagedNativeHeader"));
