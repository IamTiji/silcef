...
public class _CERT_SYSTEM_STORE_RELOCATE_PARA {
    ...
    private static final AddressLayout hKeyBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9689:5"), groupElement("hKeyBase"));
    ...
    private static final long hKeyBase$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9689:5"), groupElement("hKeyBase"));
    ...
    private static final AddressLayout pvBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9689:5"), groupElement("pvBase"));
    ...
    private static final long pvBase$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9689:5"), groupElement("pvBase"));
    ...
    private static final AddressLayout pvSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9693:5"), groupElement("pvSystemStore"));
    ...
    private static final long pvSystemStore$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9693:5"), groupElement("pvSystemStore"));
    ...
    private static final AddressLayout pszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9693:5"), groupElement("pszSystemStore"));
    ...
    private static final long pszSystemStore$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9693:5"), groupElement("pszSystemStore"));
    ...
    private static final AddressLayout pwszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9693:5"), groupElement("pwszSystemStore"));
    ...
    private static final long pwszSystemStore$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$9693:5"), groupElement("pwszSystemStore"));
