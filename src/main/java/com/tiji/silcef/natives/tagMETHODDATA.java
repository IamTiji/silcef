...
public class tagMETHODDATA {
    ...
    private static final long ppdata$OFFSET = $LAYOUT.byteOffset(groupElement("ppdata"));
    ...
    private static final long dispid$OFFSET = $LAYOUT.byteOffset(groupElement("dispid"));
    ...
    private static final long iMeth$OFFSET = $LAYOUT.byteOffset(groupElement("iMeth"));
    ...
    private static final long cArgs$OFFSET = $LAYOUT.byteOffset(groupElement("cArgs"));
    ...
    private static final long vtReturn$OFFSET = $LAYOUT.byteOffset(groupElement("vtReturn"));
