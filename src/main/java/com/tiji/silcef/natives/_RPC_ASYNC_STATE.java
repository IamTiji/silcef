...
public class _RPC_ASYNC_STATE {
    ...
    private static final long StubInfo$OFFSET = $LAYOUT.byteOffset(groupElement("StubInfo"));
    ...
    private static final long UserInfo$OFFSET = $LAYOUT.byteOffset(groupElement("UserInfo"));
    ...
    private static final long RuntimeInfo$OFFSET = $LAYOUT.byteOffset(groupElement("RuntimeInfo"));
    ...
    private static final long NotificationType$OFFSET = $LAYOUT.byteOffset(groupElement("NotificationType"));
