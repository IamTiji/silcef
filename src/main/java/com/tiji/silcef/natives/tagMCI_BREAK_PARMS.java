...
public class tagMCI_BREAK_PARMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_INT, 1).withName("nVirtKey"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_POINTER, 1).withName("hwndBreak")
    ...
    private static final long nVirtKey$OFFSET = $LAYOUT.byteOffset(groupElement("nVirtKey"));
    ...
    private static final long hwndBreak$OFFSET = $LAYOUT.byteOffset(groupElement("hwndBreak"));
