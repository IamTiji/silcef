 ...
 * }
 */
public final class PFN_CERT_IS_WEAK_HASH {

    private PFN_CERT_IS_WEAK_HASH() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_CERT_IS_WEAK_HASH.Function.class, "apply", $DESC);
