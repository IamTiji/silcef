 ...
 * }
 */
public final class PFN_EXPORT_PRIV_KEY_FUNC {

    private PFN_EXPORT_PRIV_KEY_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(PFN_EXPORT_PRIV_KEY_FUNC.Function.class, "apply", $DESC);
