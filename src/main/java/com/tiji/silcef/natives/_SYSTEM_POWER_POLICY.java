...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_master_h.C_INT.withName("LidOpenWake"),
        cef_master_h.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        cef_master_h.C_LONG.withName("IdleTimeout"),
        cef_master_h.C_CHAR.withName("IdleSensitivity"),
        cef_master_h.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, cef_master_h.C_CHAR).withName("Spare2"),
        cef_master_h.C_INT.withName("MinSleep"),
        cef_master_h.C_INT.withName("MaxSleep"),
        cef_master_h.C_INT.withName("ReducedLatencySleep"),
        cef_master_h.C_LONG.withName("WinLogonFlags"),
        cef_master_h.C_LONG.withName("Spare3"),
        cef_master_h.C_LONG.withName("DozeS4Timeout"),
        cef_master_h.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        cef_master_h.C_LONG.withName("VideoTimeout"),
        cef_master_h.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, cef_master_h.C_LONG).withName("VideoReserved"),
        cef_master_h.C_LONG.withName("SpindownTimeout"),
        cef_master_h.C_CHAR.withName("OptimizeForPower"),
        cef_master_h.C_CHAR.withName("FanThrottleTolerance"),
        cef_master_h.C_CHAR.withName("ForcedThrottle"),
