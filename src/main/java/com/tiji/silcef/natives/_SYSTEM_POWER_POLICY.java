...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("LidOpenWake"),
        cef_render_handler_capi_h.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        cef_render_handler_capi_h.C_LONG.withName("IdleTimeout"),
        cef_render_handler_capi_h.C_CHAR.withName("IdleSensitivity"),
        cef_render_handler_capi_h.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, cef_render_handler_capi_h.C_CHAR).withName("Spare2"),
        cef_render_handler_capi_h.C_INT.withName("MinSleep"),
        cef_render_handler_capi_h.C_INT.withName("MaxSleep"),
        cef_render_handler_capi_h.C_INT.withName("ReducedLatencySleep"),
        cef_render_handler_capi_h.C_LONG.withName("WinLogonFlags"),
        cef_render_handler_capi_h.C_LONG.withName("Spare3"),
        cef_render_handler_capi_h.C_LONG.withName("DozeS4Timeout"),
        cef_render_handler_capi_h.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        cef_render_handler_capi_h.C_LONG.withName("VideoTimeout"),
        cef_render_handler_capi_h.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, cef_render_handler_capi_h.C_LONG).withName("VideoReserved"),
        cef_render_handler_capi_h.C_LONG.withName("SpindownTimeout"),
        cef_render_handler_capi_h.C_CHAR.withName("OptimizeForPower"),
        cef_render_handler_capi_h.C_CHAR.withName("FanThrottleTolerance"),
        cef_render_handler_capi_h.C_CHAR.withName("ForcedThrottle"),
    ...
    private static final long PowerButton$OFFSET = $LAYOUT.byteOffset(groupElement("PowerButton"));
    ...
    private static final long SleepButton$OFFSET = $LAYOUT.byteOffset(groupElement("SleepButton"));
    ...
    private static final long LidClose$OFFSET = $LAYOUT.byteOffset(groupElement("LidClose"));
    ...
    private static final long LidOpenWake$OFFSET = $LAYOUT.byteOffset(groupElement("LidOpenWake"));
    ...
    private static final long Idle$OFFSET = $LAYOUT.byteOffset(groupElement("Idle"));
    ...
    private static final long IdleTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("IdleTimeout"));
    ...
    private static final long IdleSensitivity$OFFSET = $LAYOUT.byteOffset(groupElement("IdleSensitivity"));
    ...
    private static final long DynamicThrottle$OFFSET = $LAYOUT.byteOffset(groupElement("DynamicThrottle"));
    ...
    private static final long Spare2$OFFSET = $LAYOUT.byteOffset(groupElement("Spare2"));
    ...
    public static byte Spare2(MemorySegment struct, long index0) {
        return (byte)Spare2$ELEM_HANDLE.get(struct, Spare2$OFFSET, index0);
    }
    ...
    public static void Spare2(MemorySegment struct, long index0, byte fieldValue) {
        Spare2$ELEM_HANDLE.set(struct, Spare2$OFFSET, index0, fieldValue);
    }
    ...
    private static final long MinSleep$OFFSET = $LAYOUT.byteOffset(groupElement("MinSleep"));
    ...
    private static final long MaxSleep$OFFSET = $LAYOUT.byteOffset(groupElement("MaxSleep"));
    ...
    private static final long ReducedLatencySleep$OFFSET = $LAYOUT.byteOffset(groupElement("ReducedLatencySleep"));
    ...
    private static final long WinLogonFlags$OFFSET = $LAYOUT.byteOffset(groupElement("WinLogonFlags"));
    ...
    private static final long DozeS4Timeout$OFFSET = $LAYOUT.byteOffset(groupElement("DozeS4Timeout"));
    ...
    private static final long BroadcastCapacityResolution$OFFSET = $LAYOUT.byteOffset(groupElement("BroadcastCapacityResolution"));
    ...
    private static final long DischargePolicy$OFFSET = $LAYOUT.byteOffset(groupElement("DischargePolicy"));
    ...
    public static MemorySegment DischargePolicy(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)DischargePolicy$ELEM_HANDLE.invokeExact(struct, DischargePolicy$OFFSET, index0);
    ...
    private static final long VideoTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("VideoTimeout"));
    ...
    private static final long VideoDimDisplay$OFFSET = $LAYOUT.byteOffset(groupElement("VideoDimDisplay"));
    ...
    private static final long VideoReserved$OFFSET = $LAYOUT.byteOffset(groupElement("VideoReserved"));
    ...
    public static int VideoReserved(MemorySegment struct, long index0) {
        return (int)VideoReserved$ELEM_HANDLE.get(struct, VideoReserved$OFFSET, index0);
    }
    ...
    public static void VideoReserved(MemorySegment struct, long index0, int fieldValue) {
        VideoReserved$ELEM_HANDLE.set(struct, VideoReserved$OFFSET, index0, fieldValue);
    }
    ...
    private static final long SpindownTimeout$OFFSET = $LAYOUT.byteOffset(groupElement("SpindownTimeout"));
    ...
    private static final long OptimizeForPower$OFFSET = $LAYOUT.byteOffset(groupElement("OptimizeForPower"));
    ...
    private static final long FanThrottleTolerance$OFFSET = $LAYOUT.byteOffset(groupElement("FanThrottleTolerance"));
    ...
    private static final long ForcedThrottle$OFFSET = $LAYOUT.byteOffset(groupElement("ForcedThrottle"));
    ...
    private static final long OverThrottled$OFFSET = $LAYOUT.byteOffset(groupElement("OverThrottled"));
