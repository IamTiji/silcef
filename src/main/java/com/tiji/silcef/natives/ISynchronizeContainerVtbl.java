...
public class ISynchronizeContainerVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("AddSynchronize"),
        cef_render_handler_capi_h.C_POINTER.withName("WaitMultiple")
     ...
     * }
     */
    public final static class AddSynchronize {

        private AddSynchronize() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(AddSynchronize.Function.class, "apply", $DESC);
    ...
    private static final long AddSynchronize$OFFSET = $LAYOUT.byteOffset(groupElement("AddSynchronize"));
     ...
     * }
     */
    public final static class WaitMultiple {

        private WaitMultiple() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(WaitMultiple.Function.class, "apply", $DESC);
    ...
    private static final long WaitMultiple$OFFSET = $LAYOUT.byteOffset(groupElement("WaitMultiple"));
