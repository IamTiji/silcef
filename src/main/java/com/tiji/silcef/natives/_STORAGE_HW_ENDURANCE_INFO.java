...
public class _STORAGE_HW_ENDURANCE_INFO {
    ...
    private static final long ValidFields$OFFSET = $LAYOUT.byteOffset(groupElement("ValidFields"));
    ...
    private static final long LifePercentage$OFFSET = $LAYOUT.byteOffset(groupElement("LifePercentage"));
    ...
    private static final long BytesReadCount$OFFSET = $LAYOUT.byteOffset(groupElement("BytesReadCount"));
    ...
    public static byte BytesReadCount(MemorySegment struct, long index0) {
        return (byte)BytesReadCount$ELEM_HANDLE.get(struct, BytesReadCount$OFFSET, index0);
    }
    ...
    public static void BytesReadCount(MemorySegment struct, long index0, byte fieldValue) {
        BytesReadCount$ELEM_HANDLE.set(struct, BytesReadCount$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ByteWriteCount$OFFSET = $LAYOUT.byteOffset(groupElement("ByteWriteCount"));
    ...
    public static byte ByteWriteCount(MemorySegment struct, long index0) {
        return (byte)ByteWriteCount$ELEM_HANDLE.get(struct, ByteWriteCount$OFFSET, index0);
    }
    ...
    public static void ByteWriteCount(MemorySegment struct, long index0, byte fieldValue) {
        ByteWriteCount$ELEM_HANDLE.set(struct, ByteWriteCount$OFFSET, index0, fieldValue);
    }
