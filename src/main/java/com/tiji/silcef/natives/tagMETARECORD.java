...
public class tagMETARECORD {
    ...
    private static final long rdSize$OFFSET = $LAYOUT.byteOffset(groupElement("rdSize"));
    ...
    private static final long rdFunction$OFFSET = $LAYOUT.byteOffset(groupElement("rdFunction"));
    ...
    private static final long rdParm$OFFSET = $LAYOUT.byteOffset(groupElement("rdParm"));
    ...
    public static short rdParm(MemorySegment struct, long index0) {
        return (short)rdParm$ELEM_HANDLE.get(struct, rdParm$OFFSET, index0);
    }
    ...
    public static void rdParm(MemorySegment struct, long index0, short fieldValue) {
        rdParm$ELEM_HANDLE.set(struct, rdParm$OFFSET, index0, fieldValue);
    }
