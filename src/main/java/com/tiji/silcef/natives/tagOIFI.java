...
public class tagOIFI {
    ...
    private static final long fMDIApp$OFFSET = $LAYOUT.byteOffset(groupElement("fMDIApp"));
    ...
    private static final long hwndFrame$OFFSET = $LAYOUT.byteOffset(groupElement("hwndFrame"));
    ...
    private static final long haccel$OFFSET = $LAYOUT.byteOffset(groupElement("haccel"));
    ...
    private static final long cAccelEntries$OFFSET = $LAYOUT.byteOffset(groupElement("cAccelEntries"));
