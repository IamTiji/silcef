...
public class _CRL_DIST_POINT {
    ...
    private static final long ReasonFlags$OFFSET = $LAYOUT.byteOffset(groupElement("ReasonFlags"));
    ...
    private static final long CRLIssuer$OFFSET = $LAYOUT.byteOffset(groupElement("CRLIssuer"));
