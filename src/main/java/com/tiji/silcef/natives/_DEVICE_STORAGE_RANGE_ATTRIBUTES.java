...
public class _DEVICE_STORAGE_RANGE_ATTRIBUTES {
    ...
    private static final long LengthInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("LengthInBytes"));
    ...
    private static final OfInt AllFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$4920:5"), groupElement("AllFlags"));
    ...
    private static final long AllFlags$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$4920:5"), groupElement("AllFlags"));
