...
public class _ENCRYPTED_FILE_METADATA_SIGNATURE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_master_h.C_LONG.withName("dwEfsAccessType"),
        MemoryLayout.paddingLayout(4),
        cef_master_h.C_POINTER.withName("pCertificatesAdded"),
        cef_master_h.C_POINTER.withName("pEncryptionCertificate"),
        cef_master_h.C_POINTER.withName("pEfsStreamSignature")
