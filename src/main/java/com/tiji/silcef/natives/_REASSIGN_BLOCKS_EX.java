...
public class _REASSIGN_BLOCKS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_SHORT, 1).withName("Reserved"),
        cef_render_handler_capi_h.align(cef_render_handler_capi_h.C_SHORT, 1).withName("Count"),
        MemoryLayout.sequenceLayout(1, cef_render_handler_capi_h.align(_LARGE_INTEGER.layout(), 1)).withName("BlockNumber")
    ...
    private static final long BlockNumber$OFFSET = $LAYOUT.byteOffset(groupElement("BlockNumber"));
    ...
    public static MemorySegment BlockNumber(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)BlockNumber$ELEM_HANDLE.invokeExact(struct, BlockNumber$OFFSET, index0);
