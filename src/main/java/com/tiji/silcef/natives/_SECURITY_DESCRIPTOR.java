...
public class _SECURITY_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_POINTER.withName("Owner"),
        cef_render_handler_capi_h.C_POINTER.withName("Group"),
        cef_render_handler_capi_h.C_POINTER.withName("Sacl"),
        cef_render_handler_capi_h.C_POINTER.withName("Dacl")
    ...
    private static final long Sbz1$OFFSET = $LAYOUT.byteOffset(groupElement("Sbz1"));
    ...
    private static final long Sacl$OFFSET = $LAYOUT.byteOffset(groupElement("Sacl"));
    ...
    private static final long Dacl$OFFSET = $LAYOUT.byteOffset(groupElement("Dacl"));
