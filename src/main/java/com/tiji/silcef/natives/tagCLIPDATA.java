...
public class tagCLIPDATA {
    ...
    private static final long ulClipFmt$OFFSET = $LAYOUT.byteOffset(groupElement("ulClipFmt"));
    ...
    private static final long pClipData$OFFSET = $LAYOUT.byteOffset(groupElement("pClipData"));
