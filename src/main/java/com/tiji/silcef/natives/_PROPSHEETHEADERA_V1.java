...
public class _PROPSHEETHEADERA_V1 {
    ...
    private static final long hIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("hIcon"));
    ...
    private static final long pszIcon$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("pszIcon"));
    ...
    private static final long nStartPage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("nStartPage"));
    ...
    private static final long pStartPage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("pStartPage"));
    ...
    private static final long ppsp$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("ppsp"));
    ...
    private static final long phpage$OFFSET = $LAYOUT.byteOffset(groupElement("$anon$473:5"), groupElement("phpage"));
