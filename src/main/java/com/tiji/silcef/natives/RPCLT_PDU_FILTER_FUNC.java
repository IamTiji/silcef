 ...
 * }
 */
public final class RPCLT_PDU_FILTER_FUNC {

    private RPCLT_PDU_FILTER_FUNC() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(RPCLT_PDU_FILTER_FUNC.Function.class, "apply", $DESC);
