...
public class _IMAGE_ENCLAVE_IMPORT {
    ...
    private static final long MinimumSecurityVersion$OFFSET = $LAYOUT.byteOffset(groupElement("MinimumSecurityVersion"));
    ...
    private static final long UniqueOrAuthorID$OFFSET = $LAYOUT.byteOffset(groupElement("UniqueOrAuthorID"));
    ...
    public static byte UniqueOrAuthorID(MemorySegment struct, long index0) {
        return (byte)UniqueOrAuthorID$ELEM_HANDLE.get(struct, UniqueOrAuthorID$OFFSET, index0);
    }
    ...
    public static void UniqueOrAuthorID(MemorySegment struct, long index0, byte fieldValue) {
        UniqueOrAuthorID$ELEM_HANDLE.set(struct, UniqueOrAuthorID$OFFSET, index0, fieldValue);
    }
    ...
    private static final long ImportName$OFFSET = $LAYOUT.byteOffset(groupElement("ImportName"));
