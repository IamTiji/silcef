 ...
 * }
 */
public final class I_RpcPerformCalloutFn {

    private I_RpcPerformCalloutFn() {
    ...
    private static final MethodHandle UP$MH = cef_render_handler_capi_h.upcallHandle(I_RpcPerformCalloutFn.Function.class, "apply", $DESC);
