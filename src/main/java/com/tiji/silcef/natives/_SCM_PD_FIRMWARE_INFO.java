...
public class _SCM_PD_FIRMWARE_INFO {
    ...
    private static final long NextActiveSlot$OFFSET = $LAYOUT.byteOffset(groupElement("NextActiveSlot"));
    ...
    public static MemorySegment Slots(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Slots$ELEM_HANDLE.invokeExact(struct, Slots$OFFSET, index0);
