...
public class _UNWIND_HISTORY_TABLE {
    ...
    private static final long LocalHint$OFFSET = $LAYOUT.byteOffset(groupElement("LocalHint"));
    ...
    private static final long GlobalHint$OFFSET = $LAYOUT.byteOffset(groupElement("GlobalHint"));
    ...
    private static final long Once$OFFSET = $LAYOUT.byteOffset(groupElement("Once"));
    ...
    private static final long LowAddress$OFFSET = $LAYOUT.byteOffset(groupElement("LowAddress"));
    ...
    private static final long HighAddress$OFFSET = $LAYOUT.byteOffset(groupElement("HighAddress"));
    ...
    public static MemorySegment Entry(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Entry$ELEM_HANDLE.invokeExact(struct, Entry$OFFSET, index0);
