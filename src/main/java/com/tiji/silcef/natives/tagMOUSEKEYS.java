...
public class tagMOUSEKEYS {
    ...
    private static final long iMaxSpeed$OFFSET = $LAYOUT.byteOffset(groupElement("iMaxSpeed"));
    ...
    private static final long iTimeToMaxSpeed$OFFSET = $LAYOUT.byteOffset(groupElement("iTimeToMaxSpeed"));
    ...
    private static final long iCtrlSpeed$OFFSET = $LAYOUT.byteOffset(groupElement("iCtrlSpeed"));
