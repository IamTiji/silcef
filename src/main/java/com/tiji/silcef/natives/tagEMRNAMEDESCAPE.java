...
public class tagEMRNAMEDESCAPE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        cef_render_handler_capi_h.C_INT.withName("cbDriver"),
    ...
    private static final long iEscape$OFFSET = $LAYOUT.byteOffset(groupElement("iEscape"));
    ...
    private static final long cbDriver$OFFSET = $LAYOUT.byteOffset(groupElement("cbDriver"));
    ...
    private static final long cbEscData$OFFSET = $LAYOUT.byteOffset(groupElement("cbEscData"));
    ...
    private static final long EscData$OFFSET = $LAYOUT.byteOffset(groupElement("EscData"));
    ...
    public static byte EscData(MemorySegment struct, long index0) {
        return (byte)EscData$ELEM_HANDLE.get(struct, EscData$OFFSET, index0);
    }
    ...
    public static void EscData(MemorySegment struct, long index0, byte fieldValue) {
        EscData$ELEM_HANDLE.set(struct, EscData$OFFSET, index0, fieldValue);
    }
