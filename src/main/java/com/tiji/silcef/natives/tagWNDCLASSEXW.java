...
public class tagWNDCLASSEXW {
    ...
    private static final long lpfnWndProc$OFFSET = $LAYOUT.byteOffset(groupElement("lpfnWndProc"));
    ...
    private static final long cbClsExtra$OFFSET = $LAYOUT.byteOffset(groupElement("cbClsExtra"));
    ...
    private static final long cbWndExtra$OFFSET = $LAYOUT.byteOffset(groupElement("cbWndExtra"));
    ...
    private static final long hCursor$OFFSET = $LAYOUT.byteOffset(groupElement("hCursor"));
    ...
    private static final long hbrBackground$OFFSET = $LAYOUT.byteOffset(groupElement("hbrBackground"));
    ...
    private static final long lpszMenuName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszMenuName"));
    ...
    private static final long lpszClassName$OFFSET = $LAYOUT.byteOffset(groupElement("lpszClassName"));
    ...
    private static final long hIconSm$OFFSET = $LAYOUT.byteOffset(groupElement("hIconSm"));
